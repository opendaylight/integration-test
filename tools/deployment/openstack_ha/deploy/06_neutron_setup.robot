...
Install Neutron
    ...
    Run Keyword If    2 < ${NUM_NEUTRON_NODES}    Install Configure Neutron    ${OS_NEUTRON_2_IP}    ${OS_NEUTRON_2_IP}    ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}
    Run Keyword If    2 < ${NUM_NEUTRON_NODES}    Install Configure Neutron    ${OS_NEUTRON_3_IP}    ${OS_NEUTRON_3_IP}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}

...
Install Neutron
    ...
    Install Configure Neutron    ${OS_NEUTRON_1_IP}    ${OS_NEUTRON_1_IP}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}
    Run Keyword If    2 < ${NUM_NEUTRON_NODES}    Install Configure Neutron    ${OS_NEUTRON_2_IP}    ${OS_NEUTRON_2_IP}    ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}
    Run Keyword If    2 < ${NUM_NEUTRON_NODES}    Install Configure Neutron    ${OS_NEUTRON_3_IP}    ${OS_NEUTRON_3_IP}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}     ${HAPROXY_HOSTNAME}    ${HAPROXY_HOSTNAME}
    ...
    Run Keyword If    2 < ${NUM_NEUTRON_NODES}    Generic HAProxy Entry    ${HAPROXY_IP}    ${HAPROXY_IP}    9796    neutron_server    9696      ${OS_NEUTRON_1_IP}    ${OS_NEUTRON_2_IP}     ${OS_NEUTRON_3_IP}
...
Install Configure Neutron
    [Arguments]    ${os_node_cxn}    ${host_ip}    ${host_name}    ${db_host_name}     ${auth_host_name}     ${odl_host_name}     ${neutron_host_name}

...
def get_prefixes(odl_ip, port, uri, auth, prefix_base=None, prefix_len=None,
    ...
    Args:
        ...
        :param xml_data: xml template for building the xml data
...
def create_prefixes(odl_ip, port, uri, auth, prefix_base=None, prefix_len=None,
    ...
    rsp = send_request("POST", odl_ip, port, uri, auth, xml_data)
    return rsp
...
def delete_prefixes(odl_ip, port, uri, auth, prefix_base, prefix_len, count,
    ...
    Args:
        ...
        :param xml_data: xml template for building the xml data (not used)
...
_commands = ["add", "create", "delete", "delete-all", "get"]
...
if __name__ == "__main__":
    ...
    if command == "create":
        create_prefixes(odl_ip, port, uri, auth, xml_template=xml_template)
    if command == "add":

...
class MessageGenerator(object):
    ...
    def __init__(self, args):
        ...
        Arguments:
            :args: parsed command-line arguments used for initialisation
        Notes:
        ...
        self.log_error = args.loglevel <= logging.ERROR
        self.log_warning = args.loglevel <= logging.WARNING
    ...
    def store_results(self, file_name=None, threshold=None):
        ...
        logging.info('    Updates sent during straightforward phase: ' +
        ...
        if self.phase1_updates_sent >= threshold:
            ...
            totals1 = None
            performance1 = None
        logging.info('    Updates sent during mixed phase: ' +
        ...
        if self.phase2_updates_sent >= threshold:
            ...
            totals2 = None
            performance2 = None
        logging.debug('    Threshold for reporting is: ' + str(threshold))
        # making labels
        phase1_label = ('+' + str(self.prefix_count_to_add_default) +
                        ' routes per UPDATE')
        if self.single_update_default:

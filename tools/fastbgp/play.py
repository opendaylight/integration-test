...
#        msg_out = self.update_message_without_prefix + prefix_packed
        PrefixList = self.get_prefix_list(self.Iteration, count=1)
        msg_out = self.UPDATE(NLRI_Prefixes=PrefixList)
...
#    logging.debug('... originally encoded open message: ' + binascii.hexlify(msg_out))

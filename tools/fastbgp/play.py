...
class MessageGenerator(object):
    ...
    def __init__(self, args):
        ...
        logging.info('  Fast prefill up to ' +
        ...
        logging.debug('  Prefix index range used for test after prefill procedure [' +
...
class StateTracker(object):
    ...
    def perform_one_loop_iteration(self):
        ...
        if write_list:
            ...
            logging.info('Everything has been done. Just waiting for possible incomming message.')

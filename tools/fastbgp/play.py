...
def parse_arguments():
    ...
    parser.add_argument("--bgpls", default="no", type=str, help=str_help)
...
class MessageGenerator(object):
    ...
    def get_ls_nlri_values(self, index):
        """Generates LS-NLRI parameters (http://tools.ietf.org/html/draft-ietf-idr-te-lsp-distribution-03).
...
#                "\x06"      # LS-NLRI.Variable.ProtocolID ()

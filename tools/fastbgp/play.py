...
supported decodingfor these elements."
...
class ReadTracker(object):
    ...
    def __init__(self, bgp_socket, timer, storage, evpn=False):
...
class Rpcs:
    ...
    def get(self, text=''):
        ...
        - returns stored data, at the moment only 'update' is stored

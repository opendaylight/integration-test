...
def parse_arguments():
    ...
    str_help = 'The number of remaining prefixes to process along with parallel prefix withdrawals'
    parser.add_argument('--remain', default='0', type=int, help=str_help)
    str_help = 'Prefix addition and withdrawal combined in one UPDATE message'
    parser.add_argument('--combined', dest='combined', action='store_const', const=True,
...
class MessageGenerator(object):
    ...
    def __init__(self, args):
        ...
        self.Remaining_Prefixes_Treshold = args.remain

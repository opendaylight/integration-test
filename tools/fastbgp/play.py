...
class MessageGenerator(object):
    ...
    def compose_update_message(self):
        ...
        AddIndex = self.Iteration
        RemoveIndex = self.Iteration - self.Sweep_Range_Default
        if RemoveIndex < 0:
            ToRemove = 0
        PrefixesToRemove = self.get_prefix_list(RemoveIndex, count=ToRemove)
        PrefixesToAdd = self.get_prefix_list(AddIndex, count=ToAdd)

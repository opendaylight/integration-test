...
class MessageGenerator(object):
    ...
    def compose_update_message(self, withdrawal):
        ...
        if not withdrawal:
            ...
            print 'DEBUG: Update message (without Withdrawn Routes):', binascii.b2a_hex(msg_out)
        else:
            msg_out = self.update_message_without_prefix_del_routes + prefix_packed + '\x00\x00'  # No Path Attributes
            print 'DEBUG: Update message (with Withdrawn Routes):', binascii.b2a_hex(msg_out)

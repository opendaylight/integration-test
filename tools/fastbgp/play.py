...
class MessageGenerator(object):
    ...
    def __init__(self, args):
        ...
        logging.info('  Fast prefill up to ' +
                     str(str(self.Total_Prefix_Amount) - self.Remaining_Prefixes_Treshold) + ' prefixes')
        ...
        self.Verbosed = args.loglevel < logging.ERROR
    ...
    def randomize_index(self, index, lowest=None, highest=None):
        """
        Calculates pseudo-randomized (reproducible) index for indexes from inside of the selected range.
        Created just as a frame for randomized message generator.

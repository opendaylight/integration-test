...
def main():
    ...
    while 1:
        ...
        args = dict(
            ...
            insert=int(mgr_args.insert),
            withdraw=int(mgr_args.withdraw),
            prefill=int(mgr_args.prefill),
            updates=str(mgr_args.updates),
            prefixlen=int(mgr_args.prefixlen),
            holdtime=int(mgr_args.holdtime),
            results=str(mgr_args.results),
            treshold=int(mgr_args.threshold),
            rfc4760=str(mgr_args.rfc4760),
        )

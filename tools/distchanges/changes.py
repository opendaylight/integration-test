...
class Changes:
    ...
    def __init__(self, branch=BRANCH, distro_path=DISTRO_PATH,
        ...
        self.init_projects(project_names)

    def set_query(self, gerritquery):
        self.gerritquery = gerritquery
    ...
    def init_projects(self, project_names=PROJECT_NAMES):
    ...
    def extract_gitproperties_file(fullpath):
        ...
        :return str: Containing git.properties
        """
        pfile = None
    ...
    def get_changeid_from_properties(self, project, pfile):
        ...
        print("did not find Change-Id in %s, try with commit-msg" % project)
    ...
    def find_distro_changeid(self, project):
        ...
        :return str: The Change-Id
        """
        project_dir = self.distro_path + "/system/org/opendaylight/" + project
        pfile = None
    ...
    def init(self):
        ...
        self.init_projects(self.project_names)
    ...
    def print_options(self):
        ...
        print("projects: %s" % (str(self.project_names)))

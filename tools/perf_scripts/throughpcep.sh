...
pushd "test"
git fetch "https://git.opendaylight.org/gerrit/integration/test" "refs/changes/77/35877/47"
...
-v PCCS:512 -v LSPS:128 -v JDKVERSION: -v CONTROLLER_PASSWORD:"$PASSWORD" \
-v ODL_SYSTEM_PASSWORD:"$PASSWORD" -v TOOLS_SYSTEM_PASSWORD:"$PASSWORD" \
"test/csit/suites/netconf/ready/netconfready.robot" \
"test/csit/suites/bgpcep/throughpcep/cases.robot" || true
set +u
deactivate
killall java

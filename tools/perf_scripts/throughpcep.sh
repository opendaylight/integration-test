...
Edit BUNDLEFOLDER when testing something else than Berylluium release.'
if [ "x$1" == "x" ]; then
...
pushd "test"
git fetch "https://git.opendaylight.org/gerrit/integration/test" "refs/changes/77/35877/15"
git checkout FETCH_HEAD
popd
pybot -N throughpcep -v CONTROLLER_PROMPT:"\$" -v ODL_SYSTEM_PROMPT:"\$" -v TOOLS_SYSTEM_PROMPT:"\$" \
-v UPDATERVM_ENABLE_TCP_RW_REUSE:"False" -v NETCONFREADY_WAIT:240s \
-v WORKSPACE:"/home/virl/vrpolak" -v BUNDLEFOLDER:"distribution-karaf-0.4.0-Beryllium" \

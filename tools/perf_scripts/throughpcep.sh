...
pushd "test"
git fetch https://git.opendaylight.org/gerrit/integration/test refs/changes/77/35877/9
git checkout FETCH_HEAD
popd
pybot -N throughpcep -v CONTROLLER_PROMPT:"\$" -v ODL_SYSTEM_PROMPT:"\$" \
-v NEXUSURLPREFIX:"http://nexus.opendaylight.org" -v NETCONFREADY_WAIT:240s \
-v CONTROLLER:"127.0.0.1" -v ODL_SYSTEM_IP:"127.0.0.1" -v UPDATER_COLOCATED:"True" \
-v CONTROLLER_USER:"$USERNAME" -v ODL_SYSTEM_USER:"$USERNAME" \
-v CONTROLLER_PASSWORD:"$PASSWORD" -v ODL_SYSTEM_PASSWORD:"$PASSWORD" \

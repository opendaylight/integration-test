...
for the current user and KARAF_HOME of the installation to test.
...
pushd "test"
git fetch "https://git.opendaylight.org/gerrit/integration/test" "refs/changes/77/35877/18"

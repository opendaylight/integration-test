...
pushd "test"
git fetch "https://git.opendaylight.org/gerrit/integration/test" "refs/changes/77/35877/46"
git checkout FETCH_HEAD
popd
pybot -N ingest -v ODL_SYSTEM_PROMPT:"\$" -v TOOLS_SYSTEM_PROMPT:"\$" \
-v TEST_DURATION_MULTIPLIER:8 -v USER_HOME:"/tmp" \
...
"test/csit/suites/bgpcep/bgpingest/bgp_app_peer_prefixcount.robot" || true
set +u
deactivate
killall java

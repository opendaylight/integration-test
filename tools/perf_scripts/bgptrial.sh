...
pushd "test"
git fetch "https://git.opendaylight.org/gerrit/integration/test" "refs/changes/77/35877/32"
...
"test/csit/suites/bgpcep/bgpingest/bgp_trial_peer_prefixcount.robot"
set +u
deactivate
killall java

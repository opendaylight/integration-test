...
async def get_events():
    ...
    async with sse_client.EventSource('http://' + args.controller + args.uri, session=client) as event_source:
        try:
...
def parse_arguments():
    ...
    parser.add_argument("--controller", default="http://127.0.0.1:8181", help="Controller IP")
    parser.add_argument("--uri", default="/rests/notif/data-change-event-subscription/opendaylight-inventory:nodes/datastore=CONFIGURATION/scope=BASE", help="URI endpoint to connect")

...
class FlowConfigBlaster(object):
    ...
    FLWURL = "rests/data/opendaylight-inventory:nodes/node=openflow:%d/flow-node-inventory:table=0/flow=%d"
    TBLURL = "rests/data/opendaylight-inventory:nodes/node=openflow:%d/flow-node-inventory:table=0"

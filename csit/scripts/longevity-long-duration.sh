...
scp ${WORKSPACE}/org.apache.karaf.decanter.scheduler.simple.cfg ${ODL_SYSTEM_IP}:/tmp/${BUNDLEFOLDER}/etc/org.apache.karaf.decanter.scheduler.simple.cfg
scp ${WORKSPACE}/org.apache.karaf.decanter.appender.elasticsearch.rest.cfg ${ODL_SYSTEM_IP}:/tmp/${BUNDLEFOLDER}/etc/org.apache.karaf.decanter.appender.elasticsearch.rest.cfg
scp ${WORKSPACE}/org.apache.karaf.decanter.collector.jmx-local.cfg ${ODL_SYSTEM_IP}:/tmp/${BUNDLEFOLDER}/etc/org.apache.karaf.decanter.collector.jmx-local.cfg
scp ${WORKSPACE}/org.apache.karaf.decanter.collector.jmx-others.cfg ${ODL_SYSTEM_IP}:/tmp/${BUNDLEFOLDER}/etc/org.apache.karaf.decanter.collector.jmx-others.cfg

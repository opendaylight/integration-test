...
Usage: python construct_json.py port:ip
...
# ELK DB IP and port to be passed as ':' separated argument
if len(sys.argv) == 2:
    if ':' in sys.argv[1]:
        ELK_DB_IP = sys.argv[1].split(':')[0]
        ELK_DB_PORT = sys.argv[1].split(':')[1]
else:
    print("Usage: python construct_json.py port:ip")
...
PUT_URL = 'https://{}:{}{}{}{}'.format(ELK_DB_IP, ELK_DB_PORT, PUT_URL_INDEX, PUT_URL_TYPE, PUT_URL_ID)
print(PUT_URL)

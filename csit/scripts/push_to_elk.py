...
try:
    index = '{}-{}'.format(BODY[BODY['type']]['project'], BODY[BODY['type']]['subject'])
    ES_ID = '{}:{}-{}'.format(BODY['type'],BODY[BODY['type']]['test-name'], BODY[BODY['type']]['test-run'])
...
INDEX_PATTERN_BODY = {
    ...
    "index-pattern": {
      ...
      "title": '{}-{}'.format(BODY[BODY['type']]['project'], BODY[BODY['type']]['subject'])
    }
  }


KIBANA_CONFIG = {'config': {
      'defaultIndex': 'pattern-for-{}-{}'.format(BODY[BODY['type']]['project'], BODY[BODY['type']]['subject']),
...
try:
    index = '.kibana'
    ES_ID = 'index-pattern:pattern-for-{}-{}'.format(BODY[BODY['type']]['project'], BODY[BODY['type']]['subject'])

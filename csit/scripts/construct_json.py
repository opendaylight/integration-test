...
"""
This script is used to parse logs and construct JSON BODY to ELK database.
...
Finally, this JSON object is sent to ELK DB push_data.py script.
"""
...
push_data.pushData(BODY, ELK_DB_IP)

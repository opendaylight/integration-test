...
echo "dowloading zrpcd"
    ...
    sudo sed -e 's/libboost1.55-all-dev/libboost1.58-all-dev/' /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_script.sh > /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_script.sh

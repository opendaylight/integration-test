...
echo "Create the quagga group and quagga user"
    ...
    *java*)
        ...
        yum -y install readline readline-devel glib2-devel
...
#Checkout Compile and Install Quagga
    echo "Compilng the Quagga ......."
    find / -name "*readline*"
    echo "The find is over ......."
    cd quagga
    ...
    autoreconf -i
    LIBS='-L'/tmp/6wind_quagga_build_dir'/zeromq4-1/.libs/ \
    -L'/tmp/6wind_quagga_build_dir'/c-capnproto/.libs/' '-L'/lib/x86_64-linux-gnu/ \

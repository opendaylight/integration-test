...
echo "dowloading zrpcd"
    ...
    sed -e 's/addgroup/#addgroup/' pkgsrc/dev_compile_script.sh > pkgsrc/dev_compile_ubuntu16.04_script.sh
    sed -e 's/adduser/#adduser/' pkgsrc/dev_compile_ubuntu16.04_script.sh > pkgsrc/dev_compile_ubuntu16.04_1_script.sh
    sed -e 's/groupadd/#groupadd/' pkgsrc/dev_compile_ubuntu16.04_1_script.sh > pkgsrc/dev_compile_ubuntu16.04_2_script.sh
    chmod 777 /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_ubuntu16.04_2_script.sh
    /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_ubuntu16.04_2_script.sh -d -b -t -v 2

...
echo "dowloading zrpcd"
    ...
    sed -e 's/1.55-all-dev/1.58-all-dev/' /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_script.sh > /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_ubuntu16.04_script.sh
    sudo bash /tmp/build_quagga/zrpcd/pkgsrc/dev_compile_ubuntu16.04_script.sh -d -b -t

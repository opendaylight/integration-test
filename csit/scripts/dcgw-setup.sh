...
cat > ${WORKSPACE}/dcgw-setup.sh <<EOF
    ...
    *builder*|*docker*)
        ...
        c_capn="c-capnproto/1.0.2.75f7901.CentOS7.5.1804-0.x86_64/c-capnproto-1.0.2.75f7901.CentOS7.5.1804-0.x86_64"
        thirft="thrift/1.0.0.b2a4d4a.CentOS7.5.1804-0.x86_64/thrift-1.0.0.b2a4d4a.CentOS7.5.1804-0.x86_64"
        zmq="zmq/4.1.3.56b71af.CentOS7.5.1804-0.x86_64/zmq-4.1.3.56b71af.CentOS7.5.1804-0.x86_64"
        quagga="quagga/1.1.0.7a786f4.CentOS7.5.1804-0.x86_64/quagga-1.1.0.7a786f4.CentOS7.5.1804-0.x86_64"
        zrpc="zrpc/0.2.333829b.thriftv4.CentOS7.5.1804-0.x86_64/zrpc-0.2.333829b.thriftv4.CentOS7.5.1804-0.x86_64"
        for pkg in \${c_capn} \${thirft} \${zmq} \${quagga} \${zrpc}
        do
            sudo wget \${Nexus_url}/\${pkg}.rpm
        done
        sudo rpm -Uvh c-capnproto-1.0.2.75f7901.CentOS7.5.1804-0.x86_64.rpm
        sudo rpm -Uvh thrift-1.0.0.b2a4d4a.CentOS7.5.1804-0.x86_64.rpm
        sudo rpm -Uvh zmq-4.1.3.56b71af.CentOS7.5.1804-0.x86_64.rpm
        sudo rpm -Uvh quagga-1.1.0.7a786f4.CentOS7.5.1804-0.x86_64.rpm
        sudo rpm -Uvh zrpc-0.2.333829b.thriftv4.CentOS7.5.1804-0.x86_64.rpm
        ;;

...
echo "dowloading zrpcd"
    ...
    *java*)
        ...
        cd /tmp/build_quagga/zrpcd/pkgsrc
    ...
    *)
         ...
         cd /tmp/build_quagga/zrpcd/pkgsrc
         sudo dpkg -i  thrift_1.0.0.*.deb
         sudo dpkg -i zmq_4.1.3.*.deb
         sudo dpkg -i c-capnproto_1.0.2.*.deb
         sudo dpkg -i quagga_1.1.0.*.deb
         sudo dpkg -i zrpc_0.2.*.deb
        ;;
    esac

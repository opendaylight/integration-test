...
# Mininet Custom Topology Path and File for Service Chain Functioning
CREATE_SCF_TOPOLOGY_FILE = "topo_handson.py"
CREATE_SCF_TOPOLOGY_FILE_PATH = "MininetTopo/" +\
                                CREATE_SCF_TOPOLOGY_FILE

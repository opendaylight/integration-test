...
OPERATIONAL_TOPO_API = "/rests/data/network-topology:" "network-topology?content=nonconfig"
...
PREDEFINE_CONNECTION_URI = "/rests/data/nemo-object:connection-definitions?content=config"
...
GET_CONFIGURATION_URI = "/rests/data/configuration:configurationRecord?content=nonconfig"
STREAMRECORD_CONFIG = "/rests/data/stream:streamRecord?content=config"
SET_STREAMRECORD = "/rests/operations/stream:set-stream"
ALERTFIELDCONTENTRULERECORD = "/rests/data/alertrule:alertFieldContentRuleRecord?content=config"
SET_ALERTFIELDCONTENTRULERECORD = (
    "/rests/operations/alertrule:set-alert-field-content-rule"
)
ALERTFIELDVALUERULERECORD = "/rests/data/alertrule:alertFieldValueRuleRecord?content=config"
SET_ALERTFIELDVALUERULERECORD = (
    "/rests/operations/alertrule:set-alert-field-value-rule"
)
ALERTMESSAGECOUNTRULERECORD = "/rests/data/alertrule:alertMessageCountRuleRecord?content=config"

...
ODL_SYSTEM_IP = '10.183.254.140'  # Override if ODL is not running locally to pybot
...
TOOLS_SYSTEM_IP = '10.183.254.140'  # Override if tools are not run locally to pybot
...
MININET1 = "10.183.254.141"
MININET_USER = TOOLS_SYSTEM_USER
MININET_PASSWORD = TOOLS_SYSTEM_PASSWORD
MININET_PROMPT = TOOLS_SYSTEM_PROMPT
MININET1_USER = TOOLS_SYSTEM_USER
MININET1_PASSWORD = TOOLS_SYSTEM_PASSWORD
MININET1_PROMPT = TOOLS_SYSTEM_PROMPT

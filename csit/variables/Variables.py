...
HEADERS_NODE = {'Content-Type': 'application/vnd.onem2m-res+json;ty=14', 'Accept': 'application/vnd.onem2m-res+json;ty=14', 'X-M2M-Origin': 'AE-ID','X-M2M-NM': 'mockNode','X-M2M-RI': '12345'}

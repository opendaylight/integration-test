...
@{SUBNET_CIDR}    30.1.1.0/24    40.1.1.0/24    50.1.1.0/24
...
@{EXTRA_NW_IP}    30.1.1.110    40.1.1.110
${FIB_ENTRY_2}    30.1.1.110
${FIB_ENTRY_4}    40.1.1.110
${RPING_MIP_IP}    sudo arping -I eth0:1 -c 5 -b -s 30.1.1.110 30.1.1.110
${RPING_MIP_IP_2}    sudo arping -I eth0:1 -c 5 -b -s 40.1.1.110 40.1.1.110

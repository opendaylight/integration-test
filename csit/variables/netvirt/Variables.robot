...
@{EXTRA_NW_IP}    15.15.15.110    15.20.20.110
${FIB_ENTRY_2}    15.15.15.110
${FIB_ENTRY_4}    15.20.20.110
${RPING_MIP_IP}    sudo arping -I eth0:1 -c 5 -b -s 15.15.15.110 15.15.15.110
${RPING_MIP_IP_2}    sudo arping -I eth0:1 -c 5 -b -s 15.20.20.110 15.20.20.110

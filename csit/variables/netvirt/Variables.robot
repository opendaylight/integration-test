...
@{NETVIRT_EXCEPTIONS_WHITELIST}    OptimisticLockFailedException: Optimistic lock failed    ConflictingModificationAppliedException: Node was created by other transaction

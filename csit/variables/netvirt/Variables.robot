...
@{DISPLAY_NAPT_CMD_CONTAINERS}    Utils.Run Command On Controller    ${ODL_SYSTEM_IP}    sudo docker exec -i opendaylight_api /opt/opendaylight/bin/client -u karaf -p karaf display-napt-switches

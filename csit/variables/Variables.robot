...
${ODL_SYSTEM_IP}    192.168.122.93    # IP address of system hosting ODL for SSHLibrary to connect to. First node if ODL is a cluster.
${TOR_USER}       mininet
${TOR_PASSWORD}    mininet
${OVS_USER}       mininet
${OVS_PASSWORD}    mininet
${DEFAULT_TOR_PROMPT}    ${DEFAULT_LINUX_PROMPT}
${DEFAULT_OVS_PROMPT}    ${DEFAULT_LINUX_PROMPT}
${OVS_SWITCH_IP}    192.168.122.62
${TOR_IP}         192.168.122.62

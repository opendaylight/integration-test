...
${KARAF_DETAILED_PROMPT}    root.*>    # Larger substring of Karaf prompt regexp, shorter ones may result in false positives.
${KARAF_PASSWORD}    karaf    # Plaintext password to authenticate to Karaf console.
${KARAF_PROMPT}    root.*>    # Simple and readable Karaf prompt regexp.

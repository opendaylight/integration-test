vtn_data_models = [
        ...
        'operational/opendaylight-inventory:nodes/node/openflow:1/table/0',
        'operational/opendaylight-inventory:nodes/node/openflow:2/table/0',
        'operational/opendaylight-inventory:nodes/node/openflow:3/table/0',

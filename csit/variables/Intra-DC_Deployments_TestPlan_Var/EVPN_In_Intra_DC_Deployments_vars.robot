...
@{NETWORKS_ASSOCIATION_TESTAREA4_EVPN2}    NET5    NET6    #@{NETWORKS}    NET1    NET2    #@{VM_INSTANCES_DPN1}    VM11
...               # VM12    VM21    VM22    #@{VM_INSTANCES_DPN2}    VM13    VM14    VM23
...               # VM24    #@{VM_INSTANCES_NET1}    VM11    VM12    VM13    VM14    #@{VM_INSTANCES_NET2}
...               # VM21    VM22    VM23    VM24    #@{VM_INSTANCES}    VM11    VM12
...               # VM21    VM22    VM13    VM14    VM23    # VM24    #@{PORT_LIST}
...               # PORT11    PORT12    PORT21    PORT22    PORT13    PORT14    PORT23
...               # PORT24    #@{SUBNETS}    SUBNET1    SUBNET2    #@{ROUTER1_INTERFACE}    SUBNET1    #@{ROUTER2_INTERFACE}
...               # SUBNET2    #@{SUBNET_CIDR}    10.1.0.0/16    10.2.0.0/16    10.3.0.0/16    10.4.0.0/16    10.5.0.0/16
...
${ODL_SYSTEM_USER}    root
${ODL_SYSTEM_PASSWORD}    rootroot
${USER_HOME}      /root/
${DELAY_AFTER_VM_CREATION}    30
${VAR_BASE}       /root/SF218_review/test/csit/variables/bgpfunctional
${RESTCONFPORT}    8181

...
${HW_ETHER}                             hw ether
${HWVTEP_NETWORK_TOPOLOGY}              /rests/data/network-topology:network-topology/topology/hwvtep:1?content=nonconfig
${IFCONF}                               ifconfig
...
${L2GW_LIST_REST_URL}                   /rests/data/neutron:neutron/l2gateways?content=config
${L2GW_CONN_LIST_REST_URL}              /rests/data/neutron:neutron/l2gatewayConnections?content=config
...
${OVSDB_NETWORK_TOPOLOGY}               /rests/data/network-topology:network-topology/topology/ovsdb:1?content=nonconfig

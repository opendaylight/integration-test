...
${Parameter_Key}
${Parameter_Value}
${Parameter_List_ROW}    ${Parameters_TABLE}//div[contains(@class, "trdiv ng-scope")]    
...
${History_Table_Sent_Data_BOX}    ${History_TABLE}${Sent_Data_BOX}
...
Load Link List Button In CustomContainer Area
    ...
    Run Keyword If    "${status}"=="True"    Run Keywords    Click Element    ${Testing_Root_API_Link_Link_Id_XPATH}    AND    
    ...    Wait Until Page Contains Element    ${Testing_Root_API_Link_List_BUTTON}
    Run Keyword If    "${status}"=="False"    Run Keywords    Click Element    ${Testing_Root_API_Topology_Topology_Id_XPATH}    AND
    ...    Wait Until Page Contains Element    ${Testing_Root_API_Link_Link_Id_XPATH}    AND    Click Element    ${Testing_Root_API_Link_Link_Id_XPATH}                        
...
Insert Topology Or Node Or Link Id In Form
    ...
    ${status}=    Run Keyword And Return Status    Page Should Contain Element    ${Testing_Root_API_Topology_List_Plus_BUTTON}
    Run Keyword If    "${status}"=="True"    Run Keywords    Click Element    ${Testing_Root_API_Topology_List_Plus_BUTTON}    AND
    ...    Insert Text To Input Field    ${Testing_Root_API_Topology_List_Topology_Id_INPUT}    ${topology_id}
    ${status}=    Run Keyword And Return Status    Page Should Contain Element    ${Testing_Root_API_Node_List_Plus_BUTTON}
    Run Keyword If    "${status}"=="True"    Run Keywords    Click Element    ${Testing_Root_API_Node_List_Plus_BUTTON}    AND
    ...    Insert Text To Input Field    ${Testing_Root_API_Node_List_Node_Id_INPUT}    ${node_id}
    ${status}=    Run Keyword And Return Status    Page Should Contain Element    ${Testing_Root_API_Link_List_Plus_BUTTON}
    Run Keyword If    "${status}"=="True"    Run Keywords    Click Element    ${Testing_Root_API_Link_List_Plus_BUTTON}    AND
    ...    Insert Text To Input Field    ${Testing_Root_API_Link_List_Link_Id_INPUT}    ${link_id}
...
Verify Topology And Node And Link Id Presence In Form
    [Documentation]    Verifies whether the chosen data has been filled to form by "drop"
    ...    button in History table.
    [Arguments]    ${topology_id}    ${node_id}    ${link_id}
...
Return Parameter Key
    ...
    [Documentation]    Will return parameter key in format <<${parameter_name}>>.
    ${parameter_key}=    Catenate    SEPARATOR=    <<    ${parameter_name}    >>    
...
Click History Table Execute Request Button In Row
    ...
    Wait Until Page Contains Element    ${History_Table_Row_Execute_Request_BUTTON}
    Focus     ${History_Table_Row_Execute_Request_BUTTON}    
...
Click History Table Delete Request Button In Row
    ...
    Click Element    ${History_Table_Row_Delete_BUTTON}
...
Click Add To Collection Button
    ...
    Click Element    ${History_Table_Row_Add_To_Collection_BUTTON}    
...
Add Request To Collection
    ...
    Run Keyword If    "${comp_2}" == "True"    Run Keywords    Insert Text To Input Field    ${Add_To_Collection_Box_Group_Name_New_INPUT}    ${new_group}    AND    Focus    ${Add_To_Collection_Box_Add_BUTTON}
    Run Keyword If    "${comp_3}" == "True"    Run Keywords    Select Chosen Collection Group    ${select_group}    AND    Focus    ${Add_To_Collection_Box_Add_BUTTON}   
...
Verify Collection Table Nongroup Row Content
    ...
    ${got_name}=     Get Text    ${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col8"]/span
    ...
    ${Url}=    Get Text    ${Collection_Table_Nongroup_Row_Url_XPATH}
    ${url2}=    Remove Leading And Trailing Spaces    ${Url}
    Should Be Equal As Strings    ${url1}    ${url2}
...
Expand Collection Table Group Expander
    ...
    Run Keyword If    "${status}" == "False"    Run Keywords    Focus    ${Collection_Table_List_Group_EXPANDER}    AND    Click Element    ${Collection_Table_List_Group_EXPANDER}    
    ...    AND    Wait Until Page Contains Element    ${Collection_Table_List_Group_ROW}
...
Verify Collection Table Group Row Content
    ...
    ${Url}=    Get Text    ${Collection_Table_Group_Row_Url_XPATH}
    ${url2}=    Remove Leading And Trailing Spaces    ${Url}
    Should Be Equal As Strings    ${url1}    ${url2}
...
Verify No Sent No Received Data Elements Presence In Collection Table Nongroup Row
    ...
    [Arguments]    ${row_number}    
    ${Collection_Table_List_Nongroup_ROW}=    Return Collection Table Nongroup Row Number    ${row_number}
    ${dict}=    Create Dictionary    ${Collection_Table_Nongroup_Row_Sent_Data_Disabled_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col5"]//button[@class="btn btn-primary ng-scope btn-slim disabled"]
    ...    ${Collection_Table_Nongroup_Row_Received_Data_Disabled_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col6"]//button[@class="btn btn-primary ng-scope btn-slim disabled"]
    ...    ${Collection_Table_Nongroup_Row_Execute_Request_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col7"]//button[contains(@ng-click, "executeCollectionRequest")]
    ...    ${Collection_Table_Nongroup_Row_Fill_Data_Disabled_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col7"]//button[@class="yangButton iconFillData disabled"]
    ...    ${Collection_Table_Nongroup_Row_Move_To_Group_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col7"]//div[contains(@ng-click, "showCollBox")]
...
Verify No Sent No Received Data Elements Presence In Collection Table Group Row
    ...
    [Arguments]    ${group_number}    ${row_number}    
    ${Collection_Table_List_Group_ROW}=    Return Collection Table Group Row Number    ${group_number}    ${row_number}
    ${dict}=    Create Dictionary    ${Collection_Table_Group_Row_Sent_Data_Disabled_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col5"]//button[@class="btn btn-primary ng-scope btn-slim disabled"]
    ...    ${Collection_Table_Group_Row_Received_Data_Disabled_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col6"]//button[@class="btn btn-primary ng-scope btn-slim disabled"]
    ...    ${Collection_Table_Group_Row_Execute_Request_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col7"]//button[contains(@ng-click, "executeCollectionRequest")]
    ...    ${Collection_Table_Group_Row_Fill_Data_Disabled_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col7"]//button[@class="yangButton iconFillData disabled"]
    ...    ${Collection_Table_Group_Row_Move_To_Group_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col7"]//div[contains(@ng-click, "showCollBox")]
...
Verify Sent Data Elements Presence In Collection Table Nongroup Row
    ...
    [Arguments]    ${row_number}    
    ${Collection_Table_List_Nongroup_ROW}=    Return Collection Table Nongroup Row Number    ${row_number}
    ${dict}=    Create Dictionary    ${Collection_Table_Nongroup_Row_Sent_Data_Enabled_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col5"]//button[@class="btn btn-primary ng-scope btn-slim "]
    ...    ${Collection_Table_Nongroup_Row_Received_Data_Disabled_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col6"]//button[@class="btn btn-primary ng-scope btn-slim disabled"]
    ...    ${Collection_Table_Nongroup_Row_Execute_Request_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col7"]//button[contains(@ng-click, "executeCollectionRequest")]
    ...    ${Collection_Table_Nongroup_Row_Fill_Data_Enabled_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col7"]//button[@class="yangButton iconFillData "]
    ...    ${Collection_Table_Nongroup_Row_Move_To_Group_BUTTON}=${Collection_Table_List_Nongroup_ROW}//div[@class="tddiv rh-col7"]//div[contains(@ng-click, "showCollBox")]
...
Verify Sent Data Elements Presence In Collection Table Group Row
    ...
    [Arguments]    ${group_number}    ${row_number}    
    ${Collection_Table_List_Group_ROW}=    Return Collection Table Group Row Number    ${group_number}    ${row_number}
    ${dict}=    Create Dictionary    ${Collection_Table_Group_Row_Sent_Data_Enabled_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col5"]//button[@class="btn btn-primary ng-scope btn-slim "]
    ...    ${Collection_Table_Group_Row_Received_Data_Disabled_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col6"]//button[@class="btn btn-primary ng-scope btn-slim disabled"]
    ...    ${Collection_Table_Group_Row_Execute_Request_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col7"]//button[contains(@ng-click, "executeCollectionRequest")]
    ...    ${Collection_Table_Group_Row_Fill_Data_Enabled_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col7"]//button[@class="yangButton iconFillData "]
    ...    ${Collection_Table_Group_Row_Move_To_Group_BUTTON}=${Collection_Table_List_Group_ROW}//div[@class="tddiv rh-col7"]//div[contains(@ng-click, "showCollBox")]
...
Open Collection Table Nongroup Sent Data Box
    ...
    Click Element    ${Collection_Table_Nongroup_Row_Sent_Data_Enabled_BUTTON}
...
Verify Collection Nongroup Sent Box ParamKey Presence In Code Mirror
    [Arguments]    ${row_number}    ${parameter_name}
    ${Collection_Table_List_Nongroup_ROW}=    Return Collection Table Nongroup Row Number    ${row_number}
    ${parameter_key}=    Return Parameter Key    ${parameter_name}
    ${Sent_Data_Box_Code_Mirror_CODE}=    Set Variable    //div[@class="CodeMirror-lines"]//div[@class="CodeMirror-code"]//span[contains(text(), "${parameter_key}")]
...
Verify Collection Group Sent Box ParamKey Presence In Code Mirror
    [Arguments]    ${group_number}    ${row_number}    ${parameter_name}
    ${Collection_Table_List_Group_ROW}=    Return Collection Table Group Row Number    ${group_number}    ${row_number}
    ${parameter_key}=    Return Parameter Key    ${parameter_name}
    ${Sent_Data_Box_Code_Mirror_CODE}=    Set Variable    //div[@class="CodeMirror-lines"]//div[@class="CodeMirror-code"]//span[contains(text(), "${parameter_key}")]

...
Initial_Wait_For_Ipv4_Topology_To_Become_Empty
    [Arguments]    ${timeout}=60s
    [Documentation]    Within ${timeout}, at least once GET should return code 200 with data having zero prefixes.
    BuiltIn.Wait_Until_Keyword_Succeeds    ${timeout}    1s    Check_Ipv4_Topology_Is_Empty

...
Set_Tmp_Shard_Variables_For_Nodes
    ...
    ...    ${new_follower_sessions} - http session for the follower node
    ...    ${new_first_follower_session} - http session for the first follower session

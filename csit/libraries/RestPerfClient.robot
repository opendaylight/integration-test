...
Library           SSHLibrary
Resource          ${CURDIR}/NetconfKeywords.robot
...
Get_Current_Log_Name
    [Documentation]    Get the name of the currently produced log file.
    ...    Needs to be a "getter keyword" to avoid exporting the resource
    ...    local variable that holds the value.

...
def configure_device_range(
    ...
    for i in range(first_device_id, first_device_id + device_count):
        ...
        if version == "calcium":
            edits.append(get_calcium_payload(name, device_ipaddress, device_port))
        else:
            edits.append(get_scandium_payload(name, device_ipaddress, device_port))
...
def get_calcium_payload(name, device_ipaddress, device_port):
    return """
        {
          "edit-id" : "node-%s",
          "operation" : "replace",
...
def get_scandium_payload(name, device_ipaddress, device_port):
    return """
        {
          "edit-id" : "node-%s",
          "operation" : "replace",

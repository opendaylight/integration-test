...
${BROWSER_EXT}    tar.bz2
${BROWSER_FILE_NAME}    ${BROWSER NAME}.${BROWSER EXT}
${BROWSER_URL}    https://bitbucket.org/ariya/phantomjs/downloads/${BROWSER FILE NAME}
${BROWSER_PATH_EXECUTABLE}    ${BROWSER NAME}/bin/phantomjs

...
Generate Virtual Ip
    [Arguments]    ${ip_start}
    [Documentation]    Return unused ip-address in range starting by ${ip_start}
...
Put Route Definition To Cluster
    ...
    [Documentation]    Puts single route definition into DS and removes all other
...
Add Route Definition To Cluster
    [Arguments]    ${VIRTUAL_IP}    ${VIRTUAL_IP_MASK}    ${VIRTUAL_INTERFACE}    ${follower}
    [Documentation]    Append new routing definition to DS

...
Setup SXP Cluster Session
    ...
    Wait Until Keyword Succeeds    120    10    Prepare SSH Keys On Karaf    ${TOOLS_SYSTEM_IP}    ${TOOLS_SYSTEM_USER}    ${TOOLS_SYSTEM_PASSWORD}    ${TOOLS_SYSTEM_PROMPT}    /tmp
...
Generate Virtual Interface
    ...
    ${route}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    whereis route
    Log    ${route}

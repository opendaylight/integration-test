...
Generate Virtual Interface
    ...
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ifconfig    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}
    log    ${interface}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get 127.0.0.1 0.0.0.0    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${TOOLS_SYSTEM_IP} 0.0.0.0    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${ip_address} ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${ip_address} 0.0.0.0    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${ip_address} 0.0.0.0 | grep ${ip_address} | awk '{print $(NF-2)}'    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}

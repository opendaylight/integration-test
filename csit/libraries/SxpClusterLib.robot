...
Generate Virtual Interface
    ...
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${ip_address} | grep ${ip_address} | awk '{print $3}'    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}

...
Setup SXP Cluster Session
    ...
    \    ${stdout}    Run Command On Remote System    ${ODL_SYSTEM_${i+1}_IP}    sudo yum -y install net-tools
    \    Log    ${stdout}
    \    ${stdout}    Run Command On Remote System    ${ODL_SYSTEM_${i+1}_IP}    whereis route
    \    Log    ${stdout}
    \    ${stdout}    Run Command On Remote System    ${ODL_SYSTEM_${i+1}_IP}    route
    \    Log    ${stdout}

...
Generate Virtual Interface
    ...
    log    ${interface}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${ip_address}    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}
    ${interface}    Run Command On Remote System    ${ODL_SYSTEM_${ODL_SYSTEM_INDEX}_IP}    ip route get ${ip_address} | grep ${ip_address} | awk '{print $(NF-2)}'    ${ODL_SYSTEM_USER}    ${ODL_SYSTEM_PASSWORD}

...
Get Active Controller
    ...
    \    BuiltIn.Append To List    ${votes}    ${controller}
...
Map Followers To Mac Addresses
    ...
    \    BuiltIn.Set To Dictionary    ${mac_addresses}    ${ODL_SYSTEM_${i+1}_IP}    ${mac_address}
...
Shutdown Tools Node
    ...
    ${stdout}    BuiltIn.Run Keyword And Return If    ${rc} == 0    Run Command On Remote System    ${ip_address}    sudo shutdown -P 0    ${user}
    ...    ${passwd}
    BuiltIn.Log    ${stdout}

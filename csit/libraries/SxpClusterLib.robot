...
Clean SXP Cluster Session
    ...
    \    Delete Node    ${CLUSTER_NODE_ID}    session=controller${i+1}
    Clean SXP Session
...
Clean SXP Cluster
    ...
    \    Rejoin_Member_From_List_Or_All    ${i+1}
    \    Flush_Iptables_From_List_Or_All
    \    Clean Connections    ${CLUSTER_NODE_ID}    session=controller${i+1}
    \    Clean Bindings    ${CLUSTER_NODE_ID}    session=controller${i+1}

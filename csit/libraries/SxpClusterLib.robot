...
Setup SXP Cluster
    ...
    \    Add Connection    ${SXP_VERSION}    ${peer_mode}    ${ODL_SYSTEM_${i+1}_IP}    64999    ${DEVICE_NODE_ID}
    ...
    Add Connection    version4    ${cluster_mode}    ${ODL_SYSTEM_IP}    64999    ${CLUSTER_NODE_ID}    session=controller${controller_id}

...
Setup Device Session
    ...
    KarafKeywords.Issue_Command_On_Karaf_Console    feature:list    controller=${DEVICE_NODE_ID}
    Utils.Run Command On Remote System    ${DEVICE_NODE_ID}    ls -lash    ${TOOLS_SYSTEM_USER}    ${TOOLS_SYSTEM_PASSWORD}
    Utils.Run Command On Remote System    ${DEVICE_NODE_ID}    ls -lash .m2    ${TOOLS_SYSTEM_USER}    ${TOOLS_SYSTEM_PASSWORD}
    KarafKeywords.Issue_Command_On_Karaf_Console    feature:repo-add mvn:org.opendaylight.sxp/features-sxp/1.8.0/xml/features    controller=${DEVICE_NODE_ID}

...
Run Tempest Tests
    ...
    ...    ELSE IF    "${debug}" == "False"    Run Tempest Tests Without Debug    ${tempest_regex}    timeout=${timeout}
    ...    ELSE IF    "${debug}" == "True"    Run Tempest Tests With Debug    ${tempest_regex}    timeout=${timeout}
    ...    ELSE IF    "${debug}" != "True" and "${debug}"!="False"    Fail    debug argument must be True or False

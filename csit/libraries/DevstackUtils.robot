...
Devstack Suite Setup
    ...
    Write Commands Until Prompt    git clone https://git.openstack.org/openstack-dev/devstack
    Write Commands Until Prompt    cd devstack
    Write Commands Until Prompt    git checkout stable/liberty
    ${local_conf}=    OperatingSystem.Get File    ${CURDIR}/../variables/ovsdb/local.conf
    Log    ${local_conf}
    Write Commands Until Prompt    ./stack.sh

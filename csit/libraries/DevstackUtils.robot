...
Run Tempest Tests With Debug
    ...
    ${results}=    Write Commands Until Prompt    ostestr --regex ${tempest_regex} --pdb ${tempest_regex} -b ${exclusion_file}    timeout=${timeout}
...
Tempest Conf Add External Network
    ...
    Modify Config In File On Existing SSH Connection    ${tempest_config_file}    set    DEFAULT    debug    True
    Modify Config In File On Existing SSH Connection    ${tempest_config_file}    set    DEFAULT    log_level    DEBUG

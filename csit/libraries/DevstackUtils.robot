...
Run Tempest Tests
    ...
    Write Commands Until Prompt    sudo pip install --upgrade pip
    Write Commands Until Prompt    sudo pip install urllib3 --upgrade
    Write Commands Until Prompt    sudo pip install httplib2
    Write Commands Until Prompt    source ${DEVSTACK_DEPLOY_PATH}/openrc admin admin
    Write Commands Until Prompt    neutron net-list
    Write Commands Until Prompt    sudo -E neutron net-list

...
Set Node Data For 3 Control Nodes And 2 Compute Nodes Setup
    ...
    BuiltIn.Set Suite Variable    ${OS_CMP1_IP}    ${OS_COMPUTE_1_IP}
    BuiltIn.Set Suite Variable    ${OS_CMP2_IP}    ${OS_COMPUTE_2_IP}
    BuiltIn.Set Suite Variable    ${OS_CNTL_1_IP}    ${OPENSTACK_CONTROL_NODE_1_IP}
    BuiltIn.Set Suite Variable    ${OS_CNTL_2_IP}    ${OPENSTACK_CONTROL_NODE_2_IP}
    BuiltIn.Set Suite Variable    ${OS_CNTL_3_IP}    ${OPENSTACK_CONTROL_NODE_3_IP}
    BuiltIn.Set Suite Variable    ${OS_CNTL_IP}    ${OPENSTACK_CONTROL_NODE_1_IP}
    BuiltIn.Set Suite Variable    @{OS_CMP_IPS}    ${OS_CMP1_IP}    ${OS_CMP2_IP}
...
Get DevStack Nodes Data
    ...
    ...    ELSE IF    ${NUM_OS_SYSTEM} == 5    DevstackUtils.Set Node Data For 3 Controleri Nodes And 2 Compute Nodes Setup

...
def add_domain_xml_fluorine(node_id, name, sgt, prefixes, origin):
    """Generate xml for Add Domain request (Fluorine version: xml_prefixes with origin)
...
def add_domain_xml_oxygen(node_id, name, sgt, prefixes):
    """Generate xml for Add Domain request (Oxygen version: xml_prefixes without origin)

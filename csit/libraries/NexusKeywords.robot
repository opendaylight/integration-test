...
Deploy_Artifact
    ...
    BuiltIn.Log    ${NEXUS_RELEASE_BASE_URL}
    ...
    ${use_nexus_rls} =    BuiltIn.Set_Variable_If    "${is_mri_component}" == "TRUE" and "${is_staged}" == "FALSE"    "TRUE"    "FALSE"
    ${urlbase} =    BuiltIn.Set_Variable_If    '${use_nexus_rls}' == "TRUE"    ${NEXUS_RELEASE_BASE_URL}    ${urlbase}

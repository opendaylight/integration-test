...
Set_Java_Home
    ...
    BuiltIn.Should_Contain    container=${openjdk}    item=openjdk    Got unsupported openjdk: ${openjdk}
    ...
    BuiltIn.Log    ${rc}
    BuiltIn.Log    ${out}
    BuiltIn.Fail    Failed to set desired JAVA_HOME corresponding to: ${openjdk}

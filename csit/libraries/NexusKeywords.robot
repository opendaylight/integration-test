...
Deploy_Artifact
    ...
    ${version}    ${location} =    BuiltIn.Run_Keyword_If    '${component}'!='odl-micro' and '${build_version}'=='${EMPTY}'    NexusKeywords__Detect_Version_To_Pull    ${component}
    ${version}    ${location} =    BuiltIn.Run_Keyword_If    '${build_version}'!='${EMPTY}'    BuiltIn.Set_Variable    ${build_version}    ${build_location}
    ${version} =    BuiltIn.Run_Keyword_If    '${component}'=='odl-micro'    BuiltIn.Set_Variable    ${ODL_MICRO_VERSION}
    ...    ELSE    BuiltIn.Set_Variable    ${version}
    ${location} =    BuiltIn.Run_Keyword_If    '${component}'=='odl-micro'    BuiltIn.Set_Variable    org/opendaylight/odlmicro
    ...    ELSE    BuiltIn.Set_Variable    ${location}

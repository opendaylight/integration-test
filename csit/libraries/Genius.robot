...
Get Tunnel Between DPNs
    [Arguments]    ${tunnel_type}    ${config_api_type}    ${dpn_id_index}
    ...
    Comment    ${DPN_ID_INDEX} =    BuiltIn.Evaluate    ${DPN_ID_INDEX}+1
...
Update Dpn id List And Get Tunnels
    ...
    ${dpn_id_index_2} =    BuiltIn.Set Variable    0
    Comment    BuiltIn.Set Suite Variable    ${DPN_ID_INDEX}
    : FOR    ${tool_system_index}    IN RANGE    ${NUM_TOOLS_SYSTEM}
    \    ${dpn_id_index_1} =    BuiltIn.Set Variable    ${dpn_id_index_2}
    ...
    \    ${dpn_id_index_2} =    Get Tunnel Between DPNs    ${tunnel_type}    ${config_api_type}    ${dpn_id_index_1}

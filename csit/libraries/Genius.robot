...
Start Suite
    ...
    ${check} =    Wait Until Keyword Succeeds    30    10    Check Establishment    ${ODL_OF_PORT_6653}
    ${check} =    Wait Until Keyword Succeeds    30    10    Check Establishment    ${OVSDBPORT}
...
Check Establishment
    ...
    \    ${check_establishment}    Run Command On Remote System And Log    ${tools_ip}    netstat -anp | grep ${port}

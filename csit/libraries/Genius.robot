...
Set Json
    ...
    ${body} =    CompareStream.Run_Keyword_If_At_Least_Sodium    OperatingSystem.Get File    ${genius_config_dir}/Itm_creation_no_vlan_sodium_and_above.json
    ...
    ${body} =    CompareStream.Run_Keyword_If_At_Least_Sodium    BuiltIn.Set Variable    ${body}
    : FOR    ${tool_system_index}    IN RANGE    ${NUM_TOOLS_SYSTEM}

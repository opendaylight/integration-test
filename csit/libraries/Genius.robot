...
Set Json
    ...
    \    Set To Dictionary    ${vtep_json}    dpn-id=@{DPN_ID_LIST}[${tool_system_index}]
...
Check Table0 Entry In a Dpn
    [Arguments]    ${tools_ip}    ${bridgename}    ${port_numbers}    ${oft_enabled}=false

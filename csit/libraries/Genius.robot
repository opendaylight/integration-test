...
Verify Tunnel Status As Up
    ...
    ${lines_of_state_up} =    CompareStream.Run_Keyword_If_At_Most_Aluminium    String.Get Lines Containing String    ${no_of_tunnels}    ${STATE_UP}
    ${lines_of_state_up} =    CompareStream.Run_Keyword_If_At_Least_Silicon    String.Get Lines Containing String    ${no_of_tunnels}    Up

...
Create Vteps
    ...
    ${body} =    Genius.Set Json    ${vlan_id}    ${gateway_ip}    ${SUBNET}
...
Set Json
    ...
    \    ${body}    Replace String    ${body}    "ip-address": "${tool_system_index+2}.${tool_system_index+2}.${tool_system_index+2}.${tool_system_index+2}"    "ip-address": "@{TOOLS_SYSTEM_ALL_IPS}[${tool_system_index}]"
...
Verify Response Code Of Dpn Endpointconfig API

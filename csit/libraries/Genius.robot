...
Get Tools System ID
    [Arguments]    ${tools_ip}
    ${ret} =    String.Get Substring    ${tools_ip}    -1
    ${ret} =    BuiltIn.Convert To Integer    ${ret}
    [Return]    ${ret}
...
Set Json
    ...
    \    ${tools_id} =    Get Tools System ID    ${tools_ip}
    \    Set To Dictionary    ${vtep_json}    dpn-id=${tools_id + 100}
    \    Set To Dictionary    ${vtep_json}    ip-address=${tools_ip}
    \    Set To Dictionary    ${vtep_json}    portname=br-int-eth${tools_id}

...
Verify Tunnel Status as UP
    ...
    ${no_of_nodes}    Get Line Count    ${Lines_of_TZA}
    ...
    ${no_of_created_tunnels}    Get Line Count    ${lines_of_VXLAN}
    ${no_of_estimated_tunnels}    Set Variable    ${no_of_nodes*${no_of_nodes - 1}}
    Should Be Equal As Strings    ${no_of_created_tunnels}    ${no_of_estimated_tunnels}

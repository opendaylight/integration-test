...
Schedule Export
    ...
    ${response_json}    ClusterManagement.Post_As_Json_To_Member    ${SCHEDULE_EXPORT_URL}    ${json}    ${controller_index}
    Builtin.Log    ${response_json}
...
Mount Netconf Endpoint
    ...
    ${json}    Builtin.Replace Variables    ${json}
    Builtin.Log    ${json}
    ${resp}    ClusterManagement.Put_As_Json_To_Member    ${NETCONF_MOUNT_URL}${endpoint}    ${json}    ${host_index}
    Builtin.Log    ${resp}
...
Schedule Import
    ...
    ${json}    Builtin.Replace Variables    ${json}
    Builtin.Log    ${json}
    ${resp}    Builtin.Wait Until Keyword Succeeds    120 seconds    10 seconds    ClusterManagement.Post_As_Json_To_Member    ${IMPORT_URL}    ${json}
    ...    ${host_index}
    Builtin.Log    ${resp}

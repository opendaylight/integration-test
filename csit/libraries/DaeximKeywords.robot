...
Verify Status Information
    [Arguments]    ${endpoint}    ${host_index}    ${itr}=15
    ...
    \    Builtin.Log    ${i}
    \    Exit For Loop If    "${sts}" == "${NTCF_OPR_STATUS}"
    [Return]    ${sts}    ${op}
...
Verify Netconf Mount
    ...
    Builtin.Run Keyword If    "${sts1}" != "${NTCF_OPR_STATUS}"    Builtin.Fail    The Netconf endpoint status is Not connected

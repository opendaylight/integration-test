...
Clean_Directories_On_List_Or_All
    ...
    BuiltIn.Run_Keyword_If    """${tmp_dir}""" != ""    Check_Bash_Command_On_List_Or_All    mkdir -p '${tmp_dir}' && rm -rf '${tmp_dir}/log' && mv -rf '${karaf_home}/data/log' '${tmp_dir}/'    ${member_index_list}
    Safe_With_Ssh_To_List_Or_All_Run_Keyword    ${member_index_list}    ClusterManagement__Clean_Directories    ${path_list}    ${karaf_home}
    BuiltIn.Run_Keyword_If    """${tmp_dir}""" != ""    Check_Bash_Command_On_List_Or_All    mkdir -p '${karaf_home}/data' && rm -rf '${karaf_home}/log' && mv -rf '${tmp_dir}/log' '${karaf_home}/data/'    ${member_index_list}

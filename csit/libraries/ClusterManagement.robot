...
&{SINGLETON_DEVICE_ID_PREFIX}    netconf=${SINGLETON_NETCONF_DEVICE_ID_PREFIX}
&{SINGLETON_DEVICE_ID_SUFFIX}    netconf=${SINGLETON_NETCONF_DEVICE_ID_SUFFIX}    bgpcep=${SINGLETON_BGPCEP_DEVICE_ID_SUFFIX}
...
Get_Owner_And_Candidates_For_Device_Singleton
    ...
    ${device_id_prefix} =    BuiltIn.Set_Variable    ${EMPTY}
    BuiltIn.Run_Keyword_If    ${device_type} in ${SINGLETON_DEVICE_ID_PREFIX}
    ....    ${device_id_prefix} =    Collections.Get From Dictionary    ${SINGLETON_DEVICE_ID_PREFIX}    ${device_type}
    Log    ${device_id_prefix}
    ${device_id_suffix} =    BuiltIn.Set_Variable    ${EMPTY}
    BuiltIn.Run_Keyword_If    ${device_type} in ${SINGLETON_DEVICE_ID_SUFFIX}

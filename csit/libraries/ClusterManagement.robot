...
Freeze_Single_Member
    ...
    ${live_list} =    List_Indices_Minus_Member    ${member_index}    ${live_member_index_list}
...
Unfreeze_Single_Member
    ...
    ${live_list} =    List_Indices_Plus_Member    ${member_index}    ${live_member_index_list}
...
List_Indices_Plus_Member
    ...
    [Documentation]    Create a new list which contains indices from ${member_index_list} (or empty) with ${member_index} added.
    ...
    ${index_list} =    BuiltIn.Create_List    ${member_index_list}
    # FIXME: Decide whether indexes are trings or ints.

...
Get_Owner_And_Candidates_For_Device_Singleton
    ...
    Keyword Should Exists    Get_Owner_And_Candidates_For_Device_Singleton_${device_type}
    ${owner}    ${candidate_list} =    Run Keyword    Get_Owner_And_Candidates_For_Device_Singleton_${device_type}    ${device_name}    ${member_index}
    [Return]    ${owner}    ${candidate_list}

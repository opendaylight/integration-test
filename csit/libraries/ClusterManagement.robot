...
# usefull.
    ...
    Run Keyword If    "${directory_list}" == "${EMPTY}"    SSHLibrary.Write    rm -fr ${karaf_home}/data ${karaf_home}/tmp ${karaf_home}/cache ${karaf_home}/journal ${karaf_home}/snapshot
    :FOR    ${dir}    IN    @{directory_list}
    \    rm -fr    ${karaf_home}/${dir}

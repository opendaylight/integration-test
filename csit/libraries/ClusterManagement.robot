...
Clean_Directories_On_List_Or_All
    ...
    SSHKeywords.Run_Keyword_Preserve_Connection    With_Ssh_To_List_Or_All_Run_Keyword    member_index_list=${member_index_list}    ClusterManagement__Clean_Directories    ${path_list}    ${karaf_home}

...
ClusterManagement_Setup
    ...
    BuiltIn.Set_Suite_Variable    ${ClusterManagement__Session_Serial_Number}    0
...
ClusterManagement__Create_New_Session
    [Arguments]    ${member_index}
    ${session} =    BuiltIn.Set_Variable    ClusterManagement__session_${ClusterManagement__Session_Serial_Number}
    Collections.Set_To_Dictionary    ${ClusterManagement__Active_Sessions}    ${member_index}    ${ClusterManagement__Session_Serial_Number}
    ${new_serial}=    BuiltIn.Evaluate    ${ClusterManagement__Session_Serial_Number}+1
    BuiltIn.Set_Suite_Variable    ${ClusterManagement__Session_Serial_Number}    ${new_serial}
...
Resolve_Http_Session_For_Member
    ...
    BuiltIn.Run_Keyword_If    not ${present}    ClusterManagement__Create_New_Session    ${member_index}
    ${serial_number}=    Collections.Get_From_Dictionary    ${ClusterManagement__Active_Sessions}    ${member_index}
    ${session} =    BuiltIn.Set_Variable    ClusterManagement__session_${serial_number}
    [Return]    ${session}

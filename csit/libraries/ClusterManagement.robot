...
Extract_OpenFlow_Device_Data
    ...
    ${clear_data} =    BuiltIn.Run Keyword If    '${ODL_STREAM}' not in ['beryllium', 'boron']' and '${ODL_OF_PLUGIN}' == 'lithium'    String.Replace_String    ${data}    org.opendaylight.mdsal.ServiceEntityType    openflow

...
Extract_OpenFlow_Device_Data
    ...
    ${clear_data} =    CompareStream.Run_Keyword_If_Version_Is_Not_Beryllium    and '${ODL_OF_PLUGIN}' == 'lithium'    String.Replace_String    ${data}    org.opendaylight.mdsal.ServiceEntityType    openflow

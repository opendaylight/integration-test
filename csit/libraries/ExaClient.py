...
class ExaClient(object):
    ...
    def _clean_counter(self, msg_type):
        cnt = self.proxy.clean_counter(msg_type)

    def clean_received_open_count(self):
        return self._clean_counter('open')

    def clean_received_keepalive_count(self):
        return self._clean_counter('keepalive')

    def clean_received_update_count(self):
        return self._clean_counter('update')

    def clean_received_route_refresh_count(self):
        return self._clean_counter('route_refresh')

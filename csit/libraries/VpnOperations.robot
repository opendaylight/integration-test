...
Verify Flows Are Present For ELAN
    ...
    Should Match Regexp    ${flow_output}    goto_table:${ODL_FLOWTABLE_ELAN_SMAC}|resubmit\\(,${ODL_FLOWTABLE_ELAN_SMAC}\\)
    Should Match Regexp    ${flow_output}    goto_table:${ODL_FLOWTABLE_ELAN_DMAC}|resubmit\\(,${ODL_FLOWTABLE_ELAN_DMAC}\\)

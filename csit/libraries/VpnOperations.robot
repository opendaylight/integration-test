...
Disable Openstack DHCP Service
    ...
    ${output}=    Write Commands Until Prompt    which service    30s
    Log    ${output}
    ${output}=    Write Commands Until Prompt    sudo service dnsmasq stop    30s
    Log    ${output}
    ${output}=    Write Commands Until Prompt    sudo service dnsmasq status    30s
    Log    ${output}

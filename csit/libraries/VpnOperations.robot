...
Verify Flows Are Present For ELAN
    ...
    Should Contain    ${flow_output}    goto_table:${ODL_FLOWTABLE_ELAN_SMAC}|resubmit(,${ELAN_SMACTABLE})
    Should Contain    ${flow_output}    goto_table:${ELAN_DMACTABLE}|resubmit(,${ELAN_DMACTABLE})

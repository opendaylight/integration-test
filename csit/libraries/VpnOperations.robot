...
Verify ARP REQUEST in groupTable
    ...
    Log    ${arp_group}
    CompareStream.Run_Keyword_If_At_Most_Oxygen    Should Match Regexp    ${arp_group}    ${ARP_REQUEST_GROUP_REGEX}
    CompareStream.Run_Keyword_If_At_Least_Fluorine    Should Match Regexp    ${arp_group}    ${ARP_REQUEST_GROUP_REGEX_1}

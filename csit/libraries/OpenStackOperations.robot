...
Generate And Add Keypair To OpenStack
    ...
    OpenStackOperations.Add New Keypair To Openstack    ${keyname}    ${JENKINS_WORKSPACE}/${keyfilename}.pub
...
Check If NonCirros Instance Is Ready For Ssh Login
    ...
    [Documentation]    Ensure the VM is erachable from ssh as tests would require. This keyword will use publickey authentication
...
Check If Cirros Instance Is Ready For Ssh Login
    ...
    [Documentation]    Ensure the VM is erachable from ssh as tests would require. This keyword will use password authentication

...
#    ${o3} =    OpenStack CLI    openstack flavor show
    ...
    ${o5} =    OpenStack CLI    nova hypervisor-show $(nova hypervisor-list | grep "queens-0" | awk '{print $2}')
    ${o6} =    OpenStack CLI    nova hypervisor-show $(nova hypervisor-list | grep "queens-1" | awk '{print $2}')

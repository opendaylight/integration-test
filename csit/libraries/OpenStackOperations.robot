...
Start Packet Capture
    ...
    Run Command On Remote System    ${system_ip}    sudo tcpdump -vvv -ni ${network_adapter} -w trace.pcap &
...
Stop Packet Capture and Log Trace
    ...
    ${output}=    Run Command On Remote System    ${system_ip}    sudo tcpdump -rn trace.pcap
    Log    ${output}
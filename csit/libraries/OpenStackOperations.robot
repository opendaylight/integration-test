...
Generate And Add Keypair To OpenStack
    ...
    ${result} =    Process.Run Process    ssh-keygen -b 2048 -t rsa -f ~/${keyfilename} -q -N ""    shell=True
    BuiltIn.Log    ${result.stdout}
    BuiltIn.Log    ${result.stderr}
    BuiltIn.Should Be True    '${result.rc}' == '0'
    OpenStackOperations.Add New Keypair To Openstack    ${keyname}    ~/${keyfilename}.pub
    OpenStackOperations.Get ControlNode Connection
    SSHLibrary.Put_File    ${keyfilename}    /tmp

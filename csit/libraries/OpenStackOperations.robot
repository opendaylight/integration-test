...
Neutron Security Group Rule Create
    ...
    ${cmd_remote_ip} =    BuiltIn.Set Variable    openstack security group rule create
    ...
    ...    ELSE    BuiltIn.Catenate    ${cmd}
    ${cmd} =    BuiltIn.Run Keyword If    '${remote_ip}'!='None'    BuiltIn.Catenate    ${cmd_remote_ip}    --remote-ip ${remote_ip} ${Security_group_name}
    ...    ELSE    BuiltIn.Catenate    ${cmd}

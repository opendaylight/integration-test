...
OpenStack CLI Get List
    ...
    ${json} =    OpenStack CLI With No Log    ${cmd}
...
# TODO: security group rules change - just ignore default sg's
Compare Resources
    [Arguments]    ${map1}    ${map2}
    [Documentation]    Compare two maps of resources. Default security groups are ignored.
    [Return]    ${EMPTY}
...
Validate Resources
    ...
    ${rc}    ${output} =    BuiltIn.Run Keyword If    "${rc}" == "FAIL"    BuiltIn.Run Keyword And Ignore Error    Compare Resources    ${OPENSTACK_RESOURCES}
    ...    ${current_map}

...
#    ${o3} =    OpenStack CLI    openstack flavor show
    ...
    ${o5} =    OpenStack CLI    nova hypervisor-show $(nova hypervisor-list | grep "-0.vexxh" | awk '{print $2}')
    ${o6} =    OpenStack CLI    nova hypervisor-show $(nova hypervisor-list | grep "-1.vexxh" | awk '{print $2}')

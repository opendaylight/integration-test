...
Create External Network And Subnet
    ...
    Run Keyword If    ${ext_net_physical_net} == 'vlan'    OpenStackOperations.Create Network    ${ext_net_name}=${EXTERNAL_NET_NAME}    --provider-network-type ${ext_net_type} --provider-physical-network ${ext_net_physical_net}    --provider-segment=${ext_net_segid}    --external

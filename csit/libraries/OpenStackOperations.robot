...
Exit From Vm Console
    ...
    Write Commands Until Expected Prompt    sudo ifconfig eth0 mtu 1500
    ...
    Write Commands Until Prompt    sudo ifconfig eth0 mtu 1500
    Get OvsDebugInfo
...
Test Operations From Vm Instance
    ...
    Switch Connection    ${devstack_conn_id}
    ${net_id}=    Get Net Id    ${net_name}      ${devstack_conn_id}
    ${output}=    Write Commands Until Prompt    sudo ifconfig eth0 mtu 2000
    Log    ${output}

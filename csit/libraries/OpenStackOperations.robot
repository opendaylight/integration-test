...
Get Test Teardown Debugs
    ...
    KarafKeywords.Fail If Exceptions Found During Test    ${test_name}    fail=${fail}    ${wlfile}=/tmp/whitelist.exceptions.netvirt.json

Get Suite Debugs
    ${fail} =    BuiltIn.Set Variable If    ${PREV_TEST_STATUS} != ${EMPTY}    True    False

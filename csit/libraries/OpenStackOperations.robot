...
Start Packet Capture
    ...
    Run Command On Remote System    ${system_ip}    sudo /usr/sbin/tcpdump -vvv -ni ${network_adapter} -w /tmp/trace.pcap &
...
Stop Packet Capture and Log Trace
    ...
    ${output}=    Run Command On Remote System    ${system_ip}    sudo /usr/sbin/tcpdump -nr /tmp/trace.pcap
    Log    ${output}
...
Get Two Port VM IP Address
    ...
    ${arp_two_port_cli}    BuiltIn.Set Variable    openstack server show ${vm_name} | grep "addresses" | awk '{print $4$5}'
    ${output} =    OpenStackOperations.OpenStack CLI    ${arp_two_port_cli}

...
@{DEFAULT_NETTY_SINK_NODE_INDEX}    ${2}

*** Keywords ***
Setup_Netty_Replication
    [Arguments]    ${source_memeber_index}=${DEFAULT_NETTY_SOURCE_NODE_INDEX}    ${sink_members_indexes}=@{DEFAULT_NETTY_SINK_NODE_INDEX}
...
Open_Sink_Connection
    [Arguments]    ${sink_member_index}=${DEFAULT_NETTY_SINK_NODE_INDEX}    ${source_memeber_index}=${DEFAULT_NETTY_SOURCE_NODE_INDEX}
...
Close_Sink_Connection
    [Arguments]    ${sink_member_index}=@{DEFAULT_NETTY_SINK_NODE_INDEX}

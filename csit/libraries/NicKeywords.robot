...
Add Service Functions Using RestConf
    ...
    #Should Be Equal As Strings    ${resp.status_code}    200
    Post Elements To URI From File    ${SERVICE_FUNCTIONS_URI}    ${SERVICE_FUNCTIONS_FILE}
...
Add Service Function Forwarders Using RestConf
    ...
    #Should Be Equal As Strings    ${resp.status_code}    200
    Post Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}

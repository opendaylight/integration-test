...
Register SSH call-home device in ODL controller
   ...
   ${body}    Format String    ${template}   ${device_name}    ${username}    ${password}    ${hostkey}
   ${resp}    RequestsLibrary.Post Request    session    ${whitelist}    data=${body}
...
Suite Setup
    ...
    Set Suite Variable    ${CREATE_SSH_DEVICE_REQ}    ${CURDIR}/../../../variables/variables/netconf/callhome/v2/json/create_ssh_device.json

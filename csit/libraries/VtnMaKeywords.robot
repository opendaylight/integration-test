...
Start SuiteVtnMa
    ...
    SSHLibrary.Execute Command    sudo sed -i "$ i log4j.logger.org.opendaylight.openflowplugin.impl.device.TransactionChainManager = DEBUG" ${WORKSPACE}/${BUNDLEFOLDER}/etc/org.ops4j.pax.logging.cfg

...
Get flowcondition
    ...
    [Documentation]    Retrieve the flowcondition by name and to check the removed flowcondition here we added "retrieve" argument to differentiate the status code,

...
@{BRIDGE1_DATAFLOW}    "reason":"PORTMAPPED"    "bridge-name":"vBridge1"    "tenant-name":"Tenant1"   "interface-name":"if2"
@{BRIDGE2_DATAFLOW}    "reason":"PORTMAPPED"    "bridge-name":"vBridge2"    "tenant-name":"Tenant1"   "interface-name":"if3"
${vlanmap_bridge1}    200
${vlanmap_bridge2}    300
@{VLANMAP_BRIDGE1_DATAFLOW}    "reason":"VLANMAPPED"   "bridge-name":"vBridge1_vlan"   "tenant-name":"Tenant1"   "vlan-map-id":"ANY.200"
@{VLANMAP_BRIDGE2_DATAFLOW}    "reason":"VLANMAPPED"   "bridge-name":"vBridge2_vlan"   "tenant-name":"Tenant1"   "vlan-map-id":"ANY.300"

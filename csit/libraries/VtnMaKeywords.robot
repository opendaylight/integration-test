...
${pathpolicy_path}    ${CURDIR}/../variables/customtopology/topo-3sw-2host_multipath.py
${pathpolicy_topo}    sudo mn --controller=remote,ip=${CONTROLLER} --custom ${pathpolicy_path} --topo mytopo --switch ovsk,protocols=OpenFlow13

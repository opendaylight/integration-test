...
Start PathSuiteVtnMaTest
    ...
    Start SuiteVtnMaTest
    MininetKeywords.Start Mininet Multiple Controllers    ${TOOLS_SYSTEM_IP}     ${pathpolicy_topo_13}    ${custom}

Start PathSuiteVtnMaTestOF10
    [Documentation]    Start VTN Manager Test Suite and Mininet in Open Flow 10 Specification
    Start SuiteVtnMaTest
    MininetKeywords.Start Mininet Multiple Controllers    ${TOOLS_SYSTEM_IP}        ${pathpolicy_topo_10}    ${custom}
...
Start vlan_topo
    ...
    Run Keyword If    '${OF}' == 'OF13'    MininetKeywords.Start Mininet Multiple Controllers    ${TOOLS_SYSTEM_IP}     ${vlan_topo_13}    ${CURDIR}/${CREATE_VLAN_TOPOLOGY_FILE_PATH}
    ...    ELSE IF    '${OF}' == 'OF10'    MininetKeywords.Start Mininet Multiple Controllers    ${TOOLS_SYSTEM_IP}         ${vlan_topo_10}

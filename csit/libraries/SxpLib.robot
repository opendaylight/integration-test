...
Add Bindings
    ...
    CompareStream.Run_Keyword_If_At_Least_Fluorine  Add Bindings Fluorine    ${sgt}    ${prefixes}    ${node}    ${session}    ${domain}    ${origin}
...
Add Domain
    ...
    CompareStream.Run_Keyword_If_At_Least_Fluorine  Add Domain Fluorine    ${domain_name}    ${sgt}    ${prefixes}    ${origin}    ${node}    ${session}

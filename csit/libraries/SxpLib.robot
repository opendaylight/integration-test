...
Get Bindings
    ...
    ...    ELSE    TemplatedRequests.Get_As_Xml_From_Uri    /restconf/operational/network-topology:network-topology/topology/sxp/node/${node}/master-database/    session=${session}
    [Return]    ${resp}

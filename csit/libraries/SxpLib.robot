...
Clean Bindings
    ...
    \    CompareStream.Run_Keyword_If_At_Least_Else    boron    Clean Binding    ${binding['sgt']}    ${binding['ip-prefix']}    ${node}
    \    ...    ${session}    ${domain}
...
Clean Binding
    ...
    \    CompareStream.Run_Keyword_If_At_Least_Else    boron    Delete Binding    ${sgt}    ${prefix}    ${node}
    \    ...    ${domain}    ${session}

...
Get Bindings
    ...
    ${resp}    CompareStream.Run_Keyword_If_At_Least_Else    boron    TemplatedRequests.Post_To_Uri    ${REST_CONTEXT}:get-node-bindings    data=${DATA}    accept=${ACCEPT_JSON}
    ...    content_type=${HEADERS_XML}    session=${session}

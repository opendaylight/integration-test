...
@{MESSAGE_LIST}    Successfully pushed configuration snapshot
...
Setup SXP Session
    ...
    Wait For Karaf Log    Successfully pushed configuration snapshot 22-sxp-controller-one-node.xml    180
    Wait Until Keyword Succeeds    20    10    Check Karaf Log Has Messages    sxp    @{MESSAGE_LIST}

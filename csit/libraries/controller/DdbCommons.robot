...
Leader_Movement_Test_Templ
    ...
    MdsalLowlevel.Become_Module_Leader     ${idx_to}   make-leader-local
    ${new_leader}    ${new_followers} =     BuiltIn.Wait_Until_Keyword_Succeeds    10s    1s    Verify_Shard_Leader_Elected    ${SHARD_NAME}    ${SHARD_TYPE}    ${True}    ${idx_from}

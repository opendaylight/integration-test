...
Get_Node_Indexes_For_Leader_Clean_Shutdown_Test
...
Leader_Isolation_Test_Templ
    ...
    MdsalLowlevelPy.Initiate_Write_Transactions_On_Nodes    ${all_ip_list}   ${ID_PREFIX}   ${DURATION}    ${TRANS_PER_SEC}    chained_flag=${SIMPLE_TX}

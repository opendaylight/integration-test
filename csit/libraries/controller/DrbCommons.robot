...
...               ${all_indices}, ${registered_indices}, ${nonregistered_indices},
...               ${possible_constants} and ${isolated_constant} suite variables.
...
...               ${isolated_constant} - a constant of isolated node or ${Empty}
Library           Collections
...
Rejoin_Node
    ...
    ClusterManagement.Rejoin_Member_From_List_Or_All    ${member_idx}

...
...               The linked developer guide mentions "latency of about 1 second", but on Sandbox
...               the latency can be around 3.5 second, so 5 seconds is chosen as the default tolerance.
Library           Collections

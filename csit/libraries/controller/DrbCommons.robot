...
DrbCommons_Init
    ...
    BuiltIn.Set_Suite_Variable    ${nonregistered_indices}    ${all_indices}
    BuiltIn.Set_Suite_Variable    ${active_indices}    ${all_indices}
...
Isolate_Node
    [Arguments]    ${member_index}
    [Documentation]    Isolatea a member and update appropriate suite variables.

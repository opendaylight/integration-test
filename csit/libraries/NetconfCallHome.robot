...
Register keys and certificates in ODL controller
    ...
    ${client-key}    ${stderr}    Run_Keyword_If_Less_Than_Scandium
    ...    SSHLibrary.Execute_Command
    ...    sed -u '1d; $d' ./configuration-files/certs/client.key | sed -z 's!\\n!\\\\n!g'
    ...    return_stdout=True
    ...    return_stderr=True
    ${client-key}    ${stderr}    Run_Keyword_If_At_Least_Scandium
    ...    SSHLibrary.Execute_Command
    ...    sed -z 's!\\n!\\\\n!g' ./configuration-files/certs/client.key
    ...    return_stdout=True
    ...    return_stderr=True
    ${certificate-chain}    ${stderr}        Run_Keyword_If_Less_Than_Scandium
    ...    SSHLibrary.Execute_Command
    ...    sed -u '1d; $d' ./configuration-files/certs/client.crt | sed -z 's!\\n!\\\\n!g'
    ...    return_stdout=True
    ...    return_stderr=True
    ${certificate-chain}    ${stderr}        Run_Keyword_If_At_Least_Scandium
    ...    SSHLibrary.Execute_Command
    ...
    ...    expected_status=anything
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
    ${ca-certificate}    ${stderr}    Run_Keyword_If_Less_Than_Scandium
    ...    SSHLibrary.Execute_Command
    ...    sed -u '1d; $d' ./configuration-files/certs/ca.pem | sed -z 's!\\n!\\\\n!g'
    ...    return_stdout=True
    ...    return_stderr=True
    ${ca-certificate}    ${stderr}    Run_Keyword_If_At_Least_Scandium
    ...    SSHLibrary.Execute_Command
    ...    sed -z 's!\\n!\\\\n!g' ./configuration-files/certs/ca.pem
    ...    return_stdout=True
    ...    return_stderr=True
    ${device-certificate}    ${stderr}    Run_Keyword_If_Less_Than_Scandium    SSHLibrary.Execute_Command
    ...    sed -u '1d; $d' ./configuration-files/certs/server.crt | sed -z 's!\\n!\\\\n!g'
    ...    return_stdout=True
    ...    return_stderr=True
    ${device-certificate}    ${stderr}    Run_Keyword_If_At_Least_Scandium    SSHLibrary.Execute_Command
...
Suite Teardown
    ...
    #KarafKeywords.Issue_Command_On_Karaf_Console    log:display
    Uninstall Docker Compose on tools system

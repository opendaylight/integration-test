...
${whitelist}                    /rests/data/odl-netconf-callhome-server:netconf-callhome-server/allowed-devices?content=config
${global_config_url}            /rests/data/odl-netconf-callhome-server:netconf-callhome-server/global/credentials?content=config

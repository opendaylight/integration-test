...
Get Environment Ready
    ...
    ${stdout}    ${stderr}    ${rc}=    SSHLibrary.Execute Command    sudo apt-get install -y dnsmasq    return_stdout=True    return_stderr=True
    ...    return_rc=True
    ${stdout}    ${stderr}    ${rc}=    SSHLibrary.Execute Command    /etc/init.d/dnsmasq stop    return_stdout=True    return_stderr=True
    ...    return_rc=True

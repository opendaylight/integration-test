...
Get Environment Ready
    ...
    ${stdout}    ${stderr}    ${rc}=    SSHLibrary.Execute Command    sudo yum clean all    return_stdout=True    return_stderr=True
    ...    return_rc=True
    ${stdout}    ${stderr}    ${rc}=    SSHLibrary.Execute Command    sudo yum remove -y dnsmasq    return_stdout=True    return_stderr=True
    ...    return_rc=True

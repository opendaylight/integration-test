...
def Clean_JSON(string_dump):
    ...
    string_dump = clean_hops(json.loads(string_dump))
    return string_dump
...
def Get_LispAddress_Object(eid_string, vni=None, laddr_obj=None):
    """Returns a lisp address object based on its string representation"""
...
def Get_LispAddress_JSON(eid_string, vni=None):
    """Returns a lisp address Json dict based on its string representation"""
...
def Get_LispAddress_Noeid_JSON(eid_string, vni=None):
    """Returns a lisp address Json dict without eid based on its string representation"""
...
def Get_LispAddress_JSON_And_Wrap_input(eid_string, vni=None):
    """Returns a lisp address Json dict with input wrapper based on its string representation"""
...
def Get_LocatorRecord_Object(rloc, weights='1/1/255/0', flags=001, loc_id="ISP1"):
    """Returns a locator record Json object based on its string representation"""
    sys.path.insert(0, workspace)
    from LISPFlowMappingYANGBindings.odl_mappingservice_rpc.add_mapping.input import input
    rpc_input = input()
...
def Get_LocatorRecord_JSON(rloc, weights='1/1/255/0', flags=001, loc_id="ISP1"):
    """Returns a locator record Json dict based on its string representation"""
    ...
    return out_dump  # No need to clean


def Get_MappingRecord_Object(eid, locators, ttl=1440, authoritative=True, action='NoAction'):
    """Returns a mapping record Json object based on input eid and locators"""
    sys.path.insert(0, workspace)
    from LISPFlowMappingYANGBindings.odl_mappingservice_rpc.add_mapping.input import input
    rpc_input = input()
...
def Get_MappingRecord_JSON(eid, locators, ttl=1440, authoritative=True, action='NoAction'):
    """Returns a mapping record Json dict based on input eid and locators"""
...
def Get_MappingAuthkey_Object(key_string="password", key_type=1):
    """Returns a mapping auth key Json object based on keystring and keytype"""
    sys.path.insert(0, workspace)
...
def Get_MappingAuthkey_JSON(key_string="password", key_type=1):
    """Returns a mapping auth key Json dict based on keystring and keytype"""

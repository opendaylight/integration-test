...
nova reboot
    [Arguments]    ${vm_name}
    ${output}    Write Commands Until Expected Prompt    nova reboot ${vm_name}    $    60 sec
    Comment    Write Until Expected Output    nova reboot ${vm_name}    Request to reboot server <Server: ${vm_name}> has been accepted.    100    120
    Comment    sleep    30 sec
    Comment    ${cmdoutput}    Read
    Log    ${output}
...
Delete Topology
    ...
    : FOR    ${VMs}    IN    ${VM_list}
    \    Wait Until Keyword Succeeds    60 sec    10 Sec    Delete Vm Instance    ${VMs}
    Switch Connection    ${conn_id_1}

...
Get Rendered Service Path Name
    ...
    \    ${value} =    Set Variable If    "${get_reverse}" == "False" and 0 == ${matches_length}    ${name}
    \    ...    "${get_reverse}" == "True" and 0 < ${matches_length}    ${name}
    \    ...    "${value}" != "None"    ${value}
    [Return]    ${value}

...
Open_Controller_Karaf_Console_On_Background
    ...
    SSHLibrary.Login    ${KARAF_USER}    ${KARAF_PASSWORD}    loglevel=${loglevel}
    [Teardown]    K Teardown    ${current_ssh_connection_object.index}

K Teardown
    [Arguments]    ${current_ssh_connection_object_index}
    SSHKeywords.Restore_Current_Ssh_Connection_From_Index    ${current_ssh_connection_object_index}
    SSHLibrary.Get Connections

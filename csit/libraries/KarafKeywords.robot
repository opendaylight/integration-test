...
Check_Karaf_Log_Message_Count
    [Arguments]    ${message}    ${count}    ${use_console}
    ...
    Run Keyword If    ${use_console} == True    Check_Karaf_Console_log    ${message}    ${count}
    ...    ELSE    Check_Karaf_Log_Folder    ${message}    ${count}

Check_Karaf_Console_log

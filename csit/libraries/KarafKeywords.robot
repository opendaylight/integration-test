...
Restore Current SSH Connection
    [Arguments]    ${index}
    [Documentation]    Restore active SSH connection in SSHLibrary
    ...
    ...    ${index} reported by these means is None.
...
Open Controller Karaf Console
    ...
    BuiltIn.Set Suite Variable    ${KarafKeywords__controller_index}    ${connection.index}
    SSHLibrary.Login    ${KARAF_USER}    ${KARAF_PASSWORD}
    Restore Current SSH Connection    ${current_SSH_connection.index}

...
Fail If Exceptions Found During Test
    ...
    \    ${output} =    Get Karaf Log Lines From Test Start    ${ODL_SYSTEM_${i}_IP}    ${test_name}    cmd=${cmd}
    ...
    \    ${output1} =    Get Karaf Log Lines From Test Start    ${ODL_SYSTEM_${i}_IP}    ${test_name}    cmd=${cmd}
    \    ${warn_error_grep} =    BuiltIn.Set Variable    "| WARN \ |\|| ERROR |"
    \    ${cmd} =    Set Variable    sed '1,/ROBOT MESSAGE: Starting test ${test_name}/d' ${log_file} | grep ${warn_error_grep}
    \    ${output2} =    Get Karaf Log Lines From Test Start    ${ODL_SYSTEM_${i}_IP}    ${test_name}    cmd=${cmd}
    \    ${cmd} =    Set Variable    sed '1,/ROBOT MESSAGE: Starting test ${test_name}/d' ${log_file} | grep "WARN\|ERROR"
    \    ${output3} =    Get Karaf Log Lines From Test Start    ${ODL_SYSTEM_${i}_IP}    ${test_name}    cmd=${cmd}
    \    ${cmd} =    Set Variable    sed '1,/ROBOT MESSAGE: Starting test ${test_name}/d' ${log_file}
    \    ${output4} =    Get Karaf Log Lines From Test Start    ${ODL_SYSTEM_${i}_IP}    ${test_name}    cmd=${cmd}
    \    ${output0} =    BuiltIn.Run Keyword If    ${output4} != ['']    BuiltIn.Set Variable    ${output4}
    \    ${output0} =    BuiltIn.Run Keyword If    ${output3} != ['']    BuiltIn.Set Variable    ${output3}
    \    ${output0} =    BuiltIn.Run Keyword If    ${output2} != ['']    BuiltIn.Set Variable    ${output2}
    \    ${output0} =    BuiltIn.Run Keyword If    ${output1} != ['']    BuiltIn.Set Variable    ${output1}
    \    ${output0} =    BuiltIn.Run Keyword If    ${output} != ['']    BuiltIn.Set Variable    ${output}

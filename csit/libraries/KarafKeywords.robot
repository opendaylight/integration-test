...
Safe_Issue_Command_On_Karaf_Console
    ...
    BuiltIn.Run_Keyword_And_Return    SSHKeywords.Run_Keyword_Preserve_Connection    Issue_Command_On_Karaf_Console    ${cmd}    ${controller}    ${karaf_port}    ${timeout}    ${loglevel}
...
Restore_Current_Ssh_Connection_From_Index
    ...
    [Documentation]    Fallback to SSHKeywords.
    BuiltIn.Run_Keyword_And_Return    SSHKeywords.Restore_Current_Ssh_Connection_From_Index    ${connection_index}

...
Fail If Exceptions Found During Test
    ...
    \    @{exlist}    @{matchlist} =    Get and Verify Exceptions    ${output}
    \    ${listlength} =    BuiltIn.Get Length    ${matchlist}
    \    BuiltIn.Run Keyword If    ${listlength} != 0    Collections.Log List    ${matchlist}

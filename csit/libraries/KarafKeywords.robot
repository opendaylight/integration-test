...
Setup_Karaf_Keywords
    ...
    Return From Keyword If    '${SKIP_KARAF}' == 'TRUE'    Not A Karaf App
...
Open_Controller_Karaf_Console_On_Background
    ...
    SSHLibrary.Login    ${KARAF_USER}    ${KARAF_PASSWORD}    loglevel=${loglevel}
    [Teardown]    Run Keyword If    '${SKIP_KARAF}' != 'TRUE'    SSHKeywords.Restore_Current_Ssh_Connection_From_Index    ${current_ssh_connection_object.index}
...
Configure_Timeout_For_Karaf_Console
    ...
    END
    [Teardown]    Run Keyword If    '${SKIP_KARAF}' != 'TRUE'    SSHKeywords.Restore_Current_Ssh_Connection_From_Index    ${current_connection_object.index}
...
Execute_Controller_Karaf_Command_On_Background
    ...
    [Teardown]    Run Keyword If    '${SKIP_KARAF}' != 'TRUE'    SSHKeywords.Restore_Current_Ssh_Connection_From_Index    ${current_connection_index}
    [Return]    ${message_wait}

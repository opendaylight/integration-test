...
Open_Controller_Karaf_Console_On_Background
    ...
    BuiltIn.Log    Open_Controller_Karaf_Console_On_Background: ${connection_index_dict}
    BuiltIn.Log To Console    Open_Controller_Karaf_Console_On_Background: ${connection_index_dict}
...
Log_Message_To_Controller_Karaf
    ...
    BuiltIn.Log    Log_Message_To_Controller_Karaf: ${connection_index_dict}
    BuiltIn.Log To Console    Log_Message_To_Controller_Karaf: ${connection_index_dict}
    ${index_list} =    ClusterManagement.List_Indices_Or_All    given_list=${member_index_list}

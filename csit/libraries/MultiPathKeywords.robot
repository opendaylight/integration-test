...
Tep_Port_Operations
    [Arguments]    ${OPERATION}    ${OS_COMPUTE_1_IP}    ${OS_COMPUTE_2_IP}=${EMPTY}    ${OS_COMPUTE_3_IP}=${EMPTY}
    ...
    ${COMPUTE_NODE_1_ID}    Get DPID    ${OS_COMPUTE_1_IP}
    ${NODE_ADAPTER}=    Get Ethernet Adapter    ${OS_COMPUTE_1_IP}
    Issue Command On Karaf Console    tep:${OPERATION} ${COMPUTE_NODE_1_ID} ${NODE_ADAPTER} 0 ${OS_COMPUTE_1_IP} ${SUBNET_1} null TZA
    Run Keywords    Run Keyword If    ${OS_COMPUTE_2_IP}    ${COMPUTE_NODE_2_ID}    Get DPID    ${OS_COMPUTE_2_IP}
    ...    AND    Issue Command On Karaf Console    tep:${OPERATION} ${COMPUTE_NODE_2_ID} ${NODE_ADAPTER} 0 ${OS_COMPUTE_2_IP} ${SUBNET_1} null TZA
    Run Keywords    Run Keyword If    ${OS_COMPUTE_3_IP}    ${COMPUTE_NODE_3_ID}    Get DPID    ${OS_COMPUTE_3_IP}
    ...    AND    Issue Command On Karaf Console    tep:${OPERATION} ${COMPUTE_NODE_3_ID} ${NODE_ADAPTER} 0 ${OS_COMPUTE_3_IP} ${SUBNET_1} null TZA

...
Tep_Port_Operations
    ...
    ${COMPUTE_NODE_2_ID}    Run Keyword If    ${COMPUTE_2_IP}    Get DPID    ${COMPUTE_2_IP}
    ${COMPUTE_NODE_3_ID}    Run Keyword If    ${COMPUTE_3_IP}    Get DPID    ${COMPUTE_3_IP}
    ...
    Run Keyword If    ${COMPUTE_2_IP}    Issue Command On Karaf Console    tep:${OPERATION} ${COMPUTE_NODE_2_ID} ${NODE_ADAPTER} 0 ${COMPUTE_2_IP} ${SUBNET_1} null TZA
    Run Keyword If    ${COMPUTE_3_IP}    Issue Command On Karaf Console    tep:${OPERATION} ${COMPUTE_NODE_3_ID} ${NODE_ADAPTER} 0 ${COMPUTE_3_IP} ${SUBNET_1} null TZA

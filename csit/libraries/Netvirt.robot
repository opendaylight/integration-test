...
...               config/odl-nat:ext-routers    config/odl-nat:external-networks    config/odl-nat:floating-ip-info    config/odl-nat:napt-switches    config/opendaylight-inventory:nodes    operational/ietf-interfaces:interfaces-state    operational/itm-state:tunnels_state
...               operational/neutronvpn:neutron-vpn-portip-port-data    operational/neutronvpn:subnetmaps    operational/odl-l3vpn:neutron-router-dpns    operational/odl-l3vpn:vpn-instance-op-data    operational/odl-nat:floating-ip-info

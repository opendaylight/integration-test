...
...               config/odl-l3vpn:vpn-instance-to-vpn-id    config/l3vpn:vpn-interfaces    operational/neutronvpn:neutron-vpn-portip-port-data    config/odl-nat:ext-routers    config/odl-nat:external-networks    config/odl-nat:floating-ip-info    config/odl-nat:napt-switches
...
...               operational/network-topology:network-topology     operational/opendaylight-inventory:nodes      operational/entity-owners:entity-owners    config/network-topology:network-topology

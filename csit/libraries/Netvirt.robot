...
...               config/neutronvpn:router-interfaces-map    config/neutronvpn:subnetmaps    config/neutronvpn:vpnMaps    config/odl-fib:fibEntries    config/odl-l3vpn:router-interfaces    config/l3vpn:vpn-instances    config/odl-l3vpn:vpn-id-to-vpn-instance    config/odl-l3vpn:vpn-instance-to-vpn-id
...
...               operational/itm-state:tunnels_state    operational/neutronvpn:neutron-vpn-portip-port-data    operational/odl-l3vpn:neutron-router-dpns    operational/odl-l3vpn:vpn-instance-op-data    operational/l3vpn:vpn-interfaces    operational/odl-nat:floating-ip-info

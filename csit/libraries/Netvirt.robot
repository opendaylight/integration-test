...
...               operational/odl-l3vpn:neutron-router-dpns    operational/odl-l3vpn:vpn-instance-op-data    operational/odl-nat:floating-ip-info      config/network-topology:network-topology      operational/network-topology:network-topology      config/opendaylight-inventory:nodes     operational/opendaylight-inventory:nodes 

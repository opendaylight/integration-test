...
Create And Get Hwvtep Connection Id
    [Arguments]    ${hwvtep_ip}
    [Documentation]    Creates connection and return connection id for hwvtep_ip received.
...
Create And Configure Hwvtep
    ...
    [Documentation]    Configures the Hwvtep Emulation.
    Switch Connection    ${conn_id}
...
Create Namespace And Port
    ...
    [Documentation]    Configures ports with namespace and veth pair and adds to hwvtep bridge.
    Switch Connection    ${conn_id}

...
Set_Variable_If_At_Least_Carbon
    ...
    BuildIn.Run_Keyword_And_Return  Set_Variable_If_At_Least    carbon    ${value_if_true}    ${value_if_false}
...
Run_Keyword_If_At_Least
    ...
    ...
     BuildIn.Run_Keyword_And_Return_If    &{Stream_dict}[${ODL_STREAM}]} >= &{Stream_dict}[${lower_bound}]}    ${kw_name}    @{varargs}    &{kwargs}
...
Run_Keyword_If_At_Least_Carbon
    ...
    BuildIn.Run_Keyword_And_Return_If    Run_Keyword_If_At_Least     carbon    ${kw_name}    @{varargs}    &{kwargs}

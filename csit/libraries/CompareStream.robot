*** Settings ***
Documentation     This Resource contains list of Keywords Set_Variable_If_At_Least*, Run_Keyword_If_At_Least*,
...               Run_Keyword_If_More_Than*, Run_Keyword_If_Less_Than*
...               for comparison ${ODL_STREAM} to the given ${lower_bound},
...               in order to replace conditional execution in suites, written for example such as this:
...               BuiltIn.Set_Variable_If, by these Keywords.
...

...
class ClusterData(object):
    ...
    def init(cls, *cluster_node_ips):
        """Init method for cluster data, needs to be called before any other methods will be used. It populates dictionary
           of cluster nodes which is used for requesting REST data and checking operational DS leadership. During init method,
           dictionary of cluser nodes is created with cluster node ip as key. Value is another dictionary with key member and
           leader.

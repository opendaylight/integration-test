...
Usage if script itself is described by in help. Currently, one type of monkey
is implemented:
...
class TestResults(object):
    ...
    def save_plot_data(cls):
        ...
        with open('plot-data.csv', 'w') as f:
            f.write('{},{}\r\n'.format(CtrlSwitchLinkDisconnectingMonkey.__name__,
                                       ClusterNodeIsolatingMonkey.__name__))
            f.write('{},{}\r\n'.format(cls._disconnect_run_count, cls._isolate_run_count))

...
Verify Vni Segmentation Id and Tunnel Id
    ...
    ${output} =    BuiltIn.Run Keyword If    '${ip}'=='ipv4'    OpenStackOperations.Execute Command on VM Instance    ${net1}    ${vm1_ip}    ping -c ${DEFAULT_PING_COUNT} ${vm2_ip}
    ...    Else    OpenStackOperations.Execute Command on VM Instance    ${net1}    ${vm1_ip}    ping6 -c ${DEFAULT_PING_COUNT} ${vm2_ip}

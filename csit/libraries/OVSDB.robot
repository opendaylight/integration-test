...
Get ports
    ...
    ${ports}=    Run Command On Remote System    ${node}    Collections.Convert To List    $(sudo ovs-vsctl list-ports ${br} | grep "${type})"
    Log    ${ports}
    [Return]     ${ports}
    #${port_list}=    Run Command On Remote System    ${node}    Collections.Convert To List    ${ports}
    #[Return]    ${port_list}

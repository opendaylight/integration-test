...
Select Form View
    ...
    BuiltIn.Run Keyword If    "${status}"=="False"    GUIKeywords.Mouse Down And Mouse Up Click Element    ${FORM_RADIOBUTTON_UNSELECTED}
...
Select Json View
    ...
    BuiltIn.Run Keyword If    "${status}"=="False"    GUIKeywords.Mouse Down And Mouse Up Click Element    ${JSON_RADIOBUTTON_UNSELECTED}
...
Verify Sent Data CM Is Displayed
    ...
    BuiltIn.Run keyword If    "${true_or_false_option}"=="${TRUE_OPTION}"    Selenium2Library.Wait Until Element Is Visible    ${SENT_DATA_CODE_MIRROR_DISPLAYED}
    BuiltIn.Run keyword If    "${true_or_false_option}"=="${FALSE_OPTION}"    Selenium2Library.Wait Until Element Is Not Visible    ${SENT_DATA_CODE_MIRROR_DISPLAYED}
...
Verify Received Data CM Is Displayed
    ...
    BuiltIn.Run keyword If    "${true_or_false_option}"=="${TRUE_OPTION}"    Selenium2Library.Wait Until Element Is Visible    ${RECEIVED_DATA_CODE_MIRROR_DISPLAYED}
    BuiltIn.Run keyword If    "${true_or_false_option}"=="${FALSE_OPTION}"    Selenium2Library.Wait Until Element Is Not Visible    ${RECEIVED_DATA_CODE_MIRROR_DISPLAYED}

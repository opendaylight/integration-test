...
Resource          YangmanGUIVariables.robot
...
Navigate To Yangman Submenu
    Selenium2Library.Click Element    ${Yangman_SUBMENU}


Open DLUX And Login And Navigate To Yangman Submenu
    GUIKeywords.Launch Or Open DLUX Page And Login DLUX
    GUIKeywords.Verify Submenu Presence    ${Yangman_SUBMENU}
    Navigate To Yangman Submenu
...
Return List Of Operation Names
    ${list}=    BuiltIn.Create List    ${Get_Operation_Name}    ${Put_Operation_Name}
    ...    ${Post_Operation_Name}    ${Delete_Operation_Name}
    [Return]    ${list}
...
Expand Operation Select Menu
    Selenium2Library.Click Element    ${Operation_Select_Input_Clickable}
    Selenium2Library.Wait Until Element Is Visible    ${Operation_Select_Menu_Expanded}
...
Select Operation
    ...
    Selenium2Library.Element Should Be Visible    ${Operation_Select_Menu_Expanded}    
...
Verify Selected Operation Is Displayed
    ...
    Selenium2Library.Page Should Contain Element    ${Selected_Operation_Xpath}
...
Verify Yangman Home Page Elements
    ...
    Selenium2Library.Page Should Contain Element    ${Yangman_Logo}
    Modules Tab Is Selected
...
Click Indexed Module Operations To Load Modules Detail Operations Tab
    ...
    Selenium2Library.Page Should Contain Element    ${indexed_module_operations}
    Selenium2Library.Click Element    ${indexed_module_operations}
    Selenium2Library.Wait Until Page Contains Element    ${Module_Detail_Operations_Tab_Selected}
    YangmanKeywords.Compare Operations Tab Label
...
Click Indexed Module Operational To Load Modules Detail Operational Tab
    ...
    Selenium2Library.Page Should Contain Element    ${indexed_module_operational}
    Selenium2Library.Click Element    ${indexed_module_operational}
    Selenium2Library.Wait Until Page Contains Element    ${Module_Detail_Operational_Tab_Selected}
    YangmanKeywords.Compare Operational Tab Label
    Selenium2Library.Page Should Contain Element    ${Module_Detail_Config_Tab_Deselected}
...
Click Indexed Module Config To Load Modules Detail Config Tab
    ...
    Selenium2Library.Page Should Contain Element    ${indexed_module_config}
    Selenium2Library.Click Element    ${indexed_module_config}
    Selenium2Library.Wait Until Page Contains Element    ${Module_Detail_Config_Tab_Selected}
    YangmanKeywords.Compare Config Tab Label
    Selenium2Library.Page Should Contain Element    ${Module_Detail_Operational_Tab_Deselected}


Toggle Module Detail
    Selenium2Library.Click Element    ${Arrow_Switcher_Button}
...
Expand All Branches In Module Detail Content Active Tab
    Selenium2Library.Wait Until Angular Ready    15s
    Selenium2Library.Page Should Contain Element    ${Module_Detail_Expand_Branch_Button}
    :FOR    ${i}   IN RANGE    1    1000
    \    ${count}=    Selenium2Library.Get Matching Xpath Count    ${Module_Detail_Expand_Branch_Button}
    \    BuiltIn.Exit For Loop If    ${count}==0
    \    #${expand_button_webelement}=    Selenium2Library.Get Webelement    ${Module_Detail_Expand_Branch_Button}
    \    #Selenium2Library.Click Element    ${expand_button_webelement}
...
Verify Sent Data CM Is Displayed
    Selenium2Library.Page Should Contain Element    ${Show_Sent_Data_Checkbox_Selected}
...
Verify Received Data CM Is Not Displayed
    Selenium2Library.Page Should Contain Element    ${Show_Received_Data_Checkbox_Unselected}

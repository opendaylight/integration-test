...
Expand Operation Select Menu
    ...
    GUIKeywords.Mouse Down And Mouse Up Click Element    ${OPERATION_SELECT_INPUT}
...
Select Operation
    ...
    ${status}=    BuiltIn.Run Keyword And Return Status    Selenium2Library.Wait Until Page Contains Element    ${OPERATION_SELECT_MENU_EXPANDED}
    BuiltIn.Run Keyword If    "${status}"=="False"    GUIKeywords.Mouse Down And Mouse Up Click Element    ${OPERATION_SELECT_INPUT}

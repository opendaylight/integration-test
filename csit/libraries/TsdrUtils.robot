...
Generate Syslog
    ...
    #Run    echo "<${fac_sev}>Oct 29 18:10:31: ODL: %STKUNIT0-M:CP %IFMGR-5-ASTATE_UP: Changed interface Admin state to up: Te 0/0" | nc -w 1 -u ${ODL_SYSTEM_IP} 1514
    Run Process     echo    "<${fac_sev}>${MESSAGE}"    |    nc    -w    4    -u    ${ODL_SYSTEM_IP}    1514

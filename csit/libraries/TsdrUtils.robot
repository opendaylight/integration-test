...
Generate Syslog
    ...
    #Run Process    nc    -w    4    -u    ${ODL_SYSTEM_IP}    514    <<<    <${fac_sev}>${MESSAGE}
    Run    echo "<0>Oct 29 18:10:31: ODL: %STKUNIT0-M:CP %IFMGR-5-ASTATE_UP: Changed interface Admin state to up: Te 0/0" | nc -w 4 -u ${ODL_SYSTEM_IP} 1514

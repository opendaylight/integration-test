...
Generate Syslog
    ...
    Run Command On Remote System    ${ODL_SYSTEM_IP}    sudo apt-get -y install netcat
    Run Command On Remote System    ${ODL_SYSTEM_IP}    sudo echo -n "<${fac_sev}>${MESSAGE}" | nc -4u -w1 ${ODL_SYSTEM_IP} 514
    Run Command On Remote System    ${ODL_SYSTEM_IP}    netcat

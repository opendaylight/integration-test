...
${Arrow_Switcher_Button}    //*[@id="toggle-module-detail"]
...
${Operation_Select_Input}    //*[@id="request-selected-operation"]
...
${Operation_Select_Menu_Expanded}    //*[@id="select_container_10"]
${Get_Option}    //*[@id="select_option_12"]
${Put_Option}    //*[@id="select_option_13"]
${Post_Option}    //*[@id="select_option_14"]
${Delete_Option}    //*[@id="select_option_15"]
${Selected_Operation_Xpath}    ${Operation_Select_Input}//span/div[contains(text(), ${Operation_Name})]  

${Request_URL_Input}    //*[@id="search-modules"]
...
${Show_Sent_Data_Checkbox_Selected}    //span[contains(text(), "show sent data")]//ancestor::md-checkbox[@aria-checked="true"]
${Show_Sent_Data_Checkbox_Unselected}    //span[contains(text(), "show sent data")]//ancestor::md-checkbox[@aria-checked="false"]
${Show_Received_Data_Checkbox_Selected}    //span[contains(text(), "show received data")]//ancestor::md-checkbox[@aria-checked="true"]
${Show_Received_Data_Checkbox_Unselected}    //span[contains(text(), "show received data")]//ancestor::md-checkbox[@aria-checked="false"]

${Time}    EMPTY
${Request_Status}    EMPTY
${Status_Label}    //span[contains(text(), "Status:")]
${Status_Value}    ${Status_Label}/span[contains(text(), "${Request_Status}")]            
${Time_Label}    //span[contains(text(), "Time:")]
${Time_Value}    ${Time_Label}/span[contains(text(), "${Time}")]


### Right Panel Json Content ###


${Sent_Data_Code_Mirror_Displayed}    //div[contains(@class, "yangmanModule__right-panel__req-data__cm-SENT") and contains(@aria-hidden, "false")]
...
${Received_Data_Code_Mirror_Displayed}    //div[contains(@class, "yangmanModule__right-panel__req-data__cm-RECEIVED") and contains(@aria-hidden, "false")]
...
${Form_Top_Element_List_Item_Row}    ${Form_Top_Element_Container}//section[@class="yangmanModule__right-panel__form__list__paginator ng-scope layout-align-start-center layout-row"]
${Form_Top_Element_List_Item}    ${Form_Top_Element_List_Item_Row}/section[@class="yangmanModule__right-panel__form__list-item ng-scope layout-align-start-center layout-row"]

...
*** Variables ***
${VERBOSE_RUN}    False
${ConsoleReporting__Initialized}    False
...
Start_Verbose_Test
    ...
    ConsoleReporting__Delimiter
    BuiltIn.Set_Test_Variable    ${ConsoleReporting__Initialized}    True
...
Report_To_Console
    ...
    Return_From_Keyword_If    not ${VERBOSE_RUN}
    Return_From_Keyword_If    not ${ConsoleReporting__Initialized}

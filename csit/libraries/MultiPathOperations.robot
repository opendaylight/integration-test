...
Tep_Port_Operations
    ...
    \    KarafKeywords.Issue Command On Karaf Console    tep:${operation} ${compute_node_id} ${node_adapter} 0 ${OS_COMPUTE_${compute_num}_IP} ${subnet_1} null TZA
    KarafKeywords.Issue Command On Karaf Console    ${TEP_COMMIT}

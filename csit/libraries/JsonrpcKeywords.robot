...
Run Read Service Python Script
    ...
    ${pip_cmds}    Builtin.Set Variable    sudo pip install zmq pyzmq
    ...
    ${cmd}    Builtin.Set Variable    nohup python ${CURDIR}/../variables/jsonrpc/odl-jsonrpc-test-read tcp://0.0.0.0:${DEFAULT_PORT} 0 ${DEFAULT_ENDPOINT} '${module}' '${data}' &
    Log    ${cmd}

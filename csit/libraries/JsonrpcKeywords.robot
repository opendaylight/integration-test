...
Start Test Tool
    ...
    ${logfile}=    Utils.Get Log File_Name    testtool
    BuiltIn.Set Suite Variable    ${testtool_log}    ${logfile}
    ${testtool}=    SSHKeywords.Open_Connection_To_Tools_System
    BuiltIn.Set Suite Variable    ${testtool}    ${testtool}
...
Initialize JSONRPC
    ...
    ...    This keyword can be also used to configure remote control.
...
Unconfigure JSONRPC
    ...
    ...    Calling this KW will also destroy all JSONRPC mountpoints (and thus close all JSONRPC connections to external endpoints).

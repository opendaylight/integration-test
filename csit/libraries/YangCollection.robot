...
Static_Set_As_Src
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -rf vendor/cisco/xr/601/cisco-openconfig-if-aggregate-devs.yang
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -rf vendor/cisco/xr/601/cisco-openconfig-interfaces-devs.yang

...
${PARSING_PATHS}    -p src/main/yang/experimental/ietf-extracted-YANG-modules -p src/main/yang/experimental/openconfig/release/models -p src/main/yang/standard/ietf/DRAFT -p src/main/yang/standard/ietf/RFC -p src/main/yang/experimental/ieee -p src/main/yang/experimental/ietf -p src/main/yang/experimental/mano-models -p src/main/yang/experimental/odp -p src/main/yang/experimental/openconfig/release/models/acl -p src/main/yang/experimental/openconfig/release/models/aft -p src/main/yang/experimental/openconfig/release/models/bfd -p src/main/yang/experimental/openconfig/release/models/bgp -p src/main/yang/experimental/openconfig/release/models/catalog -p src/main/yang/experimental/openconfig/release/models/interfaces -p src/main/yang/experimental/openconfig/release/models/isis -p src/main/yang/experimental/openconfig/release/models/lacp -p src/main/yang/experimental/openconfig/release/models/lldp -p src/main/yang/experimental/openconfig/release/models/local-routing -p src/main/yang/experimental/openconfig/release/models/macsec -p src/main/yang/experimental/openconfig/release/models/mpls -p src/main/yang/experimental/openconfig/release/models/multicast -p src/main/yang/experimental/openconfig/release/models/network-instance -p src/main/yang/experimental/openconfig/release/models/openflow -p src/main/yang/experimental/openconfig/release/models/optical-transport -p src/main/yang/experimental/openconfig/release/models/ospf -p src/main/yang/experimental/openconfig/release/models/platform -p src/main/yang/experimental/openconfig/release/models/policy -p src/main/yang/experimental/openconfig/release/models/policy-forwarding -p src/main/yang/experimental/openconfig/release/models/probes -p src/main/yang/experimental/openconfig/release/models/qos -p src/main/yang/experimental/openconfig/release/models/relay-agent -p src/main/yang/experimental/openconfig/release/models/rib -p src/main/yang/experimental/openconfig/release/models/segment-routing -p src/main/yang/experimental/openconfig/release/models/stp -p src/main/yang/experimental/openconfig/release/models/system -p src/main/yang/experimental/openconfig/release/models/telemetry -p src/main/yang/experimental/openconfig/release/models/types -p src/main/yang/experimental/openconfig/release/models/vlan -p src/main/yang/experimental/openconfig/release/models/wifi -p src/main/yang/stanndard/ieee/draft/802.1/ABcu -p src/main/yang/stanndard/ieee/draft/802.1/Aedk -p src/main/yang/stanndard/ieee/draft/802.1/CBdb -p src/main/yang/stanndard/ieee/draft/802.1/Qcr -p src/main/yang/stanndard/ieee/draft/802.1/Qcw -p src/main/yang/stanndard/ieee/draft/802.1/Qcw -p src/main/yang/stanndard/ieee/published/802.1 -p src/main/yang/vendor/ciena -p src/main/yang/vendor/fujitsu -p src/main/yang/vendor/huawei -p src/main/yang/vendor/nokia
...
Delete_Static_Paths
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf /tmp/yang/experimental/ietf-extracted-YANG-modules/cira-shg-mud@2019-07-08.yang
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf standard/ietf/RFC/ietf-snmp-common@2014-12-10.yang

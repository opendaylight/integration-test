...
${OPENCONFIG_REPO_COMMIT_HASH}    369f0fc51236639a77df0555fc952a8ade677157    # TODO: update docs with new date when changing
...
Delete_Static_Paths
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/l3-unicast-igp-topology@2015-06-08.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/alto-service-types@2015-03-22.yang (module alto-service-types)
    ...
    ## excluded depndency file cisco, (module SNMP-FRAMEWORK-MIB)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/bfd.yang (module bfd)
    ...
    ## removed dependency file draft-gonzalez-netmod-5277-00@2016-03-20.yang, (module draft-gonzalez-netmod-5277-00)
    ...
    ## removed dependecy removed file experimental/ietf-extracted-YANG-modules/transitions@2016-03-15.yang (module transitions)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/dot1q-tag-types@2016-07-08.yang (module dot1q-tag-types)
    ...
    ## not ended type-stm (missing character at the end ';' ), https://tools.ietf.org/html/rfc6020#section-12
    ...
    ## removed dependecy file experimental/ietf-extracted-YANG-modules/ietf-location@2014-05-08.yang, (module ietf-location)
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ieee802-pse@2017-03-02.yang
    ## xpath wrong comparison operator, used '==', should be '='
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-bfd-mpls-te@2018-08-01.yang
    ...
    ## augmenting idnetity 'bgp' instead container 'bgp', both have same identifier
    ...
    ## missing file, can not be found in this commit
    ## missing depndency node 'policy-statements'
    ## if statement: ietf-routing-policy@2020-10-05.yang line 878
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-bgp-policy@2020-06-28.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-connectionless-oam@2017-09-06.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-connectionless-oam-methods@2017-09-06.yang (module ietf-connectionless-oam-methods)
    ...
    ## multiline key, must comply with indentifier rules https://tools.ietf.org/html/rfc6020#section-6.2
    ...
    ## excluded dependency file standard/ietf/RFC/ietf-connectionless-oam@2019-04-16.yang (module ietf-connectionless-oam)
    ...
    ## excluded dependecy file experimental/ietf-extracted-YANG-modules/ietf-notification-capabilities@2020-03-23.yang (module ietf-notification-capabilities)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-diffserv-classifier@2015-04-07.yang (module ietf-diffserv-classifier)
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-dots-signal-call-home@2018-09-28.yang
    ## sx:structure should be augmented by 'sx:augment-structure' not by oridnary 'augment'
    ## https://tools.ietf.org/html/rfc6020#section-7.15
    ## newer dependency ietf-dots-signal-channel uses sx:structure not container anymore
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-dots-signal-control@2019-05-13.yang
    ## sx:structure should be augmented by 'sx:augment-structure' not by oridnary 'augment'
    ## https://tools.ietf.org/html/rfc6020#section-7.15
    ## newer dependency ietf-dots-signal-channel uses sx:structure not container anymore
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-dots-signal-control-filter@2019-02-15.yang
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-ext-xponder-wdm-if@2020-03-09.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-fabric-service-types@2017-08-30.yang (module ietf-fabric-service-types)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-fb-rib-types@2017-03-13.yang (moduel ietf-fb-rib-types)
    ...
    ## description for output list of response is put outside of the scope of list, line 1141
    ## list is closed with closing bracket '}', comment should be put before it
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-gen-oam-ais@2016-06-25.yang (module  ietf-gen-oam)
    ...
    ## referenced elment routing-instance-ref can be found only in cisco yangs, which are excluded from test
    ...
    ## incorrect key name, which is multiline, key-arg = node-identifier *(sep node-identifier)
    ## line 2190 in yang file
    ## https://tools.ietf.org/html/rfc6020#section-6.2
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-i2nsf-policy-rule-for-nsf@2020-08-28.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-ipv6-unicast-routing-2@2017-10-06.yang (module ietf-ipv6-unicast-routing-2 to which it belongs)
    ...
    ## instead there is required submodule with revision 2017-10-05 in file ietf-ipv6-router-advertisements-2@2017-10-05.yang
    ...
    ## excluded dependency file ietf-l3vpn-ntw@2020-10-16.yang, (module ietf-l3vpn-ntw)
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-l3nm-te-service-mapping@2020-11-02.yang
    ## missing dependecy node 'ietf-routing:routing-instance', nowhere to be found
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-l3vpn-ntw@2020-10-16.yang
    ## can not use 'uses' t oreference container, only grouping on line 37, https://tools.ietf.org/html/rfc6020#section-7.12
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-gen-oam@2015-04-09.yang, (module ietf-gen-oam)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/iana-civic-address-type@2014-05-08.yang, (module iana-civic-address-type)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-mpls-mldp@2018-10-22.yang, (module ietf-mpls-mldp@2018-10-22.yang)
    ...
    ## MIGHT BE BUG, key is multiline (sep can be new line) https://tools.ietf.org/html/rfc6020#section-12
    ...
    ## augment-arg node identifier can not include include new line character, https://tools.ietf.org/html/rfc6020#section-6.2
    ...
    ## missing prefix acl definition, https://tools.ietf.org/html/rfc6020#section-6.4
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-mud-quarantine@2019-12-27.yang
    ...
    ## excluded depndency file experimental/ietf-extracted-YANG-modules/ietf-bgp-l3vpn@2018-04-17.yang (module ietf-bgp-l3vpn)
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-mvpn@2019-12-02.yang


    ## multiline key, multiple nodde key, line 690
    ...
    ## depends on 'client-auth', which is missing in newr revision experimental/ietf-extracted-YANG-modules/ietf-tls-server@2020-08-20.yang
    ...
    ## excluded dependecy file, experimental/ietf-extracted-YANG-modules/ietf-bgp-l3vpn@2018-04-17.yang (module ietf-bgp-l3vpn)
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-nvo3-base@2020-08-26.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ieee802-pse@2017-03-02.yang, (module ieee802-pse)
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-poe-power-management@2017-03-09.yang
    ## MUST is not valid for CASE, https://tools.ietf.org/html/rfc7950#section-7.9.2.1
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-qos@2016-10-20.yang
    ## excluded dependecy file experimental/ietf-extracted-YANG-modules/ietf-tpm-remote-attestation@2020-03-09.yang, (module ietf-tpm-remote-attestation)
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-restconf-list-pagination@2015-01-30.yang
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-rib-extension@2020-09-18.yang
    ## missing dependency node 'rsvp:session-attributes-state'
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-rsvp-te@2020-03-09.yang
    ## missing dependency node 'lsps-state'
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-rsvp-te-mpls@2020-03-09.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-yang-packages@2020-01-21.yang, (module ietf-yang-packages)
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-yl-packages@2020-01-21.yang, (module ietf-yl-packages)
    ...
    ## multiline identifier inside key-arg string on line 719, https://tools.ietf.org/html/rfc6020#section-6.2
    ...
    ## excluded depndency file experimental/ieee/1906.1/ieee1906-dot1-system.yang
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-service-pm@2020-07-13.yang
    ## excluded dependency file standard/ietf/RFC/ietf-connectionless-oam@2019-04-16.yang, (module ietf-connectionless-oam)
    ...
    ## MIGHT BE A BUG ask about it, submodule augmentation when does not know prefix
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-common@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-community@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-engine@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-notification@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-proxy@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-security@2018-10-16.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-ssh@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-target@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-tls@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-tsm@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-usm@2014-05-06.yang
    ##rm -vrf experimental/ietf-extracted-YANG-modules/ietf-snmp-vacm@2014-05-06.yang
    ## multiline namespace, https://tools.ietf.org/html/rfc3986#appendix-A
    ...
    ## POTENTIAL BUG, used new line as node seprator inside key-arg
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/ietf-ucpe-ni-properties@2019-11-27.yang
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/ietf-yang-package-types@2020-01-21.yang, (module ietf-yang-package-types)
    ...
    ## incorrect prefix: prefix >"ct"y;< character 'y' after quatation, before stmtend line 7
    ...
    ## but "In some cases, extra whitespace (spaces, line-breaks, tabs, etc.) may
    ## have to be added to break a long URI across lines.  The whitespace
    ## should be ignored when the URI is extracted." [https://tools.ietf.org/html/rfc3986#appendix-C]
    ...
    ## excluded dependecy file experimental/ietf-extracted-YANG-modules/mpls-rsvp@2015-04-22.yang, (module mpls-rsvp)
    ...
    ## MAYBE A BUG, multine separated indentifiers inside key-arg-str
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/ietf-extracted-YANG-modules/openconfig-network-instance-types@2015-10-18.yang
    ...
    ## MIGHT BE A BUG multiline identifiers inside key-arg
    ...
    ## excluded dependency file experimental/ietf-extracted-YANG-modules/service-function@2014-29-04.yang, (module service-function)
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf experimental/openconfig/release/models/wifi/openconfig-ap-interfaces.yang
    ...
    ## excluded dependency file standard/ieee/draft/1906.1/ieee1906-dot1-properties.yang, (module ieee1906-dot1-properties)
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf standard/ieee/draft/1906.1/ieee1906-dot1-components.yang
    ## excluded depndency file standard/ieee/draft/1906.1/ieee1906-dot1-types.yang
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf standard/ieee/draft/802.1/Qcz/ieee802-dot1q-lldp-dcbx-tlv.yang
    ...
    ## MIGHT BE A BUG, multiline key separated by new line chracter
    ...
    ## removed depndency file standard/ietf/RFC/ietf-connectionless-oam@2019-04-16.yang (module ietf-connectionless-oam)
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf standard/ietf/RFC/ietf-connectionless-oam-methods@2019-04-16.yang
    ## removed dependecy file standard/ietf/RFC/ietf-connectionless-oam-methods@2019-04-16.yang
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    rm -vrf standard/ietf/RFC/ietf-connectionless-oam-methods.yang
    ## removed dependency file standard/ietf/RFC/ietf-connectionless-oam@2019-04-16.yang

...
${PARSING_PATHS}    -p ./experimental/ietf-extracted-YANG-modules -p ./experimental/openconfig/release/models -p ./standard/ietf/DRAFT -p ./standard/ietf/RFC -p experimental/ieee -p experimental/ietf -p experimental/mano-models -p experimental/odp -p experimental/openconfig/release/models/acl -p experimental/openconfig/release/models/aft -p experimental/openconfig/release/models/bfd -p experimental/openconfig/release/models/bgp -p experimental/openconfig/release/models/catalog -p experimental/openconfig/release/models/interfaces -p experimental/openconfig/release/models/isis -p experimental/openconfig/release/models/lacp -p experimental/openconfig/release/models/lldp -p experimental/openconfig/release/models/local-routing -p experimental/openconfig/release/models/macsec -p experimental/openconfig/release/models/mpls -p experimental/openconfig/release/models/multicast -p experimental/openconfig/release/models/network-instance -p experimental/openconfig/release/models/openflow -p experimental/openconfig/release/models/optical-transport -p experimental/openconfig/release/models/ospf -p experimental/openconfig/release/models/platform -p experimental/openconfig/release/models/policy -p experimental/openconfig/release/models/policy-forwarding -p experimental/openconfig/release/models/probes -p experimental/openconfig/release/models/qos -p experimental/openconfig/release/models/relay-agent -p experimental/openconfig/release/models/rib -p experimental/openconfig/release/models/segment-routing -p experimental/openconfig/release/models/stp -p experimental/openconfig/release/models/system -p experimental/openconfig/release/models/telemetry -p experimental/openconfig/release/models/types -p experimental/openconfig/release/models/vlan -p experimental/openconfig/release/models/wifi -p standard/ieee/draft/802.1/ABcu -p standard/ieee/draft/802.1/Aedk -p standard/ieee/draft/802.1/CBdb -p standard/ieee/draft/802.1/Qcr -p standard/ieee/draft/802.1/Qcw -p standard/ieee/draft/802.1/Qcw -p standard/ieee/published/802.1 -p vendor/ciena -p vendor/fujitsu -p vendor/huawei -p vendor/nokia

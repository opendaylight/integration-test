...
Install Agent
    ...
    ${conn_id}=    SSHLibrary.Open Connection    ${mininet}    prompt=#   timeout=${DEFAULT_TIMEOUT}
...
Start Emulator Single
    ...
    [Documentation]    Start Agent with custom topology and connect to controller.
    ${mininet_conn_id}=    SSHLibrary.Open Connection    ${mininet}    prompt=#   timeout=${DEFAULT_TIMEOUT}

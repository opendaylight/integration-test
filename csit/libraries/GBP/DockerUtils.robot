...
Execute Curl
    ...
    ${output}    ${err}    ${rc}    SSHLibrary.Execute Command    docker exec ${docker_name} curl ${dest_address}:${service_port} -m 5 && echo success    return_stdout=True    return_stderr=True    return_rc=True
    Should Contain    ${output}    success

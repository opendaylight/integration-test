"""
    ...
    Usage
            ...
            call
                    foo.plot_points(title, filename, duration,
                                    metric, submetric, submetrickey)
...
class ElasticsearchAppender(BaseAppender):
    ...
    def plot_points(self, title, filename, duration, metric, submetric,
                    submetrickey=None):
    ...
    def _get_plot_points(self, duration, metric, submetric, submetrickey=None):
        ...
        func = 'get_jvm_' + metric.lower().replace("'", "")
        resource = getattr(self, func)
        points = []

...
Run Docker Keystone
    ...
    Log    ${output}
    ${output}=    SSHLibrary.Execute Command    docker exec -t keystone bash -c "ps -elf"
    Log    ${output}
    ${output}=    SSHLibrary.Execute Command    docker exec -t keystone bash -c "ls -altr /var"
    Log    ${output}
    ${output}=    SSHLibrary.Execute Command    docker exec -t keystone bash -c "ls -altr /var/log"
    Log    ${output}

...
Set Connection ids and Bridge
    ...
    BuiltIn.Set Global Variable    @{TOOLS_SYSTEM_ALL_CONN_IDS}
...
Ping Pods
    ...
    \    ${ping} =    Write Commands Until Expected Prompt    kubectl exec -it ${pod_name} -- ping -c 3 -i 0.2 ${pod ips[${i}]}    ${DEFAULT_LINUX_PROMPT_STRICT}
    \    BuiltIn.log    ${ping}

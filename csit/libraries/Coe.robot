...
${WATCHER_DESTINATION}    /usr/local/bin/watcher
...
Tear Down
    ...
    Coe.Watcher output file
    Coe.Journalctl Output
...
Ansible Playbook
    ...
    SSHKeywords.Copy_File_To_Remote_System    ${TOOLS_SYSTEM_1_IP}    ${WATCHER_COE}    ${WATCHER_DESTINATION}
...
Check Config File
    Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    cat ${CONFIG_FILES_PATH}
    Run Command On Remote System And Log    ${TOOLS_SYSTEM_2_IP}    cat ${CONFIG_FILES_PATH}
    Run Command On Remote System And Log    ${TOOLS_SYSTEM_3_IP}    cat ${CONFIG_FILES_PATH}

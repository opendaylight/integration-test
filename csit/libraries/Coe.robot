...
Verify Nodes Status
    ...
    Utils.Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    kubectl get nodes    ${DEFAULT_LINUX_PROMPT_STRICT}
...
Verify Pod Status
    ...
    Utils.Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    kubectl get pods -o wide    ${DEFAULT_LINUX_PROMPT_STRICT}
...
Check Config File
    Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    cat /etc/cni/net.d/master.odlovs-cni.conf
    Run Command On Remote System And Log    ${TOOLS_SYSTEM_2_IP}    cat /etc/cni/net.d/master.odlovs-cni.conf
    Run Command On Remote System And Log    ${TOOLS_SYSTEM_3_IP}    cat /etc/cni/net.d/master.odlovs-cni.conf

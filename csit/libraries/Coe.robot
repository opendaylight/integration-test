...
Check Node Status Is Ready
    ...
    ${no_of_lines} =    String.Get Lines Matching Regexp    ${nodes}    ${NODE_READY_STATUS}    partial_match=True
    BuiltIn.Should Be Equal As Strings    ${no_of_lines}    ${NUM_TOOLS_SYSTEM}

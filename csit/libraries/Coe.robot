...
@{nodes_ip}       ${K8s_MASTER_IP}    ${K8s_MINION1_IP}    ${K8s_MINION2_IP}
...
Check Node Status Is Ready
    ...
    ${nodes} =    Utils.Run Command On Remote System    ${K8s_MASTER_IP}    kubectl get pods -o wide    ${DEFAULT_USER}    \    ${EMPTY}
...
Check Pod Status Is Running
    ...
    ${pods} =    Utils.Run Command On Remote System    ${K8s_MASTER_IP}    kubectl get pods -o wide    ${DEFAULT_USER}    \    ${EMPTY}
    ...    return_stdout=False    return_stderr=True

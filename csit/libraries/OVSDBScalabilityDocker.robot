...
Setup Docker Test Suite
    ...
    Put File On Remote System   ${MININET}    'include-raw-pipework.sh'     '/usr/local/pipework'
    Run Command On Mininet    ${CHMOD_PIPEWORK_CMD}
    Run Command On Mininet    ${SETUP_DOCKER}

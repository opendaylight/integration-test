...
def get_entities(restconf_url):
    resp = post(
        url=restconf_url
            + """/operations/odl-entity-owners:get-entities""",
        headers={
...
def get_entity(restconf_url, type, name):
    ...
    resp = post(
        url=restconf_url
            + """/operations/odl-entity-owners:get-entity""",
        headers={
            "Content-Type": "application/json",
            "Accept": "application/json",
            "User-Agent": "csit agent",
    ...
    result = {"candidates": resp.json()["odl-entity-owners:output"]["candidate-nodes"],
...
def get_entity_owner(restconf_url, type, name):
    ...
    resp = post(
        url=restconf_url
            + """/operations/odl-entity-owners:get-entity-owner""",
        headers={
            "Content-Type": "application/json",
            "Accept": "application/json",
            "User-Agent": "csit agent",

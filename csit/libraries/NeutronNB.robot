...
Get Neutron Networks
    ...
    ${output}    Utils.Write Commands Until Expected Prompt    ls -R    30s
    ${output}    Utils.Write Commands Until Expected Prompt    ls -R ${WORKSPACE}    30s
    ${output}    Utils.Write Commands Until Expected Prompt    find . -name activate    30s
    ${output}    Utils.Write Commands Until Expected Prompt    find ${WORKSPACE} -name activate    30s

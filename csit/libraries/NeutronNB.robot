...
Get Neutron Networks
    ...
    ${output}    Utils.Run Command On Remote System    system=${neutron_client_ip}    cmd=echo $WORKSPACE
    ${output}    Utils.Run Command On Remote System    system=${neutron_client_ip}    cmd=ls -R /home
    ${output}    Utils.Run Command On Remote System    system=${neutron_client_ip}    cmd=ls -R /opt
    ...
    ${output}    Utils.Run Command On Remote System    system=${neutron_client_ip}    cmd=ls -R ${WORKSPACE}
    ${output}    Utils.Run Command On Remote System    system=${neutron_client_ip}    cmd=find . -name activate
    ${output}    Utils.Run Command On Remote System    system=${neutron_client_ip}    cmd=find ${WORKSPACE} -name activate

...
Get Neutron Networks
    ...
    ${output}    Utils.Write Commands Until Expected Prompt    cmd=sh pwd    prompt=${DEFAULT_LINUX_PROMPT}
    Log    ${output}
    ${output}    Utils.Write Commands Until Expected Prompt    cmd=sh ls -R    prompt=${DEFAULT_LINUX_PROMPT}
    Log    ${output}

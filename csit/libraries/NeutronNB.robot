...
Get Neutron Networks
    ...
    ${tools_system_shell}    SSHLibrary.Open Connection    ${neutron_client_ip}    prompt=${DEFAULT_LINUX_PROMPT_STRICT}
    Switch Connection    ${tools_system_shell}
...
NeutronNB Setup
    ...
    ${tools_system_shell}    SSHKeywords.Open_Connection_To_Tools_System

...
Get Neutron Networks
    ...
    ${output}    SSHLibrary.Write Commands Until Prompt    ls -R    30s
    ${output}    SSHLibrary.Write Commands Until Prompt    ls -R ${WORKSPACE}    30s
    ${output}    SSHLibrary.Write Commands Until Prompt    find . -name activate    30s
    ${output}    SSHLibrary.Write Commands Until Prompt    find ${WORKSPACE} -name activate    30s

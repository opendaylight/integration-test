...
def _initiate_rpcs(host_list, url_templ, data_templ, subst_dict):
...
def start_write_transactions_on_nodes(host_list, id_prefix, duration, rate, chained_flag=False):

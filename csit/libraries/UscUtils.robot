...
*** Variables ***
${REST_VIEW_CHANNEL}        /rests/operations/usc-channel:view-channel
${REST_ADD_CHANNEL}         /rests/operations/usc-channel:add-channel
${REST_REMOVE_CHANNEL}      /rests/operations/usc-channel:remove-channel
${REST_REMOVE_SESSION}      /rests/operations/usc-channel:remove-session
${REST_SEND_MESSAGE}        /rests/operations/usc-channel:send-message

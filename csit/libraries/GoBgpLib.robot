...
${BINARY_URL}    https://github.com/osrg/gobgp/releases/tag/v2.18.0/gobgp-2.18.0.tar.gz
${BROWSER_FILE_NAME}    gobgp-2.18.0.tar.gz

*** Keywords ***
Start_GoBgp
    [Arguments]    ${cfg_file}
    [Documentation]    Dump the start command into prompt. It assumes that no gobgp is running. For verified
    Process.Run Process    wget    ${BINARY_URL}
    Process.Run Process    tar    -xzf    ${BROWSER_FILE_NAME}

...
${EXECUTION_COMMAND}    env gobgp.tcp.port=17900 /home/jenkins/gobgpd -l debug -f
...
Start_GoBgp
    ...
    ${start_cmd}    BuiltIn.Set_Variable    ${EXECUTION_COMMAND} /home/jenkins/${cfg_file}
...
Start_GoBgp_And_Verify_Connected
    [Arguments]    ${cfg_file}    ${session}    ${gobgp_ip}    ${connection_retries}=${2}
    ...
    FOR    ${idx}    IN RANGE    ${connection_retries}
        ...
        ${status}    ${value}=    BuiltIn.Run_Keyword_And_Ignore_Error    BuiltIn.Wait_Until_Keyword_Succeeds    2x    15s

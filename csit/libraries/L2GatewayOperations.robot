...
Add Ovs Bridge Manager Controller And Verify
    ...
    ...    Controller "tcp:${ODL_IP}:${ODL_OF_PORT}"    ${OVS_SHOW}
...
Namespace Dhclient Verify
    ...
    Wait Until Keyword Succeeds    30s    2s    Verify Strings In Command Output    ${hwvtep_conn_id}    ${ns_port_ip}    ${NETNS_EXEC} ${ns_name} ${IFCONF}

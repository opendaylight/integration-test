...
Verify L2GW Node
    ...
    Switch Connection    ${conn_id}
    Wait Until Keyword Succeeds    120s    4s    Verify L2GW Node PhysicalSwitch    ${conn_id}    ${ovs_bridge}    ${ovs_port_name}    ${vid}
    Wait Until Keyword Succeeds    120s    4s    Verify L2GW Node LogicalSwitch    ${conn_id}    ${ovs_bridge}    ${ovs_port_name}    ${vid}    ${vni}    ${number}

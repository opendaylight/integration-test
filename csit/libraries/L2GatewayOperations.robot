...
Get L2gw Debug Info
    ...
    Exec Command    ${ovs_conn_id}    sudo ovs-ofctl dump-group-stats -O Openflow13 br-int
    Exec Command    ${hwvtep_conn_id}    sudo ovs-ofctl dump-flows br-ovs -O Openflow13
    Exec Command    ${hwvtep_conn_id}    sudo ovs-ofctl dump-group-stats -O Openflow13 br-ovs

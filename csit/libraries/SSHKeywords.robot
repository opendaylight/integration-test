...
Execute_Command_Should_Pass
    ...
    BuiltIn.Run_Keyword_And_Return    Execute_Command_Passes    ${command}    return_on_success_only=False    log_on_success=${log_on_success}    log_on_failure=${log_on_failure}    stderr_must_be_empty=${stderr_must_be_empty}

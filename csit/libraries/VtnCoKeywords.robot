...
Get VtnCo
    ...
    #SSHLibrary.Open_Connection    ${CONTROLLER1}
    #SSHLibrary.Login_With_Public_Key    ${CONTROLLER_USER}    ${USER_HOME}/.ssh/${SSH_KEY}    any
...
Start SuiteVtnCo
    ...
    SSHLibrary.Set Suite Variable    ${vtnc_conn_id}
    SSHLibrary.Login With Public Key    ${CONTROLLER_USER}    ${USER_HOME}/.ssh/${SSH_KEY}    any
    ${VTNC_FILENAME}=    Catenate    SEPARATOR=/    ${WORKSPACE}    vtn_coordinator.tar.bz2

...
Download VtnCo Distribution
    ...
    CompareStream.Run_Keyword_If_Equals    boron    SSHLibrary.Execute Command    wget "${nexus_path}/${boron_version_val}/maven-metadata.xml"
    CompareStream.Run_Keyword_If_Equals    carbon    SSHLibrary.Execute Command    wget "${nexus_path}/${carbon_version_val}/maven-metadata.xml"
    CompareStream.Run_Keyword_If_At_Least_Boron    SSHLibrary.Get_file    maven-metadata.xml
    ...
    CompareStream.Run_Keyword_If_Equals    boron    SSHLibrary.Execute Command    wget '${nexus_path}/${boron_version_val}/${vtn_dist}-${boron_version_val}-${time_stamp}-${build_number}-bin.tar.bz2'
    CompareStream.Run_Keyword_If_Equals    carbon    SSHLibrary.Execute Command    wget '${nexus_path}/${carbon_version_val}/${vtn_dist}-${carbon_version_val}-${time_stamp}-${build_number}-bin.tar.bz2'

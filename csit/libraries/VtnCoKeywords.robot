...
Start SuiteVtnCo
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y https://yum.postgresql.org/9.3/redhat/rhel-5.5-x86_64/postgresql93-odbc-09.03.0400-1PGDG.rhel5.x86_64.rpm

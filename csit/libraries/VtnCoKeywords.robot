...
Start SuiteVtnCo
    ...
    #SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-5.5-x86_64/postgresql93-libs-9.3.12-1PGDG.rhel5.x86_64.rpm
    #SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-5.5-x86_64/postgresql93-9.3.12-1PGDG.rhel5.x86_64.rpm
    #SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-5.5-x86_64/postgresql93-server-9.3.12-1PGDG.rhel5.x86_64.rpm
    #SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-5.5-x86_64/postgresql93-contrib-9.3.12-1PGDG.rhel5.x86_64.rpm
    #SSHLibrary.Execute Command    sudo yum install -q -y postgresql93-libs-9.3.12 postgresql93-9.3.12 postgresql93-server-9.3.12 postgresql93-contrib-9.3.12
    SSHLibrary.Execute Command    sudo yum install -q -y postgresql93-libs-9.3 postgresql93-9.3 postgresql93-server-9.3 postgresql93-contrib-9.3
    SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-5.5-x86_64/postgresql93-odbc-09.03.0400-1PGDG.rhel5.x86_64.rpm
    #SSHLibrary.Execute Command    sudo yum install -q -y postgresql93-libs-9.3.12 postgresql93-9.3.12 postgresql93-server-9.3.12 postgresql93-contrib-9.3.12 postgresql93-odbc-09.03.0400
    ...
    SSHLibrary.Execute Command    sudo cat /etc/redhat-release

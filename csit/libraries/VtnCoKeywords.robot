...
Start SuiteVtnCo
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y postgresql93-libs postgresql93 postgresql93-server postgresql93-contrib postgresql93-odbc-debuginfo-09.03.0400

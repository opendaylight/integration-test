...
Download VtnCo Distribution
    ...
    CompareStream.Run_Keyword_If_Equals    carbon    SSHLibrary.Execute Command    wget 'https://nexus.opendaylight.org/content/repositories/autorelease-1821/org/opendaylight/vtn/distribution.vtn-coordinator/6.4.0-Carbon/distribution.vtn-coordinator-6.4.0-Carbon-bin.tar.bz2'

...
Start SuiteVtnCo
    ...
    ${timestamp}=    XML.Get Element Text    maven-metadata.xml    xpath=.//snapshotVersion/classifier/extension='tar.bz2'/value
    SSHLibrary.Execute Command    wget '${boron_nexus_path}/distribution.vtn-coordinator-${timestamp}-bin.tar.bz2'

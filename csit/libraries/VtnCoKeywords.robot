...
Start SuiteVtnCo
    ...
    Run Keyword If    '${ODL_STREAM}' == 'boron' or '${ODL_STREAM}' == 'carbon'    SSHLibrary.Get_file    maven-metadata.xml    ${time_stamp}=    XML.Get Element Text    maven-metadata.xml    
    ...    xpath=.//snapshot/timestamp    ${build_number}=    XML.Get Element Text    maven-metadata.xml    xpath=.//snapshot/buildNumber

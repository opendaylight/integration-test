...
Start SuiteVtnCo
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.2/redhat/rhel-7.3-x86_64/pgdg-centos92-9.2-2.noarch.rpm
    SSHLibrary.Execute Command    sudo yum install -q -y postgresql92-libs postgresql92 postgresql92-server postgresql92-contrib
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.2/redhat/rhel-7.3-x86_64/postgresql92-odbc-09.05.0400-1PGDG.rhel7.x86_64.rpm

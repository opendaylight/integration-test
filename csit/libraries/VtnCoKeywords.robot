...
Start SuiteVtnCo
    ...
    Run Keyword If    '${ODL_STREAM}' == 'boron'    SSHLibrary.Execute Command    wget 'https://nexus.opendaylight.org/content/repositories/autorelease-1495/org/opendaylight/vtn/distribution.vtn-coordinator/6.3.0-Boron/distribution.vtn-coordinator-6.3.0-Boron-bin.tar.bz2'

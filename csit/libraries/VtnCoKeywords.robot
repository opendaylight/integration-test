...
Start SuiteVtnCo
    ...
    CompareStream.Run_Keyword_If_Version_Is_Boron    SSHLibrary.Execute Command    wget "${nexus_path}/${boron}/maven-metadata.xml"
    ...    ELSE    CompareStream.Run_Keyword_If_Version_Is_Carbon    SSHLibrary.Execute Command    wget "${nexus_path}/${carbon}/maven-metadata.xml"
    ...
    CompareStream.Run_Keyword_If_Version_Is_Boron    SSHLibrary.Execute Command    wget '${nexus_path}/${boron}/${vtn_dist}-6.3.0-${time_stamp}-${build_number}-bin.tar.bz2'
    ...    ELSE    CompareStream.Run_Keyword_If_Version_Is_Carbon    SSHLibrary.Execute Command    wget '${nexus_path}/${carbon}/${vtn_dist}-6.4.0-${time_stamp}-${build_number}-bin.tar.bz2'
    CompareStream.Run_Keyword_If_At_Least_Boron    SSHLibrary.Execute Command    tar -C/ -jxvf ${vtn_dist}*-bin.tar.bz2

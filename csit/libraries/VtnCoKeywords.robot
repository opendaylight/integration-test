...
*** variable ***
${Start1}      sudo mn --controller=remote,ip=${CONTROLLER} --custom vlan_vtn_test.py --topo mytopo
...
Start SuiteVtnCo
    ...
    Execute Command    sudo apt-get install python-apt
    Put File    ${CURDIR}/${CREATE_VTN_TOPOLOGY_FILE_PATH}
    Log    Vlan started

...
Start SuiteVtnCo
    ...
    BuiltIn.Run Keyword If    CompareStream.Run_Keyword_If_At_Least_Boron    SSHLibrary.Execute Command    wget "${nexus_path}/${boron}/maven-metadata.xml"    ELSEIF    CompareStream.Run_Keyword_If_At_Least_Carbon    SSHLibrary.Execute Command
    ...    wget "${nexus_path}/${carbon}/maven-metadata.xml"
    BuiltIn.Run Keywords    CompareStream.Run_Keyword_If_At_Least_Boron    SSHLibrary.Get_file    maven-metadata.xml
    ...AND    CompareStream.Run_Keyword_If_At_Least_Carbon    SSHLibrary.Get_file    maven-metadata.xml
    ...
    BuiltIn.Run Keyword If    CompareStream.Run_Keyword_If_At_Least_Boron    SSHLibrary.Execute Command    wget '${nexus_path}/${boron}/${vtn_dist}-6.3.0-${time_stamp}-${build_number}-bin.tar.bz2'    ELSEIF    CompareStream.Run_Keyword_If_At_Least_Carbon    SSHLibrary.Execute Command
    ...    wget '${nexus_path}/${carbon}/${vtn_dist}-6.4.0-${time_stamp}-${build_number}-bin.tar.bz2'
    BuiltIn.Run Keywords    CompareStream.Run_Keyword_If_At_Least_Boron    SSHLibrary.Execute Command    tar -C/ -jxvf ${vtn_dist}*-bin.tar.bz2
    ...AND    CompareStream.Run_Keyword_If_At_Least_Carbon    SSHLibrary.Execute Command    tar -C/ -jxvf ${vtn_dist}*-bin.tar.bz2
    ...AND    CompareStream.Run_Keyword_If_Less_Than_Boron    SSHLibrary.Execute Command    tar -C/ -jxvf ${WORKSPACE}/${BUNDLEFOLDER}/externalapps/${vtn_dist}*-bin.tar.bz2

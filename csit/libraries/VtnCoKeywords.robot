...
Start SuiteVtnCo
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-7.3-x86_64/pgdg-centos93-9.2-2.noarch.rpm
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y http://yum.postgresql.org/9.3/redhat/rhel-7.3-x86_64/postgresql93-odbc-09.05.0200-1PGDG.rhel7.x86_64.rpm

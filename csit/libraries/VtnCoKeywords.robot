...
Start SuiteVtnCo
    ...
    Execute Command    sed -i 's/*\*\*/log/g' /usr/local/vtn/bin/vtn_stop
    Execute Command    sed -i 's/*\*\*/log/g' /usr/local/vtn/bin/vtn_start
    Execute Command    sed -i 's/*\*\*/log/g' /usr/local/vtn/sbin/db_setup
    Execute Command    sed -i 's/*\*\*/log/g' /usr/local/vtn/sbin/db_start
    Execute Command    sed -i 's/*\*\*/log/g' /usr/local/vtn/sbin/db_stop

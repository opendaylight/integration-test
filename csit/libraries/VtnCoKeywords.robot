...
Start SuiteVtnCo
    ...
    CompareStream.Run_Keyword_If_At_Least_Else    boron    Download VtnCo Distribution    ELSE    SSHLibrary.Execute Command    tar -C/ -jxvf ${WORKSPACE}/${BUNDLEFOLDER}/externalapps/${vtn_dist}*-bin.tar.bz2

...
Start SuiteVtnCo
    ...
    ${time_stamp}=    Run Keyword If    '${ODL_STREAM}' == 'boron' or '${ODL_STREAM}' == 'carbon'    XML.Get Element Text    maven-metadata.xml    xpath=.//snapshot/timestamp
    ${build_number}=    Run Keyword If    '${ODL_STREAM}' == 'boron' or '${ODL_STREAM}' == 'carbon'    XML.Get Element Text    maven-metadata.xml    xpath=.//snapshot/buildNumber

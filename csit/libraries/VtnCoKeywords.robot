...
Start SuiteVtnCo
    ...
    SSHLibrary.Execute Command    sudo yum upgrade -q -y  java-1.8.0-openjdk-devel
    ...
    SSHLibrary.Execute Command    export JAVA_HOME=${JAVA_HOME}
    SSHLibrary.Execute Command    export PATH=${JAVA_HOME}/bin:\${PATH}

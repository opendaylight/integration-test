...
Start SuiteVtnCo
    ...
    SSHLibrary.Execute Command    sudo yum install -q -y https://yum.postgresql.org/9.3/redhat/rhel-7.1-x86_64/pgdg-centos93-9.3-2.noarch.rpm
    SSHLibrary.Execute Command    sudo yum install -q -y postgresql93-libs-9.3 postgresql93-9.3 postgresql93-server-9.3 postgresql93-contrib-9.3 postgresql93-odbc

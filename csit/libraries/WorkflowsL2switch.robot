...
Workflow Single Switch Multiple Hosts
    ...
    ${status}    ${result}    Run Keyword And Ignore Error    MininetKeywords.Start Mininet Multiple Hosts    ${hosts}    mininet_timeout=${hosts}
    ...
    ${status}    ${result}    Run Keyword And Ignore Error    Wait Until Keyword Succeeds    5s    1s    FlowLib.Check No Hosts

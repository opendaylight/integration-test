...
Workflow Linear Topology
    ...
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail adding table Miss flows    ${topology_discover_time}
    END
    ...
    ...    ${switches}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking table miss flows    ${topology_discover_time}
    END
    ...
    ...    ${switches}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking flows in mininet    ${topology_discover_time}
    END
    ...
    ...    ${flows_after}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking flows in operational DS    ${topology_discover_time}
    END
    ...
    ...    nrthreads=${nrthreads}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail deconfiguring flows    ${topology_discover_time}
    END
    ...
    ...    ${switches}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking no flows in mininet    ${topology_discover_time}
    END
    ...
    ...    ${flows_before}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking no flows in operational DS    ${topology_discover_time}
    END
    ...
    ...    ${switches}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking no switch    ${topology_discover_time}
    END
    ...
    ...    ${switches}
    IF    '${status}' == 'FAIL'
        RETURN    ${status}    Fail checking no topology    ${topology_discover_time}
    END

...
Check Cars
    ...
    ${resp}    Getcars    ${selected controller}    ${RESTCONFPORT}    ${0}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Check People
    ...
    ${resp}    GetPersons    ${selected controller}    ${RESTCONFPORT}    ${0}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Check CarPeople
    ...
    ${resp}    GetCarPersonMappings    ${selected controller}    ${RESTCONFPORT}    ${0}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Check Elements In Shards
    ...
    wait until keyword succeeds    3    1    Check Cars    ${selected controller}    ${nth}
    wait until keyword succeeds    3    1    Check People    ${selected controller}    ${nth}
    wait until keyword succeeds    3    1    Check CarPeople    ${selected controller}    ${nth}

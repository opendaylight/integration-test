...
Get Ovsdb Entity Owner Status For One Device
    [Arguments]    ${device}    ${controller_index}    ${controller_index_list}=${EMPTY}    ${peer_down_status}=${EMPTY}    ${down_index}=${EMPTY}
    ...
    ...    device_type=ovsdb    member_index=${controller_index}    candidate_list=${controller_index_list}    peer_down_status=${peer_down_status}    down_index=${down_index}

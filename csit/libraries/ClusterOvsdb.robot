...
Get Dynamic Datapath id
    ...
    ${element1}=    Get from List    ${id1}    5
    Set Suite Variable    ${element1}
    ${element2}=    Get from List    @{id1}    6
    Set Suite Variable    ${element2}
    ${element3}=    Get from List    ${id1}    7
    Set Suite Variable    ${element3}
    ${element4}=    Get from List    ${id1}    8
    Set Suite Variable    ${element4}
    ${element5}=    Get from List    ${id1}    9
    Set Suite Variable    ${element5}
    ${element6}=    Get from List    ${id1}    10
    Set Suite Variable    ${element6}
    ${element7}=    Get from List    ${id1}    11
    Set Suite Variable    ${element7}
    ${element8}=    Get from List    ${id1}    12
    Set Suite Variable    ${element8}
    ${element9}=    Get from List    ${id1}    13
    Set Suite Variable    ${element9}
    ${element10}=    Get from List    ${id1}    14
    Set Suite Variable    ${element10}
    ${element11}=    Get from List    ${id1}    15
    Set Suite Variable    ${element11}
    ${element12}=    Get from List    ${id1}    16

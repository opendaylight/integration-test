...
Get OVS Flows
    ...
    ${flow_output} =    Utils.Run Command On Remote System    ${ovs_ip}    sudo ovs-ofctl -O OpenFlow13 dump-flows ${bridge} | sed ${OVS_FLOWS_REGEX} | egrep -v 'idle_timeout|table=5[01]'

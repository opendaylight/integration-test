...
Utils__Wait_For_Data_To_Satisfy_Keyword_Core
    ...
    ${status}=    BuiltIn.Wait_Until_Keyword_Succeeds    ${timeout}    ${period}    Utils__Request_And_Check_Data    ${getter}    ${stop_at_http_errors}    ${count}
    ...    @{keyword}
...
Wait For Data To Satisfy Keyword
    ...
    Utils__Wait_For_Data_To_Satisfy_Keyword_Core    ${timeout}    ${period}    ${count}    ${getter}    False    ${keyword}    @{arguments}
...
Wait For Data To Satisfy Keyword And Ignore Errors
    ...
    ...    a row.
    Utils__Wait_For_Data_To_Satisfy_Keyword_Core    ${timeout}    ${period}    ${count}    ${getter}    True    ${keyword}    @{arguments}

...
Report_Failure_Due_To_Linked_Bugs
    ...
    ${params}=    Create_Dictionary    f1=content    o1=matches    v1=${reference}    f2=bug_status    o2=notequals    v2=VERIFIED
    ${rsp}=    RequestsLibrary.Get Request    BugZilla    buglist.cgi    params=${params}

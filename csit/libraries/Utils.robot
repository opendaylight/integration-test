...
Report_Failure_Due_To_Linked_Bugs
    ...
    ${bugs}=    BuiltIn.Set_Variable    - open bugs: https://bugs.opendaylight.org/buglist.cgi?f1=keywords&o1=substring&v1=${SUITE_NAME}/${TEST_NAME}&f2=bug_status&o2=notequals&v2=VERIFIED
    ${regression}=    BuiltIn.Set_Variable    - possible regession: https://bugs.opendaylight.org/buglist.cgi?f1=keywords&o1=substring&v1=${SUITE_NAME}/${TEST_NAME}&f2=bug_status&o2=equals&v2=VERIFIED
    ${newline}=    BuiltIn.Evaluate    chr(10)

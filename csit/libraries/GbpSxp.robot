...
${ISE_REST_PORT}                                    9060
${GBP_ENDPOINTS_URI}                                /rests/data/base-endpoint:endpoints
${GBP_EP_TEMPLATES_CONFIG_URI}                      /rests/data/sxp-ep-provider-model:sxp-ep-mapper
${GBP_RENDERER_CONFIG_URI}                          /rests/data/renderer:renderers/renderer/ios-xe-renderer
${GBP_RENDERER_POLICY_OPERATIONAL_URI}
...                                                 /rests/data/renderer:renderers/renderer/ios-xe-renderer/renderer-policy
...
${GBP_TENANT_CONFIG_URI}                            /rests/data/policy:tenants/tenant/tenant-red
...
...                                                 /rests/data/network-topology:network-topology/topology/topology-netconf
${SXP_EP_PROVIDER_CONFIG_URI}                       /rests/data/sxp-ep-provider-model:sxp-ep-mapper
${SXP_ISE_ADAPTER_CONFIG_URI}                       /rests/data/sxp-ise-adapter-model:gbp-sxp-ise-adapter
${SXP_ISE_ADAPTER_OPERATIONAL_URI}                  /rests/data/sxp-ise-adapter-model:gbp-sxp-ise-adapter
${SXP_NODE_RPC_ADD_ENTRY_URI}                       /restconf/operations/sxp-controller:add-entry
${SXP_TOPOLOGY_NODE_CONFIG_URI}                     /rests/data/network-topology:network-topology/topology/sxp
${SXP_TOPOLOGY_NODE_OPERATIONAL_URI}
...                                                 /rests/data/network-topology:network-topology/topology/sxp

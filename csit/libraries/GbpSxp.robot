...
Deploy_Ise_Mock_Server
    ...
    SSHLibrary.Write    cd ${ise_mock_server_api_folder} && mock-server --dir=. --port=${ise_rest_port} --debug
...
Teardown_Ise_Mock_Server
    ...
    SSHKeywords.Execute_Command_At_Path_Should_Pass     cat access*log      path=${ise_mock_server_api_folder}

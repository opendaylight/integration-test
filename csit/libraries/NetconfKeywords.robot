...
Check_Device_Completely_Gone
    ...
    ${uri} =    Restconf.Generate URI    network-topology:network-topology/topology/topology-netconf/node/${device_name}    config
...
Check_Device_Connected
    ...
    ${uri} =    Restconf.Generate URI    network-topology:network-topology/topology/topology-netconf/node/${device_name}    operational

...
${_DIRECTORY_FOR_SCHEMAS}    schemas
...
NetconfKeywords__Deploy_Additional_Schemas
    ...
    # used.
    ${response}=    SSHLibrary.Execute_Command    rm -rf ${_DIRECTORY_FOR_SCHEMAS} 2>&1
    ...
    # machine.
    SSHLibrary.Put_Directory    ${schemas}    destination=./${_DIRECTORY_FOR_SCHEMAS}
    [Return]    --schemas-dir \$HOME/${_DIRECTORY_FOR_SCHEMAS}

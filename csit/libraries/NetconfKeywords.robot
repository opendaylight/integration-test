...
Install_And_Start_Testtool
    ...
    # Start the testtool
    ${command}    BuiltIn.Set_Variable    java -Dorg.apache.sshd.registerBouncyCastle=false -Xmx1G -XX:MaxPermSize=256M -jar ${filename} ${options} --device-count ${device-count} --debug ${debug} ${schemas_option}

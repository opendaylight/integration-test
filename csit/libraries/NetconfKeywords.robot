...
Configure_Devices_In_Netconf
    ...
    \    Collections.Set_To_Dictionary    ${NetconfKeywords__mounted_device_types}    ${device_name}${iteration}    ${device_type}
...
Remove_Devices_From_Netconf
    ...
    ${device_type}=    Collections.Pop_From_Dictionary    ${NetconfKeywords__mounted_device_types}

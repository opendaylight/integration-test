...
Check No OpenFlow Network Operational Information
    ...
    ${dictionary}    Create Dictionary    openflow=0
    Wait Until Keyword Succeeds    20s    1s    ClusterManagement.Check_Item_Occurrence_Member_List_Or_All    uri=${RFC8040_OPERATIONAL_TOPO_API}    dictionary=${dictionary}    member_index_list=${controller_index_list}

...
Get OpenFlow Entity Owner Status For One Device
    ...
    ${owner}    ${candidate_list}    Wait Until Keyword Succeeds    10s    1s    ClusterManagement.Verify_Owner_And_Successors_For_Device    device_name=${device}
    ...    device_type=openflow    member_index=@{controller_index_list}[0]    candidate_list=${controller_index_list}

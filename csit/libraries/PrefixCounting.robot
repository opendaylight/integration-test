...
*** Keywords ***
Select_Topology
    [Arguments]    ${connection}    ${topology}
    [Documentation]    Select the ${connection-id} and ${topology-id} to be used for counting.
    Builtin.Set_Suite_Variable    ${connection-id}    ${connection}
    Builtin.Set_Suite_Variable    ${topology-id}    ${topology}

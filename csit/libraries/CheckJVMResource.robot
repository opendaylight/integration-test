...
Create_JVM_Plots_Cluster
    ...
    \    Plot Points    ${elastic-${index}}    JVM ThreadCount    threadcount-${index}.png    'Threading'    'TotalStartedThreadCount'
    \    Plot Points    ${elastic-${index}}    JVM Heap Memory    heapmemory-${index}.png    'Memory'    'HeapMemoryUsage'    'used'
    \    Plot Points    ${elastic-${index}}    JVM LoadedClassCount    class_count-${index}.png    'ClassLoading'    'TotalLoadedClassCount'
    \    Plot Points    ${elastic-${index}}    JVM CPU Usage    cpu_usage-${index}.png    'OperatingSystem'    'ProcessCpuLoad'

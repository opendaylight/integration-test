...
Add Pre-define Node
    ...
    ${resp}    RequestsLibrary.Put Request    session    ${PREDEFINE_NODE_URI}    data=${body}    headers=${headers}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Add Pre-define Connection
    ...
    ${resp}    RequestsLibrary.Put Request    session    ${PREDEFINE_CONNECTION_URI}    data=${body}    headers=${headers}
    Should Be Equal As Strings    ${resp.status_code}    200

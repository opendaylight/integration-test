...
Add Pre-define Role
    ...
    ${resp}    RequestsLibrary.Put Request    session    ${PPREDEFINE_ROLE_URI}    data=${jsonbody}    headers=${HEADERS_YANG_JSON}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Add Pre-define Node
    ...
    ${jsonbody}     To Json      ${body}
    ${resp}    RequestsLibrary.Put Request    session    ${PREDEFINE_NODE_URI}    data=${jsonbody}    headers=${HEADERS_YANG_JSON}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Add Pre-define Connection
    ...
    ${jsonbody}     To Json      ${body}
    ${resp}    RequestsLibrary.Put Request    session    ${PREDEFINE_CONNECTION_URI}    data=${jsonbody}    headers=${HEADERS_YANG_JSON}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Register Tenant
    ...
    ${jsonbody}     To Json      ${body}
    ${resp}    RequestsLibrary.Post Request    session    ${REGISTER_TENANT_URI}    data=${jsonbody}    headers=${HEADERS_YANG_JSON}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Add Host Intent
    ...
    ${jsonbody}     To Json      ${body}
    ${resp}    RequestsLibrary.Post Request    session    ${STRUCTURE_INTENT_URI}    data=${jsonbody}    headers=${HEADERS_YANG_JSON}
    Should Be Equal As Strings    ${resp.status_code}    200

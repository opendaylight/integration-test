...
Add Pre-define Role
    ...
    ${resp}    RequestsLibrary.Put Request    session    ${PPREDEFINE_ROLE_URI}    data=${jsonbody}    headers=${headers}
    Should Be Equal As Strings    ${resp.status_code}    200
...
Add Pre-define Node
    ...
    ${jsonbody}     To Json      ${body}
    ${resp}    RequestsLibrary.Put Request    session    ${PREDEFINE_NODE_URI}    data=${jsonbody}    headers=${headers}
    Should Be Equal As Strings    ${resp.status_code}    200

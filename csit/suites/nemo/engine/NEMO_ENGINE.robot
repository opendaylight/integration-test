...
${REGISTER_TENANT_FILE}     ../../../variables/nemo/register-tenant.json
${TRANSACTION_BEGIN_URI}     /restconf/operations/nemo-intent:register-user
${TRANSACTION_END_URI}     ../../../variables/nemo/register-tenant.json
${TRANSACTION_FILE}       ../../../variables/nemo/transaction.json
...
Add Pre-define Role
    ...
    Put Elements To URI From File    ${PREDEFINE_ROLE_URI}     ${PREDEFINE_ROLE_FILE}
...
Add Pre-define Node
    ...
    Put Elements To URI From File    ${PREDEFINE_NODE_URI}     ${PREDEFINE_NODE_FILE}
...
Add Pre-define Connection
    ...
    Put Elements To URI From File    ${PREDEFINE_CONNECTION_URI}     ${PREDEFINE_CONNECTION_FILE}

...
TC3_BGP_Peer2_Check_Log_For_No_Updates
    ...
    [Tags]    critical
    SSHLibrary.Switch Connection    bgp_peer2_console
    ${log_check_timeout} =    BuiltIn.Evaluate    ${DEFAULT_LOG_CHECK_TIMEOUT} * 2
    BuiltIn.Wait_Until_Keyword_Succeeds    ${log_check_timeout}    ${DEFAULT_LOG_CHECK_PERIOD}    Check_File_For_Word_Count    ${BGP_PEER2_LOG_FILE}    total_received_update_message_counter: 0    4
    Check_Example_IPv4_Topology_Content

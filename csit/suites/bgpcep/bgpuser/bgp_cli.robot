...
Test_Cli
    ...
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-rib -peer-group application-peers
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-peer1
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-peer1 -peer-group application-peers
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-peer1 -neighbor 127.0.0.1
    BuiltIn.Log    ${output}
...
BGP_Peer2_Check_Log_For_Introduced_Prefixes
    ...
    BuiltIn.Log    ${BGP_PEER2_LOG_FILE}
...
Configure_One_iBGP_Route_Reflector_Client_And_One_iBGP_Non_Client
...
TC2_Test_Cli
    ...
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-peer2 -peer-group application-peers
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-peer2 -neighbor 127.0.0.1
    BuiltIn.Log    ${output}

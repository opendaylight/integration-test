...
Test_Cli
    ...
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-rib -peer-group test-group
    BuiltIn.Log    ${output}
    ...
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-rib -peer-group test-group -neighbor 127.0.0.1
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-rib -peer-group application-peers -neighbor 127.0.0.1
    BuiltIn.Log    ${output}

...
Resource          ${CURDIR}/../../../libraries/CompareStreams.robot
...
Check_Cli_Returns_Full_Topology
...
Check_Cli_Returns_With_One_Connected
    [Documentation]    Tests results of commands through odl-bgpcep-bgp-cli
    [Tags]    critical
...
Check_Cli_Returns_Empty_Topology
    [Documentation]    Tests results of commands through odl-bgpcep-bgp-cli
    [Tags]    critical
...
TC2_Check_Cli_Returns_Full_Topology
    [Documentation]    Tests results of commands through odl-bgpcep-bgp-cli
    [Tags]    critical
    Test_Cli    bgp_rib_value=6    ibgp_1=3    ibgp_2=3
...
TC2_Check_Cli_Returns_With_One_Connected
    [Documentation]    Tests results of commands through odl-bgpcep-bgp-cli
    [Tags]    critical
    Test_Cli    bgp_rib_value=3    ibgp_1=0    ibgp_2=3
...
TC2_Check_Cli_Returns_Empty_Topology
    [Documentation]    Tests results of commands through odl-bgpcep-bgp-cli
    [Tags]    critical
    Test_Cli    bgp_rib_value=0    ibgp_1=0    ibgp_2=0
...
Test_Cli
    ...
    [Tags]    critical
    CompareStreams.Run_Keyword_If_At_Least_Oxygen    BuiltIn.Wait_Until_Keyword_Succeeds    3x    2s    Test_Bgp_Rib    bgp_rib_value=${bgp_rib_value}
    CompareStreams.Run_Keyword_If_At_Least_Oxygen    BuiltIn.Wait_Until_Keyword_Succeeds    3x    2s    Test_Bgp_Rib_Neighbor1    ibgp_1=${ibgp_1}
    CompareStreams.Run_Keyword_If_At_Least_Oxygen    BuiltIn.Wait_Until_Keyword_Succeeds    3x    2s    Test_Bgp_Rib_Neighbor2    ibgp_2=${ibgp_2}

...
Test_Cli
    ...
    BuiltIn.Log    ${output}
    ${output}=    KarafKeywords.Issue_Command_On_Karaf_Console    bgp:operational-state -rib example-bgp-peer1 -neighbor 192.0.2.1
    BuiltIn.Log    ${output}
...
Setup_Everything
    ...
    Builtin.Set_Suite_Variable    ${tools_system_conn_id}    alias=bgp_peer_console

...
...
...               Reported bugs:
...               Bug 4681 - UPDATE message sent by controller to BGP peer has incorrect Total path attribute length (should not cover the NLRI bytes).
...               Bug 4682 - Withdrawn routes missing in UPDATE message from controller to BGP peer
...
Check_For_Empty_Example_App_Rib
    [Documentation]    See no routes in example-app-rib in maximum ${BGP_APP_PEER_TIMEOUT}.
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
    Start_Console_Tool    ${BGP_APP_PEER_GET_COMMAND}    ${BGP_APP_PEER_OPTIONS}
    Wait_Until_Console_Tool_Finish    ${BGP_APP_PEER_TIMEOUT}
    Store_File_To_Workspace    bgp_app_peer.log    bgp_app_peer_get.log
    Count_In_File    bgp_app_peer.log    prefix_count=0    1
...
TC1_Connect_BGP_Peer
    ...
    Count_In_File    bgp_peer.log    nlri_prefix_received:    0
    Count_In_File    bgp_peer.log    withdrawn_prefix_received:    0

TC1_Start_BGP_Application_Peer_And_Post_3_Initial_Routes
...
TC1_BGP_Peer_Check_Incomming_Updates_For_3_Introduced_Prefixes
    ...
    [Tags]    critical
    Switch_To_BGP_Peer_Console
    Count_In_File    bgp_peer.log    nlri_prefix_received:    3
    Count_In_File    bgp_peer.log    nlri_prefix_received: 8.0.1.0/28    1
    Count_In_File    bgp_peer.log    nlri_prefix_received: 8.0.1.16/28    1
    Count_In_File    bgp_peer.log    nlri_prefix_received: 8.0.1.32/28    1
    Count_In_File    bgp_peer.log    withdrawn_prefix_received:    0
    [Teardown]    Report_Failure_Due_To_Bug    4681

TC1_Start_BGP_Application_Peer_And_Delete_3_Initial_Routes
    [Documentation]    Start BGP application peer tool and give him ${BGP_APP_PEER_TIMEOUT}
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
...
TC1_Peer_Check_Incomming_Updates_For_3_Withdrawn_Prefixes
    ...
    [Tags]    critical
    Switch_To_BGP_Peer_Console
    Count_In_File    bgp_peer.log    withdrawn_prefix_received:    3
    Count_In_File    bgp_peer.log    withdrawn_prefix_received: 8.0.1.0/28    1
    Count_In_File    bgp_peer.log    withdrawn_prefix_received: 8.0.1.16/28    1
    Count_In_File    bgp_peer.log    withdrawn_prefix_received: 8.0.1.32/28    1
    Count_In_File    bgp_peer.log    nlri_prefix_received:    3
...
TC2_Start_BGP_Application_Peer_And_Put_3_Routes
    [Documentation]    Start BGP application peer tool and give him ${BGP_APP_PEER_TIMEOUT}
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
...
TC2_Start_BGP_Application_Peer_And_Delete_All_Routes
    [Documentation]    Start BGP application peer tool and give him ${BGP_APP_PEER_TIMEOUT}
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
...
TC3_Start_BGP_Application_Peer_And_Put_3_Routes
    [Documentation]    Start BGP application peer tool and give him ${BGP_APP_PEER_TIMEOUT}
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
    Start_Console_Tool    ${BGP_APP_PEER_PUT_COMMAND}    ${BGP_APP_PEER_OPTIONS}
...
TC3_Start_BGP_Application_Peer_And_Delete_All_Routes
    [Documentation]    Start BGP application peer tool and give him ${BGP_APP_PEER_TIMEOUT}
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
    Start_Console_Tool    ${BGP_APP_PEER_DELETE_ALL_COMMAND}    ${BGP_APP_PEER_OPTIONS}
...
Count_In_File
    [Arguments]    ${source_file_name}    ${substring}    ${expected_result}
    [Documentation]    Count ${substring} in ${source_file_name}. Expect ${expected_result} occurence(s)
    ${output_log}=    SSHLibrary.Execute_Command    grep -c '${substring}' ${source_file_name}
    BuiltIn.Log    ${output_log}
    BuiltIn.Should_Be_Equal_As_Strings    ${output_log}    ${expected_result}

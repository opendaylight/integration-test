...
Start_BGP_Peer
    ...
    Start_Console_Tool    ${BGP_PEER_COMMAND}
    Read_And_Fail_If_Prompt_Is_Seen

Start_BGP_Application_Peer
    [Documentation]    Start BGP application peer tool
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
    Start_Console_Tool    ${BGP_APP_PEER_ADD_COMMAND}
    Wait_Until_Console_Tool_Finish    60s
...
Stop_BGP_Application_Peer
    [Documentation]    Stop BGP application peer tool
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
    Stop_Console_Tool
    Store_File_To_Workspace    bgp_peer.log
...
Stop_BGP_Peer
    ...
    Switch_To_BGP_Peer_Console
    Stop_Console_Tool
    Store_File_To_Workspace    bgp_app_peer.log

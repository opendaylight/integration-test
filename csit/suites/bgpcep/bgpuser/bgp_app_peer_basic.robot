...
...               TC1: POST request for 3 routes, BGP peer connected 1st time, delete routes one by one.
...               TC2: PUT request for 3 routes and consequent deletion by one request.
...               TC3: toploogy is prefilled, check updates towards BGP peer after re-connection.
...

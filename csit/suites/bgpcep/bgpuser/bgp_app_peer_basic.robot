...
${BGP_APP_PEER_POST_COMMAND}    python bgp_app_peer.py --command post --count 3 --prefix 8.0.1.0 --prefixlen 28 --${BGP_APP_PEER_LOG_LEVEL}
${BGP_APP_PEER_PUT_COMMAND}    python bgp_app_peer.py --command put --count 3 --prefix 8.0.1.0 --prefixlen 28 --${BGP_APP_PEER_LOG_LEVEL}
${BGP_APP_PEER_DELETE_COMMAND}    python bgp_app_peer.py --command delete --count 3 --prefix 8.0.1.0 --prefixlen 28 --${BGP_APP_PEER_LOG_LEVEL}
${BGP_APP_PEER_DELETE_ALL_COMMAND}    python bgp_app_peer.py --command delete-all --${BGP_APP_PEER_LOG_LEVEL}
${BGP_APP_PEER_GET_COMMAND}    python bgp_app_peer.py --command get --${BGP_APP_PEER_LOG_LEVEL}
${BGP_APP_PEER_OPTIONS}    &>/dev/null
${BGP_APP_PEER_TIMEOUT}    10s
...
Reconfigure_ODL_To_Accept_BGP_Application_Peer
    ...
    [Tags]    critical
    ${template_as_string}=    BuiltIn.Set_Variable    {'NAME': 'example-bgp-peer-app', 'IP': '${TOOLS_SYSTEM_IP}'}
...
Check_For_Empty_Example_Bgp_Rib
...
Start_BGP_Application_Peer
    ...
    Store_File_To_Workspace    bgp_app_peer.log    bgp_app_peer_add.log

Check_Example_Bgp_Rib_Is_Filled
...
Check_Example_App_Rib_Is_Filled
    [Documentation]    See new routes in example-app-rib in maximum ${BGP_APP_PEER_TIMEOUT}.
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console
    ...
    # TODO: Add checks
    Count_In_File    prefix_count=3    bgp_app_peer.log    1
...
Count_In_File
    [Arguments]    ${substring}    ${source_file_name}    ${expected_result}

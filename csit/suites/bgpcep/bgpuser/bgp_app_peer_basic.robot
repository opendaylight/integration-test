...
${BGP_APP_PEER_ADD_COMMAND}    python bgp_app_peer.py --command add --count 3 --prefix 8.0.1.0 --prefixlen 28 --${BGP_APP_PEER_LOG_LEVEL} &>/dev/null
${BGP_APP_PEER_GET_COMMAND}    python bgp_app_peer.py --command get --${BGP_APP_PEER_LOG_LEVEL} &>/dev/null
...
Start_BGP_Application_Peer
    ...
    Start_Console_Tool    ${BGP_APP_PEER_ADD_COMMAND}    ${BGP_APP_PEER_OPTIONS}
...
Check_Example_App_Rib_Is_Filled
    ...
    Count_In_File    prefix    bgp_app_peer.log    1

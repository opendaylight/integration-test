...
Start_BGP_Application_Peer
    [Documentation]    Start BGP application peer tool and wait ${BGP_APP_PEER_TIMEOUT}
    [Tags]    critical
...
Check_Example_App_Rib_Is_Filled
    [Documentation]    See new routes in example-app-rib as a proof that synchronization was correct.
    [Tags]    critical
    Switch_To_BGP_Application_Peer_Console

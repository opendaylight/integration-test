...
TC1_Check_Example_Bgp_Rib_Is_Empty
    ...
    BgpOperations.Check_Example_Bgp_Rib_Does_Not_Contain    ${JSONKEYSTR}    ${CONFIG_SESSION}
...
TC1_Check_Example_Bgp_Rib
    ...
    [Tags]    critical
    SSHLibrary.Switch Connection    bgp_peer_console
    WaitForFailure.Verify_Keyword_Does_Not_Fail_Within_Timeout    ${DEFAULT_RIB_CHECK_TIMEOUT}    ${DEFAULT_RIB_CHECK_PERIOD}    BgpOperations.Check_Example_Bgp_Rib_Does_Not_Contain    ${JSONKEYSTR}    ${CONFIG_SESSION}
...
TC2_Check_Example_Bgp_Rib
    ...
    [Tags]    critical
    SSHLibrary.Switch Connection    bgp_peer_console
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEFAULT_RIB_CHECK_TIMEOUT}    ${DEFAULT_RIB_CHECK_PERIOD}    BgpOperations.Check_Example_Bgp_Rib_Content    ${JSONKEYSTR}    session=${CONFIG_SESSION}

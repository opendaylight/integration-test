...
...                 - introduce and check 2 prefixes
...
Start_Listening_BGP_Speaker
    ...
    BGPSpeaker.Start_BGP_Speaker    --amount 2 --listen --myip={TOOLS_SYSTEM_IP} --myport=${BGP_TOOL_PORT} --peerip=${ODL_SYSTEM_IP}
    Read_And_Fail_If_Prompt_Is_Seen
...
Setup_Everything
    ...
    # TODO: Do not include slash in ${OPERATIONAL_API}, having it typed here is more readable.
...
Compare_Topology
    ...
    ${response}=    RequestsLibrary.Get    operational    topology/example-ipv4-topology

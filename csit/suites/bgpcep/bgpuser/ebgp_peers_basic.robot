...
${EMPTY_IPv4_TOPOLOGY}    {"topology":[{"topology-id":"example-ipv4-topology","server-provided":true,"topology-types":{}}]}
...
Connect_iBGP_Peer1
    ...
    Check_Example_IPv4_Topology    ${EMPTY_IPv4_TOPOLOGY}
...
Disconnect_eBGP_Peer2
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEFAULT_CHECK_TIMEOUT}    1s    Check_Example_IPv4_Topology    ${EMPTY_IPv4_TOPOLOGY}

...
Connect_eBGP_Peer1
    ...
    Read_And_Fail_If_Prompt_Is_Seen
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEFAULT_TOPOLOGY_CHECK_TIMEOUT}    ${DEFAULT_TOPOLOGY_CHECK_PERIOD}    Check_Example_IPv4_Topology_Content    {"prefix":"${eBGP_PEER1_FIRST_PREFIX_IP}/${PREFIX_LEN}"}
...
Disconnect_eBGP_Peer1
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEFAULT_TOPOLOGY_CHECK_TIMEOUT}    ${DEFAULT_TOPOLOGY_CHECK_PERIOD}    Check_Example_IPv4_Topology_Content    {"prefix":"${eBGP_PEER2_FIRST_PREFIX_IP}/${PREFIX_LEN}"}

...
${eBGP_PEER2_FIRST_PREFIX_IP}    ${eBGP_PEER1_FIRST_PREFIX_IP}
...
Disconnect_eBGP_Peer2
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEFAULT_CHECK_TIMEOUT}    1s    Check_Example_IPv4_Topology_Does_Not_Contain    prefix
...
iBGP_Check_Log_For_Withdrawn_Prefixes
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEFAULT_CHECK_TIMEOUT}    1s    Check_File_For_Word_Count    ${iBGP_PEER1_LOG_FILE}    withdrawn_prefix_received:    ${prefixes_to_be_removed}
    [Teardown]    Report_Failure_Due_To_Bug    4835

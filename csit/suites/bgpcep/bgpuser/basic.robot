...
${HOLDTIME}       180
${ODL_BGP_LOG_LEVEL}    DEBUG    #MODIFIED FOR DEBUGGING WAS DEFAULT
${ODL_LOG_LEVEL}    INFO
...
TC_LA_Kill_Bgp_Speaker
    ...
    BuiltIn.Log    ${rib}
    ${topo}    TemplatedRequests.Get_As_Json_From_Uri    /restconf/operational/network-topology:network-topology/topology/example-ipv4-topology    session=${CONFIG_SESSION}
    BuiltIn.Log    ${topo}
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Speaker_Is_Connected
    #ENDDEBUGGING
    CompareStream.Run_Keyword_If_Less_Than_Fluorine    BuiltIn.Pass_Execution    Test case valid only for versions fluorine and above.

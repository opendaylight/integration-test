...
Configure_Peer_Group
    ...
    CompareStream.Run_Keyword_If_At_Least_Else    sulfur    ${verify_peer_group_folder}    BuiltIn.Set Variable    verify_${peer_group_folder}.sulfur
    ...    ELSE    ${verify_peer_group_folder}    BuiltIn.Set Variable    verify_${peer_group_folder}

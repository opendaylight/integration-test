...
${IPV4_IBGP_2EBGP_FOLDER}    ${CURDIR}/../../../variables/bgpfunctional/ipv4_ibgp_2ebgp
...
Verify_ODL_LocRib_Contains_All_Advertised_Routes
    TemplatedRequests.Get_As_Json_Templated    folder=${IPV4_IBGP_2EBGP_FOLDER}    session=${CONFIG_SESSION}    verify=True

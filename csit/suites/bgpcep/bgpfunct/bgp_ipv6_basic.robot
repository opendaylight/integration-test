...
Verify_Controller_Karaf_Log_Has_No_ModifiedNodeDoesNotExistException
    ...
    Check Karaf Log File Does Not Have Messages    ${controller_ip}    ModifiedNodeDoesNotExistException

...
${HOLDTIME}       180
${RIB_INSTANCE}    example-bgp-rib-basic
...
Configure_App_Peer
    ...
    &{mapping}    Create Dictionary    IP=${TOOLS_SYSTEM_2_IP}    HOLDTIME=${HOLDTIME}    PEER_PORT=${BGP_TOOL_PORT}    INITIATE=false    BGP_RIB=${RIB_INSTANCE}
    ...    PASSIVE_MODE=true    BGP_RIB_OPENCONFIG=${RIB_INSTANCE}    RIB_INSTANCE_NAME=${RIB_INSTANCE}

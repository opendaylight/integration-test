...
Verify_Controller_Karaf_Log_Has_No_ModifiedNodeDoesNotExistException_1
    [Arguments]    ${controller_ip}=${IPV4_IP}
    [Documentation]    Will execute any tests to verify the controller is not having any null pointer eceptions.
    Check Karaf Log File Does Not Have Messages    ${IPV4_IP}    ModifiedNodeDoesNotExistException
...
Verify_Controller_Karaf_Log_Has_No_ModifiedNodeDoesNotExistException_2
    [Arguments]    ${controller_ip}=${IPV4_IP}
    [Documentation]    Will execute any tests to verify the controller is not having any null pointer eceptions.
    Check Karaf Log File Does Not Have Messages    ${IPV4_IP}    ModifiedNodeDoesNotExistException

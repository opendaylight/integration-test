...
Start_Suite
    ...
    ${stdout}    SSHLibrary.Read_Until_Prompt
    BuiltIn.Log    ${stdout}
    ${status}    ${output}    Run Keyword And Ignore Error    SSHLibrary.Write    sudo sh -c 'echo "IPV6INIT=yes" >> /etc/sysconfig/network-scripts/ifcfg-enp0s8'
    ${status}    ${output}    Run Keyword And Ignore Error    SSHLibrary.Write    sudo sh -c 'echo "IPV6ADDR=2607:f0d0:1002:0011:0000:0000:0000:0002" >> /etc/sysconfig/network-scripts/ifcfg-enp0s8'
    ${status}    ${output}    Run Keyword And Ignore Error    SSHLibrary.Write    sudo sh -c 'echo "IPV6_DEFAULTGW=2607:f0d0:1002:0011:0000:0000:0000:0001" >> /etc/sysconfig/network-scripts/ifcfg-enp0s8'

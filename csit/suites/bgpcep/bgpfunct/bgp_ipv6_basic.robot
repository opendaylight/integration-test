...
Start_Exabgp
    ...
    ${output}    SSHLibrary.Execute_Command    ${start_cmd}
    BuiltIn.Log    ${output}
...
Stop_All_Exabgps
    [Documentation]    Save exabgp logs as exa1.log, and stop exabgp with ctrl-c bash signal
    BGPcliKeywords.Store_File_To_Workspace    exa1.log    exa1.log

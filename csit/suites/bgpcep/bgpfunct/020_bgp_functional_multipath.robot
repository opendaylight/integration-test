...
${TWO_PATHS}      2
&{DEFAULT_MAPPING}   ODLIP=${ODL_SYSTEM_IP}   EXAIP=${TOOLS_SYSTEM_IP}     ADDPATH=disable   NPATHS=${TWO_PATHS}
@{PATH_ID_LIST}    1     2      3
${PATH_ID_LIST_LEN}     3
...
${ADDPATHCAP_S}     send/receive
${ADDPATHCAP_R}     send/receive
${ADDPATHCAP_SR}     send/receive
...
Odl Npaths Exa SendReceived
    ...
    [Setup]     Configure_Path_Sellection_And_Connect_Peer       ${NPATHS_SELM}     send/receive
...
Odl Allpaths Exa SendReceived
    ...
    [Setup]     Configure_Path_Sellection_And_Connect_Peer       ${ALLPATHS_SELM}     send/receive
...
Configure_Path_Sellection_And_Connect_Peer
    ...
    Start_Tool_And_Verify_Connected    ${DEFAUTL_RPC_CFG}
...
Verify_Expected_Update_Count
    ...
    BuiltIn.Sound_Be_Equal_As_Numbers    ${exp_count}       ${tool_count}

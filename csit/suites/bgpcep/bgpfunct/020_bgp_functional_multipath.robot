...
Odl Npaths Exa SendReceived
    ...
    [Setup]     Configure_path_policy_and_connect_peer       n-paths     send/receive
    
    [Teardown]     Stop_Tool

Odl Allpaths Exa SendReceived
    [Documentation]    all-paths selected policy selected
    [Setup]     Configure_path_policy_and_connect_peer       all-paths     send/receive
    [Teardown]     Stop_Tool

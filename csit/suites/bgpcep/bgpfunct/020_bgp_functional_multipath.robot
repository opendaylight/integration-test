...
Configure_App_Peer_With_Routes
    ...
    \    &{route_mapping}     Create Dictionary     NEXTHOP=${NEXT_HOP_PREF}${pathid}     LOCALPREF=${pathid}00    PATHID=${pathid}
...
Upload Config Files
    ...
    SSHLibrary.Put File    ${BGP_VAR_FOLDER}/${DEFAUTL_RPC_CFG}    .
    ...
    \    SSHLibrary.Execute Command    sed -i -e 's/ADDPATH/${addpath}/g' ${cfgfile}

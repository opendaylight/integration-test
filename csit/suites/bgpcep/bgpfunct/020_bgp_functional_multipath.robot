...
Configure_Odl_Peer_With_Path_Selection_Mode
    ...
    ${npaths}=    BuiltIn.Set_Variable_If    "${psn}"=="${ALLPATHS_SELM}"    0    ${N_PATHS_VALUE}
    ...
    TemplatedRequests.Put_As_Xml_Templated    ${MULT_VAR_FOLDER}/bgp_peer
    BuiltIn.Set_Suite_Variable    ${rib_old}    ${Empty}    # thos is just not to fail Stop_Suite if rib_old not defined

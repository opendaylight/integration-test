...
Odl Allpaths Exa SendReceived
    ...
    [Setup]    Configure_Path_Selection_And_Connect_Peer    ${ALLPATHS_SELM}    ${ADDPATHCAP_SR}
...
Odl Npaths Exa SendReceived
    ...
    [Setup]    Configure_Path_Selection_And_Connect_Peer    ${NPATHS_SELM}    ${ADDPATHCAP_SR}
    Log_Loc_Rib_Operational
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    2s    Verify_Expected_Update_Count    ${N_PATHS_VALUE}
    [Teardown]    Stop_Tool
...
Start_Suite
    ...
    SSHKeywords.Virtual_Env_Install_Package      exabgp==3.4.16 --quiet
...
Configure_Path_Selection_And_Connect_Peer
...
Start_Tool_And_Verify_Connected
    [Arguments]    ${cfg_file}
    [Documentation]    Start the tool and verify it's connection
    Start_Tool    ${cfg_file}

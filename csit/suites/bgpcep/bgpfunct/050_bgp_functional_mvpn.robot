...
Start_Suite
    ...
    BuiltIn.Set_Suite_Variable    ${MVPN_LOC_RIB}    /restconf/operational/bgp-rib:bgp-rib/rib/${RIB_NAME}/peer/bgp:%2F%2F${TOOLS_SYSTEM_IP}/adj-rib-in/tables/bgp-types:ipv4-address-family/bgp-mvpn:mcast-vpn-subsequent-address-family/bgp-mvpn-ipv4:mvpn-routes
...
Start_Bgp_Peer
    ...
    BGPSpeaker.Start_BGP_Speaker    --amount 0 --myip=${TOOLS_SYSTEM_IP} --myport=${BGP_TOOL_PORT} --peerip=${ODL_SYSTEM_IP} --peerport=${ODL_BGP_PORT} --debug --mvpn --wfr 1 --logfile
...
Loc_Rib_Presence
    ...
    Run Keyword And Ignore Error    BuiltIn.Log    ${rsp.content}

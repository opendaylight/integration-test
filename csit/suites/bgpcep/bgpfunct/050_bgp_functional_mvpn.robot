...
Start_Suite
    ...
    BuiltIn.Set_Suite_Variable    ${MVPN_CONF_URL}    /restconf/config/bgp-rib:application-rib/${ODL_SYSTEM_IP}/tables/bgp-types:ipv4-address-family/bgp-mvpn:mcast-vpn-subsequent-address-family/bgp-mvpn-ipv4:mpvn-routes-ipv4
...
Withdraw_Route_And_Verify
    ...
    BgpRpcClient.play_send    ${withdraw_hex}
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    2s    Loc Rib Presence    ${empty_routes}

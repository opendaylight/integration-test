...
Verify_Route_Was_Kept_After_Peer_Restart
    ...
    ...    Within graceful-restart timer, the route would be still present in loc-rib,
    ...    therefore we sleep for 5 seconds, and verify that route is still present in loc-rib.

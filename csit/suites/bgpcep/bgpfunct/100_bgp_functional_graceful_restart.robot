...
TC_0
    [Setup]    Setup_TC0
    Verify_One_Route
    Kill_Talking_BGP_Speaker    log_name=gr_tc0.out
    BuiltIn.Sleep    5s
    Verify_No_Routes
...
TC_1
    ...
    Verify_One_Route
    Kill_Talking_BGP_Speaker    log_name=gr_tc1.out

TC_2
    [Setup]    Setup_TC2
    Start_Bgp_Peer    grace=3    log_name=gr_tc2.out
    Verify_One_Route
    Kill_Talking_BGP_Speaker    log_name=gr_tc2.out
...
TC_3
    ...
    Kill_Talking_BGP_Speaker    log_name=gr_tc3.out
...
TC_4
    ...
    BuiltIn.Log    ${update}    #TODO: verify update message
    Verify_One_Route
    Kill_Talking_BGP_Speaker    log_name=gr_tc4.out
...
TC_5
    ...
    BuiltIn.Log    ${update}    #TODO: verify update message
    Verify_Two_Routes
    Kill_Talking_BGP_Speaker    log_name=gr_tc5.out

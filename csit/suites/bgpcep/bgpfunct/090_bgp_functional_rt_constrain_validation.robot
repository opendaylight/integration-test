...
Start_Play
    ...
    SSHLibrary.Read
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    Start_Bgp_Peer    ${ODL_2_IP}    play.py.090.2
    BGPcliKeywords.Store_File_To_Workspace    play.py.090.2    090_rt_constrain_play.log
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    Start_Bgp_Peer    ${ODL_3_IP}    play.py.090.3
    BGPcliKeywords.Store_File_To_Workspace    play.py.090.3    090_rt_constrain_play.log
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    Start_Bgp_Peer    ${ODL_4_IP}    play.py.090.4
    BGPcliKeywords.Store_File_To_Workspace    play.py.090.4    090_rt_constrain_play.log
...
Start_Bgp_Peer
    ...
    BGPSpeaker.Start_BGP_Speaker    --amount 0 --myip=${ip} --myport=${BGP_TOOL_PORT} --peerip=${ODL_SYSTEM_IP} --peerport=${ODL_BGP_PORT} --debug --allf --wfr 1 & &> ${filename}

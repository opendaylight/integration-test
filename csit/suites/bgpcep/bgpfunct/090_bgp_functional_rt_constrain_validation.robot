...
Library           SSHLibrary
Library           String
Library           ../../../libraries/BgpRpcClient.py    127.0.0.1    8002    WITH NAME    BgpRpcClient2
Library           ../../../libraries/BgpRpcClient.py    127.0.0.1    8003    WITH NAME    BgpRpcClient3
Library           ../../../libraries/BgpRpcClient.py    127.0.0.1    8004    WITH NAME    BgpRpcClient4
...
Start_Bgp_Peer
    ...
    ${command}=    BuiltIn.Set_Variable    python play.py --amount 0 --myip=${ip} --myport=${BGP_TOOL_PORT} --peerip=${ODL_SYSTEM_IP} --peerport=${ODL_BGP_PORT} --port=${port} --usepeerip=True --debug --allf --wfr 1 &> ${filename} &
    BuiltIn.Log    ${command}

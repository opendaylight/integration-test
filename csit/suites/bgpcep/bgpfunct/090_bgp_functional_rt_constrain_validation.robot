...
Start_Play
    ...
    SSHLibrary.Read
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    Start_Bgp_Peer    ${ODL_2_IP}
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    Start_Bgp_Peer    ${ODL_3_IP}
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    Start_Bgp_Peer    ${ODL_4_IP}

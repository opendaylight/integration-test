...
${BGPRPCCLIENT_LIB_PATH}    ${CURDIR}/../../../libraries/BgpRpcClient.py
...
Play_To_Odl_l3vpn_rt_arg
    BgpOperations.Play_To_Odl_Non_Removal_Template    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_2_IP}    BgpRpcClient2    l3vpn_rt_arg    ${RT_CONSTRAIN_DIR}

Play_To_Odl_rt_constrain_type_0
    BgpOperations.Play_To_Odl_Non_Removal_Template    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_3_IP}    BgpRpcClient3    rt_constrain_type_0    ${RT_CONSTRAIN_DIR}
    ...
    \    BgpOperations.Get_Update_Message_And_Compare_With_Hex    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_${i}_IP}    BgpRpcClient${i}    ${announce_hex}    ${option}

Play_To_Odl_rt_constrain_type_1
    BgpOperations.Play_To_Odl_Non_Removal_Template    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_4_IP}    BgpRpcClient4    rt_constrain_type_1    ${RT_CONSTRAIN_DIR}
    ${announce}=    OperatingSystem.Get_File    ${RT_CONSTRAIN_DIR}/l3vpn_rt_arg/announce_l3vpn_rt_arg.hex
    ${announce_hex}=    BuiltIn.Remove_String    ${announce}    \n
    BgpOperations.Get_Update_Message_And_Compare_With_Hex    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_4_IP}    BgpRpcClient4    ${announce_hex}    true
...
Play_To_Odl_remove_rt
    ...
    BgpOperations.Get_Update_Message_And_Compare_With_Hex    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_3_IP}    BgpRpcClient3    ${withdraw_hex}    true
...
Play_To_Odl_remove_routes
    ...
    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_2_IP}    BgpRpcClient2    l3vpn_rt_arg    ${RT_CONSTRAIN_DIR}
    ${BGPRPCCLIENT_LIB_PATH}    ${ODL_4_IP}    BgpRpcClient4    rt_constrain_type_1    ${RT_CONSTRAIN_DIR}

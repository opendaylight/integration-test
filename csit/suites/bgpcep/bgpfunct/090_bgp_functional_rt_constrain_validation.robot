...
Play_To_Odl_l3vpn_rt_arg
    BgpOperations.Play_To_Odl_Non_Removal_Template_BgpRpcClient2    l3vpn_rt_arg    ${RT_CONSTRAIN_DIR}

Play_To_Odl_rt_constrain_type_0
    BgpOperations.Play_To_Odl_Non_Removal_Template_BgpRpcClient3    rt_constrain_type_0    ${RT_CONSTRAIN_DIR}
    ...
    \    BgpOperations.Get_Update_Message_And_Compare_With_Hex    ${announce_hex}    ${option}

Play_To_Odl_rt_constrain_type_1
    BgpOperations.Play_To_Odl_Non_Removal_Template_BgpRpcClient4    rt_constrain_type_1    ${RT_CONSTRAIN_DIR}
    ${announce}=    OperatingSystem.Get_File    ${RT_CONSTRAIN_DIR}/l3vpn_rt_arg/announce_l3vpn_rt_arg.hex
    ${announce_hex}=    BuiltIn.Remove_String    ${announce}    \n

...
Test Teardown     Remove Configured Routes
...
Play To Odl Template
    ...
    BuiltIn.Wait Until Keyword Succeeds   5x   1s     Loc Rib Presnece     ${data_json}
    BgpRpcClient.play_send     ${withdraw_hex}
    BuiltIn.Wait Until Keyword Succeeds   5x   1s     Loc Rib Presnece     ${empty_routes}

...
Start_Suite
    ...
    BuiltIn.Set_Suite_Variable    ${MVPN_LOC_RIB}    /restconf/operational/bgp-rib:bgp-rib/rib/${RIB_NAME}/loc-rib/tables/bgp-types:ipv4-address-family/bgp-mvpn:mcast-vpn-subsequent-address-family/bgp-mvpn-ipv4:mpvn-routes-ipv4
    BuiltIn.Set_Suite_Variable    ${MVPN_EFFECTIVE_RIB}    /restconf/operational/bgp-rib:bgp-rib/rib/${RIB_NAME}/peer/bgp:%2F%2F${TOOLS_SYSTEM_IP}/effective-rib-in/tables/bgp-types:ipv4-address-family/bgp-mvpn:mcast-vpn-subsequent-address-family/bgp-mvpn-ipv4:mpvn-routes-ipv4

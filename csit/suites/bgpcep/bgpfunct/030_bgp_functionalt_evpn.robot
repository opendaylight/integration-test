...
...               It uses play.py odl and exabgpa as bgp peers. Routes advertized from odl
...
Configure_App_Peer
    ...
    [Setup]    KarafKeywords.Log Testcase Start To Controller Karaf
...
Start_Suite
    ...
    KarafKeywords.Install_a_Feature     odl-jolokia
...
Odl_To_Play_Template
    ...
    ${resp}=    RequestsLibrary.Get_Request    ${CONFIG_SESSION}    /restconf/operational/bgp-rib:bgp-rib/rib/example-bgp-rib/loc-rib/tables/odl-bgp-evpn:l2vpn-address-family/odl-bgp-evpn:evpn-subsequent-address-family/odl-bgp-evpn:evpn-routes     headers=${HEADERS_XML}

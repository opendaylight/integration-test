...
Resource          ${CURDIR}/../../../libraries/CURDIR}/WaitForFailure.robot
...
Verify Exabgp Not Connected
    ...
    WaitForFailure.Verify_Keyword_Does_Not_Fail_Within_Timeout    15s    2s    ExaBgpLib.Verify_ExaBgps_Connection    ${CONFIG_SESSION}    ${TOOLS_SYSTEM_IP}    ${connected}=${False}
    ExaBgpLib.Stop_ExaBgp
    [Teardown]    Delete_Bgp_Peer_Configuration

...
${BGP_EXAMD5_CFG}    ${BGP_VAR_FOLDER}${/}exa-md5.cfg
${MD5_PASSWD}       topsecret
${PROTOCOL_OPENCONFIG}    example-bgp-rib

*** Test Cases ***
Verify Exabgp Connection
    [Documentation]    Verifies exabgp connected with md5 settings
    [Setup]    Reconfigure_ODL_To_Accept_Connection
    ...
    [Teardown]    Delete_Bgp_Peer_Configuration
...
Reconfigure_ODL_To_Accept_Connection
    ...
    &{mapping}    BuiltIn.Create_Dictionary    BGP_RIB_OPENCONFIG=${PROTOCOL_OPENCONFIG}    BGP_NAME=${BGP_PEER_NAME}    IP=${TOOLS_SYSTEM_IP}    HOLDTIME=${HOLDTIME}    PEER_PORT=${BGP_TOOL_PORT}
    ...    PASSWORD=${MD5_PASSWD}    PASSIVE_MODE=true
...
Upload_Config_Files
    ...
    SSHLibrary.Put_File    ${BGP_EXAMD5_CFG}    .
    ...
    \    SSHLibrary.Execute_Command    sed -i -e 's/PASSWORD/${MD5_PASSWD}/g' ${cfgfile}

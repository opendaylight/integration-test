...
Reconfigure_ODL_To_Accept_Connection
    ...
    TemplatedRequests.Put_As_Xml_Templated    ${RT_CONSTRAIN_DIR}/bgp_peer    mapping=${mapping}    session=${CONFIG_SESSION}
...
Play_To_Odl_rt_constrain_type_0
    ...
    CompareStream.Run_Keyword_If_At_Least_Fluorine    BuiltIn.Pass_Execution
...
Odl_To_Play_l3vpn_rt_arg
    ...
    ...    For fluorine and further this l3vpn route also needs to contain route-target argument.
    CompareStream.Run_Keyword_If_Less_Than_Fluorine    L3vpn_Ipv4_To_Odl
    CompareStream.Run_Keyword_If_At_Least_Fluorine    BgpOperations.Odl_To_Play_Template    l3vpn_rt_arg    ${RT_CONSTRAIN_DIR}    False

...
Configure_App_Peer
    ...
    CompareStream.Run_Keyword_If_At_Least_Carbon    TemplatedRequests.Post_As_Xml_Templated    ${BGP_VAR_FOLDER}/openconfog_app_peer    mapping=${mapping}    session=${CONFIG_SESSION}

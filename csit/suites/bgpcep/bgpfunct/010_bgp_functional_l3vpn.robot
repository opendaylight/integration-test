...
${L3VPN_RSP_FLUORINE}    ${BGP_L3VPN_DIR}/bgp-l3vpn-ipv4.fluorine.json
...
${L3VPN_EXP_FLUORINE}    ${BGP_L3VPN_DIR}/route_expected/exa-expected.fluorine.json
...
Verify_Reported_Data
    ...
    CompareStream.Run_Keyword_If_At_Least_Fluorine    BuiltIn.Set_Variable    ${exprspfile}    ${L3VPN_RSP_FLUORINE}

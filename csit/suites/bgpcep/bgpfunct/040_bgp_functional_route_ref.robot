...
Exa_To_Send_Route_Refresh
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    5s    Verify_Odl_Openconfig_State_Count    notification_count=0    update_count=${nr_configured_routes}
...
Odl_To_Send_Route_Refresh
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    5s    Verify_Odl_Openconfig_State_Count    notification_count=1    update_count=4

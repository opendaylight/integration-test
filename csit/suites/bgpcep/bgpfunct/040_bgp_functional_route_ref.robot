...
Verify_Odl_Sent_Route_Request
    ...
    BuiltIn.Should_Contain    ${output}    MessagesReceived|NOTIFICATION|${expcount}
...
Normalize_String
    ...
    ${list_from_tuple}     Collections.Convert_To_List    ${string}
    ${ret}=    Evaluate    ${list_from_tuple}[-1]
    #${ret}=    BuiltIn.Run_Keyword_And_Ignore_Error    Convert To String    ${string}
    ${ret}=    String.Remove_String    ${ret}    ${SPACE}    \r
    Log    ${ret}
    [Return]    ${ret}

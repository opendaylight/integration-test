...
Verify_ExaBgp_Received_Updates
    ...
    BuiltIn.Should_Contain    ${output}    Sent|${expcount}
...
Normalize_String
    ...
    Log    ${ret}
    ${ret2}=    BuiltIn.Run_Keyword_And_Ignore_Error    Convert To String    ${string}
    Log    ${ret2}
    ${ret2}=    BuiltIn.Run_Keyword_And_Ignore_Error    Catenate    ${ret2}
    Log    ${ret2}

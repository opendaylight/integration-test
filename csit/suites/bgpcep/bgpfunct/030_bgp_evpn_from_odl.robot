...
Odl To Play route_eth_as
    [Template]     Odl To Play Template
    route_eth_as

Odl To Play route_eth_lacp
    [Template]     Odl To Play Template
    route_eth_lacp

Odl To Play route_eth_lacp_extdef
    [Template]     Odl To Play Template
    route_eth_lacp_extdef

Odl To Play route_eth_lacp_extesilab
    [Template]     Odl To Play Template
    route_eth_lacp_extesilab

Odl To Play route_eth_lacp_extesr
    [Template]     Odl To Play Template
    route_eth_lacp_extesr

Odl To Play route_eth_lacp_extl2
    [Template]     Odl To Play Template
    route_eth_lacp_extl2

Odl To Play route_eth_lacp_extmac
    [Template]     Odl To Play Template
    route_eth_lacp_extmac

Odl To Play route_eth_lan
    [Template]     Odl To Play Template
    route_eth_lan

Odl To Play route_eth_mac
    [Template]     Odl To Play Template
    route_eth_mac

Odl To Play route_eth_rou
    [Template]     Odl To Play Template
    route_eth_rou

Odl To Play route_inc_arb
    [Template]     Odl To Play Template
    route_inc_arb

Odl To Play route_inc_as
    [Template]     Odl To Play Template
    route_inc_as

Odl To Play route_inc_lacp
    [Template]     Odl To Play Template
    route_inc_lacp

Odl To Play route_inc_lan
    [Template]     Odl To Play Template
    route_inc_lan

Odl To Play route_inc_mac
    [Template]     Odl To Play Template
    route_inc_mac

Odl To Play route_inc_rou
    [Template]     Odl To Play Template
    route_inc_rou

Odl To Play route_mac_arb
    [Template]     Odl To Play Template
    route_mac_arb

Odl To Play route_mac_as
    [Template]     Odl To Play Template
    route_mac_as

Odl To Play route_mac_lacp
    [Template]     Odl To Play Template
    route_mac_lacp

Odl To Play route_mac_lan
    [Template]     Odl To Play Template
    route_mac_lan

Odl To Play route_mac_mac
    [Template]     Odl To Play Template
    route_mac_mac

Odl To Play route_mac_rou
    [Template]     Odl To Play Template
    route_mac_rou
...
Start Bgp Peer
    ...
    BGPSpeaker.Start_BGP_Speaker    --amount 0 --myip=${TOOLS_SYSTEM_IP} --myport=${BGP_TOOL_PORT} --peerip=${ODL_SYSTEM_IP} --peerport=${ODL_BGP_PORT} --${BGP_TOOL_LOG_LEVEL} --evpn --wfr 2
...
Odl To Play Template
    ...
    ${announce_hex}=    BuiltIn.Evaluate    '''${announce_hex}'''[:-1]    #removing \n from the end
    ${withdraw_hex}=    BuiltIn.Evaluate    '''${withdraw_hex}'''[:-1]    #removing \n from the end
    ...
    ${aupdate}=       BuiltIn.Wait Until Keyword Succeeds   5x   1s   Get Update Content
    BuiltIn.Log     ${aupdate};
    BuiltIn.Should Be Equal As Strings   ${aupdate}    ${announce_hex}
    BgpRpcClient.play_clean
    Remove Configured Routes
    ${wupdate}=       BuiltIn.Wait Until Keyword Succeeds   5x   1s   Get Update Content
    BuiltIn.Log     ${wupdate}
...
Play To Odl Template
    ...
    BuiltIn.Wait Until Keyword Succeeds   3x   2s     Loc Rib Presnece     ${data_json}

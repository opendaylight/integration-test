...
PCEP_sessions_from_multiple_machines
    ...
    Download_Pcc_Mock    ${TOOLS_SYSTEM_IP}    ${TOOLS_SYSTEM_USER}    ${TOOLS_SYSTEM_PASSWORD}    ${TOOLS_SYSTEM_PROMPT}    ${ssh_alias}=pccmock_toolsvm
    Set_Hop    0
    Start_Pcc_Mock    ${ssh_alias}=pccmock_toolsvm    ${TOOLS_SYSTEM_IP}    ${PCCS}    ${LSPS}    throughpcep_tools.log
...
Download_Pccmock_Log
    ...
    SSHLibrary.Execute Command     tar -xvf mock_log.tar.gz

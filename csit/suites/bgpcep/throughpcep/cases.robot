...
${PCCMOCKVM_IP}    ${ODL_SYSTEM_IP}
${PCCMOCKVM_PASSWORD}    ${ODL_SYSTEM_PASSWORD}
${PCCMOCKVM_PROMPT}    ${ODL_SYSTEM_PROMPT}
${PCCMOCKVM_USER}    ${ODL_SYSTEM_USER}
${PCCMOCKVM_WORKSPACE}    ${ODL_SYSTEM_WORKSPACE}
${PCCS}           1
...
${UPDATERVM_IP}    ${ODL_SYSTEM_IP}
${UPDATERVM_PASSWORD}    ${ODL_SYSTEM_PASSWORD}
${UPDATERVM_PROMPT}    ${ODL_SYSTEM_PROMPT}
${UPDATERVM_USER}    ${ODL_SYSTEM_USER}
${UPDATERVM_WORKSPACE}    ${ODL_SYSTEM_WORKSPACE}
...
PCEP Sessions Flapped with LSP updates
    ...
    FOR    ${devices}    IN RANGE    ${INIT_PCC_DEVICE_COUNT}    ${MAX_PCC_DEVICE_COUNT+1}    ${PCC_DEVICE_INCREMENT}
        Flap Pcc Mock Continuously with given PCC sessions    ${FIRST_PCC_IP}    ${devices}
    END
...
PCEP Sessions Flapped alongside LSP updates
    ...
    FOR    ${devices}    IN RANGE    ${INIT_PCC_DEVICE_COUNT}    ${MAX_PCC_DEVICE_COUNT+1}    ${PCC_DEVICE_INCREMENT}
        Flap Pcc Mock parallelly with given PCC sessions    ${FIRST_PCC_IP}    ${devices}
        BGPcliKeywords.Stop_Console_Tool_And_Wait_Until_Prompt
    END
    [Teardown]    BGPcliKeywords.Stop_Console_Tool_And_Wait_Until_Prompt

...
Compare_Topology
    ...
    ${resp}=    Run Keyword And Ignore Error    TemplatedRequests.Get_As_Json_Templated    ${NODE_SESSION_STATE_FOLDER}    ${mapping}    ${CONFIG_SESSION}
    Run Keyword And Ignore Error    BuiltIn.Log    ${resp}

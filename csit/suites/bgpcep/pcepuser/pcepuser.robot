...
*** Variables ***
${DIR_FOR_EXPECTED_RESPONSES}    ${TEMPDIR}${/}expected_pcepuser_responses
...
Set_It_Up
    ...
    OperatingSystem.Remove_Directory    ${DIR_FOR_EXPECTED_RESPONSES}    recursive=True
    OperatingSystem.Create_Directory    ${DIR_FOR_EXPECTED_RESPONSES}
...
Compare_Topology
    ...
    # TODO: Add Node Session State Check For Oxygen
    ${response}=    RequestsLibrary.Get Request    ${CONFIG_SESSION}    ${OPERATIONAL_TOPO_API}/topology/pcep-topology/node/pcc:%2F%2F${TOOLS_SYSTEM_IP}/path-computation-client

...
Tear_It_Down
    ...
    Run Keyword And Ignore Error    ${pccmocklog}=    OperatingSystem.Run    cat pccmock.log
    Run Keyword And Ignore Error    BuiltIn.Log    ${pccmocklog}
    Run Keyword And Ignore Error    ${diff}=    OperatingSystem.Run    diff -dur ${directory_for_expected_responses} ${directory_for_actual_responses}

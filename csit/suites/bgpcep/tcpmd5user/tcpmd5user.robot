...
Set_Wrong_Password
    ...
    Replace_Password_Xml_Element_In_Pcep_Client_Module    password=${password_line}
...
Unset_Password
    ...
    Replace_Password_Xml_Element_In_Pcep_Client_Module    password=${EMPTY}
...
Construct_Password_Element_Line_Using_Password
    ...
    ${element}=    String.Replace_String    ${SPACE}${SPACE}${SPACE}${SPACE}<password>$PASSWORD</password>${\n}${SPACE}${SPACE}${SPACE}${SPACE}    $PASSWORD    ${password}
    BuiltIn.Log    ${element}
    [Return]    ${element}

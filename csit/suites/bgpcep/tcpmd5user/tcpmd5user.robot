...
Set_Wrong_Password
    ...
    CompareStream.Run_Keyword_If_Less_Than_Oxygen    Set_Password_Lt_Oxygen    password=changeme
...
Set_Correct_Password
    ...
    CompareStream.Run_Keyword_If_Less_Than_Oxygen    Set_Password_Lt_Oxygen    password=topsecret
...
Unset_Password
    ...
    CompareStream.Run_Keyword_If_At_Least_Oxygen    Unset_Password_Xml_Element_In_Pcep_Client_Module
...
Tear_It_Down
    ...
    Run Keyword And Ignore Error    SSHLibrary.Get_File    pccmock.log
    ${pccmocklog}=    Run Keyword And Ignore Error    OperatingSystem.Run    cat pccmock.log
    Run Keyword And Ignore Error    BuiltIn.Log    ${pccmocklog}
    ${diff}=    Run Keyword And Ignore Error    OperatingSystem.Run    diff -dur ${directory_for_expected_responses} ${directory_for_actual_responses}
    Run Keyword And Ignore Error    BuiltIn.Log    ${diff}
...
#    Replace_Password_Xml_Element_In_Pcep_Client_Module    ${password}

Set_Password_Lt_Oxygen
    [Arguments]    ${password}=${EMPTY}

...
Topology_Intercondition
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    10s    1s    Verify Pcep Session State Data    default_on_state    ${mapping}
...
Verify Pcep Session State Data
    ...
    ${keys_with_volatiles}=    BuiltIn.Create_List    messages/odl-pcep-stateful-stats:last-received-rpt-msg-timestamp    session-duration    messages:odl-pcep-stateful-stats:last-received-rpt-msg-timestamp

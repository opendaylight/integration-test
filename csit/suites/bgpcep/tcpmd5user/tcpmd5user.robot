...
Topology_Updated
    ...
    CompareStream.Run_Keyword_If_At_Least_Oxygen    BuiltIn.Wait_Until_Keyword_Succeeds    10s    1s    Verify Pcep Session State Data    default_on_updated_state    ${mapping}

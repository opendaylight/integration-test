...
Start_Secure_Pcc_Mock
    ...
    ${command}=    BuiltIn.Set_Variable    \${JAVA_HOME}/bin/java -jar ${filename} --password topsecret --reconnect 1 --local-address ${MININET} --remote-address ${CONTROLLER} 2>&1 | tee pccmock.log
    BuiltIn.Log    ${command}

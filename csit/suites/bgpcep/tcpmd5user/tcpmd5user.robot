...
Verify_Netconf_Feature
    ...
    ${status}    ${output}=    Run Keyword And Ignore Error    Wait Until Keyword Succeeds    4x    30s    Verify_Feature_Is_Installed    odl-netconf-connector-ssh

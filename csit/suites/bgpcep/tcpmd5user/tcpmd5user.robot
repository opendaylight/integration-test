...
Tear_It_Down
    ...
    uiltIn.Run_Keyword_If    """${USE_NETCONF_CONNECTOR}""" == """False"""    Uninstall_Netconf_Connector
    RequestsLibrary.Delete_All_Sessions
    SSHLibrary.Close_All_Connections

Install_Netconf_Connector
    [Documentation]    Installs odl-netconf-connector-ssh feature
    #KarafKeywords.Setup_Karaf_Keywords
    #KarafKeywords.Install_a_Feature    odl-netconf-connector-ssh
    ClusterManagement.ClusterManagement_Setup
    ClusterManagement.Install_Feature_On_List_Or_All    odl-netconf-connector-ssh
...
Uninstall_Netconf_Connector
    ...
    KarafKeywords.Uninstall_a_Feature    odl-netconf-connector-ssh

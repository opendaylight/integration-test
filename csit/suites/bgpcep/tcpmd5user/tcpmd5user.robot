...
Start_Secure_Pcc_Mock
    ...
    ${command}=    NexusKeywords.Compose_Full_Java_Command    -jar ${filename} --password topsecret --reconnect 1 --local-address ${MININET} --remote-address ${CONTROLLER} 2>&1 | tee pccmock.log    openjdk=${JDKVERSION}
    BuiltIn.Log    ${command}

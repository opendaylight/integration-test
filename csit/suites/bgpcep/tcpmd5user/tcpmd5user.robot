...
Install_Netconf_Connector
    [Documentation]    Installs ${CONNECTOR_FEATURE} feature. As this feature
    #KarafKeywords.Setup_Karaf_Keywords
    #KarafKeywords.Install_a_Feature    odl-netconf-connector-ssh
    ClusterManagement.ClusterManagement_Setup
    ${status}    ${results} =    BuiltIn.Run_Keyword_And_Ignore_Error    ClusterManagement.Install_Feature_On_List_Or_All    ${CONNECTOR_FEATURE}
    BuiltIn.Log    ${results}
...
Check_Netconf_Up_And_Running
    ...
    ${response}=    RequestsLibrary.Get_Request    ${ses}    restconf/config/network-topology:network-topology/topology/topology-netconf/node/controller-config/yang-ext:mount/config:modules/module/odl-pcep-topology-provider-cfg:pcep-topology-provider/pcep-topology
...
Uninstall_Netconf_Connector
    ...
    ${status}    ${results} =    BuiltIn.Run_Keyword_And_Ignore_Error    ClusterManagement.Run_Karaf_Command_On_List_Or_All    feature:uninstall ${CONNECTOR_FEATURE}
    BuiltIn.Log    ${results}

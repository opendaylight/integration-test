...
Topology_Intercondition
    ...
    &{mapping}    BuiltIn.Create_Dictionary    IP=${TOOLS_SYSTEM_IP}    CODE=${path_name_code}    NAME=${pcc_name}
...
Set_It_Up
    ...
    BuiltIn.Set_Suite_Variable    ${pcc_name}    pcc_${TOOLS_SYSTEM_IP_tunnel_1}_tunnel_1

...
Topology_Updated
    ...
    [Tags]    critical
    ${response}=    BuiltIn.Wait_Until_Keyword_succeeds    5s    1s    Compare_Topology    ${updated_json}    060_Topology_Updated.json
...
Topology_Unauthorized_3
    ...
    [Tags]    critical
    ${response}=    BuiltIn.Wait_Until_Keyword_Succeeds    5s    1s    Compare_Topology    ${offjson}    070_Unauthorized_4.json

...
Verify_New_Pcep_Owner
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    5x    2s    Verify_New_Pcep_Owner_Elected    ${old_pcep_owner}    ${living_node}
...
Verify_Data_Reported
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    10s    1s    TemplatedRequests.Get_As_Json_Templated    ${DIR_WITH_TEMPLATES}${/}default_on    ${mapping}    ${living_session}
    ...    verify=True

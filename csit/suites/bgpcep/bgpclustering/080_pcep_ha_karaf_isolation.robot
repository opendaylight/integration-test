...
Get_Example_Pcep_Owner
    ...
    ...    pcep-topology    org.opendaylight.mdsal.AsyncServiceCloseEntityType    1
...
Rejoin_Old_Owner_Member
    ...
    ClusterManagement.Rejoin_Member_From_List_Or_All    ${old_pcep_owner}
...
Verify_Data_Reported
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    5s    TemplatedRequests.Get_As_Json_Templated    ${DIR_WITH_TEMPLATES}${/}default_on_state    ${mapping}    ${living_session}
    ...    verify=True

Verify_New_Pcep_Owner_Elected
    [Arguments]    ${old_owner}    ${node_to_ask}
    [Documentation]    Verifies new owner was elected
    ${owner}    ${candidates}=    ClusterManagement.Get_Owner_And_Successors_For_device    pcep-topology    org.opendaylight.mdsal.AsyncServiceCloseEntityType    ${node_to_ask}

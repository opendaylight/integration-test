...
Start_Bmp_Mock
    ...
    ${command}=    NexusKeywords.Compose_Full_Java_Command    -jar ${filename} --local_address 127.0.0.1 -ra ${ODL_SYSTEM_1_IP}:12345,${ODL_SYSTEM_2_IP}:12345,${ODL_SYSTEM_3_IP}:12345 --routers_count 1 --peers_count 1 --log_level DEBUG 2>&1 | tee ${BMP_LOG_FILE}
    BuiltIn.Log    ${command}
...
Setup_Everything
    ...
    ${tools_system_conn_id}=    SSHLibrary.Open_Connection    127.0.0.1    prompt=${DEFAULT_LINUX_PROMPT}    timeout=6s

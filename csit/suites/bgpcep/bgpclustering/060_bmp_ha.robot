...
Start_Bmp_Mock
    ...
    ${until_phrase}=    Set Variable    final successfully established.
...
Setup_Everything
    ...
    RequestsLibrary.Create_Session    ${living_session3}    http://${ODL_SYSTEM_3_IP}:${RESTCONFPORT}    auth=${AUTH}    timeout=1    max_retries=0
    RequestsLibrary.Create_Session    ${living_session2}    http://${ODL_SYSTEM_2_IP}:${RESTCONFPORT}    auth=${AUTH}    timeout=1    max_retries=0
    RequestsLibrary.Create_Session    ${living_session}    http://${ODL_SYSTEM_1_IP}:${RESTCONFPORT}    auth=${AUTH}    timeout=1    max_retries=0

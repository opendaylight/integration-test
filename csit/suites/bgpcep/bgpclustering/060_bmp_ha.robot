...
Get_Example_Bm_Owner
    ...
    ${bm_owner}    ${bm_candidates}=    Wait_Until_Keyword_Succeeds    5x    2s    ClusterManagement.Get_Owner_And_Successors_For_device    bmp-monitors    org.opendaylight.mdsal.ServiceEntityType    1
...
Stop_Current_Owner_Member
    ...
    #ClusterManagement.Freeze_Single_Member    ${bm_owner}
...
Start_Old_Owner_Member
    ...
    #ClusterManagement.Unfreeze_Single_Member   ${old_bm_owner}
    ClusterManagement.Start_Single_Member    ${old_bm_owner}
...
Setup_Everything
    ...
    ClusterManagement.Install_Feature_On_List_Or_All    odl-bgpcep-bmp
    ClusterManagement.Install_Feature_On_List_Or_All    odl-bgpcep-bmp-config-example
...
Teardown_Everything
    ...
    Log    ${cnt}
    Run Keyword And Ignore Error    ClusterManagement.Uninstall_Feature_On_List_Or_All    odl-bgpcep-bmp
    Run Keyword And Ignore Error    ClusterManagement.Uninstall_Feature_On_List_Or_All    odl-bgpcep-bmp-config-example
...
Verify_Data_Reported
    ...
    ${output}=    Wait Until Keyword Succeeds    6x    10s    TemplatedRequests.Get_As_Json_Templated    folder=${BGP_BMP_DIR}

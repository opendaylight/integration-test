...
#${PEER_CHECK_URL}    /restconf/operational/bgp-bm:bgp-bm/bm/example-bgp-bm/peer/bgp:%2F%2F
...
Verify BMP Feature
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    10s    TemplatedRequests.Get_As_Json_Templated    folder=${BGP_BMP_FEAT_DIR}    mapping=${mapping}    session=${living_session}
    ...    verify=True

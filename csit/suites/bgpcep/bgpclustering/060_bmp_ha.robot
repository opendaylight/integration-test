...
*** Variables ***
${BGP_VAR_FOLDER}    ../../../variables/bgpclustering
${BGP_PEER_FOLDER}    ../../../variables/bgpclustering/bgp_peer_openconf
${HOLDTIME}       180
...
Start_Bmp_Mock
    ...
    ${command}=    NexusKeywords.Compose_Full_Java_Command    -jar ${filename} --local_address ${TOOLS_SYSTEM_IP} -ra ${ODL_SYSTEM_1_IP}:12345,${ODL_SYSTEM_2_IP}:12345,${ODL_SYSTEM_3_IP}:12345 --routers_count 1 --peers_count 1 --log_level DEBUG 2>&1 | tee ${BMP_LOG_FILE}
    BuiltIn.Log    ${command}
...
Stop_Current_Owner_Member
    ...
    BgpClustering.Kill_Single_Member    ${rib_owner}

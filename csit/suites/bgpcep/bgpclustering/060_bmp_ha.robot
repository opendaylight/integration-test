...
Get_Example_Bm_Owner
    ...
    Wait_Until_Keyword_Succeeds    10x    10s    ${bm_owner}    ${bm_candidates}=    ClusterManagement.Get_Owner_And_Successors_For_device    bmp-monitors    org.opendaylight.mdsal.ServiceEntityType    1

...
Verify BMP Feature
    ...
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp    controller=${ODL_SYSTEM_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp-config-example    controller=${ODL_SYSTEM_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp-config-example
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp    controller=${ODL_SYSTEM_1_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp-config-example    controller=${ODL_SYSTEM_1_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp    controller=${ODL_SYSTEM_2_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp-config-example    controller=${ODL_SYSTEM_2_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp    controller=${ODL_SYSTEM_3_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature    odl-bgpcep-bmp-config-example    controller=${ODL_SYSTEM_3_IP}
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature_Using_Active_Connection    odl-bgpcep-bmp
    BuiltIn.Run_Keyword_And_Ignore_Error    KarafKeywords.Install_A_Feature_Using_Active_Connection    odl-bgpcep-bmp-config-example
...
Verify_Data_Reported_2
    [Documentation]    Verifies if the tool reported expected data
    Verify_Data_Reported    ip=${ODL_SYSTEM_1_IP}

Verify_Data_Reported_3
    [Documentation]    Verifies if the tool reported expected data
    Verify_Data_Reported    ip=${ODL_SYSTEM_2_IP}

Verify_Data_Reported_4
    [Documentation]    Verifies if the tool reported expected data
    Verify_Data_Reported    ip=${ODL_SYSTEM_3_IP}

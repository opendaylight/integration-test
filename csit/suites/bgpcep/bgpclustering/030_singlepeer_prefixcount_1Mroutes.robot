...
Check_For_Empty_Ipv4_Topology_Before_Talking_1
    ...
    PrefixCounting.Select_Topology    ${CONFIGURATION_1}    ${example_ipv4_topology_1}
...
Check_For_Empty_Ipv4_Topology_Before_Talking_2
    ...
    [Tags]    critical
    [Setup]    SetupUtils.Setup_Test_With_Logging_And_Without_Fast_Failing
    PrefixCounting.Select_Topology    ${CONFIGURATION_2}    ${example_ipv4_topology_2}
    BuiltIn.Wait_Until_Keyword_Succeeds    ${INITIAL_RESTCONF_TIMEOUT}    1s    PrefixCounting.Check_Ipv4_Topology_Is_Empty
...
Check_For_Empty_Ipv4_Topology_Before_Talking_3
    ...
    [Tags]    critical
    [Setup]    SetupUtils.Setup_Test_With_Logging_And_Without_Fast_Failing
    PrefixCounting.Select_Topology    ${CONFIGURATION_3}    ${example_ipv4_topology_3}
    BuiltIn.Wait_Until_Keyword_Succeeds    ${INITIAL_RESTCONF_TIMEOUT}    1s    PrefixCounting.Check_Ipv4_Topology_Is_Empty
...
Reconfigure_ODL_To_Accept_Connection
    ...
    # sleep needed, because of https://bugs.opendaylight.org/show_bug.cgi?id=5681 is not implemented yet and in Beryllium will not even be
    BuiltIn.Sleep    3s
    BuiltIn.Wait Until Keyword Succeeds    10x    3s    TemplatedRequests.Get_As_Xml_Templated    ${BGP_VARIABLES_FOLDER_OP}    mapping=${mappings}    session=${CONFIG_SESSION}

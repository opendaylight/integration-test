...
Wait_For_Stable_Talking_Ipv4_Topology_1
    ...
    PrefixCounting.Wait_For_Ipv4_Topology_Prefixes_To_Become_Stable    timeout=${bgp_filling_timeout}    period=${CHECK_PERIOD}    repetitions=${REPETITIONS}    excluded_count=0    session=${CONFIGURATION_1}    topology=${EXAMPLE_IPV4_TOPOLOGY}    ${shards_list}={SHARD_MONITOR_LIST}    ${shards_details}=${init_shard_details}

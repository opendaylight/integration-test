...
${RIB_INSTANCE}    example-bgp-rib-1
...
Configure_Netconf_Device
    ...
    NetconfKeywords.Configure_Device_In_Netconf    ${DEVICE_NAME}    device_type=configure-via-topology    device_port=1830    device_address=127.0.0.1    device_user=admin    device_password=admin
...
Reconfigure_ODL_To_Accept_Connection
    ...
    [Setup]    SetupUtils.Setup_Test_With_Logging_And_Without_Fast_Failing
    NetconfViaRestconf.Activate_NVR_Session    controller-1
    ${template_as_string}=    BuiltIn.Set_Variable    {'NAME': 'example-bgp-peer', 'IP': '${TOOLS_SYSTEM_IP}', 'HOLDTIME': '${HOLDTIME}', 'PEER_PORT': '${BGP_TOOL_PORT}', 'INITIATE': 'false', 'BGP_RIB': '${RIB_INSTANCE}'}
    NetconfViaRestconf.Put_Xml_Template_Folder_Via_Restconf    ${BGP_VARIABLES_FOLDER}${/}bgp_cluster_peer    ${template_as_string}

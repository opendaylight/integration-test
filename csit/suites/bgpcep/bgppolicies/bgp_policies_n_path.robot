...
Start_Exabgps
    ...
    \    ${start_cmd}    BuiltIn.Set_Variable    ${CMD} exabgp${index}.cfg > exa${index}_npath.log &
...
Stop_All_Peers
    ...
    : FOR    ${index}    IN    ${NUMBERS}
    \    BGPcliKeywords.Store_File_To_Workspace    exa${index}_npath.log    exa${index}_npath.log

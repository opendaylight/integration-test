...
Configure_App_Peer
    ...
    TemplatedRequests.Post_As_Xml_Templated    ${POLICIES_VAR}/pathselection    mapping=${mapping}    session=${CONFIG_SESSION}
...
Start_Exabgps
    ${start_cmd}    BuiltIn.Set_Variable    ${CMD} exabgp.cfg > exa1.log &

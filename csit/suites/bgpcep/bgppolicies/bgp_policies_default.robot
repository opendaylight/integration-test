...
Verify_Rib_Status
    ...
    BuiltIn.Log    ${output}
    &{mapping}    BuiltIn.Create_Dictionary    IP=127.0.0.3
    ${output}    TemplatedRequests.Get_As_Json_Templated    ${POLICIES_VAR}/ribs/effective_rib_in/ipv4_mpls_labeled_vpn    mapping=${mapping}    session=${CONFIG_SESSION}
    BuiltIn.Log    ${output}
    &{mapping}    BuiltIn.Create_Dictionary    IP=127.0.0.6
    ${output}    TemplatedRequests.Get_As_Json_Templated    ${POLICIES_VAR}/ribs/effective_rib_in/ipv6_mpls_labeled_vpn    mapping=${mapping}    session=${CONFIG_SESSION}
    BuiltIn.Log    ${output}

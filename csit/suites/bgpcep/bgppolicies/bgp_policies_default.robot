...
Configure_App_Peer
    ...
    ...    IP=${ODL_SYSTEM_IP}    APP_PEER_IP=127.0.0.7
...
Deconfigure_App_Peer
    ...
    &{mapping}    BuiltIn.Create_Dictionary    APP_PEER_NAME=${APP_PEER_NAME}    IP=${ODL_SYSTEM_IP}    BGP_RIB_OPENCONFIG=${RIB_INSTANCE}    APP_PEER_IP=127.0.0.7

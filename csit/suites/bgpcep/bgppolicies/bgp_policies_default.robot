...
Verify_Rib_Status
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    5x    3s    TemplatedRequests.Get_As_Json_Templated    ${POLICIES_VAR}/ribs/app_peer_rib    mapping=${mapping}    session=${CONFIG_SESSION}    verify=True

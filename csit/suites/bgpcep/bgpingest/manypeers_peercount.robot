...
Check_Logs_For_Updates
    ...
    # FIXME: Is the calculation of ${expected_prefixcount} correct just when the ${COUNT_PREFIX_COUNT_MANY} is a multiplication of ${MULTIPLICITY_PREFIX_COUNT_MANY}?
...
Wait_For_Stable_Ipv4_Topology_After_Talking
    ...
    [Teardown]    Report_Failure_Due_To_Bug    Bug 5097

...
Check_That_Ipv4_Topology_Is_Empty
    ...
    BuiltIn.Log    waiting ...    console=yes
...
Wait_For_Ipv4_Topology
    ...
    [Setup]    SetupUtils.Setup_Test_With_Logging_And_Without_Fast_Failing
    BuiltIn.Log    waiting ...    console=yes
    BuiltIn.Wait_Until_Keyword_Succeeds    ${bgp_filling_timeout}    ${CHECK_PERIOD_PREFIX_COUNT_MANY}    Check_Ipv4_Topology    ${COUNT_PREFIX_COUNT_MANY}
...
Check_Ipv4_Topology
    ...
    BuiltIn.Log    ${current_time}: actual prefix count is ${actual_count} / ${expected_count}    console=yes

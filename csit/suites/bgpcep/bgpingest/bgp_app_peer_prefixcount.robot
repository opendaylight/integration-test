...
${BATCH}          {COUNT_APP_PEER_PREFIX_COUNT}
${CHECK_PERIOD}    1
...
${BGP_APP_PEER_INITIAL_COMMAND}    python bgp_app_peer.py --host ${ODL_SYSTEM_IP} --port ${RESTCONFPORT} --command post --count 0 --${BGP_APP_PEER_LOG_LEVEL}
${BGP_APP_PEER_ADD_COMMAND}    python bgp_app_peer.py --host ${ODL_SYSTEM_IP} --port ${RESTCONFPORT} --command add --count ${COUNT} --prefix 8.0.1.0 --prefixlen 28 --${BGP_APP_PEER_LOG_LEVEL}

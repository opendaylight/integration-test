...
Store_Results_For_Talking_BGP_Speaker
    ...
    Store_File_To_Workspace    ${BGPSpeaker__OUTPUT_LOG}    changecount-talking-${BGPSpeaker__OUTPUT_LOG}
...
Store_Results_For_Listening_BGP_Speaker
    ...
    Store_File_To_Workspace    ${BGPSpeaker__OUTPUT_LOG}    changecount-listening-${BGPSpeaker__OUTPUT_LOG}

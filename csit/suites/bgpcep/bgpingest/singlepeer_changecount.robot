...
Setup_Everything
    ...
    ${COUNT_CHANGE_COUNT_SINGLE}    CompareStream.Set_Variable_If_At_Least_Fluorine    ${COUNT_POLICIES}    ${COUNT_CHANGE_COUNT}
    BuiltIn.Set_Suite_Variable    ${COUNT_CHANGE_COUNT_SINGLE}

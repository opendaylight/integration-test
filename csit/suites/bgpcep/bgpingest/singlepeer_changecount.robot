...
Recource          ${CURDIR}/../../../libraries/WaitUtils.robot
...
Wait_For_Stable_Talking_Topology
    [Documentation]    Wait until example-ipv4-topology becomes stable. This is done by checking the change counter.
    ChangeCounter.Wait_For_Topology_To_Become_Stable    timeout=${timeout_for_topology_filling}    period=${CHECK_PERIOD_CHANGE_COUNTER}    repetitions=${REPETITIONS_CHANGE_COUNTER}    count_to_overcome=${last_change_count}
...
Wait_For_Stable_Topology_After_Talking
    [Documentation]    See example-ipv4-topology stable again.
    [Tags]    critical
    ChangeCounter.Wait_For_Topology_To_Become_Stable    timeout=${timeout_for_topology_emptying}    period=${CHECK_PERIOD_CHANGE_COUNTER}    repetitions=${REPETITIONS_CHANGE_COUNTER}    count_to_overcome=${last_change_count}
...
Wait_For_Stable_Topology_After_Listening
    [Documentation]    See example-ipv4-topology stable again.
    [Tags]    critical
    ChangeCounter.Wait_For_Topology_To_Become_Stable    timeout=${timeout_for_topology_emptying}    period=${CHECK_PERIOD_CHANGE_COUNTER}    repetitions=${REPETITIONS_CHANGE_COUNTER}    count_to_overcome=${last_change_count}
...
Setup_Everything
    ...
    Builtin.Set_Suite_Variable    ${timeout_for_topology_emptying}    ${count/50+5} s

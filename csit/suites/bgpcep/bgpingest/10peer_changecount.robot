...
Start_Talking_BGP_Manager
    ...
    BGPSpeaker.Start_BGP_Manager    --amount=${COUNT_CHANGE_COUNTER} --multiplicity=${MULTIPLICITY} --myip=${MININET} --myport=${BGP_TOOL_PORT} --peerip=${CONTROLLER} --peerport=${ODL_BGP_PORT}

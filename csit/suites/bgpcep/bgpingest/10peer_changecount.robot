...
Reconfigure_ODL_To_Accept_Connections
    ...
    \    ${individual_ip}=    BuiltIn.Evaluate    "127.0.0." + str(${index})
...
Start_Talking_BGP_Manager
    ...
    BGPSpeaker.Start_BGP_Manager    --amount=${COUNT_CHANGE_COUNTER} --multiplicity=${MULTIPLICITY} --myip=${FIRST_IP} --myport=${BGP_TOOL_PORT} --peerip=${CONTROLLER} --peerport=${ODL_BGP_PORT}
...
Require_Python
    ...
    # TODO: This Keywords come from throughpcep suite. Extract to Utils or separate library.

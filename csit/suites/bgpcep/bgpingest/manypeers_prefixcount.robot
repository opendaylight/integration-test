...
Setup_Everything
    ...
    ${timeout} =    BuiltIn.Evaluate    ${COUNT_PREFIX_COUNT} * 3.0 / 10000 + ${period} * (${REPETITIONS_PREFIX_COUNT} + 1) + 10
    Builtin.Set_Suite_Variable    ${bgp_filling_timeout}    ${timeout}
    ${timeout} =    BuiltIn.Evaluate    ${COUNT_PREFIX_COUNT} * 2.0 / 10000 + ${period} * (${REPETITIONS_PREFIX_COUNT} + 1) + 10

...
Setup_Everything
    ...
    ${repetitions} =    BuiltIn.Convert_To_Integer    ${REPETITIONS_PREFIX_COUNT}
    Builtin.Set_Suite_Variable    ${bgp_filling_timeout}    ${count*3/10000+repetitions*period+period}
    Builtin.Set_Suite_Variable    ${bgp_emptying_timeout}    ${count*2/10000+repetitions*period+period}

...
Check_Talking_Ipv4_Topology_Count
    ...
    ${output}    TemplatedRequests.Get_As_Json_Templated    ${BGP_VARIABLES_FOLDER}${/}get_neighbors
    BuiltIn.Log    ${output}
    ${output}    TemplatedRequests.Get_As_Json_Templated    ${BGP_VARIABLES_FOLDER}${/}get_peer_groups
    BuiltIn.Log    ${output}
    ${output}    TemplatedRequests.Get_As_Json_Templated    ${BGP_VARIABLES_FOLDER_TEMP}${/}topology_state
    BuiltIn.Log    ${output}

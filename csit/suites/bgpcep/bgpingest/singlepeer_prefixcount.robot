...
Get_Sysstat_Results
    ...
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    ls /var/log/sa
    Log    ${output}
    ...
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    cat /etc/default/sysstat
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    sar -A -f /var/log/sa/sa*
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    free -m
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    ps -e -o pcpu,pmem,args --sort=pcpu | cut -d" " -f1-10 | tail
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    ps -e -o pcpu,pmem,args
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}

...
Get_Sysstat_Results
    ...
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    ls /etc/var/sysstat
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Write    sar -A -f /etc/var/sysstat/sa*
    Log    ${output}
    ${status}    ${output}    Run_Keyword_And_Ignore_Error    SSHLibrary.Read_Until_Prompt
    Log    ${output}

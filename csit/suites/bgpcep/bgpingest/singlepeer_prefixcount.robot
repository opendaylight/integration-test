...
Start_Talking_BGP_speaker
    ...
    BGPSpeaker.Start_BGP_speaker    --amount ${COUNT_PREFIX_COUNT} --myip=${MININET} --myport=${BGP_TOOL_PORT} --peerip=${CONTROLLER} --peerport=${ODL_BGP_PORT} --ipadd=${BGP_IPADD} --ipdel=${BGP_IPDEL} --sweep=${BGP_SWEEP} --${BGP_LOG_LEVEL} ${BGP_OPTION}
...
Start_Listening_BGP_Speaker
    ...
    BGPSpeaker.Start_BGP_speaker    --amount ${COUNT_PREFIX_COUNT} --listen --myip=${MININET} --myport=${BGP_TOOL_PORT} --peerip=${CONTROLLER} --peerport=${ODL_BGP_PORT} --ipadd=${BGP_IPADD} --ipdel=${BGP_IPDEL} --sweep=${BGP_SWEEP} --${BGP_LOG_LEVEL} ${BGP_OPTION}

...
Create Vm Instances For l2_network_1
    ...
    Create Vm Instances    l2_network_1    ${NET_1_VM_INSTANCES}    sg=csit    image=cirros-0.3.5-x86_64-disk

Create Vm Instances For l2_network_2
    [Documentation]    Create Four Vm instances using flavor and image names for a network.
    Create Vm Instances    l2_network_2    ${NET_2_VM_INSTANCES}    sg=csit    image=cirros-0.3.5-x86_64-disk   

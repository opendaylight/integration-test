...
${inventory}      ${CURDIR}/../../variables/coe/hosts.yaml

*** Test Cases ***
ansible inventory
    ${hosts} =    OperatingSystem.Get File    ${inventory}
    ...
    OperatingSystem.Create File    ${inventory}    ${hosts}
    ${rc}    ${output}    Run And Return Rc And Output    -i ${inventory}
    ${rc}    ${output}    Run And Return Rc And Output    ansible -m ping 'coe-master'
    ${rc}    ${output}    Run And Return Rc And Output    ansible-playbook coe_play.yaml

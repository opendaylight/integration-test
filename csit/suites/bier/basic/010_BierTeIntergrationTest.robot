...
&{NODE_TO_TP_ID_LIST}
...                         1111.1111.1111=${TP_ID_LIST_OF_NODE1}
...                         1111.1111.1122=${TP_ID_LIST_OF_NODE2}
...                         1111.1111.1133=${TP_ID_LIST_OF_NODE3}
...                         1111.1111.1144=${TP_ID_LIST_OF_NODE4}
&{NODE_TO_BP_LIST}
...                         1111.1111.1111=${BP_LIST_OF_NODE1}
...                         1111.1111.1122=${BP_LIST_OF_NODE2}
...                         1111.1111.1133=${BP_LIST_OF_NODE3}
...                         1111.1111.1144=${BP_LIST_OF_NODE4}
...
TC1_Load Topology
    ...
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/load_topology
    ...    {}
    ...    session
    ...    True
...
TC1_Query Link
    ...
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/query_link
    ...    ${mapping1}
    ...    session
    ...    True
...
TC2_Configure Domain
    ...
    ${mapping1}    Create Dictionary
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ...    DOMAINID1=${DOMAIN_ID_LIST[0]}
    ...    DOMAINID2=${DOMAIN_ID_LIST[1]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_domain_configuration/configure_domain
    ...    ${mapping1}
    ...    session
...
TC2_Delete Domain
    ...
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_domain_configuration/delete_domain
    ...    ${mapping1}
    ...    session
    Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC2_Query Domain
    ...
    ${mapping1}    Create Dictionary    TOPOLOGYID=${TOPOLOGY_ID}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_domain_configuration/query_domain
    ...    ${mapping1}
    ...    session
    ...    True
...
TC3_Configure Subdomain
    ...
    ...    SUBDOMAIN1=${SUBDOMAIN_ID_LIST[0]}
    ...    SUBDOMAIN2=${SUBDOMAIN_ID_LIST[1]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_domain_configuration/configure_subdomain
    ...    ${mapping1}
    ...    session
    Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC3_Delete Subdomain
    ...
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ...    DOMAINID=${DOMAIN_ID_LIST[0]}
    ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[1]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_domain_configuration/delete_subdomain
    ...    ${mapping1}
    ...    session
    Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC3_Query Subdomain
    ...
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_domain_configuration/query_subdomain
    ...    ${mapping1}
    ...    session
    ...    True
...
TC4_Configure Node
    ...
    FOR    ${i}    IN RANGE    len(${NODE_ID_LIST})
        ...
        ...    NODEID=${node-id}
        ...    DOMAINID=${DOMAIN_ID_LIST[0]}
        ...    DOMAINBFRID=${domain-bfr-id}
        ...    SUBDOMAINBFRID=${domain-bfr-id}
        ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
        ${resp}    TemplatedRequests.Post_As_Json_Templated
        ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/configure_node
        ...    ${mapping1}
        ...    session
        Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
    END
...
TC4_Delete Node
    ...
    ...    NODEID=${node-id}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/delete_node
    ...    ${mapping}
    ...    session
    Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC4_Delete IPV4
    ...
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/delete_ipv4
    ...    ${mapping}
    ...    session
    Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC4_Query Subdomain Link
    ...
    ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/query_subdomain_link
    ...    ${mapping}
    ...    session
    ...    True
...
TC5_Configure Te Label
    ...
    FOR    ${i}    IN RANGE    len(${NODE_ID_LIST})
        ...
        ...    LABELRANGESIZE=${TE_LABEL_RANGE_SIZE}
        ${resp}    TemplatedRequests.Post_As_Json_Templated
        ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/configure_te_label
        ...    ${mapping}
        ...    session
        Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
    END
...
TC5_Query Te Subdomain Link
    ...
    ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/query_te_subdomain_link
    ...    ${mapping}
    ...    session
    ...    True
...
TC5_Delete Te BP
    ...
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/delete_te_bp
    ...    ${mapping2}
    ...    session
...
TC5_Delete Te SI
    ...
    ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
    ${resp2}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/delete_te_si
    ...    ${mapping2}
    ...    session
    Verify_Response_As_Json_Templated    ${resp2}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC5_Delete Te BSL
    ...
    ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
    ${resp2}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/delete_te_bsl
    ...    ${mapping2}
    ...    session
    Verify_Response_As_Json_Templated    ${resp2}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC5_Delete Te Label
    ...
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/delete_te_label
    ...    ${mapping}
    ...    session
    Verify_Response_As_Json_Templated    ${resp}    ${BIER_TE_VAR_FOLDER}/common    success_response
...
TC6_Add Channel
    ...
    FOR    ${i}    IN RANGE    len(${CHANNEL_NAME_LIST})
        ...
        ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
        ${resp}    TemplatedRequests.Post_As_Json_Templated
        ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/add_channel
        ...    ${mapping}
        ...    session
        Verify_Response_As_Json_Templated
        ...    ${resp}
        ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration
        ...    success_response
    END
...
TC6_Get Channel
    ...
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/get_channel
    ...    ${mapping}
    ...    session
    ...    True
...
TC6_Query Channel
    ...
    ${mapping}    Create Dictionary
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ...    CHANNEL1=${CHANNEL_NAME_LIST[0]}
    ...    CHANNEL2=${CHANNEL_NAME_LIST[1]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/query_channel
    ...    ${mapping}
    ...    session
    ...    True
...
TC6_Remove Channel
    ...
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/remove_channel
    ...    ${mapping}
    ...    session
    Verify_Response_As_Json_Templated
    ...    ${resp}
...
TC6_Modify Channel
    ...
    ${mapping}    Create Dictionary
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ...    CHANNELNAME=${CHANNEL_NAME_LIST[0]}
    ...    SRCIP=10.10.10.10
    ...    DSTGROUP=${DST_GROUP_LIST[0]}
    ...    DOMAINID=${DOMAIN_ID_LIST[0]}
    ...    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
    ${resp}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/modify_channel
    ...    ${mapping}
    ...    session
    Verify_Response_As_Json_Templated
    ...    ${resp}
...
TC6_Deploy Channel
    ...
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ...    CHANNELNAME=${CHANNEL_NAME_LIST[0]}
    ...    INGRESSNODE=${NODE_ID_LIST[0]}
    ...    SRCTP=${TP_ID_LIST_OF_NODE1[3]}
    ...    NODEID1=${NODE_ID_LIST[1]}
    ...    RCVTP1=${TP_ID_LIST_OF_NODE2[1]}
    ...    NODEID2=${NODE_ID_LIST[2]}
    ...    RCVTP2=${TP_ID_LIST_OF_NODE3[2]}
    ${resp1}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/deploy_channel
    ...    ${mapping1}
    ...    session
    Verify_Response_As_Json_Templated
    ...    ${resp1}
    ...
    ${mapping2}    Create Dictionary
    ...    TOPOLOGYID=${TOPOLOGY_ID}
    ...    CHANNELNAME=${CHANNEL_NAME_LIST[1]}
    ...    INGRESSNODE=${NODE_ID_LIST[0]}
    ...    SRCTP=${TP_ID_LIST_OF_NODE1[3]}
    ...    NODEID1=${NODE_ID_LIST[1]}
    ...    RCVTP1=${TP_ID_LIST_OF_NODE2[1]}
    ...    NODEID2=${NODE_ID_LIST[3]}
    ...    RCVTP2=${TP_ID_LIST_OF_NODE4[1]}
    ${resp2}    TemplatedRequests.Post_As_Json_Templated
    ...    ${BIER_TE_VAR_FOLDER}/bier_channel_configuration/deploy_channel
    ...    ${mapping2}
    ...    session

...
TC1_Load Topology
    ...
    Wait Until Keyword Succeeds    30s    2s    NodeOnline
...
TC5_Configure Te Node
    ...
    \    ${length}    Get Length    ${bp-list}
    \    FORJ    ${node-id}    ${tp-id-list}    ${bp-list}    ${length}
...
TC5_Delete Te BP
    ...
    ...
    ${mapping1}    Create Dictionary    TOPOLOGYID=${TOPOLOGY_ID}    NODEID=1111.1111.1155    DOMAINID=${DOMAIN_ID_LIST[0]}    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}    TPID=spi-0/1/0/3
    ...    BP=13
    ...
    ${mapping2}    Create Dictionary    TOPOLOGYID=${TOPOLOGY_ID}    NODEID=1111.1111.1155    DOMAINID=${DOMAIN_ID_LIST[0]}    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}    TPID=spi-0/1/0/3
...
TC5_Delete Te SI
    ...
    ${resp1}    TemplatedRequests.Post_As_Json_Templated    ${BIER_TE_VAR_FOLDER}/bier_node_configuration/configure_te_node    ${mapping1}    session
    Verify_Response_As_Json_Templated    ${resp1}    ${BIER_TE_VAR_FOLDER}/common    success_response
    ${mapping2}    Create Dictionary    TOPOLOGYID=${TOPOLOGY_ID}    NODEID=1111.1111.1155    DOMAINID=${DOMAIN_ID_LIST[0]}    SUBDOMAINID=${SUBDOMAIN_ID_LIST[0]}
...
TC5_Delete Te Label
    ...
    ...
    ${mapping}    Create Dictionary    TOPOLOGYID=${TOPOLOGY_ID}    NODEID=1111.1111.1155
...
TC6_Deploy Channel
    ...
    Sleep    5    #Wait Until TE path and bitstring calculation success

...
pyang ./ietf-yang-types.yang

ls -la $PYBINDPLUGIN

sleep 20

cat ietf-yang-types.yang

pyang --plugindir $PYBINDPLUGIN -f pybind --build-rpcs --split-class-dir ./LISPFlowMappingYANGBindings ${WORKSPACE}/$DIRECTORY/ietf-yang-types.yang

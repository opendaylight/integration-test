...
GITWEB_INTEGRATION="https://git.opendaylight.org/gerrit/gitweb?p=integration/test.git;a=blob_plain"
...
# Successfully.
PATCH_URL="h=3b3cf5e9fdb8d05f2b5f4997f362a5d92e660c9b;hb=54385466d0b3b95196c7a6340e90b52c603f9c00"
curl "$GITWEB_INTEGRATION;f=csit/suites/lispflowmapping/scripts/bits.patch;$PATCH_URL" -o bits.patch

...
*** Variables ***
${JSON_PATH}      ${CURDIR}/../../../variables/lispflowmapping/${ODL_VERSION}
${IPV4_C_MAP}     ${JSON_PATH}/rpc_add-mapping_ipv4_ipv4.json
${IPV4_C_KEY}     ${JSON_PATH}/rpc_add-key_ipv4.json
${IPV4_RD}        ${JSON_PATH}/rpc_get-remove_ipv4.json
${IPV6_C_MAP}     ${JSON_PATH}/rpc_add-mapping_ipv6_ipv4.json
${IPV6_C_KEY}     ${JSON_PATH}/rpc_add-key_ipv6.json
${IPV6_RD}        ${JSON_PATH}/rpc_get-remove_ipv6.json
${MAC_C_MAP}      ${JSON_PATH}/rpc_add-mapping_mac_ipv4.json
${MAC_C_KEY}      ${JSON_PATH}/rpc_add-key_mac.json
${MAC_RD}         ${JSON_PATH}/rpc_get-remove_mac.json
${DN_C_MAP}       ${JSON_PATH}/rpc_add-mapping_dn_ipv4.json
${DN_C_KEY}       ${JSON_PATH}/rpc_add-key_dn.json
${DN_RD}          ${JSON_PATH}/rpc_get-remove_dn.json
${AS_C_MAP}       ${JSON_PATH}/rpc_add-mapping_as_ipv4.json
${AS_C_KEY}       ${JSON_PATH}/rpc_add-key_as.json
${AS_RD}          ${JSON_PATH}/rpc_get-remove_as.json
${IID_C_MAP}      ${JSON_PATH}/rpc_add-mapping_iid_ipv4.json
${IID_C_KEY}      ${JSON_PATH}/rpc_add-key_iid.json
${IID_RD}         ${JSON_PATH}/rpc_get-remove_iid.json
${SD_C_MAP}       ${JSON_PATH}/rpc_add-mapping_srcdst_ipv4.json
${SD_C_KEY}       ${JSON_PATH}/rpc_add-key_srcdst.json
${SD_RD}          ${JSON_PATH}/rpc_get-remove_srcdst.json
${KV_C_MAP}       ${JSON_PATH}/rpc_add-mapping_kv_ipv4.json
${KV_C_KEY}       ${JSON_PATH}/rpc_add-key_kv.json
${KV_RD}          ${JSON_PATH}/rpc_get-remove_kv.json
${LST_C_MAP}      ${JSON_PATH}/rpc_add-mapping_ipv4_list.json
${APP_C_MAP}      ${JSON_PATH}/rpc_add-mapping_ipv4_appdata.json
${ELP_C_MAP}      ${JSON_PATH}/rpc_add-mapping_ipv4_elp.json

*** Test Cases ***
IPv4 Prefix
    [Documentation]    Perform mapping/key operations with an IPv4 EID
    ${IPV4_C_MAP}    ${IPV4_RD}    ${IPV4_C_KEY}

IPv6 Prefix
    [Documentation]    Perform mapping/key operations with an IPv6 EID
    ${IPV6_C_MAP}    ${IPV6_RD}    ${IPV6_C_KEY}

MAC Address
    [Documentation]    Perform mapping/key operations with a MAC address EID
    ${MAC_C_MAP}    ${MAC_RD}    ${MAC_C_KEY}

Distinguished Name
    [Documentation]    Perform mapping/key operations with a Distinguished Name EID
    ${DN_C_MAP}    ${DN_RD}    ${DN_C_KEY}

AS Number
    [Documentation]    Perform mapping/key operations with an Autonomous System Number EID
    ${AS_C_MAP}    ${AS_RD}    ${AS_C_KEY}

Instance ID
    [Documentation]    Perform mapping/key operations with an IPv4 EID in Instance ID 1
    ${IID_C_MAP}    ${IID_RD}    ${IID_C_KEY}

Source/Destination
    [Documentation]    Perform mapping operations with a Source/Destination EID
    ${SD_C_MAP}    ${SD_RD}    ${EMPTY}

Key/Value
    [Documentation]    Perform mapping/key operations with a Key/Value EID

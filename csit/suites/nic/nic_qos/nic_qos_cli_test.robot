...
Verify OF Renderer QOS Constraint CLI
    ...
    ${idd}=    Add Intent From Karaf Console    ${source_macaddress}    ${destination_macaddress}    ALLOW
    ${iddd}=    Add Intent From Karaf Console    ${destination_macaddress}    ${source_macaddress}    ALLOW

...
Verify OF Renderer ALLOW Action CLI
    [Documentation]    Verification of NIC Console command for QOS Configuration.
    [Tags]    NIC
    ...
    ${allow_flow_one}=    Add Intent From Karaf Console    ${source_macaddress}    ${destination_macaddress}    ALLOW
    ${allow_flow_two}=    Add Intent From Karaf Console    ${destination_macaddress}    ${source_macaddress}    ALLOW

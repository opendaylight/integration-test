...
Verify NIC Redirect CLI Command and Mininet Ping
    ...
    ${mininet_conn_id}=    Wait Until Keyword Succeeds    20s    1s    Start Mininet    ${MININET}    ${redirect_topo}    ${custom}
...
Install Bridge Utils
    ...
    SSHLibrary.Execute Command    yum install bridge-utils
    SSHLibrary.Execute Command    yum install tunctl

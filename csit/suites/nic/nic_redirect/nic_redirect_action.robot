...
Start Mininet
    ...
    Read Until    mininet>
    #......temp checking
    Wait Until Keyword Succeeds    120s    5s    Wait Until Keyword Succeeds    120s    30s    Wait Until Keyword Succeeds    120s    30s    Write    srvc1 ip addr del 10.0.0.6/8 dev srvc1-eth0
    Wait Until Keyword Succeeds    120s    5s    Wait Until Keyword Succeeds    120s    30s    Write    srvc1 brctl addbr br0
    Wait Until Keyword Succeeds    120s    5s    Write    srvc1 brctl addif br0 srvc1-eth0
    Wait Until Keyword Succeeds    120s    5s    Wait Until Keyword Succeeds    120s    30s    Wait Until Keyword Succeeds    120s    30s    Write    srvc1 brctl addif br0 srvc1-eth1
    Wait Until Keyword Succeeds    120s    5s    Wait Until Keyword Succeeds    120s    30s    Write    srvc1 ifconfig br0 up

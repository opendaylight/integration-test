...
Unification Node Update
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=8    supporting-node_count=10    tp_count=14    tp-ref_count=14
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=7    supporting-node_count=10    tp_count=11    tp-ref_count=11
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=8    supporting-node_count=10    tp_count=9    tp-ref_count=9
    : FOR    ${index}    IN RANGE    1    11
    \    Should Contain X Times    ${resp.content}    <node-ref>bgp:${index}</node-ref>    1
...
Unification Node Inventory
    ...
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=7    supporting-node_count=10    tp_count=12    tp-ref_count=12
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=6    supporting-node_count=10    tp_count=12    tp-ref_count=12
    : FOR    ${index}    IN RANGE    1    11
...
Filtration Range Number Node Update Network Topology Model
    ...
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=4    supporting-node_count=4    node-ref_count=4    tp_count=5    tp-ref_count=5
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=3    supporting-node_count=3    node-ref_count=3    tp_count=3    tp-ref_count=3
    ...
    Basic Request Put    ${request}    network-topology:network-topology/topology/network-topo:2/node/bgp:7
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=4    supporting-node_count=4    node-ref_count=4    tp_count=3    tp-ref_count=3
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=4    supporting-node_count=4    node-ref_count=4    tp_count=4    tp-ref_count=4
...
Filtration Range Number Node Update Inventory Model
    ...
    ${request}    Set Range Number Filter    ${request}    20    25
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=3    supporting-node_count=3    node-ref_count=3    tp_count=0    tp-ref_count=0
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=4    supporting-node_count=4    node-ref_count=4    tp_count=0    tp-ref_count=0
    : FOR    ${index}    IN RANGE    7    11
    \    Should Contain X Times    ${resp.content}    <node-ref>of-node:${index}</node-ref>    1
...
Filtration Range Number Termination Point Update NT
    ...
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=5    supporting-node_count=5    node-ref_count=5    tp_count=3    tp-ref_count=3
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=5    supporting-node_count=5    node-ref_count=5    tp_count=4    tp-ref_count=4
...
Filtration Range Number Termination Point Update Inventory
    ...
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=5    supporting-node_count=5    node-ref_count=5    tp_count=5    tp-ref_count=5
    #Update a previously out-of-range termination point, so it passes filtration
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=5    supporting-node_count=5    node-ref_count=5    tp_count=6    tp-ref_count=6
...
Filtration Range Number Link Update Network Topology Model
    ...
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    link_count=3    link-ref_count=3
    #Filter a link out
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    link_count=2    link-ref_count=2
...
Link Computation Aggregation Inside Update NT
    ...
    Basic Request Put    ${request}    ${OVERLAY_TOPO_URL}
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=4    supporting-node_count=5    node-ref_count=5    link_count=4    link-ref_count=4
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=5    supporting-node_count=5    node-ref_count=5    link_count=4    link-ref_count=4
    ...
    ${resp}    Wait Until Keyword Succeeds    2x    1s    Output Topo Should Be Complete    node_count=5    supporting-node_count=5    node-ref_count=5    link_count=3    link-ref_count=3
    #Refresh node IDs
    ${node_26}    Check Aggregated Node in Topology    ${model}    ${resp.content}    0    bgp:26
    ${node_27}    Check Aggregated Node in Topology    ${model}    ${resp.content}    0    bgp:27
    ${node_28}    Check Aggregated Node in Topology    ${model}    ${resp.content}    0    bgp:28

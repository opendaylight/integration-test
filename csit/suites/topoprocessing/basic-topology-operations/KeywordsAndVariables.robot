...
Insert Underlay Topologies
    ...
    ${resp}    RequestsLibrary.Put    session    ${CONFIGURATION}/${TOPOLOGY_URL}/network-topo:4    data=${NETWORK_UNDERLAY_TOPOLOGY_4}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    # Network underlay topology 5
    ${resp}    RequestsLibrary.Put    session    ${CONFIGURATION}/${TOPOLOGY_URL}/network-topo:5    data=${NETWORK_UNDERLAY_TOPOLOGY_5}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    # Network underlay topology 6
    ${resp}    RequestsLibrary.Put    session    ${CONFIGURATION}/${TOPOLOGY_URL}/network-topo:6    data=${NETWORK_UNDERLAY_TOPOLOGY_6}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}    RequestsLibrary.Put    session    ${CONFIGURATION}/${TOPOLOGY_URL}/openflow-topo:4    data=${OPENFLOW_UNDERLAY_TOPOLOGY_4}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    # Openflow underlay topology 5
    ${resp}    RequestsLibrary.Put    session    ${CONFIGURATION}/${TOPOLOGY_URL}/openflow-topo:5    data=${OPENFLOW_UNDERLAY_TOPOLOGY_5}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    # Openflow underlay topology 5
    ${resp}    RequestsLibrary.Put    session    ${CONFIGURATION}/${TOPOLOGY_URL}/openflow-topo:6    data=${OPENFLOW_UNDERLAY_TOPOLOGY_6}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Issue Command On Karaf Console    log:clear
    Log    ${resp.content}

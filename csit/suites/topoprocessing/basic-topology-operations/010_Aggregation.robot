...
Unification node
    ...
    ${UNIFICATION_NT}    Set Element Text    ${UNIFICATION_NT}    network-topology-model    xpath=.//correlation/aggregation/mapping[1]/input-model
    ${UNIFICATION_NT}    Set Element Text    ${UNIFICATION_NT}    network-topo:1    xpath=.//correlation/aggregation/mapping[1]/underlay-topology
    ${UNIFICATION_NT}    Set Element Text    ${UNIFICATION_NT}    network-topology-pcep:path-computation-client/network-topology-pcep:ip-address    xpath=.//correlation/aggregation/mapping[1]/target-field
    ${UNIFICATION_NT}    Set Element Text    ${UNIFICATION_NT}    network-topology-model    xpath=.//correlation/aggregation/mapping[2]/input-model
    ${UNIFICATION_NT}    Set Element Text    ${UNIFICATION_NT}    network-topo:2    xpath=.//correlation/aggregation/mapping[2]/underlay-topology
    ${UNIFICATION_NT}    Set Element Text    ${UNIFICATION_NT}    network-topology-pcep:path-computation-client/network-topology-pcep:ip-address    xpath=.//correlation/aggregation/mapping[2]/target-field

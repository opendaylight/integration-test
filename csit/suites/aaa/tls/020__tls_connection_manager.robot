...
Init Suite
    ...
    Enable TLS in AAA
    Stop Karaf
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/clientcert.pem
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/clientkey.pem
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/rootCA.key
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/rootCA.pem
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/rootCA.srl
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/servercert.pem
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/server.crt
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/server.csr
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/server.key
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/serverkey.pem
    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    rm -f ${WORKSPACE}/server.p12

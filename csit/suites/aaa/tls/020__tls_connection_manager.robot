...
Set Valid Certificates
    ...
    Copy File To Remote System    ${ODL_SYSTEM_IP}    ${SUITES}/certs/ctl.jks    ${KEYSTORE_PATH}
    Copy File To Remote System    ${ODL_SYSTEM_IP}    ${SUITES}/certs/truststore.jks    ${TRUSTSTORE_PATH}
    Copy File To Remote System    ${TOOLS_SYSTEM_IP}    ${SUITES}/certs/sc-privkey.pem    /tmp/.
    Copy File To Remote System    ${TOOLS_SYSTEM_IP}    ${SUITES}/certs/sc-cert.pem    /tmp/.
    Copy File To Remote System    ${TOOLS_SYSTEM_IP}    ${SUITES}/certs/ca-chain.cert.pem    /tmp/.

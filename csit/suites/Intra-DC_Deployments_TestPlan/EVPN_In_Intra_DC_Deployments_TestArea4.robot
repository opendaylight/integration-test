...
Associate L3VPN To Routers
    ...
    :FOR   ${index}   IN RANGE   0   ${NUM_OF_ROUTER}
    \    ${router_id}=    Get Router Id    ${ROUTERS[${index+1}]}    ${devstack_conn_id}
...
Add Interfaces To Routers
    ...
    \    ${subnet_id} =    Get Subnet Id    ${INTERFACE}    ${devstack_conn_id}
    \    Should Contain    ${interface_output}    ${subnet_id}
    ${GWMAC_ADDRS_ROUTER1_TESTAREA4}    ${GWIP_ADDRS_ROUTER1_TESTAREA4} =    Get Gateway MAC And IP Address    ${ROUTERS[0]}
...
Create Neutron Ports
    ...
    Wait Until Keyword Succeeds    3s    1s    Check For Elements At URI    ${PORT_URL}    ${PORT_LIST_TEST_TOPOLOGY_4}

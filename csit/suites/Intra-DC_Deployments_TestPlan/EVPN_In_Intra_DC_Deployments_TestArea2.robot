...
TC26 7.2.1 Verification of intra_router_intra_openvswitch network connectivity
    ...
    Wait Until Keyword Succeeds    180s    10s    Verify Ping    @{REQ_NETWORKS}[2]    ${VM_IP_NET3[0]}    ${VM_IP_NET3[1]}
    Wait Until Keyword Succeeds    180s    10s    Verify Ping    @{REQ_NETWORKS}[3]    ${VM_IP_NET4[0]}    ${VM_IP_NET4[1]}
...
TC27 7.2.2 Verification of intra_router_inter_openvswitch network connectivity
    ...
    Wait Until Keyword Succeeds    180s    10s    Verify Ping    @{REQ_NETWORKS}[2]    ${VM_IP_NET3[0]}    ${VM_IP_NET3[2]}
    Wait Until Keyword Succeeds    180s    10s    Verify Ping    @{REQ_NETWORKS}[3]    ${VM_IP_NET4[0]}    ${VM_IP_NET4[2]}
    ${output}=    Get Fib Entries    session
...
TC29 7.2.4 Verification of inter_router_inter_openvswitch network connectivity
    ...
    Wait Until Keyword Succeeds    180s    10s    Verify Ping    @{REQ_NETWORKS}[0]    ${VM_IP_NET1[0]}    ${VM_IP_NET3[2]}
    Wait Until Keyword Succeeds    180s    10s    Verify Ping    @{REQ_NETWORKS}[1]    ${VM_IP_NET2[1]}    ${VM_IP_NET4[3]}

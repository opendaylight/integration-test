...
Start Log Message to controller Karaf
    ...
    Log Message To Controller Karaf      Start of OF13 VTN Manager Dataflow Robot test file
...
Stop Log Message to controller Karaf
    ...
    Log Message To Controller Karaf     End of OF13 VTN Manager Dataflow Robot test file

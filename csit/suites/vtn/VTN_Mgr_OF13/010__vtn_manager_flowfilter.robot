...
Verify inet4src and inet4dst of vtn flowfilter
    ...
    Wait_Until_Keyword_Succeeds    10s    1s    Verify Flow Entries for Flowfilter    ${DUMPFLOWS_OF13}    @{inet_actions}
...
Verify icmp action for vtn flowfilter
    ...
    [Tags]    exclude
    Wait_Until_Keyword_Succeeds    6s    1s    Verify Flow Entries for Flowfilter    ${DUMPFLOWS_OF13}    @{icmp_action}
...
Verify dscp action for vtn flowfilter
    ...
    [Tags]    exclude
    Wait_Until_Keyword_Succeeds    12s    1s    Verify flowactions    ${dscp_flow}    ${DUMPFLOWS_OF13}

...
*** Variables ***
${flowfilterDscpdata}    {"input": {"output": "false", "tenant-name": "Tenant1", "bridge-name": "vBridge1", "vtn-flow-filter":[{"condition": "cond_1", "index": 1, "vtn-pass-filter": {}, "vtn-flow-action":[{"order": "1","vtn-set-inet-dscp-action":{"dscp":"6"}}]}]}}
...
Add a flowfilter with dscp
    ...
    Add a flowfilter    Tenant1    vBridge1    if1    ${flowfilterDscpdata}    
    Wait_Until_Keyword_Succeeds    20s    1s    Mininet Ping Should Succeed    h1    h3

...
Verify dscp action for vbrif flowfilter
    ...
    Wait_Until_Keyword_Succeeds    20s    1s    Verify flowactions    ${dscp_action}    ${FF_OUT_DUMPFLOWS_OF13}
...
Verify Removed Flow Entry For Inet After Drop Action
    ...
    Wait_Until_Keyword_Succeeds    20s    1s    Verify flowactions    ${drop_action}    ${DROP_OUT_DUMPFLOWS_OF13}

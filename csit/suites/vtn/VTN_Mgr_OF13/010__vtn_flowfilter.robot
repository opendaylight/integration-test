...
${flowfilterIcmpCodedata}    "vtn-flow-filter":[{"condition":"cond_1","vtn-pass-filter":{},"vtn-flow-action": [{ "order": "1", "vtn-set-icmp-code-action":{"code": "22"}},{"order": "2","vtn-set-icmp-type-action": {"type": "33"}}],"index": "1"}]

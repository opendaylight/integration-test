...
Add a vbr flowfilter with set-port
    [Documentation]    Create a flowfilter with dscp and Verify ping
    Add a vtn flowfilter    Tenant1    vBridge1    ${flowfilterportdata}
    Wait_Until_Keyword_Succeeds    20s    1s    Mininet Iperf Should Succeed    h1    h3
...
Remove vbr Flowfilter index which have set-port
    [Documentation]    Remove a index of vtn flowfilter which have DSCP
    Remove a vtn flowfilter    Tenant1    vBridge1    ${filter_index}
    
Add a vbrif flowfilter with set-port
    [Documentation]    Create a flowfilter with dscp and Verify ping
    Add a vtn flowfilter    Tenant1    vBridge1    if1    ${flowfilterportdata}
    Wait_Until_Keyword_Succeeds    20s    1s    Mininet Iperf Should Succeed    h1    h3
...
Remove vbrif Flowfilter index which have set-port
    [Documentation]    Remove a index of vtn flowfilter which have DSCP
    Remove a vtn flowfilter    Tenant1    vBridge1    if1    ${filter_index}

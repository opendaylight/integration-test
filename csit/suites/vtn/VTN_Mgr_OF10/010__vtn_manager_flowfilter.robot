...
${flowfilterIcmpCodedata}    "vtn-flow-filter": [{"condition": "cond_1","index": "1", "vtn-pass-filter": {}, "vtn-flow-action": [{"order": "1", "vtn-set-icmp-code-action":{"code": "11"}},{"order": "2","vtn-set-icmp-type-action": {"type": "22"}}]}]
...
Verify icmp action for vtn flowfilter
    ...
    Verify Flow Entries for Flowfilter     @{icmp_action}    ${DUMPFLOWS_OF10}
...
Verify dscp action for vtn flowfilter
    ...
    Verify flowactions     ${dscp_action}    ${DUMPFLOWS_OF10}

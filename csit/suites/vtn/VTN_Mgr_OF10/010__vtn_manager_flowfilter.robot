...
Start Log Message to controller Karaf
    ...
    Log Message To Controller Karaf      Start of VTN Manager Flowfilter Robot test file
...
Stop Log Message to controller Karaf
    ...
    Log Message To Controller Karaf     End of VTN Manager Flowfilter Robot test file

...
Suite Setup       Start PathSuiteVtnMaTest    OF10
...
Verify flowEntryBeforePathPolicy
    ...
    [Tags]    Switch
    Wait Until Keyword Succeeds    10s    2s    Verify flowEntryBeforePathPolicy    OF10
...
Verify flowEntryAfterPathPolicy
    [Documentation]    Checking Flows on switch s1 and s3
    [Tags]    Switch
    Wait Until Keyword Succeeds    10s    2s    Verify flowEntryAfterPathPolicy    OF10

...
Start Log Message to controller Karaf
    ...
    Log Message To Controller Karaf      Start of Robot test file to test get flows and entries
...
Stop Log Message to controller Karaf
    ...
    Log Message To Controller Karaf      End of Robot test file to test get flows and entries

...
Verify mac addressof h3 and h1
    ...
    Wait_Until_Keyword_Succeeds    20s    1s    Verify Flows On OpenFlow    h1    h3    ${DUMPFLOWS_OF10}
...
Verify mac addressof h1 and h3
    [Documentation]    Verify mac address in flow entries
    Wait_Until_Keyword_Succeeds    20s    1s    Verify Flows On OpenFlow    h3    h1    ${DUMPFLOWS_OF10}

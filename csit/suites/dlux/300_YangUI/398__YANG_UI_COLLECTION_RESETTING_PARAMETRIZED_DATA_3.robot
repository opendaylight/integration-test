*** Settings ***
Documentation     Verification that nongroup data is reset only in sent data box in which reset parametrized data button is hit. 
...
Step_05_run
    ...
    Verify Collection Table Nongroup Row Content    ${row_number_1}    ${Put_Method_NAME}    ${Name_1}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Nongroup Row    ${row_number_1}

Step_06_run
    ${row_number_2}=    Set Variable    2
    ...
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}
    Verify Collection Table Nongroup Row Content    ${row_number_2}    ${Put_Method_NAME}    ${Name_2}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Nongroup Row    ${row_number_2}
...
Step_07_run
    ...
    Verify Collection Nongroup Sent Box Data Presence In Code Mirror    ${row_number_1}    ${parameter_key_1}
    ...
    Reset Nongroup Parametrized Data    ${row_number_1} 
    Verify Collection Nongroup Sent Box Data NONPresence In Code Mirror    ${row_number_1}    ${parameter_key_1}
    Verify Collection Nongroup Sent Box Data Presence In Code Mirror    ${row_number_1}    ${Topology_Id_0}
    Verify Collection Nongroup Sent Box Data Presence In Code Mirror    ${row_number_2}    ${parameter_key_3}
    Close Collection Nongroup Sent Box    ${row_number_1}
    Close Collection Nongroup Sent Box    ${row_number_2}

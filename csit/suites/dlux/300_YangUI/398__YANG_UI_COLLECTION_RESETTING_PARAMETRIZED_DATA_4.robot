*** Settings ***
Documentation     Verification that group data is reset only in sent data box in which reset parametrized data button is hit. 
...
Step_07
   [Documentation]    Click Sent data button in row 1. Edit sent data - insert parameter1 key
    ...    to topology id input in path wrapper. Param1 key = <<p1>> 
    ...    Click Sent data button in row 2.  Edit sent data - insert parameter2 key
    ...    to topology id input and param3 key to node id input in path wrapper. Param2 key = <<p2>>, Param3 key = <<p3>>.
    ...    Click Reset parametrized data button in row 1.
    ...    Result
...
Step_05_run
    ...
    Verify Collection Table Group Row Content    ${group_number_1}    ${row_number_1}    ${Put_Method_NAME}    ${Name_1}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Group Row    ${group_number_1}    ${row_number_1}
...
Step_06_run
    ...
    Click Element    ${Add_To_Collection_Box_Add_BUTTON}
    Click Element    ${COLLECTION_TAB}  
    Expand Collection Table Group Expander    ${group_number_1}    ${Group_1}    ${row_number_2}
    Verify Collection Table Group Row Content    ${group_number_1}    ${row_number_2}    ${Put_Method_NAME}    ${Name_2}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Group Row    ${group_number_1}   ${row_number_2}
...
Step_07_run
    ...
    Verify Collection Table Group Row Content    ${group_number_2}    ${row_number_1}    ${Put_Method_NAME}    ${Name_3}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Group Row    ${group_number_2}    ${row_number_1}
    
Step_08_run    
    ${Collection_Table_List_Group_ROW}=    Return Collection Table Group Row Number    ${group_number_1}    ${row_number_1}
    Verify Elements Of Group Row Sent Data Box    ${group_number_1}    ${row_number_1}
    ...
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_1}    ${row_number_1}    ${parameter_key_1}
    
    ${Collection_Table_List_Group_ROW}=    Return Collection Table Group Row Number    ${group_number_1}    ${row_number_2}
    Verify Elements Of Group Row Sent Data Box    ${group_number_1}    ${row_number_2}
    ${Collection_Table_Group_Row_Sent_Data_BOX}=    Set Variable    ${Collection_Table_List_Group_ROW}${Sent_Data_BOX}
    ${Collection_Table_Group_Row_Sent_Data_Box_Path_WRAPPER}=    Set Variable    ${Collection_Table_Group_Row_Sent_Data_BOX}${Sent_Data_Box_Path_WRAPPER}    
    ${Collection_Table_Group_Row_Sent_Data_Box_Topology_Id_Path_Wrapper_INPUT}=    Set Variable    ${Collection_Table_Group_Row_Sent_Data_Box_Path_WRAPPER}${Sent_Data_Box_Topology_Id_Path_Wrapper_INPUT}    
    ...
    Insert Text To Input Field    ${Collection_Table_Group_Row_Sent_Data_Box_Topology_Id_Path_Wrapper_INPUT}    ${parameter_key_2}
    Insert Text To Input Field    ${Collection_Table_Group_Row_Sent_Data_Box_Node_Id_Path_Wrapper_INPUT}    ${parameter_key_3}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_1}    ${row_number_2}    ${parameter_key_3}
    
    ${Collection_Table_List_Group_ROW}=    Return Collection Table Group Row Number    ${group_number_2}    ${row_number_1}
    Verify Elements Of Group Row Sent Data Box    ${group_number_2}    ${row_number_1}
    ${Collection_Table_Group_Row_Sent_Data_BOX}=    Set Variable    ${Collection_Table_List_Group_ROW}${Sent_Data_BOX}
    ${Collection_Table_Group_Row_Sent_Data_Box_Path_WRAPPER}=    Set Variable    ${Collection_Table_Group_Row_Sent_Data_BOX}${Sent_Data_Box_Path_WRAPPER}    
    ${Collection_Table_Group_Row_Sent_Data_Box_Topology_Id_Path_Wrapper_INPUT}=    Set Variable    ${Collection_Table_Group_Row_Sent_Data_Box_Path_WRAPPER}${Sent_Data_Box_Topology_Id_Path_Wrapper_INPUT}    
    ...
    Insert Text To Input Field    ${Collection_Table_Group_Row_Sent_Data_Box_Topology_Id_Path_Wrapper_INPUT}    ${parameter_key_4}
    Insert Text To Input Field    ${Collection_Table_Group_Row_Sent_Data_Box_Link_Id_Path_Wrapper_INPUT}    ${parameter_key_5}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_2}    ${row_number_1}    ${parameter_key_5}

    Reset Group Parametrized Data    ${group_number_1}    ${row_number_2}
    
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_1}    ${row_number_1}    ${parameter_key_1}
    Verify Collection Group Sent Box Data NONPresence In Code Mirror    ${group_number_1}    ${row_number_2}    ${parameter_key_3}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_1}    ${row_number_2}    ${Node_Id_0}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_2}    ${row_number_1}    ${parameter_key_5}

...
Step_05
    [Documentation]    Execute DELETE operation. Add request to Collection. Clear History data.
    ...    Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: - success no sent no received data elements.  
    Step_05_run
    
Step_06
    [Documentation]    If the page contains any request in collection list, click Clear collection data.
    ...    Navigate to HISTORY tab. Execute GET operation. Add request to Collection. Clear History data.
    ...    Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: - error no sent no received data elements. 
    Step_06_run

Step_07
    [Documentation]    If the page contains any request in collection list, click Clear collection data.
    ...    Navigate to HISTORY tab. POST(functionality disabled) PUT topology-id with valid data. Topology id = t0.
    ...    Add request to Collection. Clear History data. Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: - success sent data elements  
    Step_07_run
...
Step_08
    ...
    ...    Add request to Collection. Clear History data. Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: - success received data elements
    Step_08_run
...
Step_09
    ...
    ...    Add request to Collection. Clear History data. Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: - error sent data elements
    Step_09_run    
...
Step_05_run
    ...
    Add Request To Collection    1    ${EMPTY}    ${Select_Option}    ${EMPTY}
    Click Element    ${Add_To_Collection_Box_Add_BUTTON}    
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}
    Verify Collection Table Nongroup Row Content    1    ${Remove_Method_NAME}    ${EMPTY}    ${Success_STATUS}
...
Step_06_run
    ...
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}
    Verify Collection Table Nongroup Row Content    1    ${Get_Method_NAME}    ${EMPTY}    ${Error_STATUS}
    Verify No Sent No Received Data Elements Presence In Collection Table Nongroup Row    1
...
Step_07_run
    ...
    Click Element    ${COLLECTION_TAB}
    Verify Collection Table Nongroup Row Content    1    ${Put_Method_NAME}    ${EMPTY}    ${Success_STATUS}
...
Step_08_run
    ...
    Close Form In CustomContainer Area    ${Testing_Root_API_Topology_List_Topology_Delete_BUTTON}    ${Testing_Root_API_Topology_List_Topology_Id_INPUT}
    Click Element    ${COLLECTION_TAB}
    Verify Collection Table Nongroup Row Content    1    ${Get_Method_NAME}    ${EMPTY}    ${Success_STATUS}
...
Step_09_run
    ...
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}
    Verify Collection Table Nongroup Row Content    1    ${Put_Method_NAME}    ${EMPTY}    ${Error_STATUS}
    Verify No Sent No Received Data Elements Presence In Collection Table Nongroup Row    1

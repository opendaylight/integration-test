*** Settings ***
Documentation     Verification that Collection tab nongroup row  contains box with 
...
Step_05_run
    ...
    Verify Elements Of Nongroup Row Sent Data Box    1
    ...
    Close Collection Nongroup Sent Box And Clear Collection Data    1        
...
Step_06_run
    ...
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}  
    Verify Collection Table Nongroup Row Content    1    ${Put_Method_NAME}    ${Name_2}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Nongroup Row    1
...
Step_08_run
    ...
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}  
    Verify Collection Table Nongroup Row Content    1    ${Put_Method_NAME}    ${Name_3}    ${Success_STATUS}
    Verify Sent Data Elements Presence In Collection Table Nongroup Row    1

*** Settings ***
Documentation     Verification that it is possible to reset edited group row  sent parametrized data.
...
Step_06
    [Documentation]    Click Sent data button. Expand G1 group. Edit sent data - insert parameter1 key.
...
Step_07
    ...
    ...    Navigate to collection tab. Expand group G1. Topology id value: t0. Node id value: t0n0.
    ...    Name value: N2, Group: G1.
    ...    Result
...
Step_08
    ...
    ...    Click Reset parametrized data button. Close Sent data box.
    ...    Result
...
Step_10
    [Documentation]    Click Sent data button. Edit sent data - insert parameter4 key
    ...    to topology id input in path wrapper and param5 key to link id input. Param4 key = <<p4>>, 
    ...    Param5 key = <<p5>>. Click Reset parametrized data button. Close Sent data box.
    ...    Result
    ...    The page should contain: The page should contain: - topology id path wrapper input,
    ...    - link id path wrapper input.
    ...    Param4 and param5 key should not be present in CodeMirror.
    ...    The page should not contain Sent data box. 
    Step_10_run
...
Step_06_run
    ...
    Reset Group Parametrized Data    ${group_number_1}    ${row_number_1} 
    Verify Collection Group Sent Box Data NONPresence In Code Mirror    ${group_number_1}    ${row_number_1}    ${parameter_key_1}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number_1}    ${row_number_1}    ${Topology_Id_0}
    Close Collection Group Sent Box    ${group_number_1}    ${row_number_1}        
...
Step_08_run
    ...
    Reset Group Parametrized Data    ${group_number}    ${row_number} 
    Verify Collection Group Sent Box Data NONPresence In Code Mirror    ${group_number}    ${row_number}    ${parameter_key_3}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number}    ${row_number}    ${Node_Id_0}
...
Step_10_run
    ...
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number}    ${row_number}    ${parameter_key_5}
    Reset Group Parametrized Data    ${group_number}    ${row_number} 
    Verify Collection Group Sent Box Data NONPresence In Code Mirror    ${group_number}    ${row_number}    ${parameter_key_5}
    Verify Collection Group Sent Box Data Presence In Code Mirror    ${group_number}    ${row_number}    ${Link_Id_0}
    Close Collection Group Sent Box    ${group_number}    ${row_number}        

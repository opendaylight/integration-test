...
Step_06_run
    ...
    Verify Collection Group Sent Box ParamKey Presence In Code Mirror    ${group_number}    ${row_number}    ${Param_Name_1}
...
Step_08_run
    ...
    Verify Collection Group Sent Box ParamKey Presence In Code Mirror    ${group_number}    ${row_number}    ${Param_Name_2}
    Close Collection Group Sent Box    ${group_number}    ${row_number}        
...
Step_10_run
    ...
    Verify Collection Group Sent Box ParamKey Presence In Code Mirror    ${group_number}    ${row_number}    ${Param_Name_3}
    Close Collection Group Sent Box    ${group_number}    ${row_number}        

*** Settings ***
Documentation     Verification that requests are added to collections with name and new group. 
...
Step_06
    ...
    ...    Navigate to HISTORY tab. Execute GET operation. Add request to Collection with name and new group. 
...
Step_08
    ...
    ...    Add request to Collection with name and new group. Name value: N4. Group value: G4.
    ...    Clear History data. Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: -group G4, -name N4, - success received data elements
    Step_08_run

Step_09
    [Documentation]    If the page contains any request in collection list, click Clear collection data.
    ...    Navigate to HISTORY tab. PUT topology-id withno data.
    ...    Add request to Collection with name and new group. Name value: N5. Group value: G5 
    ...    Clear History data. Navigate to COLLECTION tab.
    ...    Result
    ...    The page should contain: -group G5, - name N5, - error sent data elements
    Step_09_run    
...
Step_06_run
    ...
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}
    Expand Collection Table Group Expander    1    ${Group_2}    1
    Verify Collection Table Group Row Content    1    1    ${Get_Method_NAME}    ${Name_2}    ${Error_STATUS}
    Verify No Sent No Received Data Elements Presence In Collection Table Group Row    1    1
...
Step_07_run
    ...
    Click Element    ${COLLECTION_TAB}
    Expand Collection Table Group Expander    1    ${Group_3}    1
    Verify Collection Table Group Row Content    1    1    ${Post_Method_NAME}    ${Name_3}    ${Success_STATUS}
...
Step_08_run
    ...
    Add Request To Collection    1    ${Name_4}    ${Select_Option}    ${Group_4}
    Click Element    ${Add_To_Collection_Box_Add_BUTTON}    
    If History Table Contains Data Then Clear History Data
    Close Form In CustomContainer Area    ${Testing_Root_API_Topology_List_Topology_Delete_BUTTON}    ${Testing_Root_API_Topology_List_Topology_Id_INPUT}
    Click Element    ${COLLECTION_TAB}
    Expand Collection Table Group Expander    1    ${Group_4}    1
    Verify Collection Table Group Row Content    1    1    ${Get_Method_NAME}    ${Name_4}    ${Success_STATUS}
    Verify Received Data Elements Presence In Collection Table Group Row    1    1
...
Step_09_run
    ...
    Add Request To Collection    1    ${Name_5}    ${Select_Option}    ${Group_5}
    Click Element    ${Add_To_Collection_Box_Add_BUTTON}    
    If History Table Contains Data Then Clear History Data
    Click Element    ${COLLECTION_TAB}
    Expand Collection Table Group Expander    1    ${Group_5}    1
    Verify Collection Table Group Row Content    1    1    ${Put_Method_NAME}    ${Name_5}    ${Error_STATUS}
    Verify No Sent No Received Data Elements Presence In Collection Table Group Row    1    1

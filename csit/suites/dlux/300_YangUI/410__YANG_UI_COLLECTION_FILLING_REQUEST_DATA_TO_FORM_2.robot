*** Settings ***
Documentation     Verification that it is possible to fill group request to form. 
...
Step_06
    [Documentation]    Fill each request to form.
    ...    Result
...
Step_05_run
    ...
    @{name_1_data}=    Create List    ${Group_1}    ${group_number_1}    ${row_number_1}    ${row_number_1}    ${Put_Method_NAME}    ${Success_STATUS}
    @{name_2_data}=    Create List    ${Group_1}    ${group_number_1}    ${row_number_2}    ${row_number_2}    ${Get_Method_NAME}    ${Success_STATUS}
    @{name_3_data}=    Create List    ${Group_2}    ${group_number_2}    ${row_number_3}    ${row_number_1}    ${Put_Method_NAME}    ${Error_STATUS}

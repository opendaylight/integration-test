...
Step_02
    ...
    ...    and submenus Topolgy, Nodes, Yang UI, Yang Visualizer.
    Step_02_run
...
Step_06
    ...
    ...    - "node <node-id: t1l1>" button and iconClose button;
    ...    -  "node <node-id: t1l2>" button and iconClose button.
    Step_06_run
...
Step_06_run 
    ...
    Verify Chosen_Id Presence On The Page    ${Node_Id_1}    ${Node_ID}    ${Testing_Root_API_Node_List_NAME}
    Verify Chosen_Id Presence On The Page    ${Node_Id_2}    ${Node_ID}    ${Testing_Root_API_Node_List_NAME}
    
    Verify Chosen_Id Presence On The Page    ${Link_Id_0}    ${Link_ID}    ${Testing_Root_API_Link_List_NAME}
    Verify Chosen_Id Presence On The Page    ${Link_Id_1}    ${Link_ID}    ${Testing_Root_API_Link_List_NAME}
    Verify Chosen_Id Presence On The Page    ${Link_Id_2}    ${Link_ID}    ${Testing_Root_API_Link_List_NAME}

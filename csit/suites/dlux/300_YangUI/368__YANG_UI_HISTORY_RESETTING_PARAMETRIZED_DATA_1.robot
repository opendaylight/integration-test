...
Step_05_run
    ...
    Reset History Sent Box Parametrized Data    ${row_number} 
    Verify History Sent Box Data NONPresence In Code Mirror    ${row_number}    ${param_key_1}
    Verify History Sent Box Data Presence In Code Mirror    ${row_number}    ${Topology_Id_0}
...
Step_06_run
    ...
    Reset History Sent Box Parametrized Data    ${row_number} 
    Verify History Sent Box Data NONPresence In Code Mirror    ${row_number}    ${param_key_2}
    Verify History Sent Box Data Presence In Code Mirror    ${row_number}    ${Node_Id_0}
...
Step_07_run
    ...
    Reset History Sent Box Parametrized Data    ${row_number} 
    Verify History Sent Box Data NONPresence In Code Mirror    ${row_number}    ${param_key_3}
    Verify History Sent Box Data Presence In Code Mirror    ${row_number}    ${Link_Id_0}

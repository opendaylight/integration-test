...
Kill_All_And_Clean
    ...
    ClusterManagement.With_Ssh_To_List_Or_All_Run_Keyword    member_index_list=${EMPTY}    keyword_name=Download_Karaf_Log
...
*** Keywords ***
Download_Karaf_Log
    ${timestamp} =    TimeDate.Get_Current_Date    time_zone=UTC    result_format=%Y%m%d%H%M%S%f

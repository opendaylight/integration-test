...
Getting all Tables from Openflow Plugin
    ...
    @{openflow_1}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:1/table/0/    flow/id
    @{openflow_2}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:2/table/0/    flow/id
    @{openflow_3}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:3/table/0/    flow/id

    Set Suite Variable 	  @{openflow_1}
    Set Suite Variable    @{openflow_2}
    Set Suite Variable    @{openflow_3}

    @{openflow_1_packetcount}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:1/table/0/    ${packet_count}
    @{openflow_2_packetcount}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:2/table/0/    ${packet_count}
    @{openflow_3_packetcount}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:3/table/0/    ${packet_count}
    ...
    @{openflow_1_bytecount}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:1/table/0/    ${byte_count}
    @{openflow_2_bytecount}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:2/table/0/    ${byte_count}
    @{openflow_3_bytecount}=    Return all XML matches    ${OPERATIONAL_NODES_API}/openflow:3/table/0/    ${byte_count}

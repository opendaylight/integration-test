...
Getting all Tables from Openflow Plugin
    ...
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:1/table/0/    ${packetlookup}
    Append To List    ${openflow_packetlookup}    ${ret}
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/table/0/    ${packetlookup}
    Append To List    ${openflow_packetlookup}    ${ret}
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:3/table/0/    ${packetlookup}
    Append To List    ${openflow_packetlookup}    ${ret}

    Set Suite Variable    @{openflow_packetlookup}


    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:1/table/0/    ${activeflows}
    Append To List    ${openflow_activeflows}    ${ret}
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/table/0/    ${activeflows}
    Append To List    ${openflow_activeflows}    ${ret}
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:3/table/0/    ${activeflows}
    Append To List    ${openflow_activeflows}    ${ret}

    Set Suite Variable    @{openflow_activeflows}

    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:1/table/0/    ${packetmatched}
    Append To List    ${openflow_packetmatched}    ${ret}
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/table/0/    ${packetmatched}
    Append To List    ${openflow_packetmatched}    ${ret}
    ${ret}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:3/table/0/    ${packetmatched}
    Append To List    ${openflow_packetmatched}    ${ret}

...
Verification of FlowStats-Attributes on Cassandra Data Store
    ...
    Copy TSDR tables
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:1*DC=FLOWTABLESTATS*MN=PacketLookup*RK=Node:openflow:1,Table:0*
    Append To List    ${tsdr_pl}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:2*DC=FLOWTABLESTATS*MN=PacketLookup*RK=Node:openflow:2,Table:0*
    Append To List    ${tsdr_pl}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:3*DC=FLOWTABLESTATS*MN=PacketLookup*RK=Node:openflow:3,Table:0*
    Append To List    ${tsdr_pl}    ${ret_val1}



    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:1*DC=FLOWTABLESTATS*MN=ActiveFlows*RK=Node:openflow:1,Table:0*
    Append To List    ${tsdr_af}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:2*DC=FLOWTABLESTATS*MN=ActiveFlows*RK=Node:openflow:2,Table:0*
    Append To List    ${tsdr_af}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:3*DC=FLOWTABLESTATS*MN=ActiveFlows*RK=Node:openflow:3,Table:0*
    Append To List    ${tsdr_af}    ${ret_val1}


    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:1*DC=FLOWTABLESTATS*MN=PacketMatch*RK=Node:openflow:1,Table:0*
    Append To List    ${tsdr_pm}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:2*DC=FLOWTABLESTATS*MN=PacketMatch*RK=Node:openflow:2,Table:0*
    Append To List    ${tsdr_pm}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client     *NID=openflow:3*DC=FLOWTABLESTATS*MN=PacketMatch*RK=Node:openflow:3,Table:0*
    Append To List    ${tsdr_pm}    ${ret_val1}

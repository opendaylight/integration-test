...
Storing Statistics from Openflow REST
    ...
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:1/node-connector/openflow:1:1    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:1/node-connector/openflow:1:2    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:1/node-connector/openflow:1:LOCAL    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/node-connector/openflow:2:1    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/node-connector/openflow:2:2    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/node-connector/openflow:2:3    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:2/node-connector/openflow:2:LOCAL    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:3/node-connector/openflow:3:1    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:3/node-connector/openflow:3:2    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    \    ${ret_val}=    Get Stats XML    ${OPERATIONAL_NODES_API}/openflow:3/node-connector/openflow:3:LOCAL    ${item}
    \    Append To List    ${xml_list}    ${ret_val}
    \    ${ret_val}=    Set Variable    -1
    Log List    ${xml_list}

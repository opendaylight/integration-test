...
Verification of FlowStats-Attributes on Cassandra Data Store
    ...
    Copy TSDR tables
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmissionErrors*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:0*
    Append To List    ${tsdr_q0}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmittedPackets*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:0*
    Append To List    ${tsdr_q0}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmittedBytes*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:0*
    Append To List    ${tsdr_q0}    ${ret_val1}



    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmissionErrors*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:1*
    Append To List    ${tsdr_q1}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmittedPackets*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:1*
    Append To List    ${tsdr_q1}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmittedBytes*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:1*




    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmissionErrors*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:2*
    Append To List    ${tsdr_q2}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmittedPackets*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:2*
    Append To List    ${tsdr_q2}    ${ret_val1}
    ${ret_val1}=    Verify the Metrics Attributes on Cassandra Client    *NID=openflow:2*DC=QUEUESTATS*MN=TransmittedBytes*RK=Node:openflow:2,NodeConnector:openflow:2:2,Queue:2*
    Append To List    ${tsdr_q2}    ${ret_val1}

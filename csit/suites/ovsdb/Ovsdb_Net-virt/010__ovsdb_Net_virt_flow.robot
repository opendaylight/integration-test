...
Ensure controller is running
    ...
    Wait Until Keyword Succeeds    300s    2s    Check Item Occurrence At URI In Cluster    ${controller_index_list}    ${node_list}    ${OPERATIONAL_TOPO_API}
...
Check netvirt is loaded
    ...
    Wait Until Keyword Succeeds    300s    4s    Check Item Occurrence At URI In Cluster    ${controller_index_list}    ${netvirt}    ${OPERATIONAL_NODES_NETVIRT}

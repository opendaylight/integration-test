...
Ensure controller is running
    ...
    Wait Until Keyword Succeeds    300s    4s    Check Item Occurrence At URI In Cluster    ${original_cluster_list}    ${node_list}    ${OPERATIONAL_TOPO_API}    {HEADERS}
...
Ensure netvirt is loaded
    ...
    Wait Until Keyword Succeeds    300s    4s    Check Item Occurrence At URI In Cluster       ${original_cluster_list}    ${netvirt}    ${OPERATIONAL_NODES_NETVIRT}    {HEADERS}

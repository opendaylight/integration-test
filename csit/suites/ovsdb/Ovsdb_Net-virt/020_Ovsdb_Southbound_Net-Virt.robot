...
Check Shards Status Before Fail
    ...
    Log    Check Ovsdb Shards Status    ${original_cluster_list}
...
Ensure controller is running
    ...
    Logs    Wait Until Keyword Succeeds    300s    2s    Check For Elements At URI    ${OPERATIONAL_TOPO_API}    ${node_list}
...
Ensure netvirt is loaded
    ...
    Logs    Wait Until Keyword Succeeds    300s    4s    Check For Elements At URI    ${OPERATIONAL_NODES_NETVIRT}    ${netvirt}

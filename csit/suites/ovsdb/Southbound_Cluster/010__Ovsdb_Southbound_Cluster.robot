...
Create Bridge Manually In Owner and Verify Before Fail
    [Documentation]    Create Bridge Manually in Owner and verify it gets applied from all instances.
    Create Manual Bridge And Verify    ${original_cluster_list}    ${original_owner}

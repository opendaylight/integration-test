...
Get Operational Topology to verify the bridge has been added
    ...
    ${dictionary_operational}   Create List    ${BRIDGE1}
    Wait Until Keyword Succeeds    5s    1s    Check Item Occurrence At URI In Cluster    ${original_cluster_list}    ${dictionary_operational}    ${OPERATIONAL_TOPO_API}

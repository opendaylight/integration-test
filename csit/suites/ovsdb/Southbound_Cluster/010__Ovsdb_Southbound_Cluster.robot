...
Start Mininet Multiple Connections
    ...
    Log    ${controller_list}
    ${controller_1}=    Get from List    ${output_list}    0
    Log    ${controller_1}
    ${controller_2}=    Get from List    ${output_list}    1
    Log    ${controller_2}
    ${controller_3}=    Get from List    ${output_list}    2
    Log    ${controller_3}
...
Create a Bridge In Config DataStore
    ...
    Log    ${sample1}
    ${sample1}    Replace String    ${sample1}    tcp:controller2:6633    tcp:${controller_2}:6653
    Log    ${sample1}
    ${sample1}    Replace String    ${sample1}    tcp:controller3:6633    tcp:${controller_3}:6653
    Log    ${sample1}

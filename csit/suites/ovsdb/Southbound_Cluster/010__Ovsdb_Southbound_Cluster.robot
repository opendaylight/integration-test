...
To check the Two nodes up and one node down Instance
    [Documentation]    TO virify the two nodes up and remain the down instances.
    Remove Values From List    ${new_cluster_list}    ${original_owner}
    Kill Multiple Controllers    ${new_cluster_list}
    ${new_cluster_list}    Create Controller Index List
    Take Ovsdb Device Link Up and Verify     ${new_cluster_list}
...
To  check the Two nodes up and  Restart the owner node Instance
    [Documentation]   Create Bridge and two nodes up and ower  the instances
    Remove Values From List    ${new_cluster_list}    ${original_owner}
    Kill Multiple Controllers    ${new_cluster_list}
    ${new_cluster_list}    Create Controller Index List
    Take Ovsdb Device Link Up and Verify     ${original_owner}

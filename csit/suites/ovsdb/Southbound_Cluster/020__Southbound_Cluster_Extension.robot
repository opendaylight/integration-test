...
Check Entity Owner Status And Find Owner and Candidate After Fail
    ...
    Run Keyword And Continue On Failure    List Should Not Contain Value    ${new_candidates_list}    ${original_candidate}    Original owner ${original_candidate} still in candidate list.

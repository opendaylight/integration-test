...
Start OVS Multiple Connections
    ...
    ${ovsdb_uuid}    Ovsdb.Add Multiple Managers to OVS    ${TOOLS_SYSTEM_IP}    ${ClusterManagement__member_index_list}
...
Kill Candidate Instance
    ...
    ClusterManagement.Kill Single Member    ${original_candidate}
    ${new_cluster_list} =    BuiltIn.Create_List    @{ClusterManagement__member_index_list}
    Collections.Remove Values From List    ${new_cluster_list}    ${original_candidate}

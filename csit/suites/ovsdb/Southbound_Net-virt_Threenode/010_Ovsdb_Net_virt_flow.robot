...
${EXT_NET1_ID}    7da709ff-397f-4778-a0e8-994811272fds
...
Check netvirt is loaded
    ...
    Wait Until Keyword Succeeds    300s    4s    Check Item Occurrence At URI In Cluster    ${original_cluster_list}    ${netvirt}    ${OPERATIONAL_TOPO_API}

...
Run Tempest Tests In Groups J1 1
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 2
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 3
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 4
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 5
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 6
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 7
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 8
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 9
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 10
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 11
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    ...
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
Run Tempest Tests In Groups J1 12
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON

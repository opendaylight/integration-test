...
#NOTE: saw abort when running F,G,H1,I1 and J before "J1 1"
#NOTE: but it passed when running just F,G, and H1 before "J1 1"
#NOTE: and it passed when running just I1 and J before "J1 1"
#NOTE: FAILED with HI, I1, J before "J1 1"
#NOTE: FAILED with I1, J before "J1 1"
#NOTE: PASSED with just J before "J1 1"
#NOTE: FAILED with just I1 before "J1 1"
#NOTE: PASSED with just I1.1 before "J1 1"
#NOTE: PASSED with just I1.2 before "J1 1"
#NOTE: PASSED with both I1.1 and I1.2 before "J1 1"
#NOTE: PASSED with I1, J before "J1 1"
#NOTE: FAILED with  F,G,H1,I1 and J before "J1 1"

Run Tempest Tests In Groups J1 1
    : FOR    ${i}    IN    RANGE    1    100
    \    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_list_ports_fields
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_list_ports
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_create_update_port_with_second_ip
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_create_update_delete_port
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_create_show_delete_port_user_defined_mac
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_create_port_with_no_securitygroups
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_create_port_in_allowed_allocation_pools
    Run Tempest Tests    tempest.api.network.test_ports.PortsTestJSON.test_create_bulk_port
...
Run Tempest Tests In Groups I1.1
...
Run Tempest Tests
    ...
    Write Commands Until Prompt    sudo -E testr run ${tempest_regex} --subunit | subunit-trace --no-failure-debug -f    timeout=600s
    Write Commands Until Prompt    sudo df -h
    Write Commands Until Prompt    sudo free -m
    Write Commands Until Prompt    top -c 1
    Write Commands Until Prompt    sudo tail -n100 /var/log/messages

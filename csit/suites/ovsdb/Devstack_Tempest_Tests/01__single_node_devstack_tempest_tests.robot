...
Test novalist
    ${output}=   Write Commands Until Prompt     nova -v list
    Log    ${output}

Test imagelist
    ${output}=   Write Commands Until Prompt     nova -v  image-list
    Log    ${output}

Test instance using flavor and image names
    ${output}=   Write Commands Until Prompt     nova -v boot --image cirros-0.3.1-x86_64-uec --flavor m1.tiny MyFirstInstance
    Log    ${output}

Test Show details of instance
    ${output}=   Write Commands Until Prompt     nova -v show MyFirstInstance
    Log    ${output}

Test Crete the Router

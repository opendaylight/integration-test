...
Put GBP Goodness In To The Mix
    Install a Feature    ${DEVSTACK_SYSTEM_IP}    odl-groupbasedpolicy-base
    Install a Feature    ${DEVSTACK_SYSTEM_IP}    odl-groupbasedpolicy-neutronmapper
...
Show Devstack Debugs
    ...
    Write Commands Until Prompt    grep grep 'distribution-karaf.*zip' /opt/stack/logs/devstacklog.txt
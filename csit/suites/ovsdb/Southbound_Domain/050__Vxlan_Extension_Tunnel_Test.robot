...
Create Vxlan Port and attach to s1 Bridge
    ...
    Add Vxlan To Bridge    ${TOOLS_SYSTEM_IP}    s2    vxlanport    ${TOOLS_SYSTEM_2_IP}    create_port_key.json
...
Create Vxlan Port and attach to s2 Bridge
    ...
    Add Vxlan To Bridge    ${TOOLS_SYSTEM_2_IP}    s1    vxlanport    ${TOOLS_SYSTEM_IP}    create_port_key.json

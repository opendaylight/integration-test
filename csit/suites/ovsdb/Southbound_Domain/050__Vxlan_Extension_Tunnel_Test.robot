...
Create Vxlan Port and attach to s1 Bridge
    ...
    Add Vxlan To Bridge    ${ODL_TOOLS_SYSTEM_IP}    s2    vxlanport    ${ODL_TOOLS_SYSTEM_1_IP}    create_port_key.json
...
Create Vxlan Port and attach to s2 Bridge
    ...
    Add Vxlan To Bridge    ${ODL_TOOLS_SYSTEM_1_IP}    s1    vxlanport    ${ODL_TOOLS_SYSTEM_IP}    create_port_key.json

...
Create a Bridge through controller
    ...
    OVSDB.Add Bridge To Ovsdb Node    uuid%2F${OVSDB_UUID}    ${TOOLS_SYSTEM_IP}    ${BRIDGE2}    0000000000000002
...
Create bridge of already added bridge
    ...
    OVSDB.Add Bridge To Ovsdb Node With NodeId    uuid%2F${OVSDB_UUID}    ${TOOLS_SYSTEM_IP}    ${BRIDGE1}    0000000000000001

...
Create a Bridge through controller
    ...
    # ${body}    Replace String    ${body}     ovsdb://127.0.0.1:61644/bridge/br01    ovsdb://uuid/${ovsdb_uuid}/bridge/${BRIDGE2}
...
# TODO: fix this test case.  using wrong string replacement, I think, which breaks the test case after this.

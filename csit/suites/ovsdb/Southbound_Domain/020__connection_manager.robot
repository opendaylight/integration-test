...
Verify OVS Not In Config Topology
    ...
    Utils.Check For Elements Not At URI And Print    ${CONFIG_TOPO_API}    ${NODE_LIST}
...
Create a Bridge through controller
    ...
    ${node_id} =    BuiltIn.Set Variable    uuid/${OVSDB_UUID}
    OVSDB.Add Bridge To Ovsdb Node With NodeId   ${TOOLS_SYSTEM_IP}    ${BRIDGE2}    0000000000000002
...
Suite Teardown
    ...
    @{uris} =    Builtin.Create List    ${CONFIG_TOPO_API}/topology/ovsdb:1/node/ovsdb:%2F%2Fuuid%2F${OVSDB_UUID}%2Fbridge%2F${BRIDGE1}
    Collections.Append To List    ${uris}    ${CONFIG_TOPO_API}/topology/ovsdb:1/node/ovsdb:%2F%2Fuuid%2F${OVSDB_UUID}%2Fbridge%2F${BRIDGE2}

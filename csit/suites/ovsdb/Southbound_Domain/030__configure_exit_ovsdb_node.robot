...
Create Port of already added port in OVSDB
    ...
    OVSDB.Add Termination Point    ${TOOLS_SYSTEM_IP}:${OVSDB_NODE_PORT}    ${BRIDGE}    vx1    10.0.0.10
...
Modify the destination IP of Port
    ...
    OVSDB.Add Termination Point    ${TOOLS_SYSTEM_IP}:${OVSDB_NODE_PORT}    ${BRIDGE}    vx1    10.0.0.19

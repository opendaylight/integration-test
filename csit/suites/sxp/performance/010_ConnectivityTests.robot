...
Connectivity Test
    [Documentation]    TODO
    @{ITEMS}    Create List
    Check Connectivity    ${PEERS_TO_TEST}    40

Connectivity TCP-MD5 Test
    [Documentation]    TODO
    Check Connectivity    ${PEERS_TO_TEST_MD5}    20    passwd
...
Check Connectivity
    [Arguments]    ${peers}    ${min_speed}    ${PASSWORD}=${EMPTY}    ${version}=version4
    [Documentation]    TODO
    @{ITEMS}    Create List
    Log To Console    \n\tConnectivity statistics.
    : FOR    ${num}    IN RANGE    0    5
    \    Setup Topology    ${peers + 10}    ${PASSWORD}    ${version}
    \    ConnectionTestLibrary.Initiate Connecting    ${peers}

...
Access List Filtering
    ...
    Wait Until Keyword Succeeds  4   3  Check One Group 4-5
    ...
    Add Filter    GROUP    outbound    ${entries}
    Wait Until Keyword Succeeds  4   3  Check Two Group 4-5
...
Access List Sgt Filtering
    ...
    ${entries}    Combine Strings    ${entry1}    ${entry2}    ${entry3}
    Add Filter    GROUP    outbound    ${entries}
    Wait Until Keyword Succeeds  4   3  Check One Group 2-5
    Delete Filter    GROUP    outbound
    ${entries}    Get Filter Entry    10    permit    esgt=20,40    acl=10.10.0.0,0.0.255.255
    Add Filter    GROUP    outbound    ${entries}
    Wait Until Keyword Succeeds  4   3  Check Two Group 2-5

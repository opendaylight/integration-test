...
Setup Topology Triangel
    ...
    Add Binding    542    5.5.5.5/32    127.0.0.2
    Wait Until Keyword Succeeds    15    1    Verify Binding    542    5.5.5.5/32    127.0.0.2
    Add Binding    543    5.5.5.5/32    127.0.0.3
    Wait Until Keyword Succeeds    15    1    Verify Binding    543    5.5.5.5/32    127.0.0.3
    Add Binding    99    15.15.15.15/32    127.0.0.3
    Wait Until Keyword Succeeds    15    1    Verify Binding    99    15.15.15.15/32    127.0.0.3
...
Verify Binding
    [Arguments]    ${sgt}   ${prefix}    ${node}=127.0.0.1
    [Documentation]    Setup 3 nodes connected to each other

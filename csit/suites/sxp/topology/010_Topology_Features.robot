...
Shorthest Path Test
    ...
    Wait Until Keyword Succeeds    15    4    Verify Connection    version4    listener    127.0.0.5
    ...    64999    127.0.0.3
    Setup Topology Fork    version4
    Add Binding    542    5.5.5.5/32    127.0.0.2
...
Setup Topology Linear
    ...
    Wait Until Keyword Succeeds    15    4    Verify Connection    ${r_version}    speaker    127.0.0.3

...
Export Separation Node 7 Test
    ...
    [Tags]    SXP    Domains
    Wait Until Keyword Succeeds    15    1    Check Binding Range    20    2000    2300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    30    3000    3300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    40    4000    4300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    50    5000    5300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    60    6000    6300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    110    11000    11300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    120    12000    12300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    130    13000    13300
    ...    127.0.0.7
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    140    14000    14300
    ...    127.0.0.7
...
Export Separation Node 8-9 Test
    ...
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    20    2000
    \    ...    2300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range    30    3000
    \    ...    3300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range    40    4000
    \    ...    3300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    50    5000
    \    ...    5300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    60    6000
    \    ...    6300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    110    11000
    \    ...    11300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    120    12000
    \    ...    12300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    130    13000
    \    ...    13300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    140    14000
    \    ...    14300    127.0.0.${node}

Export Separation Node 10 Test
    [Documentation]    Test if Node 10 contains only bindings from trusted domain
    [Tags]    SXP    Domains
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    20    2000    2300
    ...    127.0.0.10
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    30    3000    3300
    ...    127.0.0.10
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    40    4000    4300
    ...    127.0.0.10
    Wait Until Keyword Succeeds    15    1    Check Binding Range    50    5000    5300
    ...    127.0.0.10
    Wait Until Keyword Succeeds    15    1    Check Binding Range    60    6000    6300
    ...    127.0.0.10
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    110    11000    11300
    ...    127.0.0.10
    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    120    12000    12300
...
Export Separation Node 11-14 Test
    ...
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    20    2000
    \    ...    2300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    30    3000
    \    ...    3300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    40    4000
    \    ...    4300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    50    5000
    \    ...    5300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range Negative    60    6000
    \    ...    6300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range    110    11000
    \    ...    11300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range    120    12000
    \    ...    12300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range    130    13000
    \    ...    13300    127.0.0.${node}
    \    Wait Until Keyword Succeeds    15    1    Check Binding Range    140    14000
    \    ...    14300    127.0.0.${node}

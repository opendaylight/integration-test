...
Setup Custom SXP Cluster Session
    ...
    Execute Controller Karaf Command On Background    log:set DEBUG org.opendaylight.sxp.route    ${1}
    Execute Controller Karaf Command On Background    log:set DEBUG org.opendaylight.sxp.route    ${2}
    Execute Controller Karaf Command On Background    log:set DEBUG org.opendaylight.sxp.route    ${3}
    ${controller_index}    Get Active Controller

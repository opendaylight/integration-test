...
${VIRTUAL_IP_1}    192.168.50.20
${VIRTUAL_INTERFACE_1}    eth1:0
${VIRTUAL_IP_MASK_1}    255.255.255.0
${VIRTUAL_IP_2}    192.168.50.30
${VIRTUAL_INTERFACE_2}    eth1:1
...
Isolation of SXP service follower Test
    ...
    Put Route Definition To Cluster    ${VIRTUAL_IP_1}    ${VIRTUAL_IP_MASK_1}    ${VIRTUAL_INTERFACE_1}    ${any_controller}

...
Test Nodes
    ...
    \    ...    ${PASSWORD}
    \    BuiltIn.Wait Until Keyword Succeeds    15    1    Verify Connection    ${cmp_version}    listener
    \    ...    127.0.0.2    64999    127.0.0.1
    \    BuiltIn.Wait Until Keyword Succeeds    15    1    Verify Connection    ${cmp_version}    speaker
...
Test Both
    ...
    BuiltIn.Wait Until Keyword Succeeds    15    1    Verify Connection    ${cmp_version}    both    127.0.0.3
    ...    64999    127.0.0.1
    BuiltIn.Wait Until Keyword Succeeds    15    1    Verify Connection    ${cmp_version}    both    127.0.0.1
    ...    64999    127.0.0.3

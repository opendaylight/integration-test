...
Setup SXP Environment Local
    ...
    Setup SXP Session
    Run Command On Remote System    ${ODL_SYSTEM_IP}    mkdir -p ${ssl_stores}
    ${rc}    Run And Return Rc    scp ${CURDIR}/../keystores/csit-keystore-* ${ODL_SYSTEM_IP}:${ssl_stores}
    Should Be Equal As Integers    ${rc}    0
    ${rc}    Run And Return Rc    scp ${CURDIR}/../keystores/csit-truststore-* ${ODL_SYSTEM_IP}:${ssl_stores}
    Should Be Equal As Integers    ${rc}    0

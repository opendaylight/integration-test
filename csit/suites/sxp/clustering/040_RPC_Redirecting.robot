...
Test Add/Delete Domain Filter
    ...
    SxpLib.Add Domain Filter    global    ${domains}    ${entries}    node=${CLUSTER_NODE_ID}    session=ClusterManagement__session_1
    SxpLib.Delete Domain Filter    global    node=${CLUSTER_NODE_ID}    session=ClusterManagement__session_2
    [Teardown]    SxpLib.Delete Node    ${CLUSTER_NODE_ID}    session=${CONTROLLER_SESSION}

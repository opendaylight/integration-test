...
Test Add/Delete Node
    ...
    BuiltIn.Wait Until Keyword Succeeds    2x    1m    SxpClusterLib.Check Cluster Node started    ${INADDR_ANY}    ip=${EMPTY}
    SxpLib.Delete Node    ${INADDR_ANY}    session=ClusterManagement__session_2
    BuiltIn.Wait Until Keyword Succeeds    2x    1m    SxpClusterLib.Check Cluster Node stopped    ${INADDR_ANY}    ip=${EMPTY}

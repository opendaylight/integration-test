...
Isolate SXP Controller
    ...
    Wait Until Keyword Succeeds    120    1    Check Device is Connected    ${DEVICE_NODE_ID}    session=${DEVICE_SESSION}
    # robot -v ODL_STREAM:boron -v TOOLS_SYSTEM_IP:192.168.50.14 -v ODL_SYSTEM_1_IP:192.168.50.11 -v ODL_SYSTEM_2_IP:192.168.50.12 -v ODL_SYSTEM_3_IP:192.168.50.13 -v NUM_ODL_SYSTEM:3 -v ODL_SYSTEM_USER:vagrant -v ODL_SYSTEM_PASSWORD:vagrant -v USER_HOME:/home/vagrant ./010_Connection_switchover.robot

...
TC11 Verify end to end data path within same network and from one network to the other
    ...
    #\    ${output}    vpn.Remotevmexec    ${MININET}    ${MININET_USER}    ${MININET_PASSWORD}    ${PING_NS2}
    \    ${output}    Send Command And Get Output    ${mininet1_conn_id_1}    ${PING_NS2}
    \    Log To Console    ${output}
    \    Log    ${output}
    #\    ${output}    vpn.Remotevmexec    ${MININET}    ${MININET_USER}    ${MININET_PASSWORD}    ${PING_NS3}
    \    ${output}    Send Command And Get Output    ${mininet1_conn_id_1}    ${PING_NS3}
    \    Log To Console    ${output}
    \    Log    ${output}
    #\    ${output}    vpn.Remotevmexec    ${MININET}    ${MININET_USER}    ${MININET_PASSWORD}    ${PING_NS4}

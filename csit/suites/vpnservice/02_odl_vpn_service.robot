...
TC11 Verify end to end data path within same network and from one network to the other
    ...
    \    ${output}    Run Command On Remote System    ${MININET}    ${PING_NS2}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    \    Log    ${output}
    \    ${output}    Run Command On Remote System    ${MININET}    ${PING_NS3}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    \    Log    ${output}
    \    ${output}    Run Command On Remote System    ${MININET}    ${PING_NS4}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    \    Log    ${output}
    ...
    ${output}    Run Command On Remote System    ${MININET}    ${FLOWS_DPN1}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    Log    ${output}
    ${output}    Run Command On Remote System    ${MININET1}    ${FLOWS_DPN2}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    Log    ${output}

    ${output}    Run Command On Remote System    ${MININET}    ${OVS-SHOW}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    Log    ${output}
    ${output}    Run Command On Remote System    ${MININET1}    ${OVS-SHOW}    ${user}=${DEFAULT_USER}    ${password}=${EMPTY}    ${prompt}=${DEFAULT_LINUX_PROMPT}    ${prompt_timeout}=${DEFAULT_TIMEOUT}
    Log    ${output}

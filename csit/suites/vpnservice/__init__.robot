...
Start Suite
    ...
    ${mininet1_conn_id_1}=    Open Connection    ${TOOLS_SYSTEM_1_IP}    prompt=${DEFAULT_LINUX_PROMPT}    timeout=30s
    ...
    Write    ${start1}
    Read Until    mininet>
    ${mininet1_conn_id_2}=    Open Connection    ${TOOLS_SYSTEM_1_IP}    prompt=${DEFAULT_LINUX_PROMPT}    timeout= 30s

...
Start Suite
    ...
    ${ns_script_stop_vm1}=    Catenate    SEPARATOR=    ${NS_SCRIPT_PATH}    ${STOP_NS_SCRIPT}
...
Stop Suite
    ...
    Write    exit
    Log    StopNameSpace
    ${resp}    Open Connection And Log In Server And Run Script    ${MININET}    ${MININET_USER}    ${MININET_PASSWORD}    ${ns_script_stop_vm1}

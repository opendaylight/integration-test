...
Start Suite
    ...
    Login With Public Key    ${DEFAULT_USER}    ${USER_HOME}/.ssh/${SSH_KEY}    any
    ...
    ${tool_system2_conn_id_1}=    Open Connection    ${TOOLS_SYSTEM_1_IP}    prompt=${DEFAULT_LINUX_PROMPT}    timeout=30s
    Set Global Variable    ${tool_system2_conn_id_1}
    Login With Public Key    ${DEFAULT_USER}    ${USER_HOME}/.ssh/${SSH_KEY}    any
    Clean OVSDB Test Environment    ${tools_system}=${TOOLS_SYSTEM_IP}

...
Single_Config_Change_Replication
    ...
    Verify_Feature_Is_Installed     odl-netconf-clustered-topology    controller=${ip_address}
    Verify_Bundle_Is_Installed    odl-netconf-clustered-topology    controller=${ip_address}
    Install_A_Feature    odl-netconf-clustered-topology    controller=${ip_address}

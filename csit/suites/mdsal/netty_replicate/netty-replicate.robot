...
Replicate_Config_Addition
    ...
    Run_Bash_Command_On_Member    command=find -name 'people' -printf "\n**********************************\n%h\n*****************************************\n" -exec ls {} \;
    &{mapping} =    BuiltIn.Create_Dictionary    i=5
    Put_Config_And_Verify    folder=${CARPEOPLE_DEV_FOLDER}/people    mapping=${mapping}
...
Change_Replication_Source
    ...
    NettyReplication.Setup_Netty_Replication
    &{mapping_older} =    BuiltIn.Create_Dictionary    DEVICE_NAME=new-netconf-device-4    DEVICE_IP=${DEVICE_IP}    DEVICE_PORT=${DEVICE_PORT}    DEVICE_USER=${DEVICE_USER}    DEVICE_PASSWORD=${DEVICE_PASSWORD}
    ...
    &{mapping_newer} =    BuiltIn.Create_Dictionary    DEVICE_NAME=new-netconf-device-5    DEVICE_IP=${DEVICE_IP}    DEVICE_PORT=1212    DEVICE_USER=newer_source    DEVICE_PASSWORD=newer_source

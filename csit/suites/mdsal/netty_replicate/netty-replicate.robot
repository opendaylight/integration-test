...
Put_Config_And_Verify
    ...
    BuilIn.Run_Keyword_If    ${verify_on_source}    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Xml_Templated    ${template_folder}     mapping=${mapping}    verify=True    session=${source_odl_session_alias}
    BuilIn.Run_Keyword_If    ${verify_on_sink}    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Xml_Templated    ${template_folder}     mapping=${mapping}    verify=True    session=${sink_odl_session_alias}

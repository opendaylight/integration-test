...
Replicate_config_Update
    ...
    &{mapping} =    BuiltIn.Create_Dictionary
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    iterations=${5}
    &{mapping_updated} =    BuiltIn.Create_Dictionary
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    iterations=${6}
...
Replicate_Multiple_Changes_to_Config
    ...
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    iterations=${7}
    &{mapping_2_updated} =    BuiltIn.Create_Dictionary
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    iterations=${8}
    Delete_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people
...
Replicate_Multiple_Changes_to_Multiple_Sinks
    ...
    &{mapping_1} =    BuiltIn.Create_Dictionary
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    sink_node_indexes=@{MULTIPLE_SINK_NODES_INDEXES}    iterations=${5}
    &{mapping_2} =    BuiltIn.Create_Dictionary
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    sink_node_indexes=@{MULTIPLE_SINK_NODES_INDEXES}    iterations=${7}
    &{mapping_2_updated} =    BuiltIn.Create_Dictionary
    Put_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people    sink_node_indexes=@{MULTIPLE_SINK_NODES_INDEXES}    iterations=${8}
    Delete_Config_And_Verify    ${CARPEOPLE_DEV_FOLDER}/people
...
Verify_Config_Is_Present
    [Arguments]    ${template_folder}    ${session}    ${mapping}={}    ${iterations}=${1}

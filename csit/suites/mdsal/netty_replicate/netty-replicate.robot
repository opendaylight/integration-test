...
Restart_Cluster_Members_And_Clear_Data
    ...
    ClusterManagementRun_Karaf_Command_On_Member     feature:list    member_index=1
    ClusterManagementRun_Karaf_Command_On_Member     feature:install odl-clustering-test-app    member_index=1

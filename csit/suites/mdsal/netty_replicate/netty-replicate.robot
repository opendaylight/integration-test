...
Change_Replication_Source
    ...
    &{mapping_newer} =    BuiltIn.Create_Dictionary    DEVICE_NAME=new-netconf-device-4    DEVICE_IP=${DEVICE_IP}    DEVICE_PORT=1212    DEVICE_USER="Newer"    DEVICE_PASSWORD="Newer"
    Put_Config_And_Verify    ${NETCONF_DEV_FOLDER}    ${mapping_newer}
    Verify_Config_Is_Not_Present    ${NETCONF_DEV_FOLDER}    ${mapping_newer}    ${sink_odl_session_alias}

...
Resource          ${CURDIR}/../../../libraries/XmlComparator.py
...
Single_Config_Change_Replication
    ...
    TemplatedRequests.Put_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    session=${source_odl_session_alias}
    ${result} =    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    verify=True    session=${source_odl_session_alias}
    ${result} =    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    verify=True    session=${sink_odl_session_alias}
...
Sink_Catch_Up_After_Opening_Connection
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    verify=True    session=${source_odl_session_alias}
    Open_Sink_Connection
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    verify=True    session=${sink_odl_session_alias}
...
Reconnect_After_Lost_Connection
    ...
    Setup_Netty_Replication
    ClusterManagement.Isolate_Member_From_List_Or_All    ${DEFAULT_SOURCE_INDEX}
    ...
    TemplatedRequests.Put_As_Xml_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    session=${source_odl_session_alias}
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    verify=True    session=${source_odl_session_alias}
    ClusterManagement.Rejoin_Member_From_List_Or_All    ${DEFAULT_SOURCE_INDEX}
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Json_Templated    ${NETCONF_DEV_FOLDER}    mapping=${mapping}    verify=True    session=${sink_odl_session_alias}

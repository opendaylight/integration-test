...
Single_Config_Change_Replication
    ...
    &{mapping} =    BuiltIn.Create_Dictionary    DEVICE_NAME=new-netconf-device-1    DEVICE_IP=${DEVICE_IP}    DEVICE_PORT=${DEVICE_PORT}    DEVICE_USER="neadmin"    DEVICE_PASSWORD=${DEVICE_PASSWORD}

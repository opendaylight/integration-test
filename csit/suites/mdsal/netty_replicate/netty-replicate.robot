...
Replicate_config_Update
    ...
    Put_Config_And_Verify    ${NETCONF_DEV_FOLDER}    mapping=${mapping}
    &{mapping_updated} =    BuiltIn.Create_Dictionary    DEVICE_NAME=new-netconf-device-1    DEVICE_IP=${DEVICE_IP}    DEVICE_PORT=${1212}    DEVICE_USER=newer    DEVICE_PASSWORD=random
...
Change_Replication_Source_EXTRA
    ...
    Verify_Config_Is_Not_Present    ${NETCONF_DEV_FOLDER}    ${mapping_older}    @{DEFAULT_NETTY_SINK_NODE_INDEXES}[0]    removal=True

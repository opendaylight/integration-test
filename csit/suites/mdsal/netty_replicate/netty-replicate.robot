...
Restart_Cluster_Members_And_Clear_Data
    ...
    BuiltIn.Run_Keyword_And_Continue_On_Failure    ClusterManagement.Run_Karaf_Command_On_Member     features-controller odl-mdsal-exp-replicate-netty odl-restconf-nb-bierman02 odl-netconf-clustered-topology    member_index=${1}

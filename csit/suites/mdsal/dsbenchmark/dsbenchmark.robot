...
Start Measurement
    ...
    Check_If_Benchmark_Tool_Is_Running
...
Wait_Until_Benchmark_Tool_Finish
    ...
    Wait Until Keyword Succeeds    ${timeout}    1s    Benchmark_Tool_Is_Not_Running
...
Store_File
    [Arguments]    ${file_name}
    [Documentation]    Store the provided file content from the MININET machne to the same file on the ROBOT machine.

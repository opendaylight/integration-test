...
${JAVA_OPTIONS}    -Xmx2g -XX:MaxPermSize=512m    # Note that '-Xmx=2g' is wrong syntax.
...
Install_Maven
    ...
    BuiltIn.Set_Suite_Variable    \${maven_bash_command}    export JAVA_HOME='${java_home}' && export MAVEN_OPTS='${JAVA_OPTIONS}' && ./${maven_directory}/bin/mvn

...
Install_Maven
    ...
    ${maven_dwnload_url} =    BuiltIn.Set_Variable    http://www-us.apache.org/dist/maven/maven-3/${MAVEN_VERSION}/binaries/${maven_archive_filename}
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    wget -N '${maven_download_url}'
...
Prepare_Yang_Files_To_Test
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    git checkout -b ytest f4b09f38ac4b794e4e9b2e8646f326eccf556fe5
...
Run_Maven
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    ${maven_bash_command} clean install dependency:tree -V -B -DoutputFile=dependency_tree.log -f '${POM_FILENAME}' ${MAVEN_OPTIONS} > tee '${MAVEN_OUTPUT_FILENAME}'

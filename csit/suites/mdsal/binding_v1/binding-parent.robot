...
Install_Maven
    ...
    BuiltIn.Pass_Execution_If    """${PATCHES_TO_BUILD}""" == ""    No post-install build requested.
    BuiltInRun_Keyword_If    """${BRANCH}""" == ""    BuiltIn.Fail    BRANCH needs to be specified for multipatch builds.
    ...
    SSHKeywords.Execute_Command_At_Cwd_Should_Pass    export WORKSPACE='${WORKSPACE}' && export BRANCH='${BRANCH}' && export PATCHES_TO_BUILD='${PATCHES_TO_BUILD}' && bash '${script_name}'

...
Check the simple IRD information
    ...
    Wait Until Keyword Succeeds    10s    1s    Check GET Response Code Equals 20x    /${ALTO_SIMPLE_IRD_INFO}
    ...
    Wait Until Keyword Succeeds    10s    1s    Check GET Response Code Equals 20x    /${RESOURCE_POOL_BASE}/${context_id}

Create two IRDs
    [Documentation]    Create two IRDs and verify their existence
    Create An IRD    ${DEFAULT_CONTEXT_ID}    ${THE_FIRST_IRD_RESOURCE_ID}
    Wait Until Keyword Succeeds    5s    1s    Check GET Response Code Equals 20x    /${ALTO_OPERATIONAL_IRD_INSTANCE}/${THE_FIRST_IRD_RESOURCE_ID}
    Create An IRD    ${DEFAULT_CONTEXT_ID}    ${THE_SECOND_IRD_RESOURCE_ID}
    Wait Until Keyword Succeeds    5s    1s    Check GET Response Code Equals 20x    /${ALTO_OPERATIONAL_IRD_INSTANCE}/${THE_SECOND_IRD_RESOURCE_ID}
...
*** Keywords ***
Check GET Response Code Equals 20x

...
#@{vpn_int_values}    tap79ad0001-19    vpn    10.1.1.2    00:16:3e:19:f7:8b    tap79ad0002-19    10.1.1.3    00:16:3e:bb:9b:0f
#...               tap79ad0003-19    20.1.1.2    00:16:3e:92:f5:f8    Vpn2    tap79ad0003-19    20.1.1.3    00:16:3e:19:57:58
...
TC01 Verify TUNNEL creation
    ...
    [Tags]    Post 
    Log    "Get the dpn ids"
    ${resp}    vpn.Create Tunnel   srcip=${MININET}    dstip=${MININET1}    ovs_pwd=${OVSPWD}
    Log To Console    ${resp}
    Should Be Equal    ${resp}    ${exp_result}

TC02 Create Neutron Network
    [Documentation]    Verify neutron network creation
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_NET1}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_NET2}
    Log To Console    ${resp}
    Log    ${resp}
...
TC03 Verify fetching available network
    ...
    ${networkid-1}    Get From Dictionary    ${networks}    ${NEUTRON_NETWORK1}
    ${networkid-2}    Get From Dictionary    ${networks}    ${NEUTRON_NETWORK2}
...
TC04 Create Neutron Subnet
    ...
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_SUBNET1}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_SUBNET2}
    Log To Console    ${resp}
    Log    ${resp}
...
TC05 Verify fetching available subnet
    ...
    Log    ${subnets}
    ${subnetid-1}    Get From Dictionary    ${subnets}    ${NEUTRON_SUBNET1}
...
TC06 Create Neutron Ports
    ...
    [Tags]    Post 
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_PORT11}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_PORT12}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_PORT21}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_PORT22}
    Log To Console    ${resp}
    Log    ${resp}
    Log    "BOOT_VMs"
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${EXPORT_IMAGE}
    Log To Console    ${resp}
    Log    ${resp}
    
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${BOOT_VM11}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${BOOT_VM12}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${BOOT_VM21}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${BOOT_VM22}
    Log To Console    ${resp}
    Log    ${resp}
...
TC07 Verify fetching available ports
    ...
    Log    ${ports}
    ${portid-1}    Get From Dictionary    ${ports}    ${NEUTRON_PORT1}
    ${portid-2}    Get From Dictionary    ${ports}    ${NEUTRON_PORT2}
    ${portid-3}    Get From Dictionary    ${ports}    ${NEUTRON_PORT3}
    ${portid-4}    Get From Dictionary    ${ports}    ${NEUTRON_PORT4}
...
TC08 Verify E2E ELAN connectivity across DPNs with VxLAN
    ...
    ${ping_output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX1}    ${PING_IP2}    ${EXP_STR}
    Log To Console    ${ping_output}
    Log    ${ping_output}
    Should Match Regexp    ${ping_output}    ${PING_REGEX}
    ${ping_output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX2}    ${PING_IP4}    ${EXP_STR}
    Log To Console    ${ping_output}
    Log    ${ping_output}
    Should Match Regexp    ${ping_output}    ${PING_REGEX}
...
#    \    Log To Console    ${ping_output}
#    \    Log    ${ping_output}
#    \    ${ping_output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX1}    ${PING_IP3}    ${EXP_STR}
#    \    Log To Console    ${ping_output}
#    \    Log    ${ping_output}
#    \    ${ping_output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX1}    ${PING_IP4}    ${EXP_STR}
#    \    Log To Console    ${ping_output}
#    \    Log    ${ping_output}


    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/neutronvpn:networkMaps/networkMap/${networkid-1}/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/neutronvpn:networkMaps/networkMap/${networkid-2}/    headers=${ACCEPT_XML}
    Log    ${resp.content}

    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/l3vpn:vpn-instances/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/odl-l3vpn:vpn-instance-to-vpn-id/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/ietf-interfaces:interfaces/    headers=${ACCEPT_XML}
    Log    ${resp.content}

    Log    "Verify VPN interfaces"
    Wait Until Keyword Succeeds    3s    1s    Check For Elements At URI    ${CONFIG_API}/l3vpn:vpn-interfaces/    ${vpn_int_values}
    Wait Until Keyword Succeeds    3s    1s    Check For Elements At URI    ${OPERATIONAL_API}/l3vpn:vpn-interfaces/    ${vpn_int_values}

    ${resp}    RequestsLibrary.Get    session    ${OPERATIONAL_API}/ietf-interfaces:interfaces-state/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/l3vpn:vpn-interfaces/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${OPERATIONAL_API}/l3vpn:vpn-interfaces/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${OPERATIONAL_API}/l3nexthop:l3nexthop/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${CONFIG_API}/odl-fib:fibEntries/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${OPERATIONAL_API}/odl-l3vpn:vpn-instance-op-data/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ${resp}    RequestsLibrary.Get    session    ${OPERATIONAL_API}/odl-l3vpn:prefix-to-interface/    headers=${ACCEPT_XML}
    Log    ${resp.content}
    ...
    Verify Flows Are Present    ${MININET}    ${swdumpflows}
    Verify Flows Are Present    ${MININET1}    ${swdumpflows}
...
TC14 Verify Deletion of vpn instance
    ...
    Sleep    180
    Wait Until Keyword Succeeds    12s    2s    Verify Flows Are Removed    ${MININET}    ${swdumpflows}
    Wait Until Keyword Succeeds    12s    2s    Verify Flows Are Removed    ${MININET1}    ${swdumpflows}
    #Verify Flows Are Removed    ${MININET}    ${swdumpflows}
    #Verify Flows Are Removed    ${MININET1}    ${swdumpflows}
...
TC15 Create Neutron Router
    ...
    ${exp_result}    ConvertToInteger    0
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_ROUTER1}
    Log To Console    ${resp}
    Log    ${resp}
...
TC16 Add Interface to the Router
    ...
    ${exp_result}    ConvertToInteger    0
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_ROUTER_IF1}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${CREATE_ROUTER_IF2}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
...
TC17 Delete Interface from Router
    ...
    ${exp_result}    ConvertToInteger    0
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_ROUTER_IF1}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_ROUTER_IF2}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
...
TC29 Add Multiple Extra Routes and check Data path before L3VPN Creation
    ...
    ${exp_result}    ConvertToInteger    0
   ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${ADD_EXTRA_ROUTES}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}

    Log    "Configure extra route ip on VM11 - extra route host-1"
    ${output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX1}    ${CONFIG_EXTRA_ROUTE_IP1}    ${EXP_STR_IFCONFIG}
    Log    ${output}

    Log    "Configure extra route ip on VM22 - extra route host-2"
    ${output}    vpn.Run Command Nova Vm    ${MININET1}    ${MININET_PASSWORD}    ${VM_INDX2}    ${CONFIG_EXTRA_ROUTE_IP2}    ${EXP_STR_IFCONFIG}
    Log    ${output}

    Log    "Verify datapath - extra route host-1"
    ${ping_output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX2}    ${PING_EXTRA_ROUTE_IP1}    ${EXP_STR}
    Log    ${ping_output}
    Should Match Regexp    ${ping_output}    ${PING_REGEX}
    ${ping_output}    vpn.Run Command Nova Vm    ${MININET1}    ${MININET_PASSWORD}    ${VM_INDX1}    ${PING_EXTRA_ROUTE_IP1}    ${EXP_STR}
    Log    ${ping_output}
    Should Match Regexp    ${ping_output}    ${PING_REGEX}

    Log    "Verify datapath - extra route host-2"
    ${ping_output}    vpn.Run Command Nova Vm    ${MININET}    ${MININET_PASSWORD}    ${VM_INDX2}    ${PING_EXTRA_ROUTE_IP2}    ${EXP_STR}
    Log    ${ping_output}
    Should Match Regexp    ${ping_output}    ${PING_REGEX}
    ${ping_output}    vpn.Run Command Nova Vm    ${MININET1}    ${MININET_PASSWORD}    ${VM_INDX1}    ${PING_EXTRA_ROUTE_IP2}    ${EXP_STR}
    Log    ${ping_output}
    Should Match Regexp    ${ping_output}    ${PING_REGEX}
...
TC30 Delete Extra Routes
    ...
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DEL_EXTRA_ROUTE}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
...
TC31 Delete and Recreate Extra Route and check Datapath
    ...
    ${exp_result}    ConvertToInteger    0
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${ADD_EXTRA_ROUTE1}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
...
TC21 Delete Neutron Router
    ...
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_ROUTER1}
    Log To Console    ${resp}
    Log    ${resp}
    Should Not Be Equal    ${resp}    ${exp_result}
...
TC23 Verify E2E Datapath after restart of OVS
    ...
    ${output}    vpn.Remotevmexec    ${MININET}    ${STOP_CMD}
    Log    ${output}
    ${output}    vpn.Remotevmexec    ${MININET1}    ${STOP_CMD}
    Log    ${output}
    Sleep    5
    ${output}    vpn.Remotevmexec    ${MININET}    ${START_CMD}
    Log    ${output}
    ${output}    vpn.Remotevmexec    ${MININET1}    ${START_CMD}
    Log    ${output}
    Sleep    90
    Log    "Checking the OVS state and Flows after restart"
    ${output}    vpn.Remotevmexec    ${MININET}    ${ovs-show}
    Log    ${output}
    ${output}    vpn.Remotevmexec    ${MININET1}    ${ovs-show}
    Log    ${output}
    ${output}    vpn.Remotevmexec    ${MININET}    ${swdumpflows}
    Log    ${output}
    ${output}    vpn.Remotevmexec    ${MININET1}    ${swdumpflows}
    Log    ${output}
...
TC36 Data path between multi vpn with Network Attached
    ...
    ${netid2}    vpn.Associate Network    ${NEUTRON_NETWORK1}   ${L3VPN}
    ${netid3}    vpn.Associate Network    ${NEUTRON_NETWORK2}   ${L3VPN}
    #${netid3}    vpn.Associate Network    ${NEUTRON_NETWORK2}   ${L3VPN2}
    Log To Console    "Check if vpn is updated after association of network"
    ${resp}    vpn.GetL3vpn    ${L3VPN}
    Log To Console    ${resp}
    ...
    Log To Console    ${netid2}
    ${netid3}    vpn.Dissociate Network    ${NEUTRON_NETWORK2}   ${L3VPN}
    #${netid3}    vpn.Dissociate Network    ${NEUTRON_NETWORK2}   ${L3VPN2}
    Log To Console    ${netid3}
    Log To Console    "Check if vpn is updated after association of network"
    ${resp}    vpn.GetL3vpn    ${L3VPN}
    Log To Console    ${resp}
...
TC24 Verify neutron Port Deletion
    ...
    [Tags]    Delete
    Log    "Delete Port"
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_VM11}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_VM21}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_VM12}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_VM22}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_PORT11}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_PORT21}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_PORT12}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_PORT22}
    Log To Console    ${resp}
    Log    ${resp}
...
#    ${exp_result}    ConvertToInteger    0
    ...
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_SUBNET1}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_SUBNET2}
    Log To Console    ${resp}
    Log    ${resp}
...
TC26 Verify neutron network Deletion
    ...
    [Tags]    Delete
    Log    "Delete Netowrk"
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_NET1}
    Log To Console    ${resp}
    Log    ${resp}
    ${resp}    Create_OpenStack_Entity    ${STK_SRVR}    ${STK_UNAME}    ${STK_PWD}    ${DELETE_NET2}
    Log To Console    ${resp}
    Log    ${resp}

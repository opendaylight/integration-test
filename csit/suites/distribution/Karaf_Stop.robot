...
...
...
...               Try to testdetect whether Karaf stops correctly when stop script is used.
...
...               This suite should runs as the last one, because it stops the karaf and does
...               not start again. And should thy to stop karaf when enough features are installed.

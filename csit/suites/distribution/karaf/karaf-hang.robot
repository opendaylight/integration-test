...
Resource          ${CURDIR}/../../../libraries/Setup.Utils.robot    #Suite Teardown    Teardown_Everything    #Library    RequestsLibrary    #Resource    ${CURDIR}/../../../libraries/KarafKeywords.robot
...               #Resource    ${CURDIR}/../../../libraries/Utils.robot    #Variables    ${CURDIR}/../../../variables/Variables.py

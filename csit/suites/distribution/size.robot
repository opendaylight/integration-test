...
Distribution_Size
    ...
    # Separate bash layer is needed for asterisk to be understood as glob pattern. TODO: Is there a nicer way?
    ${ls_output} =    SSHKeywords.Execute_Command_Should_Pass    command=bash -c 'ls -lAn ${WORKSPACE}/${BUNDLEFOLDER}*.zip'

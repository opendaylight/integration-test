...
Configure_Devices
    ...
    NetconfKeywords.Wait_Device_Connected    ${current_name}    timeout=15s    period=2s
...
Deconfigure_Devices
    ...
    NetconfKeywords.Remove_Devices_From_Netconf    ${current_name}    device_type=${device_type}

...
Configure_Devices_Onto_Netconf
    ...
    NetconfKeywords.Configure_Devices_In_Netconf    ${device_name_prefix}${dash}    device_type=${device_type}    device_port=${current_port}    iterations=500
...
Get_Data_From_Devices
    ...
    ${timeout}=    BuiltIn.Evaluate    ${DEVICE_COUNT}*${TIMEOUT_FACTOR}
    NetconfKeywords.Perform_Operation_On_Each_Device    Check_Devices_Data    count=1    timeout=${timeout}

...
Configure_Devices_Onto_Netconf
    ...
    NetconfKeywords.Perform_Operation_On_Each_Device    Configure_Devices    timeout=${timeout}
...
Deconfigure_Devices_From_Netconf
    ...
    [Tags]    critical
    ${timeout}=    BuiltIn.Evaluate    ${DEVICE_COUNT}*${TIMEOUT_FACTOR}
    NetconfKeywords.Perform_Operation_On_Each_Device    Deconfigure_Devices    timeout=${timeout}
...
Deconfigure_Devices
    ...
    NetconfKeywords.Delete_Whole_Netconf_Topology    ${current_name}    device_type=${device_type}

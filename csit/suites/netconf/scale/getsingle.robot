...
Connect_Devices_Onto_Netconf
    ...
    NetconfKeywords.Perform_Operation_On_Each_Device    Connect_Device
    [Teardown]    ConsoleReporting.End_Verbose_Test

Get_Data_From_Devices
    [Documentation]    Ask testtool devices for data and measure the time and memory usage.
    [Setup]    ConsoleReporting.Start_Verbose_Test
...
Remove_Devices_From_Netconf
    ...
    [Tags]    critical
    [Setup]    ConsoleReporting.Start_Verbose_Test
    NetconfKeywords.Perform_Operation_On_Each_Device    Remove_Device
    [Teardown]    ConsoleReporting.End_Verbose_Test

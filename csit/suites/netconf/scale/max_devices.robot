...
Get Juniper Device Schemas
    ...
    Log    ${output}
    ${output} =    OperatingSystem.Run    find yang/juniper_yang_github/19.4/19.4R1/junos -type f -name '*yang' -exec cp {} junos_19.4R1/ \;
    Log    ${output}
    ${output} =    OperatingSystem.Run    cp yang/juniper_yang_github/19.4/19.4R1/common/* junos_19.4R1/
    Log    ${output}
    ${output} =    OperatingSystem.Run    tree -L 3
    Log    ${output}

...
Get Juniper Device Schemas
    ...
    OperatingSystem.Run    find yang/juniper_yang_github/19.4/19.4R1/junos -type f -name '*yang' -exec cp {} junos_19.4R1/ \;
    OperatingSystem.Run    cp yang/juniper_yang_github/19.4/19.4R1/common/* junos_19.4R1/

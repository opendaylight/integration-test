...
Deconfigure_Devices_From_Netconf
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    1000s    900    NetconfKeywords.Delete_Whole_Netconf_Topology    devices_type=${devices_type}
...
Wait_To_Configure_Devices
    ...
    NetconfKeywords.Wait_Device_Connected    ${current_name}    timeout=300s    period=1s

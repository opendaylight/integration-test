...
Configure ODL with Key config
    ...
    SSHLibrary.Put File    ${CURDIR}/../../../variables/netconf/KeyAuth/*    ${WORKSPACE}/${BUNDLEFOLDER}/etc/
    SSHLibrary.Execute Command    chmod 400 ${WORKSPACE}/${BUNDLEFOLDER}/etc/sb-rsa-key

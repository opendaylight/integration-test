...
Configure ODL with Key config
    ...
    SSHLibrary.Execute Command    chmod 400 ${USER_HOME}/${BUNDLEFOLDER}/etc/sb-rsa-key
    ${stdout}=    SSHLibrary.Execute Command    ls -l ${USER_HOME}/${BUNDLEFOLDER}/etc/    return_stdout=True
    Restart Controller

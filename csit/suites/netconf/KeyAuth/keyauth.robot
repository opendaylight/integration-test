...
Run Netopeer Docker Container
    ...
    SSHLibrary.Put File    ${CURDIR}/../../../variables/netconf/KeyAuth/*    .
...
Configure ODL with Key config
    ...
    SSHLibrary.Put File    ${CURDIR}/../../../variables/netconf/KeyAuth/org.opendaylight.netconf.topology.sb.keypair.cfg    ${USER_HOME}/${BUNDLE_FOLDER}/etc
    Restart Controller

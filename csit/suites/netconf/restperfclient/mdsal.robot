...
Setup_Everything
    ...
    Utils.Set_Immutable_Variable_Default    DIRECT_MDSAL_TIMEOUT    ${value} s
    ${value}=    DateTime.Add_Time_To_Time    ${DIRECT_MDSAL_TIMEOUT}    60s    result_format=compact
    Utils.Set_Immutable_Variable_Default    DIRECT_MDSAL_TIMEOUT_FOR_TESTCASE    ${value}
    ${value}=    BuiltIn.Evaluate    ${REQUEST_COUNT}/10+10
    Utils.Set_Immutable_Variable_Default    NETCONF_CONNECTOR_MDSAL_TIMEOUT    ${value} s
    ${value}=    DateTime.Add_Time_To_Time    ${NETCONF_CONNECTOR_MDSAL_TIMEOUT}    60s    result_format=compact
    Utils.Set_Immutable_Variable_Default    NETCONF_CONNECTOR_MDSAL_TIMEOUT_FOR_TESTCASE    ${value}

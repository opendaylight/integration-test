...
Run_RestPerfClient_Directly_On_MDSAL
    ...
    NetconfKeywords.Invoke_Restperfclient    direct    ${DIRECT_MDSAL_TIMEOUT}    ${url}
...
Run_RestPerfClient_Through_Netconf_Connector
    ...
    NetconfKeywords.Invoke_Restperfclient    netconf-connector    ${NETCONF_CONNECTOR_MDSAL_TIMEOUT}    ${url}

...
Configure_ODL_As_A_Device_On_Netconf
    ...
    NetconfKeywords.Configure_Device_In_Netconf    odl-via-netconf-connector    device_address=${ODL_SYSTEM_IP}    device_port=${ODL_NETCONF_PORT}    device_user=${ODL_NETCONF_USER}    device_password=${ODL_NETCONF_PASSWORD}

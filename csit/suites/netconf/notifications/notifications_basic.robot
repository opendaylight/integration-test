...
Check_Subscribtion
    ...
    # debug
    ${resp} =    RequestsLibrary.Get_Request    restconf    rests/data/ietf-restconf-monitoring:restconf-state/streams/stream=replayComplete/access=JSON    headers=${SEND_ACCEPT_XML_HEADERS}
    Log_Response    ${resp}

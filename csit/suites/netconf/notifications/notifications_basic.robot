...
Create_DCN_Stream
    ...
    ${uuid} =    Get Element Text  ${resp.text}    xpath=.//output/stream-name
    ${RFC8040_DCN_STREAM_URI}    BuiltIn.Set_Variable    ${RFC8040_STREAMS_URI}/${uuid}/stream/data-change-event-subscription/${NODES_STREAM_PATH}

...
Start_Receiver
    ...
    ${output}=    SSHLibrary.Write    python wsreceiver.py --uri ${location} --logfile ${RECEIVER_LOG_FILE} ${RECEIVER_OPTIONS}
    BuiltIn.Log    ${output}
...
Check_Notification
    ...
    Should Contain    ${notification}    <data-changed-notification xmlns=
    Should Contain    ${notification}    <operation>created</operation>

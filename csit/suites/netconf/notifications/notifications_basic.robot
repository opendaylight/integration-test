...
Check_Subscribtion
    ...
    Log_Response    ${resp}
    ${resp} =    RequestsLibrary.Get_Request    restconf    rests/data/ietf-restconf-monitoring:restconf-state/streams/stream=replayComplete/access=JSON/location    headers=${SEND_ACCEPT_XML_HEADERS}
    Log_Response    ${resp}

...
${RFC8040_STREAMS_URI}          ${RESTCONF_ROOT}/data/ietf-restconf-monitoring:restconf-state/streams
...
Change_DS_Config
    ...
    ${uri} =    BuiltIn.Set_Variable    ${RESTCONF_ROOT}/data/network-topology:network-topology
    ...
    Log_Response    ${resp}
    BuiltIn.Should_Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
    ${uri} =    BuiltIn.Set_Variable    ${RESTCONF_ROOT}/data/network-topology:network-topology/topology=netconf-notif

...
Check_Subscribtion
    ...
    # FIXME: below is a hack to get around wrong location given back when using RFC8040
    ${location} =    String.Replace String    ${location}    8181    8185
    ${location} =    String.Replace String    ${location}    rests/    ${EMPTY}

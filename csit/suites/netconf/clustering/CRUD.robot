...
Check_Device_Data_Is_Created
    ...
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CHECKER}
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    Check_Config_Data    <data xmlns="${ODL_NETCONF_NAMESPACE}"><cont xmlns="urn:opendaylight:test" xmlns:a="${ODL_NETCONF_NAMESPACE}" a:operation="replace"><l>Content</l></cont></data>
...
Check_Device_Data_Is_Modified
    [Documentation]    Get the device data and make sure it contains the created content.
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CHECKER}
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    Check_Config_Data    <data xmlns="${ODL_NETCONF_NAMESPACE}"><cont xmlns="urn:opendaylight:test" xmlns:a="${ODL_NETCONF_NAMESPACE}" a:operation="replace"><l>Modified Content</l></cont></data>

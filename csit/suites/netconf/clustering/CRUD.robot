...
Mount_Device_On_Netconf
    ...
    [Tags]    critical
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_MOUNTER}
...
Check_Device_Data_Is_Empty
    ...
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CHECKER}
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    Check_Config_Data    <data xmlns="${netconf_ns}"></data>
...
Check_Device_Data_Is_Created
    ...
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CHECKER}
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    Check_Config_Data    <data xmlns="${netconf_ns}"><cont xmlns="urn:opendaylight:test" xmlns:a="${netconf_ns}" a:operation="replace"><l>Content</l></cont></data>
...
Check_Device_Data_Is_Modified
    [Documentation]    Get the device data and make sure it contains the created content.
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CHECKER}
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    Check_Config_Data    <data xmlns="${netconf_ns}"><cont xmlns="urn:opendaylight:test" xmlns:a="${netconf_ns}" a:operation="replace"><l>Modified Content</l></cont></data>
...
Setup_Everything
    ...
    NetconfViaRestconf.Create_NVR_Session    master    ${ODL_SYSTEM_1_IP}

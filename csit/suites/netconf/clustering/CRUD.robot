...
...
...               FIXME: The "Update and Delete" part is not done yet because of bug 3228.
...               Once that bug is gone, add the missing part.
...
Check_Configurer_Has_Netconf_Connector_For_Device
    ...
    [Tags]    critical
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CONFIGURER}
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEVICE_CHECK_TIMEOUT}    1s    Check_Netconf_Connector_Count    1
...
Check_Device_Data_Is_Seen_As_Empty_On_Configurer
    ...
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_CONFIGURER}
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEVICE_CHECK_TIMEOUT}    1s    Check_Config_Data    <data xmlns="${ODL_NETCONF_NAMESPACE}"></data>
    [Teardown]    Utils.Report_Failure_Due_To_Bug    3228
...
Check_New_Device_Data_Is_Visible_On_Setter
    ...
    NetconfViaRestconf.Activate_NVR_Session    ${NODE_SETTER}
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEVICE_CHECK_TIMEOUT}    1s    Check_Config_Data    <data xmlns="${ODL_NETCONF_NAMESPACE}"><cont xmlns="urn:opendaylight:test:netconf:crud" xmlns:a="${ODL_NETCONF_NAMESPACE}" a:operation="replace"><l>Content</l></cont></data>
    [Teardown]    Utils.Report_Failure_Due_To_Bug    3228

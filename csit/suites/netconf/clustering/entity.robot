...
Find_And_Shutdown_Device_Entity_Owner
    ...
    ${owner}    ${candidates}=    Get_Netconf_Entity_Info    ${DEVICE_NAME}
...
Wait_For_New_Owner_To_Appear
    ...
    [Tags]    critical
    ${owner}    ${candidates}=    BuiltIn.Wait_Until_Keyword_Succeeds    ${CLUSTER_RECOVERY_TIMEOUT}    1s    Get_Netconf_Entity_Info    ${DEVICE_NAME}
...
Get_Netconf_Entity_Info
    ...
    ${device_type}=    BuiltIn.Set_Variable    netconf
    ...
    Should Not Be Equal    ${entity_index}    -1    Device ${entity} not found in Entity Owner ${device_type}

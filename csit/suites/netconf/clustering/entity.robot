...
Find_And_Shutdown_Device_Entity_Owner
    ...
    ${owner}    ${candidates}=    ClusterKeywords.Get Cluster Entity Owner And Candidates Indexes    session=node1    netconf    ${DEVICE NAME}
...
Check_Owner_Reconfigured
    ...
    ${owner}    ${candidates}=    ClusterKeywords.Get_Device_Entity_Owner_And_Candidates_Indexes    reconfiguration_check_session    netconf    ${DEVICE_NAME}

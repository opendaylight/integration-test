...
Find_And_Shutdown_Device_Entity_Owner
    ...
    ${tmp_owner}    ${new_candidates}=    ClusterKeywords.Get Device Entity Owner And Candidates Indexes    node1    netconf    ${DEVICE NAME}
    Length Should Be    ${new_candidates}    2    Wrong count of candidates returned

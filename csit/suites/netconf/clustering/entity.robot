...
Check_Owner_Reconfigured
    ...
    Log    owner_1 ${owner}
    ${o2}    ${c2}=    ClusterKeywords.Get_Device_Entity_Owner_And_Candidates_Indexes    controller${candidate2}    netconf    ${DEVICE_NAME}
    Log    owner_2 ${o2}
    ${o3}    ${c3}=    ClusterKeywords.Get_Device_Entity_Owner_And_Candidates_Indexes    node${candidate1}    netconf    ${DEVICE_NAME}
    Log    owner_3 ${o3}
    ${o4}    ${c4}=    ClusterKeywords.Get_Device_Entity_Owner_And_Candidates_Indexes    node${candidate2}    netconf    ${DEVICE_NAME}
    Log    owner_4 ${o4}

...
Check_Owner_Reconfigured
    ...
    ${follower_session}=    BuiltIn.Set_Variable_If    ${original_device_owner} == ${follower1}    node${follower2}    node${follower1}
    ${owner}    ${candidates}=    ClusterKeywords.Get_Device_Entity_Owner_And_Candidates_Indexes    ${follower_session}    netconf    ${DEVICE_NAME}

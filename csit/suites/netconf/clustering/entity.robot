...
Check_Owner_Reconfigured
    ...
    ${candidate_session}=    BuiltIn.Set_Variable_If    ${original_device_owner} == ${candidate1}    node${candidate2}    node${candidate1}
    ${owner}    ${candidates}=    ClusterKeywords.Get_Device_Entity_Owner_And_Candidates_Indexes    ${candidate_session}    netconf    ${DEVICE_NAME}

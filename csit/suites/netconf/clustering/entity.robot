...
Wait_For_New_Owner_To_Appear
    ...
    [Tags]    critical
    ${owner}    ${candidates}=    BuiltIn.Wait_Until_Keyword_Succeeds    ${CLUSTER_RECOVERY_TIMEOUT}    1s    Get_Netconf_Entity_Info    ${DEVICE_NAME}    session=${candidate1}
...
Get_Netconf_Entity_Info
    ...
    ${entity_type}=    BuiltIn.Set_Variable    netconf

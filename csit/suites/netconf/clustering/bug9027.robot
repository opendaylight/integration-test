*** Settings ***
Documentation     Suite for reproducing Bug 9027.
...
...
...
...
...               Basically just a Outages suite in a WUKS.
...
*** Test Cases ***
Iterate
    [Documentation]    Start_Testtool and verify Iteration does not fail. Without tags or teardowns.
    Start_Testtool
    WaitForFailure.Verify_Keyword_Does_Not_Fail_Within_Timeout    ${LONGEVITY_TIME}    1s    Iteration

*** Keywords ***
Iteration
    [Documentation]    Outage suite as a single keyword, ignore failures unrelated to Bug 9027.
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Device_Is_Not_Mounted_At_Beginning
    BuiltIn.Run_Keyword_And_Ignore_Error    Configure_Device_On_Netconf
    BuiltIn.Run_Keyword_And_Ignore_Error    Wait_For_Device_To_Become_Visible_For_All_Nodes
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Device_Data_Is_Seen_As_Empty_On_All_Nodes
    BuiltIn.Run_Keyword_And_Ignore_Error    Kill_node1_Before_Create
    BuiltIn.Run_Keyword_And_Ignore_Error    Create_Device_Data_With_node1_Down
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_New_Device_Data_Is_Visible_On_Nodes_Without_node1
    Restart_node1_After_Create_And_Dump_Its_Topology_Data
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_New_Device_Data_Is_Visible_On_node1
    BuiltIn.Run_Keyword_And_Ignore_Error    Kill_node2_Before_Modify
    BuiltIn.Run_Keyword_And_Ignore_Error    Modify_Device_Data_With_node2_Down
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Modified_Device_Data_Is_Visible_On_Nodes_Without_node2
    Restart_node2_After_Modify_And_Dump_Its_Topology_Data
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Modified_Device_Data_Is_Visible_On_node2
    BuiltIn.Run_Keyword_And_Ignore_Error    Kill_node3_Before_Delete
    BuiltIn.Run_Keyword_And_Ignore_Error    Delete_Device_Data_With_node3_Down
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Device_Data_Removal_Is_Visible_On_Nodes_Without_node3
    Restart_node3_After_Delete_And_Dump_Its_Topology_Data
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Device_Data_Removal_Is_Visible_On_node3
    BuiltIn.Run_Keyword_And_Ignore_Error    Deconfigure_Device_In_Netconf
    BuiltIn.Run_Keyword_And_Ignore_Error    Check_Device_Deconfigured

...
Check_Modified_Device_Data_Is_Visible_On_node1
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEVICE_BOOT_TIMEOUT}    Check_Config_Data    node1    ${modified_data}
    [Teardown]    Utils.Report_Failure_Due_To_Bug    5761
...
Check_Modified_Device_Data_Is_Visible_On_node2
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEVICE_BOOT_TIMEOUT}    Check_Config_Data    node2    ${modified_data}
    [Teardown]    Utils.Report_Failure_Due_To_Bug    5761
...
Check_Modified_Device_Data_Is_Visible_On_node3
    BuiltIn.Wait_Until_Keyword_Succeeds    ${DEVICE_BOOT_TIMEOUT}    Check_Config_Data    node3    ${modified_data}
    [Teardown]    Utils.Report_Failure_Due_To_Bug    5761

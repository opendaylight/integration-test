...
#    TemplatedRequests.Get_As_Json_Templated    folder=${VAR_DIR}/apidoc/apis    session=session    verify=True
    TemplatedRequests.Get_As_Json_Templated    folder=${VAR_DIR}/apidoc/apis    session=session

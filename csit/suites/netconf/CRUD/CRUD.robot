...
Mount_Device_On_Netconf
    ...
    NetconfViaRestconf.Put_Xml_Template_Folder_Via_Restconf    ${directory_with_template_folders}${/}device    ${template_as_string}
...
Wait_For_Device_To_Become_Mounted
    BuiltIn.Wait_Until_Keyword_Succeeds    10s    1s    Check_Device_Mounted
...
Delete_Device_From_Netconf
    ...
    KarafKeywords.Log_Message_To_Controller_Karaf    Reconfiguring ODL to accept a connection
    ${template_as_string}=    BuiltIn.Set_Variable    {'DEVICE_NAME': '${device_name}'}
    NetconfViaRestconf.Delete_Xml_Template_Folder_Via_Restconf    ${directory_with_template_folders}${/}device    ${template_as_string}

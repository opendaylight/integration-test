...
Deconfigure_Device_From_Netconf_Temporarily
    ...
    CompareStream.Run_Keyword_If_At_Least_Oxygen    NetconfKeywords.Configure_Device_In_Netconf    ${device_name}    device_type=${device_type_delete}    http_timeout=2    http_method=post

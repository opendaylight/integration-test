...
Configure_Device_On_Netconf
    ...
    [Tags]    critical
    NetconfKeywords.Configure_Device_In_Netconf_Using_RPC    ${device_name}    device_type=${device_type_rpc}    http_timeout=2
...
Configure_The_Device_Back
    ...
    [Tags]    critical
    NetconfKeywords.Configure_Device_In_Netconf_Using_RPC    ${device_name}    device_type=${device_type_rpc}

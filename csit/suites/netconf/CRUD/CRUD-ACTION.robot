...
Start_Testtool
    ...
    # OperatingSystem.Run and Return RC and Output    ${output}=cat ${CURDIR}/../../../variables/netconf/CRUD/customaction/customaction.xml
    ${output}=    SSHLibrary.Execute Command    cat ${CURDIR}/../../../variables/netconf/CRUD/dataorigaction/post_data.json

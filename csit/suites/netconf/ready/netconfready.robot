...
...               does not use controller-config device and USE_NETCONF_CONNECTOR robot variable should
...
...               setup. This test case is skipped (Pass Execution) if the usage of controller-config
...               device is indicated.
...
...
...               if this is to be used. Some testsuites expect netconf-connector

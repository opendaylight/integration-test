...
Verify_Netconf_Ready_For_Node
    ...
    Wait_Netconf_Device_Mounted    ${DEVICE_NAME}    ${session}
...
Wait_Netconf_Device_Mounted
    [Arguments]    ${device_name}    ${session}
    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Xml_Templated    ${NETCONF_FOLDER}${/}full-uri-mount    mapping=${mapping}    session=${session}

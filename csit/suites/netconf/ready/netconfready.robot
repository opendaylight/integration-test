...
Wait_For_Netconf_Connector
    [Documentation]    Attempt to wait for the netconf-connector for ${NETCONFREADY_TIMEOUT}.
    [Tags]    critical
    BuiltIn.Run_Keyword_Unless    ${first_case_ok}    BuiltIn.Wait_Until_Keyword_Succeeds    ${NETCONFREADY_TIMEOUT}    1s    Check_Netconf_Connector

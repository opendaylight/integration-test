...
Perform_Test
    ...
    #${actual_for_magnesium}=       Run_Keyword_If_At_Least_Magnesium     Trim Whitespaces   ${actual}
    #${actual}=      Run Keyword If       ${actual_for_magnesium}!=${None}     Set Variable      ${actual_for_magnesium}      ELSE     Set Variable      ${actual}       
    ...
    ${expected}       String.Remove String       ${expected}      ]]>]]>
    ${actual}=      String.Strip String        ${actual}      mode=both
    ${expected}=      String.Strip String        ${expected}      mode=both

...
Install_Feature_On_Leader
    ...
    ClusterManagement.Run_Command_On_Member    command=log:set TRACE    member_index=${topology_leader_index}
    ...
    [Teardown]    ClusterManagement.Run_Command_On_Member    command=log:set TRACE    member_index=${topology_leader_index}

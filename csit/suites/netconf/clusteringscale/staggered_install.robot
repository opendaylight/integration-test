...
Install_Feature_On_Followers
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    1x    1s    ClusterManagement.Install_Feature_On_List_Or_All    feature_name=odl-netconf-clustered-topology    member_index_list=${topology_follower_indices}    timeout=60s

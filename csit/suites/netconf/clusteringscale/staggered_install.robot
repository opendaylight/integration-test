...
Install_Feature_On_Followers
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    3x    1s    ClusterManagement.Run_Karaf_Command_On_List_Or_All    feature:install odl-netconf-clustered-topology    timeout=60s    member_index_list=${topology_follower_indices}

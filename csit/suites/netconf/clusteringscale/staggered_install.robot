...
Single_Locate_Owner_Attempt
    ...
    \    ${new_owner}    ${new_candidates} =    ClusterManagement.Get_Owner_And_Candidates_For_Type_And_Id    type=topology-netconf    id=/general-entity:entity[general-entity:name='topology-manager']    member_index=${index}    require_candidate_list=${require_candidate_list}

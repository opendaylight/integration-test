...
Install_Feature_On_Leader
    ...
    [Teardown]    BuiltIn.Run_Keywords    ClusterManagement.Run_Karaf_Command_On_Member    command=log:set ${DEFAULT_KARAF_LOG_LEVEL}    member_index=${topology_leader_index}

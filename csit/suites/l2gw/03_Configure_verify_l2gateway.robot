...
TC01 GATEWAY Configuration Pattern A(L2GW:1, 4KPOD:1) Pod Type:VLAN
    ...
    OpenStackOperations.Create Vm Instance    ${NET_NAME11}    ${VM_NAME11}    sg=${SECURITY_GROUP_L2GW}
...
TC10 GATEWAY Configuration Pattern C(L2GW:2, 4KPOD:2) Pod Type:VLAN
    ...
    OpenStackOperations.Create Vm Instance    ${NET_NAME12}    ${VM_NAME12}    sg=${SECURITY_GROUP_L2GW}

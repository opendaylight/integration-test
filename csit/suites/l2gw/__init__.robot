...
Start Suite
    ...
    Log To Console    " Create And Set Hwvtep Connection Id"
    Create And Set Hwvtep Connection Id
    Log To Console    "Hwvtep Cleanup"
    Hwvtep Cleanup
    Log To Console    "Namespace Cleanup"
    Namespace Cleanup
    Log To Console    "Hwvtep Initiate"
    Hwvtep Initiate
    Log To Console    " Namespace Intiate"
    Namespace Intiate
    Log To Console    " Hwvtep Validation"
    Hwvtep Validation

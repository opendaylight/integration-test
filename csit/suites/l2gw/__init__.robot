...
Namespace Intiate
    ...
    Write Commands Until Prompt    ${IP_LINK_ADD} ${NS_TAP1} type veth peer name ${NS_PORT2}    30s
...
Hwvtep Validation
    ...
    ${stdout}=    Write Commands Until Prompt    sudo ovsdb-client dump hardware_vtep
    Log    ${stdout}

...
Start Suite
    ...
    Namespace Cleanup
    Hwvtep Initiate    ${hwvtep_conn_id}    ${HWVTE_IP}    ${HWVTEP_BRIDGE}
...
Namespace Intiate Hwvtep2
    ...
    Write Commands Until Prompt    ${CREATE_OVS_PORT} ${HWVTEP2_BRIDGE} ${NS2_PORT1}    30s
    ...
    Log    ${stdout}
    Write Commands Until Prompt    ${NETNS_ADD} ${HWVTEP2_NS2}    30s
    Write Commands Until Prompt    ${IP_LINK_ADD} ${NS4_TAP1} type veth peer name ${NS2_PORT2}    30s
    Write Commands Until Prompt    ${CREATE_OVS_PORT} ${HWVTEP2_BRIDGE} ${NS2_PORT2}    30s

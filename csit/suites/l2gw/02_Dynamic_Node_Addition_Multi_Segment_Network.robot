...
10 Verify Ping Among All Nodes
    ...
    L2GatewayOperations.Start Command In Hwvtep    ${NETNS_EXEC} ${HWVTEP_NS1} nohup ping ${port_ip_list[2]} &    ${HWVTEP_IP}
    L2GatewayOperations.Start Command In Hwvtep    ${NETNS_EXEC} ${HWVTEP2_NS1} nohup ping ${port_ip_list[0]} &    ${HWVTEP2_IP}

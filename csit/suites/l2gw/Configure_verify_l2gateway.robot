...
TC8 Ping Verification From Namespace Tap To Ovs Vm Normal Ping
    L2GatewayOperations.Verify Ping In Namespace_A    ${HWVTEP_NS1}    ${port_mac_list[1]}    ${port_ip_list[0]}    #TC15 Create Second Set Neutron Network Subnet Ports and Verify    #    OpenStackOperations.Create Network

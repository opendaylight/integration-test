...
TC07_C Ping Verification From Namespace Tap To Ovs Vm Normal With Extra Timeout
    L2GatewayOperations.Verify Ping In Namespace Extra Timeout    ${HWVTEP_NS1}    ${port_mac_list[1]}    ${port_ip_list[0]}    #TC8 Ping Verification From Namespace Tap To Ovs Vm Normal Ping    #    L2GatewayOperations.Verify Ping In Namespace_A

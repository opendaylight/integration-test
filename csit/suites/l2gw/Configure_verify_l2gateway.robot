...
TC02 Create First Set Of Network Subnet And Ports
    ...
    Create And Configure Security Group    ${SECURITY_GROUP_L2GW}
...
TC06_A Dhcp Ip Allocation For Hwvtep Tap Port
    ...
    ${dhcp_assigned}=    Set Variable    ASSIGNED

TC06_B Static Ip Allocation If Above Test Fails
    Run Keyword If    '${dhcp_assigned}' == '${EMPTY}'    Namespace Static Ip Assign    ${HWVTEP_NS1}    ${NS_TAP1}    ${port_ip_list[1]}
...
#TC8 Ping Verification From Namespace Tap To Ovs Vm Normal Ping    #    L2GatewayOperations.Verify Ping In Namespace_A    ${HWVTEP_NS1}    ${port_mac_list[1]}

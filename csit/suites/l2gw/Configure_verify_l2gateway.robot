...
TC8 Ping Verification From Namespace Tap To Ovs Vm Normal Ping
    ...
    #    Wait Until Keyword Succeeds    30s    2s    L2GatewayOperations.Attach Port To Hwvtep Namespace    ${port_mac_list[3]}    ${HWVTEP_NS1}
    ...    # ${NS_TAP2}
    #
    ...
    #    Wait Until Keyword Succeeds    10s    2s    L2GatewayOperations.Namespace Dhclient Verify    ${HWVTEP_NS1}    ${NS_TAP2}
    ...    # ${port_ip_list[3]}
    #

...
TC33 Update Port For Hwvtep And Attach Port To Namespace
    ...
    Wait Until Keyword Succeeds    30s    2s    L2GatewayOperations.Attach Port To Hwvtep Namespace    ${port_mac_list[0]}    ${HWVTEP2_NS1}    ${NS3_TAP1}
    ...    ${hwvtep2_conn_id}
    Wait Until Keyword Succeeds    30s    2s    L2GatewayOperations.Attach Port To Hwvtep Namespace    ${port_mac_list[1]}    ${HWVTEP2_NS2}    ${NS4_TAP1}
    ...    ${hwvtep2_conn_id}
...
TC35 Dhcp Ip Allocation For Hwvtep First Port
    Wait Until Keyword Succeeds    180s    10s    L2GatewayOperations.Namespace Dhclient Verify    ${HWVTEP2_NS1}    ${NS3_TAP1}    ${port_ip_list[0]}
    ...    ${hwvtep2_conn_id}    ${HWVTEP2_IP}

TC36 Dhcp Ip Allocation For Hwvtep Second Port
    Wait Until Keyword Succeeds    180s    10s    L2GatewayOperations.Namespace Dhclient Verify    ${HWVTEP2_NS2}    ${NS4_TAP1}    ${port_ip_list[1]}
    ...    ${hwvtep2_conn_id}    ${HWVTEP2_IP}

TC37 Ping Verification In Hwvtep From First Port To Second
    Wait Until Keyword Succeeds    30s    5s    L2GatewayOperations.Verify Ping In Namespace Extra Timeout    ${HWVTEP2_NS1}    ${port_mac_list[0]}    ${port_ip_list[1]}
    ...    ${hwvtep2_conn_id}    ${HWVTEP2_IP}

TC38 Ping Verification In Hwvtep From Second Port To First
    Wait Until Keyword Succeeds    30s    5s    L2GatewayOperations.Verify Ping In Namespace Extra Timeout    ${HWVTEP2_NS2}    ${port_mac_list[1]}    ${port_ip_list[0]}
    ...    ${hwvtep2_conn_id}    ${HWVTEP2_IP}

...
TC2c Create L2 Gateway Connection
...
TC2e Verify Itm Tunnel Status After L2 Gateway Connection
...
TC3 Create First Neutron Subnet Ports And Verify
...
TC4a Update First Port For Hwvtep
    L2GatewayOperations.Update Port For Hwvtep    ${HWVTEP_PORT_1}

TC4b Create First Ovs Vm And Verify
...
TC4c Attach First Port To Namespace Tap Port
...
TC8 Update Second Set Ports In Controller Add To Hwvtep and Ovs
...
TC9 Create Second Set L2Gateway Connection And Verify

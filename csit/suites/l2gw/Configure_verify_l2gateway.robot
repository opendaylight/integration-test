...
TC6 Dhcp Ip Allocation To Hwvtep Tap Port
    L2GatewayOperations.Namespace Dhclient Verify_A    ${HWVTEP_NS1}    ${NS_TAP1}    ${port_ip_list[1]}
...
TC14a Ping Verification From Namespace Tap To Ovs Vm
    L2GatewayOperations.Verify Ping In Namespace_A    ${HWVTEP_NS1}    ${port_mac_list[1]}    ${port_ip_list[0]}
...
TC14c Ping Verification From Namespace Tap To Ovs Vm
    L2GatewayOperations.Verify Ping In Namespace_C    ${HWVTEP_NS1}    ${port_mac_list[1]}    ${port_ip_list[0]}

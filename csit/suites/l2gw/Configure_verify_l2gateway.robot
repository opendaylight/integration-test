...
TC06 Dhcp Ip Allocation For Hwvtep Tap Port
    Run Keyword And Ignore Error    L2GatewayOperations.Namespace Dhclient Verify    ${HWVTEP_NS1}    ${NS_TAP1}    ${port_ip_list[1]}
    Run Keyword And Ignore Error    Namespace Dhclient Verify    ${HWVTEP_NS1}    ${NS_TAP1}    ${port_ip_list[1]}

...
TC3b Update Ports In Controller Add To Hwvtep and Ovs
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${OVS_PORT_1}    ${OVS_VM1_NAME}    ${OVS_IP}

TC3c Update Ports In Controller Add To Hwvtep and Ovs
...
TC3d Update Ports In Controller Add To Hwvtep and Ovs
...
TC5 Dhcp Ip Allocation To The Namespace On Vtep And Ovs
    L2GatewayOperations.Namespace Dhclient Verify    ${HWVTEP_NS1}    ${NS_TAP1}     ${port_mac_list[1]}
    DUMP
...
Basic Suite Setup
    ...
    Log    ${OS_USER} 
    Log    ${OS_PASSWORD}
    Flexible SSH Login    ${OS_USER}    ${OS_PASSWORD}

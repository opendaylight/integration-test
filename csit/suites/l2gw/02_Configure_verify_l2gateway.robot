...
TC01 GATEWAY Configuration L2GW:1, PS:1, Interface:1
    ...
    OpenStackOperations.Create Vm Instance    ${NET_NAME1}    ${VM_NAME1}    sg=${SECURITY_GROUP_L2GW}
...
TC99 Cleanup test case
    ...
    OpenStackOperations.Delete All Vm Instance
    OpenStackOperations.Delete All Network
    OpenStackOperations.Delete SecurityGroup    ${SECURITY_GROUP_L2GW}

...
TC14 Create, Update And Attach 2nd Neutron Port to Hwvtep Namespace 1
    ...
    Run_Keyword_If    ${OPENSTACK_BRANCH}=ocata    BuiltIn.Pass_Execution    Only queens or later
    Run_Keyword_If    ${OPENSTACK_BRANCH}=pike    BuiltIn.Pass_Execution    Only queens or later

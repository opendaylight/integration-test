...
TC14 Create, Update And Attach 2nd Neutron Port to Hwvtep Namespace 1
    ...
    BuiltIn.Pass_Execution_If    "${OPENSTACK_BRANCH} == "stable/ocata"    Not supported in Ocata
    BuiltIn.Pass_Execution_If    "${OPENSTACK_BRANCH} == "stable/pike"    Not supported in Pike

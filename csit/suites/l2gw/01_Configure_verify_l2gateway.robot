...
TC02 Create First Set Of Network Subnet And Ports
    ...
    OpenStackOperations.Create Port    ${NET_1}    ${OVS_PORT_1}    sg=${SECURITY_GROUP_L2GW_NONE}
...
TC09 Additional Network Subnet Port Creation
    ...
    OpenStackOperations.Create Port    ${NET_2}    ${OVS_PORT_2}    sg=${SECURITY_GROUP_L2GW_NONE}

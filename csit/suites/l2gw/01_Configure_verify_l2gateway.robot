...
TC02 Create First Set Of Network Subnet And Ports
    ...
    OpenStackOperations.Create Neutron Port With Additional Params    ${NET_1}    ${OVS_PORT_1}    ${PORT_SECURITY_DISABLED}
    OpenStackOperations.Create Neutron Port With Additional Params    ${NET_1}    ${HWVTEP_PORT_1}    ${PORT_SECURITY_DISABLED}
...
TC09 Additional Network Subnet Port Creation
    ...
    OpenStackOperations.Create Neutron Port With Additional Params    ${NET_2}    ${OVS_PORT_2}    ${PORT_SECURITY_DISABLED}
    OpenStackOperations.Create Neutron Port With Additional Params    ${NET_2}    ${HWVTEP_PORT_2}    ${PORT_SECURITY_DISABLED}

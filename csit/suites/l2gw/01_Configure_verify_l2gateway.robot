...
TC02 Create First Set Of Network Subnet And Ports
    ...
    OpenStackOperations.Create Neutron Port With Additional Params    ${NET_1}    ${OVS_PORT_1}    ${SECURITY_GROUP_L2GW_NONE}
...
TC09 Additional Network Subnet Port Creation
    ...
    OpenStackOperations.Create Neutron Port With Additional Params    ${NET_2}    ${OVS_PORT_2}    ${SECURITY_GROUP_L2GW_NONE}

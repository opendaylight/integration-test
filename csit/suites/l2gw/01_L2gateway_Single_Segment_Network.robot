...
*** Test Cases ***
01 Create L2Gateway And Connection
...
02 Verify Hwvtep Node DB Entries
...
04 Verify Ping Between Compute Node And Hwvtep VMs
...
05 Verify Flow And Group Entries
...
06 Configure L2gateway Connection to Second Network
...
07 Verify Ping Within Second Network and Flows
...
08 Verify Flows, Groups And Ping From Hwvtep Namespace
...
09 Verify Ping Fails Between Two Networks
...
10 Delete L2-gateway-connection with Second Network And Verify
...
11 Reconfigure L2gateway Connection and Verify
...
12 Delete All L2gateway Connections and Verify Ping
...
13 Verify Hwvtep DB After Deletion of L2GWs
...
14 Disconnect Hwvtep Node And Verify

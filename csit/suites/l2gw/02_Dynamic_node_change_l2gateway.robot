...
TC02 Create Network1 Subnet1 And 2Ports Update Ports Attach To Hwvtep1 Namespaces
...
TC03 Create L2Gateway Connection Between Hwvtep1 Namespaces
...
TC04 Dhcp Ip Allocation For Hwvtep1 Ports
...
TC05 Ping Verification Hwvtep1 Between Both Ports
...
TC06 Ovs Manager Addition Port Creation Vm Creations
...
TC07 Verify Ping From Compute Node1 Vm To Namespace Ports
...
TC11 Connect Hwvtep Manager For Hwvtep2
    L2GatewayOperations.Add Vtep Manager And Verify    ${ODL_IP}    ${hwvtep2_conn_id}

TC12 Create Network Subnet And Ports Update Ports Attach To Hwvtep2 Namespace
...
TC13 Create L2Gateway And Connection Between Hwvtep2 Ports
...
TC14 Dhcp Ip Allocation For Hwvtep2 Ports
...
TC15 Ping Verification In Hwvtep2 Between Ports
...
TC16 Ovs2 Manager Addition Port Creation Vm Creation
...
TC17 Verify Ping From Compute Node2 Vm To Hwvtep2 Ports
...
TC18 Ping From Compute Node2 Vm To First Namespace In First Hwvtep
    ${output}=    Wait Until Keyword Succeeds    60s    10s    Execute Command on VM Instance    ${NET_1}    ${port_ip_list[5]}
    ...    ping -c 3 ${port_ip_list[0]}
    Log    ${output}
    Should Not Contain    ${output}    ${PACKET_LOSS}

TC19 Ping From Compute Node2 Vm To Second Namespace In First Hwvtep
    ${output}=    Wait Until Keyword Succeeds    60s    10s    Execute Command on VM Instance    ${NET_1}    ${port_ip_list[5]}
    ...    ping -c 3 ${port_ip_list[1]}
    Log    ${output}
    Should Not Contain    ${output}    ${PACKET_LOSS}

TC20 Ping From Compute Node1 Vm To Hwvtep2 Ports
    ${output}=    Wait Until Keyword Succeeds    60s    10s    Execute Command on VM Instance    ${NET_1}    ${port_ip_list[2]}
    ...    ping -c 3 ${port_ip_list[3]}
    Log    ${output}
    Should Not Contain    ${output}    ${PACKET_LOSS}
...
TC99 Clean Ports
    ...
    OpenStackOperations.Delete Port    ${HWVTEP2_PORT_1}
    OpenStackOperations.Delete Port    ${HWVTEP2_PORT_2}

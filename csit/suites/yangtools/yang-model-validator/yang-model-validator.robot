...
Deploy_And_Start_Odl_Yang_Validator_Utility
    ...
    FOR    ${yang_file}    IN    @{YANG_FILES_TO_VALIDATE}
        ...
        SSHKeywords.Execute_Command_At_Cwd_Should_Pass    tree -L 3 /home/jenkins/src/main/yang/standard/ieee/draft
        ${logfile} =    NexusKeywords.Install_And_Start_Java_Artifact    component=yangtools    artifact=${TEST_TOOL_NAME}    suffix=jar-with-dependencies    tool_options=${PARSING_PATHS} ${yang_file}

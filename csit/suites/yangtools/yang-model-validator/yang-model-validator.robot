...
Deploy_And_Start_Odl_Yang_Validator_Utility
    ...
    FOR    ${yang_file}    IN    @{yang_files_to_validate}
        ${logfile} =    NexusKeywords.Install_And_Start_Java_Artifact    component=yangtools    artifact=${TEST_TOOL_NAME}    suffix=jar-with-dependencies    tool_options=-p . -r -d ${yang_file}

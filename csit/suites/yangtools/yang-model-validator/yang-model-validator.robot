...
${NITROGEN_YANG_SYSTEM_TEST_URL}    https://nexus.opendaylight.org/content/repositories/opendaylight.release/org/opendaylight/yangtools/yang-model-validator/2.0.0/
${OXYGEN_YANG_SYSTEM_TEST_URL}    https://nexus.opendaylight.org/content/repositories/opendaylight.release/org/opendaylight/yangtools/yang-model-validator/2.0.1/

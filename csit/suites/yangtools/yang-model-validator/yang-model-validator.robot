...
Prepare_Yang_Files_To_Test
    ...
    ${dirs_to_process} =    BuiltIn.Create List     ${openconfig_dirs_to_process}     ${standard_dirs_to_process}
    ${yang_dirs_to_process} =    BuiltIn.Create List     ${openconfig_dirs_to_process}     ${standard_dirs_to_process}     ${vendor_dirs_to_process}

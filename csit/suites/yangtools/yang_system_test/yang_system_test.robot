...
Deploy_And_Start_Yang_System_Test_Utility
    ...
    ${logfile} =    NexusKeywords.Install_And_Start_Java_Artifact    component=yangtools    artifact=yang-system-test    suffix=jar-with-dependencies    tool_options=-p src/main/yang    explicit_url=${url}
...
Check_Return_Code
    ...
    # TODO: How come (without As_String) the following fails with "0 != 0"?
    BuiltIn.Should_Be_Equal_As_String    0    ${rc}

...
Construct_Multipatch_Url
    ...
    ${yst_base} =    String.Concatenate    ${url_base}    org.opendaylight.yangtools$yang-system-test/artifact/org.opendaylight.yangtools/yang-system-test
    ${yst_response} =    Requests.Get_Request    url=${yst_base}
    ...
    ${yst_version} =    String.Fet_From_Left   ${yst_almost_version}    ">

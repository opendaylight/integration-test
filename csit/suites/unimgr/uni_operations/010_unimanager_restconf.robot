...
Make the OVS instance listen to a passive connection
    ...
    Run Command On Remote System    ${mininet2_IP}    sudo ovs-vsctl del-manager
    Run Command On Remote System    ${mininet2_IP}    sudo ovs-vsctl del-br ovsbr0
    Run Command On Remote System    ${mininet2_IP}    sudo ovs-vsctl set-manager ptcp:${OVS_PORT}
    ${stdout}=    Run Command On Remote System    ${mininet2_IP}    sudo ovs-vsctl show
    Should Contain     ${stdout}    "ptcp:${OVS_PORT}"

...
Create linkUni
    ${link}=    OperatingSystem.Get File    ${UniMgr_variables_DIR}/epl_uni_link.json
...
Create epl
    ...
    Wait Until Keyword Succeeds    56s    8s    Check For Elements At URI    ${CONFIG_API}/mef-services:mef-services/    ${elem}

...
Create epl service
    ...
    Wait Until Keyword Succeeds    16s    6s    Check For Elements At URI    ${CONFIG_API}elan:elan-interfaces/    ${elements}
...
Delete epl service
    ...
    ${resp}    RequestsLibrary.Delete Request    session    ${REST_CONCONFIG_API}mef-services:mef-services/    headers=${HEADERS_YANG_JSON}
    Log    ${resp.content}
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}

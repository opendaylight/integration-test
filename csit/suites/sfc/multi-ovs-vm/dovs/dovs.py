...
class Dovs(cli.Application):
    ...
    In regards to ODL, genius and netvirt-openstack must be installed.
    ...
    Example 2: Networking of 2 compute nodes, 4 VMs and 2 isulated subnets.
      ...
      > dovs add-guest --name vm-1 --ip 10.0.0.1/24 --net subnet-A --node node-1 --odl 192.168.56.1
      > dovs add-guest --name vm-2 --ip 10.0.0.1/24 --net subnet-B --node node-1 --odl 192.168.56.1
      > dovs add-guest --name vm-3 --ip 10.0.0.2/24 --net subnet-A --node node-2 --odl 192.168.56.1
      > dovs add-guest --name vm-4 --ip 10.0.0.2/24 --net subnet-B --node node-2 --odl 192.168.56.1
     ...
     Example 3: Networking with routing between subnets.
      > dovs add-node --name compute-1 --odl 192.168.56.1
      > dovs add-node --name compute-2 --odl 192.168.56.1
      > dovs add-guest --name vm-1 --ip 10.0.0.1/24 --net subnet-A --router router-1 --node node-1 --odl 192.168.56.1
      > dovs add-guest --name vm-2 --ip 10.0.1.1/24 --net subnet-B --router router-1 --node node-1 --odl 192.168.56.1
      > dovs add-guest --name vm-3 --ip 10.0.0.2/24 --net subnet-A --router router-1 --node node-2 --odl 192.168.56.1
      > dovs add-guest --name vm-4 --ip 10.0.1.2/24 --net subnet-B --router router-1 --node node-2 --odl 192.168.56.1
      > dovs.py spawn --nodes 2 --guests 2 --nets 2 --odl 192.168.56.1
      ...
      Example 4: Move a Guest from current location to seleted node:
      > dovs.py move-guest --name-guest --name-dstnode

...
Test Traffic after VM migration
    ...
    ${result}    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    cd sfc-docker/sf_hhe/logical_sff;sudo ./test_case_01_traffic_different_subnet.sh -o ${ODL_SYSTEM_IP} > >(tee myFile.log) 2> >(tee myFile.log)

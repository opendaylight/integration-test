...
Test Traffic after VM migration
    ...
    ${result}    SSHLibrary.Execute Command    cd sfc-docker/sf_hhe/logical_sff;./test_case_01_traffic_different_subnet.sh \ -o ${ODL_SYSTEM_IP} > >(tee myFile.log) 2> >(tee myFile.log)    return_stderr=True    return_stdout=True    return_rc=True
    log    ${result}

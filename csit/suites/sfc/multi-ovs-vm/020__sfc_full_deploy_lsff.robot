...
Init Suite
    ...
    SSHLibrary.Put File    ${CURDIR}/../Full_Deploy/docker-ovs.sh    .    mode=0755
    SSHLibrary.Put File    ${CURDIR}/../Full_Deploy/Dockerfile    .    mode=0755
    SSHLibrary.Put File    ${CURDIR}/setup_docker_image.sh    .    mode=0755
    ${result}    SSHLibrary.Execute Command    sudo ./setup_docker_image.sh > >(tee myFile.log) 2> >(tee myFile.log)    return_stderr=True    return_stdout=True    return_rc=True
    log    ${result}

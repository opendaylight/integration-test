        ...
        "service-node": [
            {
                ...
                "ip-mgmt-address": "192.168.56.110"
            },
            {
                "name": "sff1",
                "service-function": [
                ],
                "ip-mgmt-address": "192.168.56.120"
            },
            {
                "name": "sf1",
                "service-function": [
                ...
                "ip-mgmt-address": "192.168.56.130"
            },
            {
                "name": "sf2",
                "service-function": [
                ...
                "ip-mgmt-address": "192.168.56.140"
            },
            {
                "name": "sff2",
                "service-function": [
                ],
                "ip-mgmt-address": "192.168.56.150"
            },
            {
                "name": "classifier2",
                "service-function": [
                ],
                "ip-mgmt-address": "192.168.56.160"
            }
        ]
    }
}
        ...
        "service-function": [
            {
                "name": "dpi-1",
                "ip-mgmt-address": "192.168.56.130",
                "rest-uri": "http://192.168.56.130:5000",
                "type": "dpi",
                "nsh-aware": "true",
            ...
            },
            {
                "name": "firewall-1",
                "ip-mgmt-address": "192.168.56.140",
                "rest-uri": "http://192.168.56.140:5000",
                "type": "firewall",
                "nsh-aware": "true",
                "sf-data-plane-locator": [
                    {
...
def Load_configuration_without_RSP(controller):

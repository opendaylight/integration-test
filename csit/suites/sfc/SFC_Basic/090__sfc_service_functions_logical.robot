...
Get one Service Function
    ...
    Check For Elements At URI    ${SERVICE_FUNCTIONS_URI}service-function/firewall-1    ${elements}
...
Delete A Service Function
    ...
    Add Elements To URI From File    ${SERVICE_FUNCTIONS_URI}    ${SERVICE_FUNCTIONS_FILE}
    Remove All Elements At URI    ${SERVICE_FUNCTIONS_URI}service-function/dpi-1
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FUNCTIONS_URI}
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
...
Init Suite
    ...
    Set Suite Variable    ${SF_DPI_URI}    /restconf/config/service-function:service-functions/service-function/dpi-1/
    Set Suite Variable    ${SF_DPI_FILE}    ${CURDIR}/../../../variables/sfc/${VERSION_DIR}/sf_dpi.json

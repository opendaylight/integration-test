...
Get one Service Function Forwarder
    ...
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap    ${elements}
...
Delete A Service Function Forwarder
    ...
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
    Remove All Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap
    Should Be Equal As Strings    ${resp.status_code}    404
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDERS_URI}
...
Get Service Function Dictionary From SFF
    ...
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1    ${elements}

Delete Service Function Dictionary From SFF
    [Documentation]    Delete Service Function Dictionary From SFF
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
    Remove All Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1
    Should Be Equal As Strings    ${resp.status_code}    404
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
...
Put Service Function Dictionary to SFF
    ...
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    Add Elements To URI From File    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF100    ${SFF_SFD_SF100_FILE}
    ${elements}=    Create List    SF100    SF2-DPL    eth0
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF100    ${elements}
...
Get Service Function Dictionary's DPL From SFF
    ...
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1/sff-sf-data-plane-locator/    ${elements}

Delete Service Function Dictionary's DPL From SFF
    [Documentation]    Delete Service Function Dictionary From SFF
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1/sff-sf-data-plane-locator
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
    Remove All Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1/sff-sf-data-plane-locator
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1/sff-sf-data-plane-locator
    Should Be Equal As Strings    ${resp.status_code}    404
...
Put DPL of Service Function Dictionary to SFF
    ...
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    Add Elements To URI From File    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/service-function-dictionary/SF1/sff-sf-data-plane-locator    ${SFF_SFD_LOCATOR_FILE}
...
Get Connected SFF Dictionary From SFF
    ...
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/br-int-ovs-2    ${elements}
...
Delete Connected SFF Dictionary From SFF
    ...
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/br-int-ovs-2
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
    Remove All Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/br-int-ovs-2
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/br-int-ovs-2
    Should Be Equal As Strings    ${resp.status_code}    404
    ${resp}    RequestsLibrary.Get Request    session    ${SERVICE_FORWARDER_URI}/SFF-bootstrap
    Should Contain    ${ALLOWED_STATUS_CODES}    ${resp.status_code}
...
Put Connected SFF Dictionary to SFF
    ...
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    Add Elements To URI From File    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/SFF100    ${SFF_CSD_SFF100_FILE}
    ${elements}=    create list    SFF100    service-function-forwarder:open
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/SFF100    ${elements}
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/    ${elements}
...
Get Connected SFF Dictionary's DPL From SFF
    ...
    Check For Elements At URI    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/br-int-ovs-2/sff-sff-data-plane-locator    ${elements}

Put DPL of Connected SFF Dictionary to SFF
    [Documentation]    Put DPL of Connected SFF Dictionary to SFF
    Add Elements To URI From File    ${SERVICE_FORWARDERS_URI}    ${SERVICE_FORWARDERS_FILE}
    Add Elements To URI From File    ${SERVICE_FORWARDER_URI}/SFF-bootstrap/connected-sff-dictionary/br-int-ovs-2/sff-sff-data-plane-locator    ${SFF_CSD_LOCATOR_FILE}

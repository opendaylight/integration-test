...
Init Suite
    ...
    Run Command On Remote System    ${ODL_SYSTEM_IP}    sudo sed -i 's/${DOCKER_DEFAULT_SUBNET}/${docker_ip_octets}/g' ${CURDIR}/../../../variables/sfc/${VERSION_DIR}/full-deploy/*    ${ODL_SYSTEM_USER}    prompt=${DEFAULT_LINUX_PROMPT}

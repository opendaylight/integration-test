...
Init Suite
    ...
    SSHLibrary.Put File    ${CURDIR}/docker-ovs.sh    /home/mangel    mode=0755
    SSHLibrary.Put File    ${CURDIR}/Dockerfile    /home/mangel    mode=0755
    SSHLibrary.Put File    ${CURDIR}/supervisord.conf    /home/mangel    mode=0755
    ${stderr}    SSHLibrary.Execute Command    echo ${TOOLS_SYSTEM_PASSWORD}|sudo -S ./docker-ovs.sh spawn --nodes=6 --guests=1 --tun=vxlan-gpe --odl=${ODL_SYSTEM_IP}    return_stderr=True    return_stdout=True

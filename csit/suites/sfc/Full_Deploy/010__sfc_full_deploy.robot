...
Get Flows In Docker Containers
    ...
    DockerSfc.Multiple Docker Exec    ${docker_name_list}    ifconfig
...
Init Suite
    ...
    ${docker_subnet}=    Set Variable    10.250.0.0/24
    ${mask}=    Get Mask From CIDR    ${docker_subnet}
    ${route_to_docker_net}=    Set Variable    sudo route add -net ${docker_subnet} gw ${TOOLS_SYSTEM_IP}
    ...
    Run Command On Remote System    ${ODL_SYSTEM_IP}

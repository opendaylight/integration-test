...
${route_to_docker}    sudo route add -net 172.17.0.0 netmask 255.255.0.0 gw ${TOOLS_SYSTEM_IP}
...
Init Suite
    ...
    Run Command On Remote System    ${ODL_SYSTEM_IP}    ${route_to_docker}    ${ODL_SYSTEM_USER}    prompt=${DEFAULT_LINUX_PROMPT}

...
Init Suite
    ...
    log    ${ODL_STREAM}
    BuiltIn.Run Keywords    CompareStream.Set_Variable_If_At_Least_Lithium    ${VERSION_DIR}    lithium
    ...AND    CompareStream.Set_Variable_If_At_Least_Beryllium    ${VERSION_DIR}    master

...
Init Suite
    ...
    ${result}    Run Command On Remote System    ${TOOLS_SYSTEM_IP}    sudo ./setup-docker-image.sh > >(tee myFile.log) 2> >(tee myFile.log)    return_stderr=True    return_stdout=True    return_rc=True
    log    ${result}

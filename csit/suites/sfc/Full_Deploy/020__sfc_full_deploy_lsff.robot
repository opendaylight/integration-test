...
Init Suite
    ...
    ${result}    SSHLibrary.Execute Command    sudo ./multi-ovs-vm/setup-docker-image.sh > >(tee myFile.log) 2> >(tee myFile.log)    return_stderr=True    return_stdout=True    return_rc=True
    log    ${result}

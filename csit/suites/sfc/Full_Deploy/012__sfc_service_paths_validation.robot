...
Add Service Function Path referencing a non-existing SF
    ...
    CompareStream.Run_Keyword_If_Equals    neon    Add Elements To URI From File And Check Validation Error    ${SERVICE_FUNCTION_PATHS_URI}    ${SERVICE_FUNCTION_PATHS_WITH_HOP_FILE}

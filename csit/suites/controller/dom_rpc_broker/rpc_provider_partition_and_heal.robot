...
Verify_Rpc_Fails_On_Isolated_Member_Without_Rpc
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    15s    2s    MdsalLowlevel.Get_Constant    ${non_rpc_member_index}    use_explicit_status_codes=${NON_WORKING_RPC_STATUS_CODE}
...
Setup_Kw
    ...
    ${non_installed_rpc_member_idx_list} =    ClusterManagement.List_Indices_Minus_Member    ${INSTALLED_RPC_MEMEBER_IDX_LIST}

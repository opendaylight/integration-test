...
Setup_Keyword
    ...
    ${allowed_index_list} =    ClusterManagement.List_Indices_Minus_Member    ${UNREGISTERED_RPC_NODE}
    ...
    ${full_cluster_index_list} =    ClusterManagement.List_Indices_Minus_Member    ${EMPTY}

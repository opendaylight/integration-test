...
Unregister_Rpc_On_Node
    ...
    DrbCommons.Unregister_Rpc_And_Update_Possible_Responses    ${UNREGISTERED_RPC_NODE}
...
Reregister_Rpc_On_Node
    ...
    DrbCommons.Register_Rpc_And_Update_Possible_Responses    ${UNREGISTERED_RPC_NODE}

...
Monitor_Stability_While_Unregistered
    ...
    CsCommon.Monitor_Owner_And_Candidates_Stability    ${STABILITY_TIMEOUT}    ${owner}

Reregister_Singleton_Constant
    [Documentation]    Re-registere the unregistered candidate.
    CsCommon.Register_Singleton_And_Update_Expected_Candidates     ${unregistered_node}    ${CONSTANT_PREFIX}${unregistered_node}
...
Verify_Stability_After_Reregistration
    ...
    WaitForFailure.Verify_Keyword_Does_Not_Fail_Within_Timeout    5x    3s    CsCommon.Verify_Owner_And_Candidates_Stable    ${DEVICE_NAME}    ${DEVICE_TYPE}    ${owner}

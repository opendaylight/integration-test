...
Get_Master_And_Candidate
    ${master}    ${candidates}    ClusterManagement.Get_Owner_And_Candidates_For_Device    ${CONSTANT}    ${CONSTANT}    1
...
Unregister_Singleton_Constant_On_Each_Node
    ${index_list} =    ClusterManagement__Given_Or_Internal_Index_List
    : FOR    ${index}    IN    @{index_list}
    \    MdsalLowlevel.Unregister_Bound_Constant    ${index}

...
#       stabilize our tests and avoid false failures this rate has been set low. The test will still fail
#       if there are failed registrations during the "flapping". Some discussion of this can be found in the
#       comments of https://git.opendaylight.org/gerrit/#/c/74692/.

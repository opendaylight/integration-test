...
Add_And_Verify_Zero_Cars
    ...
    TemplatedRequests.Post_As_Json_Templated    folder=${VAR_BASE}/cars    verify=True    iterations=0
...
Add_And_Verify_People
    ...
    TemplatedRequests.Post_As_Json_Templated    folder=${VAR_BASE}/people    verify=True    iterations=${BULK_SIZE}

Add_And_Verify_Cars
    [Documentation]    Create container with several cars, verify it is seen in the datastore.
    TemplatedRequests.Post_As_Json_Templated    folder=${VAR_BASE}/cars    verify=True    iterations=${BULK_SIZE}

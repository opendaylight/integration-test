...
*** Test Cases ***
Add Cars Start
    [Documentation]    Add cars start.
    Start Tool    ${addcarcmd}    ${tool_opt}

Add Cars Wait
    [Documentation]    Add cars wait ${procedure_timeout}.
    Wait Until Tool Finish    ${procedure_timeout}

Add Cars Stop
    [Documentation]    Stop the tool.
    Stop Tool
...
Store Logs
    Store_File_To_Workspace    cluster_rest_script.log    cluster_rest_script.log

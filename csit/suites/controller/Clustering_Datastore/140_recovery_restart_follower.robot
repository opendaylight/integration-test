...
Add Cars To The First Follower
    ...
    Wait Until Keyword Succeeds    30s    2s    Add Cars And Verify Without Init    @{CAR_FOLLOWERS}[0]    ${NUM_CARS}
...
Get All The Cars From The Second Follower
    [Documentation]    Add cars to the follower and verify
    Wait Until Keyword Succeeds    30s    2s    Get Cars And Verify    @{CAR_FOLLOWERS}[1]    ${NUM_CARS}

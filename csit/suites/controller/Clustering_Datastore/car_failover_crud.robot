...
Wait_For_New_Leader
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    30s    2s    Set_Variables_For_2nodes    shard_name=car    member_index_list=${car_follower_indices}
...
Set_Variables_For_2nodes
    ...
    [Documentation]    Get leader and followers for car shard, set additional suite variables.

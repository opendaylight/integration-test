...
Get_People_Shard_Leader_And_Followers
    [Arguments]    ${member_index_list}=${EMPTY}
    [Documentation]    Find a people shard leader and followers and store them if indicated.
    ${people_leader}    ${people_followers} =    ClusterManagement.Get_Leader_And_Followers_For_Shard    shard_name=people    shard_type=config    member_index_list=${member_index_list}
    BuiltIn.Return_From_Keyword    ${people_leader}    ${people_followers}

...
*** Test Cases ***
Setup_Second_Half_Of_Nodes_Voting
    [Documentation]    Sets the second half of nodes voting and the remaining half non-voting.
    Log To Console    Setting second three nodes to Voting
    ${rpc_response}    ClusterAdmin.Change_Member_Voting_States_For_All_Shards_Flipped    4
    Log    ${rpc_response}

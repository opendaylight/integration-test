...
Wait_For_New_Leader
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    30s    2s    CarPeople.Set_Tmp_Shard_Variables_For_Nodes    member_index_list=${car_follower_indices}    shard_name=${SHARD_NAME}    shard_type=${SHARD_TYPE}
...
Start_Old_Car_Leader
    [Documentation]    Start the isolated member without deleting the persisted data.

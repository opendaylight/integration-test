...
Down_Killed_Members
    [Documentation]    Mark the killed members as down, needed to avoid Bug 7840.
    Cluster_Management.Tell_Live_Member_About_Downed_Members    live_member_index=${car_leader_index}    down_member_index_list=${list_of_killing}

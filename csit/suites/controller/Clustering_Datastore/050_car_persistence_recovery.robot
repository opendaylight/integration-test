...
Verify No Cars On Leader After Restart
    ...
    Wait Until Keyword Succeeds    30s    2s    No Cars On Leader
...
Get Cars From Leader After Restart
    ...
    Wait Until Keyword Succeeds    30s    2s    Get Cars And Verify    ${CAR_LEADER}    ${NUM_CARS}
...
*** Test Cases ***
No Cars On Leader
    [Documentation]    no cars in Leader

...
Set_Variables_For_Shard
    ...
    ${majority_list} =    Collections.Get_Slice_From_List    ${original_follower_indices}    0    ${half_of_followers}
    ${tipping_list} =    Collections.Get_Slice_From_List    ${majority_list}    0    1
    ${revive_list} =    Collections.Get_Slice_From_List    ${original_follower_indices}    ${half_of_followers}    ${half_of_followers}
    ${kill_kist} =    Collections.Combine_Lists    ${tipping_list}   ${revive_list}

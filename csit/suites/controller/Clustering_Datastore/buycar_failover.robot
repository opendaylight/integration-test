...
Add_People_To_First_Follower_And_Verify
    [Documentation]    Add all needed people to people_first_follower_session, verify on each member.
...
Setup
    ...
    ${reboot_list} =    Collections.Combine_Lists    ${leader_list}    ${car-reople_follower_indices}

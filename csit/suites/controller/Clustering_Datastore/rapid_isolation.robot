...
Scenario
    [Argument]    ${isolated_member_index}
    ${alive} =    ClusterManagement.Get_All_Indices
    ClusterManagement.Isolate_Member_From_List_Or_All    ${isolated_member_index}
    Collections.Remove_Values_From_List    ${alive}    ${isolated_member_index}
    ClusterManagement.Check_Cluster_Is_In_Sync    ${alive}
    ClusterManagement.Rejoin_Member_From_List_Or_All    ${isolated_member_index}

...
Setup
    ...
    ${leader}    ${follower_list} =    ClusterManagement.Get_Leader_And_Followers_For_Shard    shard_name=car    shard_type=config
    BuiltIn.Set_Suite_Variable    ${car_leader}    ${leader}
    BuiltIn.Set_Suite_Variable    ${car_followers}    ${follower_list}

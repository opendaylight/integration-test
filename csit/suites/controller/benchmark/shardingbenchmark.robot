...
Benchmark_Sharding
    ...
    ${cmd}=    BuiltIn.Set_Variable    python shardbenchmark.py --hosts ${ip_list} --port ${RESTCONFPORT} --warmups ${WARMUPS} --runs ${RUNS} --csv ${CSV_OUT_FILE} --fulldata ${DATA_LOG_FILE} &> ${STDOUT_LOG}

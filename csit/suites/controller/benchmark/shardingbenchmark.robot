...
Setup_Everything
    ...
    ClusterManagement.Run_Karaf_Command_On_List_Or_All    log:set debug org.opendaylight.controller.sal-distributed-datastore
    ClusterManagement.Run_Karaf_Command_On_List_Or_All    log:set debug org.opendaylight.controller.cds-access-client
    #BuiltIn.Log_To_Console     ${TEST_TYPE} ${DATA_STORE} ${SHARDS} ${SHARD_TYPE} ${DATAITEMS} ${OPERATIONS} ${PUTSPERTX} ${LISTENERS} ${WARMUPS} ${RUNS}

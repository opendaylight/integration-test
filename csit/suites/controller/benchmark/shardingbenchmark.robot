...
*** Variables ***
${ODL_LOG_LEVEL}    info
${ODL_MOREDETAILS_LOG_LEVEL}    info
${TEST_TYPE}      ROUND-ROBIN
${DATA_STORE}      CONFIG
${SHARDS}          1 4 16
${SHARD_TYPE}      CDS
${DATAITEMS}       10000 100000 1000000
${OPERATIONS}      1
${PUTSPERTX}       1
${LISTENERS}       0
${WARMUPS}         1
...
Setup_Everything
    ...
    ClusterManagement.Run_Karaf_Command_On_List_Or_All    log:set ${ODL_MOREDETAILS_LOG_LEVEL} org.opendaylight.controller.cluster.sharding.DistributedShardedDOMDataTree
    ClusterManagement.Run_Karaf_Command_On_List_Or_All    log:set ${ODL_MOREDETAILS_LOG_LEVEL} org.opendaylight.controller.cluster.sharding.ShardedDataTreeActor
    ClusterManagement.Run_Karaf_Command_On_List_Or_All    log:set ${ODL_MOREDETAILS_LOG_LEVEL} org.opendaylight.controller.cluster.datastore
    ClusterManagement.Run_Karaf_Command_On_List_Or_All    log:set ${ODL_MOREDETAILS_LOG_LEVEL} org.opendaylight.controller.cluster.access.client

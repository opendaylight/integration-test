...
${ITEM_COUNT}     ${10000}
${THREADS}        10
${ADDCMD}         python cluster_rest_script.py --port ${RESTCONFPORT} add-with-retries --itemtype car --itemcount ${ITEM_COUNT} --threads ${THREADS}
...
Wait_For_Cars_Configured
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    120x    2s    Verify_Cars_Count    ${ITEM_COUNT}    ${session}

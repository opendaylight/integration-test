...
Start Suite
    ...
    ${mininet_conn_id}=    SSHLibrary.Open Connection    ${TOOLS_SYSTEM_IP}    prompt=${DEFAULT_LINUX_PROMPT}    timeout=60s
    ...
    \    RequestsLibrary.Create Session    ${controller}    http://${controller}:${RESTCONFPORT}    auth=${AUTH}

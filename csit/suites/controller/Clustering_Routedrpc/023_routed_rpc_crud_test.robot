...
Check Contents Of New Leader Shards
    [Documentation]    Check all content using Leader
    Wait Until Keyword Succeeds    ${START_TIMEOUT}    2s    Check Elements In Shards  ${NEW_CAR_LEADER}    100

Check Contents Of New First Follower Shards
    [Documentation]    Check all content using first follower
    Check Elements In Shards  @{CAR_FOLLOWERS}[0]    100

Delete 100 Cars-Persons From New Follower1
    [Documentation]    Add 100 persons and get persons from Leader
    Delete All Cars-Persons And Verify    @{CAR_FOLLOWERS}[0]    ${100}

Repurchase 100 Cars Using New Follower1
    [Documentation]    Repurchase 100 cars using Follower1
    Buy Cars And Verify    @{CAR_FOLLOWERS}[0]    ${100}

Check Contents Of New Leader Shards After Repurchase
    [Documentation]    Check all content using Leader
    Check Elements In Shards  ${NEW_CAR_LEADER}    100

Check Contents Of New First Follower Shards After Repurchase
    [Documentation]    Check all content using first follower
    Check Elements In Shards  @{CAR_FOLLOWERS}[0]    100
...
Check Contents Of Old Leader Shards
    [Documentation]    Check all content using Leader
    Wait Until Keyword Succeeds    ${START_TIMEOUT}    2s    Check Elements In Shards  ${OLD_CAR_LEADER}    100

Delete 100 Cars-Persons From Old Leader
    [Documentation]    Add 100 persons and get persons from Leader
    Delete All Cars-Persons And Verify    ${OLD_CAR_LEADER}    ${100}

Repurchase 100 Cars Using Old Leader
    [Documentation]    Repurchase 100 cars using Follower1
    Buy Cars And Verify    ${OLD_CAR_LEADER}    ${100}

Check Contents Of New Leader Shards After Repurchase
    [Documentation]    Check all content using Leader
    Check Elements In Shards  ${OLD_CAR_LEADER}    100

...
#    ClusterManagement.Check_Bash_Command_On_List_Or_All    sed -ie "s/^use-tell-based-protocol=true/use-tell-based-protocol=false/g" ${DATASTORE_CFG}
    ClusterManagement.Change_Use_Tell_Based_Protocol    False    ${DATASTORE_CFG}

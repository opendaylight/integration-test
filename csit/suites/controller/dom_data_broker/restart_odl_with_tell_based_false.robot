...
Generate Thread Dump
    ...
    Utils.Run Command On Remote System And Log    ${system}    sudo -u ${user} /usr/lib/jvm/java-1.8.0/bin/jstack -l ${pid}    user=${user}    password=${password}    prompt=${prompt}    prompt_timeout=${prompt_timeout}

...
Remove_Leader_Shard_Replica_And_Add_It_Back
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    15s    3s    DdbCommons.Verify_Shard_Replica_Removed    ${old_leader}    ${shard_name}    ${shard_type}
...
Remove_Follower_Shard_Replica_And_Add_It_Back
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    15s    3s    DdbCommons.Verify_Shard_Replica_Removed    ${follower1}    ${shard_name}    ${shard_type}

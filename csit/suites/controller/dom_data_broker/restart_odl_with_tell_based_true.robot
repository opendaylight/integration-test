...
#    ClusterManagement.Check_Bash_Command_On_List_Or_All    sed -ie "s/^use-tell-based-protocol=false/use-tell-based-protocol=true/g" ${DATASTORE_CFG}
    ClusterManagement.Change_Use_Tell_Based_Protocol    True    ${DATASTORE_CFG}

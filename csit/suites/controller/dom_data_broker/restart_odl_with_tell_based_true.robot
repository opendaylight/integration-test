...
${VALUE_TRUE}     true
${DATASTORE_CFG}    /tmp/${BUNDLEFOLDER}/etc/org.opendaylight.controller.cluster.datastore.cfg
...
Set_Tell_Based_Protocol_Usage
    ClusterManagement.Run_Karaf_Command_On_List_Or_All   sed -ie "s/#use-tell-based-protocol=/use-tell-based-protocol=/g" ${DATASTORE_CFG}
    ClusterManagement.Run_Karaf_Command_On_List_Or_All   cat ${DATASTORE_CFG}

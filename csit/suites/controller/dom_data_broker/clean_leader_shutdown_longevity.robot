...
...               leader is removed as the result of explicit application request. This is performed
...               by having a steady-stream producer execute operations against the shard and then
...               initiate shard leader shutdown.
...
Test_Scenario
    ...
    DdbCommons.Clean_Leader_Shutdown_Test_Templ    local

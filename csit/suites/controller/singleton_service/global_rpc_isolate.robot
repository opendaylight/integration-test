...
Rpc_On_Isolated_Node
    ...
    KarafKeywords.Log_Message_To_Controller_Karaf    EOS rest resp: ${out}    member_index=${old_brt_owner}
...
Run_Rpc
    ...
    ${out} =    TemplatedRequests.Get_From_Uri    ${EOS_URL}    session=${session}
    KarafKeywords.Log_Message_To_Controller_Karaf    EOS rest resp: ${out}    member_index=${node_idx}

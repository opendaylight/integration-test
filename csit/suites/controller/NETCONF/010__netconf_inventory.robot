...
${REST_CONT_CONF}       /rests/data/network-topology:network-topology/topology/topology-netconf
${REST_CONT_OPER}       /rests/data/network-topology:network-topology/topology/topology-netconf

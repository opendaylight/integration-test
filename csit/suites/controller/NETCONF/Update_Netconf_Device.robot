...
Wait_For_Device_To_Become_Connected
    ...
    ${date}=    DateTime.Add_Time_To_Date    ${date}    1 minute
    NetconfKeywords.NetconfKeywords__Perform_Operation_With_Checking_On_Next_Device    NetconfKeywords.Check_Device_Connected    ${date}

Wait_For_Device_Data_To_Be_Seen
    [Documentation]    Wait until the device data show up at node 2.
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    Check_Data_Present

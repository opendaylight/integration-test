...
# Kill ODL
    ...
    SSHLibrary.Write    rm -fr ${WORKSPACE}/${BUNDLEFOLDER}/data ${WORKSPACE}/${BUNDLEFOLDER}/tmp ${WORKSPACE}/${BUNDLEFOLDER}/cache
# Deploy test tool
...
Wait_For_Device_Data_To_Be_Seen
    ...
    BuiltIn.Wait_Until_Keyword_Succeeds    2m    1s   NetconfKeywords.Check_If_Data_Present_On_Device    0    new_name=True

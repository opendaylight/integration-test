...
Wait_For_Device_To_Become_Connected
    ...
    NetconfKeywords.Perform_Operation_On_Each_TestDevice    NetconfKeywords.Wait_Device_Connected    timeout=5m    new_name=True

Wait_For_Device_Data_To_Be_Seen
    [Documentation]    Wait until the device data show up at node 1.
    BuiltIn.Wait_Until_Keyword_Succeeds    2m    1s   NetconfKeywords.Check_If_Data_Present_On_TestDevice    0    new_name=True

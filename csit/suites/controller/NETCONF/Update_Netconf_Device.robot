...
Wait_For_Device_To_Become_Connected
    ...
    NetconfKeywords.Perform_Operation_With_Checking_On_Next_Device    NetconfKeywords.Check_Device_Connected    timeout=1m

Wait_For_Device_Data_To_Be_Seen
    [Documentation]    Wait until the device data show up at node 1.
    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s   NetconfKeywords.Check_If_Data_Present_On_Device    1 

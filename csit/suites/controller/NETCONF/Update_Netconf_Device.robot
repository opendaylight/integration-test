...
Wait_For_Device_To_Become_Connected
    ...
    NetconfKeywords.Perform_Operation_On_Each_Device    NetconfKeywords.Wait_Device_Connected    timeout=12m    new_name=True
...
Wait_For_Device_Data_To_Be_Seen
    ...
    \    BuiltIn.Wait_Until_Keyword_Succeeds    12m    1s   NetconfKeywords.Check_If_Data_Present_On_Device    ${index}    new_name=True

...
*** Variables ***
${DURATION_5_MINUTES_IN_SECONDS}    300

*** Test Cases ***
Notifications_rate_5k
    ${5000}    ${DURATION_5_MINUTES_IN_SECONDS}

Notifications_rate_30k
    ${30000}    ${DURATION_5_MINUTES_IN_SECONDS}

Notifications_rate_60k
    ${60000}    ${DURATION_5_MINUTES_IN_SECONDS}

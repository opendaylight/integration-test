...
Dom_Notification_Broker_Test_Templ
    ...
    \    BuiltIn.Sould_Be_Equal_As_Numbers    ${err_not}    ${0}
    \    BuiltIn.Sould_Not_Be_Equal_As_Numbers    ${local_number}    ${0}
    \    BuiltIn.Sould_Be_Equal_As_Numbers    ${id_not}    ${local_number}
    \    ${rate} =    BuiltIn.Evaluate    ${local_number}/${TEST_DURATION_IN_SECONDS}
    \    BuiltIn.Sould_Be_True    "${rate}" > "0.9*${PUBLISHER_SUBSCRIBER_PAIR_RATE}"
    \    BuiltIn.Sould_Be_True    "${rate}" < "1.1*${PUBLISHER_SUBSCRIBER_PAIR_RATE}"
    ...
    BuiltIn.Sould_Be_True    "${final_rate}" > "0.9*${total_notification_rate}"
    BuiltIn.Sould_Be_True    "${final_rate}" < "1.1*${total_notification_rate}"

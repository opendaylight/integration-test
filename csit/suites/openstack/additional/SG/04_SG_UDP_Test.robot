...
Create Network1 Components
    ...
    Create Vm Instances    @{NETWORKS_NAME}[0]    ${NET_1_VM_INSTANCES}    sg=@{SECURITY_GROUP}[4]    min=1    max=1    image=cirros
    ...    flavor=cirros
...
Create Network2 Components
    ...
    Create Vm Instances    @{NETWORKS_NAME}[1]    ${NET_2_VM_INSTANCES}    sg=@{SECURITY_GROUP}[4]    min=1    max=1    image=cirros
    ...    flavor=cirros

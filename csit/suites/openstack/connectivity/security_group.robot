...
Check Vm Instances Have Ip Address
    ...
    Set Suite Variable    ${NET_1_DHCP_IP}
    ...
    Should Not Contain    ${NET_2_DHCP_IP}    None
...
Create Router
    ...
    OpenStackOperations.Create Router    ${ROUTERS_NAME}

Add Interfaces To Router
    : FOR    ${interface}    IN    @{SUBNETS_NAME}
    \    OpenStackOperations.Add Router Interface    ${ROUTERS_NAME}    ${interface}
...
Remove Router Interfaces
    : FOR    ${interface}    IN    @{SUBNETS_NAME}
    \    OpenStackOperations.Remove Interface    ${ROUTERS_NAME}    ${interface}

Delete Router
    OpenStackOperations.Delete Router    ${ROUTERS_NAME}

...
Create Vm Instances For l2_network_1
    ...
    Create Vm Instances On Compute Node    l2_network_1    NET1-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    Create Vm Instances On Compute Node    l2_network_1    NET1-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    Create Vm Instances On Compute Node    l2_network_1    NET1-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

...
@{NET_1_VM_INSTANCES_TEST}    MyFirstInstance_1     
@{NET_1_VM_INSTANCES}    MyFirstInstance_1-1     MyFirstInstance_1-2    MyFirstInstance_1-3    MyFirstInstance_1-4
@{NET_2_VM_INSTANCES_TEST}     MyFirstInstance_2     
@{NET_2_VM_INSTANCES}    MyFirstInstance_2-1    MyFirstInstance_2-2        MyFirstInstance_2-3    MyFirstInstance_2-4
...
Ping Vm Instance4 In l2_network_2
    [Documentation]    Check reachability of vm instances by pinging to them.
...
Connectivity Tests From Vm Instance4 In l2_network_1
    [Documentation]    Login to the vm instance and test some operations
    Test Operations From Vm Instance    l2_network_1    @{NET1_VM_IPS}[3]    ${NET1_VM_IPS}
...
Connectivity Tests From Vm Instance4 In l2_network_2
    [Documentation]    Login to the vm instance using generated key pair.
    Test Operations From Vm Instance    l2_network_2    @{NET2_VM_IPS}[3]    ${NET2_VM_IPS}

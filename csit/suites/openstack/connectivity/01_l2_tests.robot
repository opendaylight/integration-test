...
Connectivity Tests From Vm Instance1 In l2_network_1
    ...
    Log    ${dst_ip_list}
    Wait Until Keyword Succeeds    200s    25s    Test Operations From Vm Instance    l2_network_1    @{NET_1_VM_IPS}[0]    ${dst_ip_list}
...
Connectivity Tests From Vm Instance1 In l2_network_2
    ...
    Log    ${dst_ip_list}
    Wait Until Keyword Succeeds    200s    25s     Test Operations From Vm Instance    l2_network_2    @{NET_2_VM_IPS}[0]    ${dst_ip_list}

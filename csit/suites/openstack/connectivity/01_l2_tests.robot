...
Create Vm Instances For l2_network_1
    ...
    OpenStackOperations.Create Vm Instances On Compute Node    l2_network_1    NET1-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    l2_network_1    NET1-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    l2_network_1    NET1-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

Create Vm Instances For l2_network_2
    [Documentation]    Create multiple Vm instances using flavor and image names for a network.
    Create Vm Instances On Compute Node    l2_network_2    NET2-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    Create Vm Instances On Compute Node    l2_network_2    NET2-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    Create Vm Instances On Compute Node    l2_network_2    NET2-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
...
Check Vm Instances Have Ip Address
    ...
    ${NET2_VM_IPS}    ${NET1_DHCP_IP}    Collect VM IP Addresses    false    @{NET_1_VM_INSTANCES}
    ${NET1_VM_IPS}    ${NET2_DHCP_IP}    Collect VM IP Addresses    false    @{NET_2_VM_INSTANCES}

...
@{SUBNETS_NAME}    l2_sub_1    l2_sub_1
@{NET_1_VM_GRP_NAME}    l2_net_1_vm
@{NET_2_VM_GRP_NAME}    l2_net_2_vm
...
Create Vm Instances For l2_net_1
    ...
    OpenStackOperations.Create Vm Instances    ${NETWORKS_NAME}[0]    ${NET_1_VM_GRP_NAME}    sg=${SECURITY_GROUP}    min=3    max=3

Create Vm Instances For l2_net_2
    [Documentation]    Create Vm instances using flavor and image names for a network.
    OpenStackOperations.Create Vm Instances    ${NETWORKS_NAME}[1]    ${NET_2_VM_GRP_NAME}    sg=${SECURITY_GROUP}    min=3    max=3
...
Check Vm Instances Have Ip Address
    ...
    Should Not Contain    ${NET_1_VM_IPS}    None
    Should Not Contain    ${NET_2_VM_IPS}    None
    Should Not Contain    ${NET_1_DHCP_IP}    None
    Should Not Contain    ${NET2_DHCP_IP}    None
    [Teardown]    BuiltIn.Run Keywords    DevstackUtils.Show Debugs    @{NET_1_VM_INSTANCES}    @{NET_2_VM_INSTANCES}
    ...    AND    DevstackUtils.Get Test Teardown Debugs
...
Delete A Vm Instance
    ...
    OpenStackOperations.Delete Vm Instance    ${NETWORKS_NAME}[0]    @{NET_1_VM_INSTANCES}[0]

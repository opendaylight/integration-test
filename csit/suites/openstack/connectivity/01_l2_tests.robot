...
Connectivity Tests From Vm Instance3 In l2_network_1
    [Documentation]    Login to the vm instance and test operations
    Test Operations From Vm Instance    l2_network_1    @{NET1_VM_IPS}[3]    ${NET1_VM_IPS}      dhcp_ips=@{DHCP_IPS}[0]
...
Connectivity Tests From Vm Instance3 In l2_network_2
    ...
    Test Operations From Vm Instance    l2_network_2    @{NET2_VM_IPS}[3]     ${NET2_VM_IPS}      dhcp_ips=@{DHCP_IPS}[1]

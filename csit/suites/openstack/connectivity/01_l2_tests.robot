...
Check Vm Instances Have Ip Address
    ...
    ...        We are polling on the last VM created assuming that if it's received it's address already the other
    ...        instances should have as well.
    Wait Until Keyword Succeeds    600s    20s    Verify VM Received DHCP Lease    MyThirdInstance_2
    Verify VM Received DHCP Lease    MyFirstInstance_1
    Verify VM Received DHCP Lease    MySecondInstance_1
    Verify VM Received DHCP Lease    MyThirdInstance_1
    Verify VM Received DHCP Lease    MyFirstInstance_2
    Verify VM Received DHCP Lease    MySecondInstance_2

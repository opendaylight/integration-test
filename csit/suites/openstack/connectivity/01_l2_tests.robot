...
Create Subnets For l2_network_1
    ...
    Create SubNet    l2_network_1    l2_subnet_1    @{SUBNETS_RANGE}[0]     devstack_path=/opt/stack/devstack

Create Subnets For l2_network_2
    [Documentation]    Create Sub Nets for the Networks with neutron request.
    Create SubNet    l2_network_2    l2_subnet_2    @{SUBNETS_RANGE}[1]      devstack_path=/opt/stack/devstack
...
Ping All Vm Instances In l2_network_1
...
Ping All Vm Instances In l2_network_2
    [Documentation]    Check reachability of vm instances by pinging to them.
    ${net_id}=    Get Net Id    l2_network_2
...
Delete Sub Networks In l2_network_1
    ...
    Delete SubNet    l2_subnet_1     devstack_path=/opt/stack/devstack

Delete Sub Networks In l2_network_2
    [Documentation]    Delete Sub Nets for the Networks with neutron request.
    Delete SubNet    l2_subnet_2    devstack_path=/opt/stack/devstack

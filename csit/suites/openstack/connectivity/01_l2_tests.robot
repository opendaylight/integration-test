...
Create Vm Instances For l2_network_2
    [Documentation]    Create multiple Vm instances using flavor and image names for a network.
    Create Vm Instance On Compute Node    l2_network_2    NET2-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    Create Vm Instance On Compute Node    l2_network_2    NET2-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    Create Vm Instance On Compute Node    l2_network_2    NET2-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

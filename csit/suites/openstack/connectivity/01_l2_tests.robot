...
Create Networks
    ...
    Write Commands Until Prompt    sudo tcpdump -ni eth0 port 6640 -s 0 -w /tmp/ovsdb_packet_capture.pcap &
...
Show PKT CAP Output
    ...
    ${pkt_cap_output}=    Write Commands Until Prompt    sudo tcpdump -vvv -r /tmp/ovsdb_packet_capture.pcap    timeout=120s
    Log    ${pkt_cap_output}

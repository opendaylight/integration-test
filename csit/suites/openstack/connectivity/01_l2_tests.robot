...
Create Vm Instances For l2_network_1
    ...
    Create Vm Instances On Compute Node    l2_network_1    ${NET_1_VM_GRP_NAME}    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}    min=1    max=1
    Create Vm Instances On Compute Node    l2_network_1    ${NET_1_VM_GRP_NAME}    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}    min=2    max=2

Create Vm Instances For l2_network_2
    [Documentation]    Create multiple Vm instances using flavor and image names for a network.
    Create Vm Instances On Compute Node    l2_network_2    ${NET_2_VM_GRP_NAME}    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}    min=1    max=1
    Create Vm Instances On Compute Node    l2_network_2    ${NET_2_VM_GRP_NAME}    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}    min=2    max=2

...
Connectivity Tests From Vm Instance1 In l2_network_1
    ...
    ${dst_ip_list}=    Create List    @{NET_1_VM_IPS}[1]    @{DHCP_IPS}[0]    @{NET_1_VM_IPS}[0]
    Log    ${dst_ip_list}
    Wait Until Keyword Succeeds    60s    15s    Test Operations From Vm Instance    l2_network_1    @{NET_1_VM_IPS}[0]    ${dst_ip_list}
...
Connectivity Tests From Vm Instance2 In l2_network_1
    ...
    Log    ${dst_ip_list}
    Wait Until Keyword Succeeds    60s    15s     Test Operations From Vm Instance    l2_network_1    @{NET_1_VM_IPS}[1]    ${dst_ip_list}
...
Connectivity Tests From Vm Instance1 In l2_network_2
    ...
    ${dst_ip_list}=    Create List    @{NET_2_VM_IPS}[1]    @{DHCP_IPS}[1]    @{NET_2_VM_IPS}[1]
    Log    ${dst_ip_list}
...
Connectivity Tests From Vm Instance2 In l2_network_2
    ...
    Log    ${dst_ip_list}
    Wait Until Keyword Succeeds    60s    15s     Test Operations From Vm Instance    l2_network_2    @{NET_2_VM_IPS}[1]    ${dst_ip_list}

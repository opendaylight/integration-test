...
Check Vm Instances Have Ip Address
    ...
    ${status}    ${message}    Run Keyword And Ignore Error    Wait Until Keyword Succeeds    60s    5s    Collect VM IP Addresses    true    @{VM_INSTANCES_FLOATING}
    ${status}    ${message}    Run Keyword And Ignore Error    Wait Until Keyword Succeeds    60s    5s    Collect VM IP Addresses    true    @{VM_INSTANCES_SNAT}

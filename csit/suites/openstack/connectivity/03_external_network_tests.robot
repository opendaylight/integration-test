...
Create Vm Instances
    ...
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS_NAME}[0]    VmInstanceFloating1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS_NAME}[0]    VmInstanceFloating2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS_NAME}[0]    VmInstanceSnat3    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS_NAME}[0]    VmInstanceSnat4    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

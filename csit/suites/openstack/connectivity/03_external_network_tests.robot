...
Check Vm Instances Have Ip Address
    ...
    ${FLOATING_VM_IPS}    ${FLOATING_DHCP_IP}    Wait Until Keyword Succeeds    60s    5s    Verify And Collect VM DHCP Addresses    @{VM_INSTANCES_FLOATING}
    ${SNAT_VM_IPS}    ${SNAT_DHCP_IP}    Wait Until Keyword Succeeds    60s    5s    Verify And Collect VM DHCP Addresses    @{VM_INSTANCES_SNAT}

...
Add Router Gateway To Router
    ...
    OpenStackOperations.Add Router Gateway    router1    external-net
...
Create And Associate Floating IP For VM
    [Documentation]    Create and associate a floating IP for the VM
    OpenStackOperations.Create And Associate Floating IP    ${VM_INSTANCES[0]}    ${vm_floating_ip}

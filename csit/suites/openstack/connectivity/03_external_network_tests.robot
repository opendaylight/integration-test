...
Change Debug Level 
    Wait Until Keyword Succeeds    2x    2s    Issue Command On Karaf Console    log:set TRACE org.opendaylight.netvirt.natservice-impl
    Wait Until Keyword Succeeds    2x    2s    Issue Command On Karaf Console    log:set TRACE org.opendaylight.netvirt.fibmanager
    Wait Until Keyword Succeeds    2x    2s    Issue Command On Karaf Console    log:set TRACE org.opendaylight.netvirt.natservice.internal

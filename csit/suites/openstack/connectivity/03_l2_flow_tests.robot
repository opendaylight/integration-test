...
Verify Created Network l2_network_1 With Mac_Addr
    ...
    \    Wait Until Keyword Succeeds    25s    5s    Verify mac_add In Dump Flow    ${net1_mac_addr}    ${table}
...
Verify Created Network l2_network_2 With Mac_Addr
    ...
    : FOR    ${table}    IN    @{NETWORK_FLOWS}
    \    Wait Until Keyword Succeeds    25s    5s    Verify mac_add In Dump Flow    ${net2_mac_addr}    ${table}
...
Verify Created Vm Instance1 In l2_network_1 With Mac_Add
    ...
    ${net1_vm1_mac_addr}=    Get Mac Address    @{NET_1_VM_IPS}[0]
    Set Suite Variable    ${net1_vm1_mac_addr}
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify mac_add In Dump Flow    ${net1_vm1_mac_addr}    ${table}

Verify Created Vm Instance2 In l2_network_1 With Mac_Add
    [Documentation]    Verify the created vm instance entry in the dump flow.
    ${net1_vm2_mac_addr}=    Get Mac Address    @{NET_1_VM_IPS}[1]
    Set Suite Variable    ${net1_vm2_mac_addr}
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify mac_add In Dump Flow    ${net1_vm2_mac_addr}    ${table}

Verify Created Vm Instance3 In l2_network_1 With Mac_Add
    [Documentation]    Verify the created vm instance entry in the dump flow.
    ${net1_vm3_mac_addr}=    Get Mac Address    @{NET_1_VM_IPS}[2]
    Set Suite Variable    ${net1_vm3_mac_addr}
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify mac_add In Dump Flow    ${net1_vm3_mac_addr}    ${table}
...
Verify Created Vm Instance1 In l2_network_2 With Mac_Add
    [Documentation]    Verify the created vm instance entry in the dump flow.
    ${net2_vm1_mac_addr}=    Get Mac Address    @{NET_2_VM_IPS}[0]
    Set Suite Variable    ${net2_vm1_mac_addr}
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify mac_add In Dump Flow    ${net2_vm1_mac_addr}    ${table}

Verify Created Vm Instance2 In l2_network_2 With Mac_Add
    [Documentation]    Verify the created vm instance entry in the dump flow.
    ${net2_vm2_mac_addr}=    Get Mac Address    @{NET_2_VM_IPS}[1]
    Set Suite Variable    ${net2_vm2_mac_addr}
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify mac_add In Dump Flow    ${net2_vm2_mac_addr}    ${table}

Verify Created Vm Instance3 In l2_network_2 With Mac_Add
    [Documentation]    Verify the created vm instance entry in the dump flow.
    ${net2_vm3_mac_addr}=    Get Mac Address    @{NET_2_VM_IPS}[2]
    Set Suite Variable    ${net2_vm3_mac_addr}
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify mac_add In Dump Flow    ${net2_vm3_mac_addr}    ${table}
...
Verify Deleted Vm Instance1 In l2_network_1 With Mac_Add
    ...
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify Removed mac_add In Dump Flow    ${net1_vm1_mac_addr}    ${table}

Verify Deleted Vm Instance2 In l2_network_1 With Mac_Add
    [Documentation]    Verify the deleted vm instance entry in the dump flow.
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify Removed mac_add In Dump Flow    ${net1_vm2_mac_addr}    ${table}

Verify Deleted Vm Instance3 In l2_network_1 With Mac_Add
    [Documentation]    Verify the deleted vm instance entry in the dump flow.
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify Removed mac_add In Dump Flow    ${net1_vm3_mac_addr}    ${table}
...
Verify Deleted Vm Instance1 In l2_network_2 With Mac_Add
    [Documentation]    Verify the deleted vm instance entry in the dump flow.
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify Removed mac_add In Dump Flow    ${net2_vm1_mac_addr}    ${table}

Verify Deleted Vm Instance2 In l2_network_2 With Mac_Add
    [Documentation]    Verify the deleted vm instance entry in the dump flow.
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify Removed mac_add In Dump Flow    ${net2_vm2_mac_addr}    ${table}

Verify Deleted Vm Instance3 In l2_network_2 With Mac_Add
    [Documentation]    Verify the deleted vm instance entry in the dump flow.
    : FOR    ${table}    IN    @{VM_FLOWS}
    \    Wait Until Keyword Succeeds    90s    5s    Verify Removed mac_add In Dump Flow    ${net2_vm3_mac_addr}    ${table}
...
Verify Deleted Network l2_network_1 With Mac_Addr
    ...
    : FOR    ${table}    IN    @{NETWORK_FLOWS}
    \    Wait Until Keyword Succeeds    25s    5s    Verify Removed mac_add In Dump Flow    ${net1_mac_addr}    ${table}
...
Verify Deleted Network l2_network_2 With Mac_Addr
    [Documentation]    Verify the mac address entry removed in the dump flow.
    : FOR    ${table}    IN    @{NETWORK_FLOWS}
    \    Wait Until Keyword Succeeds    25s    5s    Verify Removed mac_add In Dump Flow    ${net2_mac_addr}    ${table}

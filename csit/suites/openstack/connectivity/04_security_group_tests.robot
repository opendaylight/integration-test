...
Create Vm Instances For network_1
    ...
    OpenStackOperations.Create Vm Instances On Compute Node    network_1    SG-NET1-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_1    SG-NET1-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

Create Vm Instances For network_2
    [Documentation]    Create VM instances using flavor and image names for a network.
    OpenStackOperations.Create Vm Instances On Compute Node    network_2    SG-NET2-VM-1    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

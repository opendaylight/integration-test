...
Ping Vm Instance3 Floating IP From Vm Instance2 With Floating IP (FIP-FIP in the same compute node)
    ...
    OpenStackOperations.Test Operations From Vm Instance    @{NETWORKS}[0]    @{NET1_FIP_VM_IPS}[1]    ${dst_ip}

...
Create Vm Instances
    ...
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS}[0]    @{SNAT_VMS}[1]    ${OS_CMP1_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS}[1]    @{SNAT_VMS}[2]    ${OS_CMP2_HOSTNAME}    sg=${SECURITY_GROUP}

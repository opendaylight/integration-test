...
Check Vm Instances Have Ip Address
    ...
    ${NET1_VM_IPS}=     Collect IpAddressess        ${NET_1_VM_INSTANCES}
    ${NET2_VM_IPS}=     Collect IpAddressess        ${NET_2_VM_INSTANCES}
    Set Variable    ${NET1_VM_IPS}
    Set Variable    ${NET2_VM_IPS}

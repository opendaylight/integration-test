...
Check Vm Instances Have Ip Address
    ...
    Set Suite Variable    ${NET_1_L3_VM_IPS}
    Set Suite Variable    ${NET_2_L3_VM_IPS}
    Set Suite Variable    ${NET_3_L3_VM_IPS}
    Should Not Contain    ${NET_1_L3_VM_IPS}    None
    Should Not Contain    ${NET_2_L3_VM_IPS}    None
    Should Not Contain    ${NET_3_L3_VM_IPS}    None
    Should Not Contain    ${NET_1_L3_DHCP_IP}    None
    Should Not Contain    ${NET_2_L3_DHCP_IP}    None
    Should Not Contain    ${NET_3_L3_DHCP_IP}    None
    [Teardown]    Run Keywords    DevstackUtils.Show Debugs    @{NET_1_VM_INSTANCES}    @{NET_2_VM_INSTANCES}    @{NET_3_VM_INSTANCES}
...
Delete Vm Instances In net_3
    ...
    \    OpenStackOperations.Delete Vm Instance    ${vm}
    [Teardown]    BuiltIn.Run Keywords    DevstackUtils.Show Debugs    @{NET_1_VM_INSTANCES}    @{NET_2_VM_INSTANCES}    @{NET_3_VM_INSTANCES}
    ...    AND    DevstackUtils.Get Test Teardown Debugs

...
Connectivity Tests From Vm Instances In network_1
    ...
    Log    ${dst_ip_list}
    ${other_dst_ip_list}=    Create List    @{DHCP_IPS}[1]    @{NET_2_VM_IPS}[1]     @{NET_2_VM_IPS}[2]
    Log    ${other_dst_ip_list}
    Test Operations From Vm Instance      ${net_id}    @{NET_1_VM_IPS}[0]    ${dst_ip_list}    l2_or_l3=l3     list_of_external_dst_ips=${other_dst_ip_list}
...
Connectivity Tests From Vm Instances In network_2
    ...
    Log    ${other_dst_ip_list}
    Test Operations From Vm Instance      ${net_id}    @{NET_2_VM_IPS}[0]    ${dst_ip_list}    l2_or_l3=l3     list_of_external_dst_ips=${other_dst_ip_list}

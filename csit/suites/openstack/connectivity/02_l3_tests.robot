...
Connectivity Tests From Vm Instance1 In network_1
    ...
    Log    ${dst_list}
    Test Operations From Vm Instance    network_1    @{NET1_L3_VM_IPS}[0]    ${dst_list}      dhcp_ips=${DHCP_IPS}
...
Connectivity Tests From Vm Instance1 In network_2
    ...
    ${dst_list}=    Create List     @{NET1_L3_VM_IPS}    @{NET2_L3_VM_IPS}
    Log    ${dst_list}
    Test Operations From Vm Instance    network_2    @{NET2_L3_VM_IPS}[0]    ${dst_list}     dhcp_ips=${DHCP_IPS}

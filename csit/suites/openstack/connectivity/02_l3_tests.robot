...
Create Vm Instances For network_1
    ...
    OpenStackOperations.Create Vm Instances On Compute Node    network_1    L3-NET1-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_1    L3-NET1-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_1    L3-NET1-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

Create Vm Instances For network_2
    [Documentation]    Create Vm instances using flavor and image names for a network.
    OpenStackOperations.Create Vm Instances On Compute Node    network_2    L3-NET2-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_2    L3-NET2-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_2    L3-NET2-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}

Create Vm Instances For network_3
    [Documentation]    Create Vm instances using flavor and image names for a network.
    OpenStackOperations.Create Vm Instances On Compute Node    network_3    L3-NET3-VM-1    ${OS_CMP1_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_3    L3-NET3-VM-2    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instances On Compute Node    network_3    L3-NET3-VM-3    ${OS_CMP2_HN}    sg=${SECURITY_GROUP}
...
Check Vm Instances Have Ip Address
    ...
    ${NET3_L3_VM_IPS}    ${NET1_DHCP_IP}    Collect VM IP Addresses    false    @{NET_1_VM_INSTANCES}
    ${NET2_L3_VM_IPS}    ${NET2_DHCP_IP}    Collect VM IP Addresses    false    @{NET_2_VM_INSTANCES}
    ${NET1_L3_VM_IPS}    ${NET3_DHCP_IP}    Collect VM IP Addresses    false    @{NET_3_VM_INSTANCES}

...
Create VLAN Network (network_2)
    [Documentation]    Create Network with neutron request.
    #use this line when l3 will work -Create Network    @{NETWORKS_NAME}[1]    --provider:network_type=vlan --provider:physical_network=${external_physical_network} --provider:segmentation_id=${network2_vlan_id}

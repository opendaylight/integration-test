...
Verify L3Broadcast With Antispoofing Table
    ...
    BuiltIn.Run Keyword If    '${subnet_var}' == 'same'    Should Be Equal As Numbers    ${pkt_diff}    ${PACKET_COUNT}    ELSE    Should Be True
    ...    ${pkt_diff}==0

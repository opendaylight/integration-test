...
Verify L3Broadcast With Antispoofing Table
    ...
    BuiltIn.Run Keyword If    '${subnet_var}' == 'same'    BuiltIn.Should Be Equal As Numbers    ${pkt_diff}    ${pkt_count}
    ...    ELSE    BuiltIn.Should Be Equal As Numbers    ${pkt_diff}    ${pkt_diff_expected}

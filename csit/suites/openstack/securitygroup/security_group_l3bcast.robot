...
Verify L3Broadcast With Antispoofing Table
    ...
    ...    ${vm_submeta}=${EMPTY}    ${additional_args}=${EMPTY}
    ...
    BuiltIn.Run Keyword If    '${ping_response}'=='pingsuccess'    BuiltIn.Should Contain    ${output}    ${PING_REGEXP}    ELSE    BuiltIn.Should Contain
    ...    ${output}    ${NO_PING_REGEXP}

...
Create Setup
    ...
    @{VM_IP_DPN1} =    BuiltIn.Wait Until Keyword Succeeds    300 sec    15 sec    OpenStackOperations.Get Two Port VM IP Address    ${OS_CMP1_CONN_ID}    @{VM_NAMES}[0]
    @{VM_IP_DPN2} =    BuiltIn.Wait Until Keyword Succeeds    300 sec    15 sec    OpenStackOperations.Get Two Port VM IP Address    ${OS_CMP2_CONN_ID}    @{VM_NAMES}[1]

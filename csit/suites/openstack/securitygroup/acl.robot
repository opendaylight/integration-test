...
Create Setup
    ...
    @{VM_IP_DPN1} =    BuiltIn.Wait Until Keyword Succeeds    440 sec    0 sec    OpenStackOperations.Get Two Port VM IP Address     @{VM_NAMES}[0]
    @{VM_IP_DPN2} =    BuiltIn.Wait Until Keyword Succeeds    440 sec    30 sec    OpenStackOperations.Get Two Port VM IP Address    @{VM_NAMES}[1]

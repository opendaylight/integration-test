...
TC3_Verify ARP request Valid MAC and Valid IP for the VM Egress Table
    ...
    Sleep    210
    @{VM_IP1}    ${dhcp_ip1}    @{VM_IP_DPN1}    Wait Until Keyword Succeeds    240 sec    60 sec    Get VM IPs    ${VM_NAMES[0]}
    @{VM_IP2}    ${dhcp_ip2}    @{VM_IP_DPN2}    Wait Until Keyword Succeeds    240 sec    60 sec    Get VM IPs    ${VM_NAMES[1]}
    @{VM_IP3}    ${dhcp_ip3}    @{VM_IP_DPN3}    Wait Until Keyword Succeeds    240 sec    60 sec    Get VM IPs    ${VM_NAMES[2]}

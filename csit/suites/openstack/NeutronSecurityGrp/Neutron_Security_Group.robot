...
Create Security Group and Validate
    ...
    ${sec_groups} =    Create List    ${sg_ssh}
    Wait Until Keyword Succeeds    10s    2s    Check For Elements At URI    ${SEC_GROUP_API}    ${sec_groups}
    [Return]    ${sg_id}
...
Create Security Rule and Validate
    ...
    ${rule_ids} =    Create List    ${rule_id}
    Wait Until Keyword Succeeds    10s    2s    Check For Elements At URI    ${SEC_RULE_API}    ${rule_ids}
    [Return]    ${rule_id}

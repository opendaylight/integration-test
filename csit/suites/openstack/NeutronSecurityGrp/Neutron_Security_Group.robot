...
TC02_Create Security Rule with port_range_min > port_range_max
    ...
    Neutron Rule Creation With Invalid Parameters    ${SGP_SSH[1]}    ${PORT_RANGE_ERROR}    direction=ingress    ethertype=IPv4    port_range_max=20    port_range_min=25    protocol=tcp
...
TC03_Create Security Rule with port_range_min = -1
    ...
    Get Flows    ${OS_COMPUTE_1_IP}    ${OS_COMPUTE_2_IP}
    Log    "Neutron Rule Creation With Port Range Min Grt Port Range Max and Validation"
    Neutron Rule Creation With Invalid Parameters    ${SGP_SSH[2]}    ${INVALID_PORT_RANGE_MIN}    direction=ingress    ethertype=IPv4    port_range_max=25    port_range_min=-1    protocol=tcp
...
TC04_Create Security Rule with port_range_max = -1
    ...
    Get Flows    ${OS_COMPUTE_1_IP}    ${OS_COMPUTE_2_IP}
    Log    "Neutron Rule Creation With Port Range Min Grt Port Range Max and Validation"
    Neutron Rule Creation With Invalid Parameters    ${SGP_SSH[3]}    ${INVALID_PORT_RANGE_MIN}     direction=ingress    ethertype=IPv4    port_range_max=-1    port_range_min=20    protocol=tcp

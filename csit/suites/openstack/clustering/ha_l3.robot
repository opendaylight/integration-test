...
Take Down Leader Of Default Shard
    ...
    ClusterManagement.Stop Single Member    ${cluster_leader}    msg=up: ODL1, ODL2, ODL3, down=none
...
Bring Up Leader Of Default Shard
    ...
    ClusterManagement.Start Single Member    ${cluster_leader}    msg=up: ???, down: ${cluster_leader}
...
Bring Up ODL2 and ODL3
    ...
    ClusterManagement.Start Single Member    2    msg=up: ODL1, down: ODL2, ODL3
    ClusterManagement.Start Single Member    3    msg=up: ODL1, ODL2, down: ODL3
...
Bring Up All Instances
    ...
    ClusterManagement.Start Single Member    1    msg=up: none, down: ODL1, ODL2, ODL3
    ClusterManagement.Start Single Member    2    msg=up: ODL1, down: ODL2, ODL3
    ClusterManagement.Start Single Member    3    msg=up: ODL1, ODL2, down: ODL3

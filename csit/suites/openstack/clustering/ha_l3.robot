...
Take Down Leader Of Default Shard
    ...
    Clustering.Stop Member and Log    ${cluster_leader}    up=ODL1, ODL2, ODL3    down=none
...
Bring Up Leader Of Default Shard
    ...
    Clustering.Start Member and Log    ${cluster_leader}    up=???    down=${cluster_leader}
...
Take Down ODL2 and ODL3
    [Documentation]    Stop the karaf in First and Second Controller
    Clustering.Stop Member and Log    2    up=ODL1, ODL2, ODL3    down=none
    Clustering.Stop Member and Log    3    up=ODL1, ODL3    down=ODL2
    [Teardown]    OpenStackOperations.Get OvsDebugInfo
...
Bring Up ODL2 and ODL3
    ...
    Clustering.Start Member and Log    2    up=ODL1    down=ODL2, ODL3
    Clustering.Start Member and Log    3    up=ODL1, ODL2    down=ODL3
...
Take Down All Instances
    ...
    Clustering.Stop Member and Log    1    up=ODL1, ODL2, ODL3    down=none
    Clustering.Stop Member and Log    2    up=ODL2, ODL3    down=ODL1
    Clustering.Stop Member and Log    3    up=ODL3    down=ODL1, ODL2

Bring Up All Instances
    [Documentation]    Bring up all controllers
    Clustering.Start Member and Log    1    up=none    down=ODL1, ODL2, ODL3
    Clustering.Start Member and Log    2    up=ODL1    down=ODL2, ODL3
    Clustering.Start Member and Log    3    up=ODL1, ODL2    down=ODL3

...
Take Down ODL1
    ...
    Get Leader And Followers Of All Shard
...
Take Down Leader Of Default Shard
    ...
    ${cluster_leader}    ${followers} =    Get Leader And Followers Of All Shard
...
*** Keywords ***
Get Leader And Followers Of All Shard Of All Shard
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_type=config
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_type=operational
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_name=entity-ownership    shard_type=operational
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_name=inventory    shard_type=config
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_name=inventory    shard_type=operational
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_name=topology    shard_type=config
    BuiltIn.Run Keyword And Ignore Error    ClusterManagement.Get Leader And Followers Of All Shard    shard_name=topology    shard_type=operational

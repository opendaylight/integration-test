...
Bring Up ODL1
    ...
    ClusterManagement.Start Cluster Member    1    @{NETVIRT_DIAG_SERVICES}
...
Bring Up ODL2
    ...
    ClusterManagement.Start Cluster Member    2    @{NETVIRT_DIAG_SERVICES}
...
Bring Up ODL3
    ...
    ClusterManagement.Start Cluster Member    3    @{NETVIRT_DIAG_SERVICES}
...
Bring Up ODL1 and ODL2
    ...
    ClusterManagement.Start_Cluster_Members    ${CLUSTER_DOWN_LIST}    @{NETVIRT_DIAG_SERVICES}

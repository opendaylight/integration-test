...
Take Down ODL2
    ...
    ClusterManagement.Kill Single Member    member=2    service_list=@{NETVIRT_DIAG_SERVICES}
...
Bring Up ODL1 and ODL2
    ...
    ClusterManagement.Start_Members_From_List_Or_All    member_index_list=${CLUSTER_DOWN_LIST}    check_system_status=True    service_list=@{NETVIRT_DIAG_SERVICES}

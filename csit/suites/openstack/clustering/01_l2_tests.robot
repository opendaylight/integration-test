...
Connectivity Tests From Vm Instances In net_1
    ...
    ${net_id}=    Get Net Id    net_1
    ${dst_ip_list}=    Create List    70.0.0.4    70.0.0.2
    Log    ${dst_ip_list}
    Test Operations From Vm Instance      ${net_id}    70.0.0.3    ${dst_ip_list}
...
Connectivity Tests From Vm Instances In net_2
    ...
    Source Password      devstack_path=/opt/stack/devstack
    ${net_id}=    Get Net Id    net_2
    ${dst_ip_list}=    Create List    80.0.0.4    80.0.0.2
    Log    ${dst_ip_list}
    Test Operations From Vm Instance     ${net_id}    80.0.0.3    ${dst_ip_list}

...
Check Vm Instances Have Ip Address
    ...
    ${NET1_VM_IPS}    ${NET1_DHCP_IP}    Wait Until Keyword Succeeds    240s    10s    Verify VMs Received DHCP Lease    @{NET_1_VM_INSTANCES}
    ${NET2_VM_IPS}    ${NET2_DHCP_IP}    Wait Until Keyword Succeeds    240s    10s    Verify VMs Received DHCP Lease    @{NET_2_VM_INSTANCES}

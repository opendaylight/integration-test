...
Check Vm Instances Have Ip Address
    ...
    ${NET1_VM_IPS}    ${NET1_DHCP_IP}    Wait Until Keyword Succeeds    60s    5s    Verify And Collect VM DHCP Addresses    @{NET_1_VM_INSTANCES}
    ${NET2_VM_IPS}    ${NET2_DHCP_IP}    Wait Until Keyword Succeeds    60s    5s    Verify And Collect VM DHCP Addresses    @{NET_2_VM_INSTANCES}

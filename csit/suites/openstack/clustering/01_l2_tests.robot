...
Check Vm Instances Have Ip Address
    ...
    ${NET1_VM_IPS}    ${NET1_DHCP_IP}    Get Vm Ip Addresses    @{NET_1_VM_INSTANCES}
    ${NET2_VM_IPS}    ${NET2_DHCP_IP}    Get Vm Ip Addresses    @{NET_2_VM_INSTANCES}
    ...
    List Should Not Contain Value    ${NET1_VM_IPS}    None
    List Should Not Contain Value    ${NET2_VM_IPS}    None

...
Check Vm Instances Have Ip Address
    ...
    ${NET1_L3_VM_IPS}    ${NET1_DHCP_IP}    Verify And Collect VM DHCP Addresses    @{NET_1_VM_INSTANCES}
    ${NET2_L3_VM_IPS}    ${NET2_DHCP_IP}    Verify And Collect VM DHCP Addresses    @{NET_2_VM_INSTANCES}

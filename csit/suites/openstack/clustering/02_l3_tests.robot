...
Check Vm Instances Have Ip Address
    ...
    ${NET1_L3_VM_IPS}    ${NET1_DHCP_IP}    Get Vm Ip Addresses    @{NET_1_VM_INSTANCES}
    ${NET2_L3_VM_IPS}    ${NET2_DHCP_IP}    Get Vm Ip Addresses    @{NET_2_VM_INSTANCES}
    # Even if we don't get all the IPs (e.g. a None value will be in the list), will make whatever we have
    # available to the rest of the suite, and then fail this test case if there was indeed a None in the list
    ...
    List Should Not Contain Value    ${NET1_L3_VM_IPS}    None
    List Should Not Contain Value    ${NET2_L3_VM_IPS}    None

...
Connectivity Tests From Vm Instances In net_1
    ...
    Test Operations From Vm Instance    ${net_id}    90.0.0.3    ${dst_ip_list}    l3    other_dst_ip_list=${other_dst_ip_list}
...
Connectivity Tests From Vm Instances In net_2
    ...
    Log    ${other_dst_ip_list}
    Test Operations From Vm Instance     ${net_id}    100.0.0.3    ${dst_ip_list}    l3    other_dst_ip_list=${other_dst_ip_list}

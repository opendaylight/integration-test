...
Create Subnets For net_1
    ...
    Create SubNet    net_1    sub_net_1    @{SUBNETS_RANGE}[0]

Create Subnets For net_2
    [Documentation]    Create Sub Nets for the Networks with neutron request.
    Create SubNet    net_2    sub_net_2    @{SUBNETS_RANGE}[1]
...
Ping Vm Instance In net_2 From net_1
    ...
    Source Password      devstack_path=/opt/stack/devstack
    ${net_id}=    Get Net Id    net_1
    ${output}    Ping Vm From DHCP Namespace    ${net_id}    @{NET_2_VM_IPS}[0]
...
Connectivity Tests From Vm Instances In net_1
    ...
    Test Operations From Vm Instance    ${net_id}    @{NET_1_VM_IPS}[0]    ${dst_ip_list}    l2_or_l3=l3    other_dst_ip_list=${other_dst_ip_list}
...
Connectivity Tests From Vm Instances In net_2
    ...
    Log    ${other_dst_ip_list}
    Test Operations From Vm Instance     ${net_id}    @{NET_2_VM_IPS}[0]    ${dst_ip_list}    l2_or_l3=l3    other_dst_ip_list=${other_dst_ip_list}

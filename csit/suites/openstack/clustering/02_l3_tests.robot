...
Create Subnets For net_1
    ...
    Create SubNet    net_1    sub_net_1    @{SUBNETS_RANGE}[0]     devstack_path=/opt/stack/devstack

Create Subnets For net_2
    [Documentation]    Create Sub Nets for the Networks with neutron request.
    Create SubNet    net_2    sub_net_2    @{SUBNETS_RANGE}[1]      devstack_path=/opt/stack/devstack
...
Connectivity Tests From Vm Instances In net_1
    ...
    Test Operations From Vm Instance    ${net_id}    @{NET_1_VM_IPS}[0]    ${dst_ip_list}    l2_or_l3=l3    other_dst_ip_list=${other_dst_ip_list}      devstack_path=/opt/stack/devstack
...
Connectivity Tests From Vm Instances In net_2
    ...
    Log    ${other_dst_ip_list}
    Test Operations From Vm Instance     ${net_id}    @{NET_2_VM_IPS}[0]    ${dst_ip_list}    l2_or_l3=l3    other_dst_ip_list=${other_dst_ip_list}    devstack_path=/opt/stack/devstack
...
Delete Sub Networks In net_1
    ...
    Delete SubNet    sub_net_1     devstack_path=/opt/stack/devstack

Delete Sub Networks In net_2
    [Documentation]    Delete Sub Nets for the Networks with neutron request.
    Delete SubNet    sub_net_2     devstack_path=/opt/stack/devstack

...
Wait For Routes To Propogate
    ...
    ${nslist} =    Write Commands Until Expected Prompt    sudo ip netns list | awk '{print $1}'    ]>
    ${output} =    Write Commands Until Expected Prompt    sudo ip netns exec ${nslist} ip route    ]>

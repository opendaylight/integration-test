...
Networks dissociated to VPN3
     ...
     ${network1_id} =     Get Net Id    ${NETWORKS[0]}    ${devstack_conn_id}
     ${network2_id} =     Get Net Id    ${NETWORKS[1]}    ${devstack_conn_id}
     Dissociate Network to VPN    ${VPN_INSTANCE_NAME[2]}    ${network1_id}
     Dissociate Network to VPN    ${VPN_INSTANCE_NAME[2]}    ${network2_id}
...
VPN L3VPN Delete
    ...
    VPN Delete L3VPN    ${VPN_INSTANCE_DELETE}

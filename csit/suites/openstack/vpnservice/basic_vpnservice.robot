...
@{VM_INSTANCES}    VM11    VM21    VM12    VM22    VM13
@{ROUTERS}        ROUTER_1    ROUTER_2
@{NET_1_VM_IPS}    10.1.1.3    10.1.1.4    10.1.1.5
...
Create VM13
    ...
    Create Vm Instances1    ${NETWORKS[0]}     ${VM_INSTANCES[4]}    sg=csit13

Ping Vm Instance1 From Network_13
    [Documentation]    Check reachability of vm instances by pinging to them.
    Get OvsDebugInfo
    Get DHCP Namespace List    ${NETWORKS[0]}
    Ping Vm From DHCP Namespace    ${NETWORKS[0]}    @{NET_1_VM_IPS}[2]
...
SSH Vm Instance1 From Network_13
    [Documentation]    Check reachability of vm instances by pinging to them.
    Get OvsDebugInfo
    SSH Namespace Network From Stack    ${NETWORKS[0]}    @{NET_1_VM_IPS}[2]
...
SSH Namespace Network From Stack
    ...
    ${output}=    Write Commands Until Expected Prompt    sudo route    20s
    Log    ${output}

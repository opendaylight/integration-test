...
Check ELAN Datapath Traffic Within The Networks
    ...
    ${output}=    Execute Command on VM Instance    @{NETWORKS}[0]    @{NET10_VM_IPS}[0]    ping -c 3 @{NET1_VM_IPS}[1]
...
Check L3_Datapath Traffic Across Networks With Router
    ...
    Log    ${other_dst_ip_list}
    ${output}=    Execute Command on VM Instance    @{NETWORKS}[0]    @{NET10_VM_IPS}[0]    ping -c 3 @{NET2_VM_IPS}[0]

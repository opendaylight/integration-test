...
Check ELAN Datapath Traffic Within The Networks
    ...
    Wait Until Keyword Succeeds    60s    5s    Check For Elements At URI    /restconf/config/odl-fib:fibEntries/    ${vm_instances}
...
Verify L3VPN Datapath with Router association
    [Documentation]    UC_26 Creates L3VPN and verify the same
...
Verify L3VPN datapath with Networks Association
    [Documentation]    UC_31 Associates L3VPN to networks and verify
    ${devstack_conn_id} =    Get ControlNode Connection

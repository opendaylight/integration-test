...
Verify Tunnel Creation
    ...
    Create TEP For Compute Node    ${OS_COMPUTE_1_IP}    ${node_1_dpid}    node1    ${subnet}    ${gateway}
    Create TEP For Compute Node    ${OS_COMPUTE_2_IP}    ${node_2_dpid}    node2    ${subnet}    ${gateway}

...
#    ${first_two_octets}    ${third_octet}    ${last_octet}=    Split String From Right    ${OS_COMPUTE_1_IP}    .
    ...    # 2
...
Verify ITM Tunnel
    [Documentation]    Verify the tunnels created by neutron
...
Delete And Recreate Interface On Router And Check The Datapath
    ...
    : FOR    ${INTERFACE}    IN    @{SUBNETS}
    \    Add Router Interface    ${ROUTERS[0]}    ${INTERFACE}
    #Add 30s delay for routes to propogate
    Sleep    30
...
Delete And Recreate L3VPN On Router And Check The Datapath

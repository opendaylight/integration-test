...
Create ITM Tunnel
    ...
    ITM Create Tunnel    tunneltype=vxlan    vlanid=0    prefix=${subnet}    gateway=${gateway}
    ...                  ipaddress1=${OS_COMPUTE_1_IP}    dpnid1=${node_1_dpid}    portname1=${node_1_adapter}
    ...                  ipaddress2=${OS_COMPUTE_2_IP}    dpnid2=${node_2_dpid}    portname2=${node_2_adapter}

...
Create Nova VMs
    ...
    Create Vm Instances    ${NETWORKS[0]}    VM13
...
Ping Vm Instance13 From Network_1
    ...
    Get OvsDebugInfo
    Get DHCP Namespace List    ${NETWORKS[0]}
    Ping Vm From ComputeNode    ${NETWORKS[0]}    10.1.1.5
...
Ping Vm From ComputeNode
    ...
    ${net_id}=    Get Net Id    ${net_name}    ${devstack_conn_id}
    Log    ${net_id}
    ${output}=    Run Command On Remote System    ${OS_COMPUTE_1_IP}    sudo ip netns list

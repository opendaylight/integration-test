...
Test Setup
    ...
    IP Assignment test for Vm Instance    ${VM_HOSTNAMES_1}    ${OS_COMPUTE_1_IP}
    IP Assignment test for Vm Instance    ${VM_HOSTNAMES_2}    ${OS_COMPUTE_2_IP}

...
TestCase1-Create VPN1 and VPN2 and bring VMs on them. Validate whether the VM from VPN1 is not accessible from VM in VPN2
...
TestCase2-Import/Export routes between VPN1 and VPN2, and validate the VMs in VPN1 are reachable from VPN2 on the same DPN

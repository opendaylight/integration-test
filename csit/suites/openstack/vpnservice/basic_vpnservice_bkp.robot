*** Settings ***
Documentation     Test suite to validate vpnservice functionality in an openstack integrated environment test.
...
Variables         ../../../variables/vpnservice/associate_nwstovpn.json
*** Variables ***

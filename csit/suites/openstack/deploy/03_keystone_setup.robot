...
Copy Fernet Keys and Admintoken
...
Configure HAProxy
    ...
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " ${bind_ip}:35357"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " default_backend keystone-admin-vms"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     $'\n'backend keystone-admin-vms
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " balance roundrobin"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " server keystone-admin-vm1 ${OS_CONTROL_1_IP}:35357 check inter 1s"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " server keystone-admin-vm2 ${OS_CONTROL_2_IP}:35357 check inter 1s"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " server keystone-admin-vm3 ${OS_CONTROL_3_IP}:35357 check inter 1s"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     $'\n'frontend keystone-public
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " ${bind_ip}:5000"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " default_backend keystone-public-vms"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     $'\n'backend keystone-admin-vms
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " balance roundrobin"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " server keystone-public-vm1 ${OS_CONTROL_1_IP}:5000 check inter 1s"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " server keystone-public-vm2 ${OS_CONTROL_2_IP}:5000 check inter 1s"
    Append To File      ${os_node_cxn}     /etc/haproxy/haproxy.cfg     " server keystone-public-vm3 ${OS_CONTROL_3_IP}:5000 check inter 1s"

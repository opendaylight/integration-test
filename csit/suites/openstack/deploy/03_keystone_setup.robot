...
Install Identity
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}      Chown File     ${OS_CONTROL_2_IP}     /etc/keystone/fernet-keys      keystone
    Run Keyword If    2 < ${NUM_CONTROL_NODES}      Chown File     ${OS_CONTROL_3_IP}     /etc/keystone/fernet-keys      keystone
...
Copy Fernet Keys
    ...
    Rsync Directory    ${os_node_cxn}      ${target_ip}     /etc/keystone/fernet-keys       /etc/keystone/fernet-keys

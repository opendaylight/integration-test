...
Destroy Openstack
    ...
    Run Command    ${os_node_cxn}    sudo rm -rf /etc/my.cnf.d /var/lib/mysql/ /var/lib/glance /var/lib/nova /etc/nova /etc/swift /etc/keystone /etc/haproxy /etc/openvswitch /etc/httpd /var/lib/rabbitmq

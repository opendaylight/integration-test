...
Install MySql Cluster
    ...
    Run Keyword If    4 < ${NUM_CONTROL_NODES}       Crudini Edit    ${os_node_cxn}    /etc/my.cnf.d/openstack.cnf    mysqld    wsrep_cluster_address    gcomm://${OS_CONTROL_1_IP},${OS_CONTROL_2_IP},${OS_CONTROL_3_IP},${OS_CONTROL_4_IP},${OS_CONTROL_5_IP}
    Run Keyword If    4 > ${NUM_CONTROL_NODES}       Crudini Edit    ${os_node_cxn}    /etc/my.cnf.d/openstack.cnf    mysqld    wsrep_cluster_address    gcomm://${OS_CONTROL_1_IP},${OS_CONTROL_2_IP},${OS_CONTROL_3_IP}
...
Configure Cluster Root Node
    ...
    ...    mysql
    #Grant Process To Mysql Database    ${os_node_cxn}    root    mysql    *.*    clustercheck_user    localhost
    ...    # my_clustercheck_password

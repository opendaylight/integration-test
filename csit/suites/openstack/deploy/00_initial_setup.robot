...
Install ODL
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Generic HAProxy Entry      ${OS_CONTROL_1_IP}     ${HAPROXY_IP}    8181     odl_rest 
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Generic HAProxy Entry      ${OS_CONTROL_1_IP}     ${HAPROXY_IP}    8080     odl_neutron 

...
Update the Distro
    ...
    Pass Execution If      '${UPGRADE_REQUIRED}' == 'no'
...
Get Crudini
    ...
    Pass Execution If      '${OS_APPS_PRE_INSTALLED}' == 'yes'
...
Get MemCached
    ...
    Run Keyword If    1 < ${NUM_CONTROL_NODES}     Crudini Edit     ${OS_CONTROL_2_IP}    /etc/sysconfig/memcached      ''      OPTIONS     "-l127.0.0.1,::1,${OS_CONTROL_2_IP}"
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}       Crudini Edit     ${OS_CONTROL_3_IP}    /etc/sysconfig/memcached      ''      OPTIONS     "-l127.0.0.1,::1,${OS_CONTROL_3_IP}"

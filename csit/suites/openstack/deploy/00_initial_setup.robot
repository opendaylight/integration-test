...
Install ODL From Local Rpm
    ...
    Install Local Rpm Package    ${OS_CONTROL_1_IP}    /tmp/${ODL_RPM}
    Run Keyword If    1 < ${NUM_CONTROL_NODES}    Install Local Rpm Package    ${OS_CONTROL_2_IP}    /tmp/${ODL_RPM}
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Install Local Rpm Package    ${OS_CONTROL_3_IP}    /tmp/${ODL_RPM}
    Run Keyword If    3 < ${NUM_CONTROL_NODES}    Install Local Rpm Package    ${OS_CONTROL_4_IP}    /tmp/${ODL_RPM}
    Run Keyword If    4 < ${NUM_CONTROL_NODES}    Install Local Rpm Package    ${OS_CONTROL_5_IP}    /tmp/${ODL_RPM}
    Install Feature as Boot    ${OS_CONTROL_1_IP}    odl-netvirt-openstack
    Run Keyword If    1 < ${NUM_CONTROL_NODES}    Install Feature as Boot    ${OS_CONTROL_2_IP}    odl-netvirt-openstack
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Install Feature as Boot    ${OS_CONTROL_3_IP}    odl-netvirt-openstack
    Run Keyword If    3 < ${NUM_CONTROL_NODES}    Install Feature as Boot    ${OS_CONTROL_4_IP}    odl-netvirt-openstack
...
Configure SNAT MODE In Odl
    ...
    Run Command      ${os_node_cxn}       sudo chmod -R 777 /opt/opendaylight/

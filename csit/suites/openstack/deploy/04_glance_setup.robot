...
Create And Configure Glance Db 
    ...
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     glance.*     ${db_user}    ${host_name}     ${mysql_pass}
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     glance.*     ${db_user}    localhost    ${mysql_pass}

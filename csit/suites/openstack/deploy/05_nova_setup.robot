...
Install Nova
    ...
    Run Keyword If    1 < ${NUM_COMPUTE_NODES}      Install Configure Nova Compute      ${OS_COMPUTE_1_IP}      ${OS_COMPUTE_1_IP}
...
Create And Configure Nova Db 
    ...
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     nova.*     ${db_user}    ${host_name}     ${mysql_pass}
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     nova.*     ${db_user}    localhost    ${mysql_pass}
    Create Database for Mysql    ${os_node_cxn}     ${mysql_user}     ${mysql_pass}     nova_api
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     nova_api.*     ${db_user}    ${host_name}     ${mysql_pass}
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     nova_api.*     ${db_user}    localhost    ${mysql_pass}
    Create Database for Mysql    ${os_node_cxn}     ${mysql_user}     ${mysql_pass}     nova_cell0
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     nova_cell0.*     ${db_user}    ${host_name}     ${mysql_pass}
    Grant Privileges To Mysql Database     ${os_node_cxn}    ${mysql_user}     ${mysql_pass}     nova_cell0.*     ${db_user}    localhost    ${mysql_pass}

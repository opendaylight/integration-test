...
List Computes
    Get Hypervisors        rc_file=/tmp/stackrc    
...
Install Configure Nova API
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}      Crudini Edit     ${os_node_cxn}       /etc/nova/nova.conf    DEFAULT     transport_url    "rabbit://openstack:rabbit@${HAPROXY_HOSTNAME}"

...
Install Configure Nova API
    ...
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      "<Directory /usr/bin>"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      " <IfVersion >= 2.4>"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      "  Require all granted"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      " </IfVersion>"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      " <IfVersion < 2.4>"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      "  Order allow,deny"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      "  Allow from all"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      " </IfVersion>"
    Append To File     ${os_node_cxn}     /etc/httpd/conf.d/00-nova-placement-api.conf      "</Directory>"

...
Create Required Image and Flavor
    Run Command    127.0.0.1     export http_proxy=$PROXY;wget http://download.cirros-cloud.net/0.3.5/cirros-0.3.5-x86_64-disk.img -O /tmp/cirros35.img;unset http_proxy 
...
Setup Passwordless Ssh
    ...
    Switch Connection     ${os_node_cxn}
    Write Commands Until Expected Prompt     ssh-copy-id ${user_name}@${node_ip}      word:     30s
    Write Commands Until Expected Prompt     ${user_name}      ${OS_NODE_PROMPT}     30s

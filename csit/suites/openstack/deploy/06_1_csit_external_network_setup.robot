...
Configure External Networks For Testing
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Create External Network For CSIT    flat1    101.0.0.2/24    101.0.0.1/24    ${OS_CONTROL_2_IP}
    ...    ${OS_CONTROL_2_IP}    9786
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Create External Network For CSIT    flat1    101.0.0.2/24    101.0.0.1/24    ${OS_CONTROL_3_IP}
    ...    ${OS_CONTROL_3_IP}    9786
    Run Keyword If    0 < ${NUM_COMPUTE_NODES}    Create External Network For CSIT    flat1    101.0.0.2/24    101.0.0.1/24    ${OS_COMPUTE_1_IP}
    ...    ${OS_COMPUTE_1_IP}    9786
    Run Keyword If    1 < ${NUM_COMPUTE_NODES}    Create External Network For CSIT    flat1    101.0.0.2/24    101.0.0.1/24    ${OS_COMPUTE_2_IP}
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Create External Network For CSIT    flat2    102.0.0.2/24    102.0.0.1/24    ${OS_CONTROL_2_IP}
    ...    ${OS_CONTROL_2_IP}    9787
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Create External Network For CSIT    flat2    102.0.0.2/24    102.0.0.1/24    ${OS_CONTROL_3_IP}
    ...    ${OS_CONTROL_3_IP}    9787
    Run Keyword If    0 < ${NUM_COMPUTE_NODES}    Create External Network For CSIT    flat2    102.0.0.2/24    102.0.0.1/24    ${OS_COMPUTE_1_IP}
    ...    ${OS_COMPUTE_1_IP}    9787
    Run Keyword If    1 < ${NUM_COMPUTE_NODES}    Create External Network For CSIT    flat2    102.0.0.2/24    102.0.0.1/24    ${OS_COMPUTE_2_IP}
    ...
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Create External Network For CSIT    physnet1    10.10.10.253/24    10.10.10.250/24    ${OS_CONTROL_2_IP}
    ...    ${OS_CONTROL_2_IP}    9788
    Run Keyword If    2 < ${NUM_CONTROL_NODES}    Create External Network For CSIT    physnet1    10.10.10.253/24    10.10.10.250/24    ${OS_CONTROL_3_IP}
    ...    ${OS_CONTROL_3_IP}    9788
    Run Keyword If    0 < ${NUM_COMPUTE_NODES}    Create External Network For CSIT    physnet1    10.10.10.253/24    10.10.10.250/24    ${OS_COMPUTE_1_IP}
    ...    ${OS_COMPUTE_1_IP}    9788
    Run Keyword If    1 < ${NUM_COMPUTE_NODES}    Create External Network For CSIT    physnet1    10.10.10.253/24    10.10.10.250/24    ${OS_COMPUTE_2_IP}

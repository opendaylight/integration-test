...
@{VM_INSTANCES}    sf1    sf2   sf3    source-vm    dest-vm
@{SUBNETS_RANGE}    30.0.0.0/24
@{PORTS}    p1in    p1out    p2in    p2out    p3in    p3out    source_vm_port    dest_vm_port
...
Create Vm Instances
    ...
    Create Vm Instance With Port    source_vm_port    source-vm    sg=sg-sfc
    Create Vm Instance With Port    dest_vm_port    dest-vm    sg=sg-sfc
...
Create Flow Classifiers
    [Documentation]    Create SFC Flow Classifiers for TCP and UDP traffic between source VM and destination VM
    Create SFC Flow Classifiers    FC_http    FIXME_SRC_IP    FIXME_DST_IP    tcp    80    FIXME_SOURCE_NEUTRON_PORT

Create Port Pairs
    [Documentation]    Create SFC Port Pairs
    Create SFC Port Pairs    PP1    p1in    p1out
    Create SFC Port Pairs    PP2    p2in    p2out
    Create SFC Port Pairs    PP3    p3in    p3out
...
Connectivity Tests From Vm Instance1 In network_1
    ...
    Test Operations From Vm Instance    network_1    source_vm    dest_vm

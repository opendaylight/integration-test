...
Create Vm Instances
    ...
    #Add New Image From Url     "https://cloud-images.ubuntu.com/releases/18.04/release/ubuntu-18.04-server-cloudimg-amd64.img"     ubuntu
    #Create New Flavor For Testing    ubuntu     2048    4
    Create Vm Instance With Ports    p1in    p1out    sf1    image=ubuntu    flavor=ubuntu    sg=${SECURITY_GROUP}
    Create Vm Instance With Port    source_vm_port    sourcevm    sg=${SECURITY_GROUP}    flavor=cirros256
    Create Vm Instance With Port    dest_vm_port    destvm    sg=${SECURITY_GROUP}    flavor=cirros256
...
Check Vm Instances Have Ip Address
    ...
    OpenStackOperations.View Vm Console     ${NET_1_VMS}

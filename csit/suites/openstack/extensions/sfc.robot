...
Create Flow Classifiers For Basic Test
    ...
    OpenStackOperations.Create SFC Flow Classifier    FC_81    @{NET1_VM_IPS}[0]    @{NET1_VM_IPS}[1]    tcp    source_vm_port    args=--destination-port 80:80
...
Create Port Chain For Src->Dest Port 80
    ...
    OpenStackOperations.Create SFC Port Chain    args=SFPC1 --port-pair-group SFPPG1 --flow-classifier FC_80
...
Create Port Chain For SRC->DEST and DEST->SRC
    [Documentation]    Create SFC Port Chain using port group and classifier created previously
    OpenStackOperations.Create SFC Port Chain    args=SFPC1 --port-pair-group SFPPG1 --flow-classifier FC_80
    OpenStackOperations.Create SFC Port Chain    args=SFPC2 --port-pair-group SFPPG2 --flow-classifier FC_81

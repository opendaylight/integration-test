...
Check If Instances Are Ready For Test
    ...
    BuiltIn.Wait Until Keyword Succeeds    300s    60s    OpenStackOperations.Check If NonCirros Instance Is Ready For Ssh Login    @{NETWORKS}[0]    @{NET1_VM_IPS}[0]    user=ubuntu
    BuiltIn.Wait Until Keyword Succeeds    300s    60s    OpenStackOperations.Check If NonCirros Instance Is Ready For Ssh Login    @{NETWORKS}[0]    @{NET1_VM_IPS}[1]    user=ubuntu

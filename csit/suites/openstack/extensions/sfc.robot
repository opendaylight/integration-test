...
Create Flow Classifiers
    ...
    Create SFC Flow Classifiers    FC_http    @{NET1_VM_IPS}[3]    @{NET1_VM_IPS}[4]    tcp    80    source_vm_port
...
Add Static Routing On Service Function VMs
    ...
    \    Execute Command on VM Instance    @{NETWORKS_NAME}[0]    @{NET1_VM@IPS}[${INDEX}]    sudo ip route add @{NET1_VM_IPS}[4] dev eth1
...
Connectivity Tests From Vm Instance1 In network_1
    ...
    Test Operations From Vm Instance    network_1    @{NET1_VM_IPS}[3]    @{NET1_VM_IPS}[4]

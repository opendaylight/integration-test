...
Create Vm Instances
    ...
    Generate And Add Keypair To OpenStack    sfctest    odlsfctest
    OpenStackOperations.Create Vm Instance With Ports And Key On Compute Node    p1in    p1out    sf1    ${OS_CMP2_HOSTNAME}    image=ubuntu    flavor=ubuntu

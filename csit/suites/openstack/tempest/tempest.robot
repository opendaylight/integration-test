...
tempest.scenario.TestNetworkAdvancedServerOps.test_server_connectivity_pause_unpause
    Run Tempest Tests    ${TEST_NAME}    ${exclusion_regex}    ${tempest_original_config_file}
tempest.scenario.TestNetworkBasicOps.test_connectivity_between_vms_on_different_networks
    Run Tempest Tests    ${TEST_NAME}    ${exclusion_regex}    ${tempest_original_config_file}
tempest.scenario.TestNetworkBasicOps.test_network_basic_ops
    Run Tempest Tests    ${TEST_NAME}    ${exclusion_regex}    ${tempest_original_config_file}

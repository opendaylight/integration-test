...
Log In To Tempest Executor And Setup Test Environment
    ...
    Run Keyword If    '${feature_check_status}' == 'True'    Create Network    Create Network    ${external_net_name}    --router:external --provider:network_type=flat --provider:physical_network=${external_physical_network}

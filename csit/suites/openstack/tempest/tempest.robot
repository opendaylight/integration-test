...
Log In To Tempest Executor And Source Credentials
    ...
    Write Commands Until Prompt    echo "[DEFAULT]" >> /tmp/tempest.conf
    Write Commands Until Prompt    echo "verbose = true" >> /tmp/tempest.conf
    Write Commands Until Prompt    echo "[network]" >> /tmp/tempest.conf
    Write Commands Until Prompt    echo "public_network_id = ${net_id}" >> /tmp/tempest.conf
    Write Commands Until Prompt    sudo cp /tmp/tempest.conf /etc/tempest/tempest.conf
    Write Commands Until Prompt    sudo cp /tmp/tempest.conf /opt/stack/tempest/etc/tempest/tempest.conf

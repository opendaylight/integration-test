...
Log In To Tempest Executor And Setup Test Environment
    ...
    ${OS_CONTROL_NODE_CXN}=     Run Keyword If     0 < ${NUM_OS_SYSTEM}       DevstackUtils.Get Ssh Connection     ${OS_CONTROL_NODE_IP}     control_1
    Run Keyword If     0 < ${NUM_OS_SYSTEM}       Set Suite Variable    ${OS_CONTROL_NODE_CXN}
    ${OS_COMPUTE_1_CXN}=     Run Keyword If     1 < ${NUM_OS_SYSTEM}       DevstackUtils.Get Ssh Connection     ${OS_COMPUTE_1_IP}     compute_1
    Run Keyword If     1 < ${NUM_OS_SYSTEM}       Set Suite Variable    ${OS_COMPUTE_1_CXN}
    ${OS_COMPUTE_2_CXN}=     Run Keyword If     2 < ${NUM_OS_SYSTEM}       DevstackUtils.Get Ssh Connection     ${OS_COMPUTE_2_IP}     compute_2

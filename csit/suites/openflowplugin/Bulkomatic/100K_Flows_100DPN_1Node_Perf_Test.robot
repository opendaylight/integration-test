...
Log Results And Determine Status
    ...
    Append To File    ${rate_results_file}    ${config_datastore_write_rate},${Mininet_write_rate},${Oper_ds_write_rate}\n
    Append To File    ${time_results_file}    Config DS,OVS Switch,Operatioanl DS\n
    Append To File    ${time_results_file}    ${config_datastore_write_time},${Mininet_write_time},${Oper_ds_write_time}\n

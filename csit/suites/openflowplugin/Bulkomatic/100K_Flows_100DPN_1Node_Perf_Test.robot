...
Start Mininet And verify Switches
    ...
    Wait Until Keyword Succeeds    ${mininet_timeout}    2s    ClusterOpenFlow.Verify_Switch_Connections_Running_On_Member    ${switch_count}    1
...
Add Bulk Flow
    ...
    Set Suite Variable    ${config_datastore_write_rate}
...
Verify Flows In Switch
    ...
    Set Suite Variable    ${Mininet_write_time}
    Set Suite Variable    ${Mininet_write_rate}

Verify Flows In Oper DS
    [Documentation]    Check Flows in Operational Datastore
    Wait Until Keyword Succeeds    ${oper_ds_timeout}    2s    ClusterOpenFlow.Check_Flows_Inventory_Oper_DS    ${flow_count_after_add}    1
    ...
    Log to console    ${\n}
    Log to console    The operational_datastore_write_time is ${oper_datastore_write_time}
    Log to console    The operational_datastore_write_rate is ${oper_datastore_write_rate}
    Set Suite Variable    ${oper_datastore_write_time}
    Set Suite Variable    ${oper_datastore_write_rate}

Stop Mininet And Verify
    [Documentation]    Stop mininet and exit connection.
    MininetKeywords.Stop Mininet And Exit    ${mininet_conn_id}
    Wait Until Keyword Succeeds    ${mininet_timeout}    2s    ClusterOpenFlow.Verify_Switch_Connections_Running_On_Member    0    1
...
Log Results And Determine Status
    ...
    Append To File    ${rate_results_file}    Config DS,OVS Switch,Operatioanl DS\n
    Append To File    ${rate_results_file}    ${config_datastore_write_rate},${Mininet_write_rate},${oper_datastore_write_rate}\n
    Append To File    ${time_results_file}    Config DS,OVS Switch,Operatioanl DS\n
    Append To File    ${time_results_file}    ${config_datastore_write_time},${Mininet_write_time},${oper_datastore_write_time}\n

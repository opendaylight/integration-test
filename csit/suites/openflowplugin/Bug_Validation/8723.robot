...
Create Two Active Switch Connections To Controller And Check OVS Connections
    ...
    # Make sure 2 connections are attempted for 5 secs
    sleep    5
    # If 2 connections have same DP ID, controller should disconnect both.
    BuiltIn.Wait Until Keyword Succeeds    5s    1s    OVSDB.Check OVS OpenFlow Connections    ${TOOLS_SYSTEM_IP}    0

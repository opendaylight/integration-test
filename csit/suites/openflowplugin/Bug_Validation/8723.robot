...
Create Two Active Switch Connections To Controller And Check OVS Connections
    ...
    # If 2 connections with same DP ID, controller should disconnect both.
    BuiltIn.Wait Until Keyword Succeeds    20s    1s    OVSDB.Check OVS OpenFlow Connections    ${TOOLS_SYSTEM_IP}    0

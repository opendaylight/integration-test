...
Start Mininet Multiple Connections
    ...
    ${mininet_conn_id}=    MininetKeywords.Start Mininet Multiple Controllers    ${TOOLS_SYSTEM_IP}    ${cluster_index_list}    --topo tree,1
...
Check Entity Owner Status And Find Owner and Successor
    ...
    ${original_owner}    ${original_successor_list}=    BuiltIn.Wait_Until_Keyword_Succeeds    60s    1s    ClusterOpenFlow.Get OpenFlow Entity Owner Status For One Device    openflow:1    1

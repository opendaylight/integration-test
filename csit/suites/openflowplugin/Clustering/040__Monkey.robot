...
${START_MONKEY_CMD}      sudo python ${MONKEY_SCRIPT_FILE} --monkey-count ${MONKEY_COUNT} --interval ${MONKEY_INTERVAL} --run-time ${RUN_TIME} --logfile ${MONKEY_LOG_FILE} --cluster-nodes ${ODL_SYSTEM_1_IP} ${ODL_SYSTEM_2_IP} ${ODL_SYSTEM_3_IP} --debug

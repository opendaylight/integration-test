...
Start Monkey Tests
    ...
    ${monkey_stdout}    ${monkey_stderr}=    SSHLibrary.Execute Command    ${START_MONKEY_CMD}     return_stderr=True
    BuiltIn.Log    ${monkey_stdout}
    BuiltIn.Log    ${monkey_stderr}

...
Restart Leader From Cluster Node
    ...
    ClusterKeywords.Kill Specific Controller           ${inventory_leader}
    ClusterKeywords.Start Specific Controller     ${START_TIMEOUT}      ${inventory_leader}
...
Restart Follower Node2
    ...
    ClusterKeywords.Kill Specific Controller       ${follower_node_2}
    ClusterKeywords.Start Specific Controller     ${START_TIMEOUT}      ${follower_node_2}

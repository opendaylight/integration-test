...
Restart Leader From Cluster Node
    ...
    ClusterKeywords.Kill One Or More Controllers    ${ODL_SYSTEM_${inventory_leader}_IP}
    ClusterKeywords.Start One Or More Controllers    ${ODL_SYSTEM_${inventory_leader}_IP}
    ClusterKeywords.Wait For Controller Sync    ${START_TIMEOUT}    ${ODL_SYSTEM_${inventory_leader}_IP}
...
Restart Follower Node2
    ...
    ClusterKeywords.Kill One Or More Controllers    ${ODL_SYSTEM_${follower_node_2}_IP}
    ClusterKeywords.Start One Or More Controllers    ${ODL_SYSTEM_${follower_node_2}_IP}
    ClusterKeywords.Wait For Controller Sync    ${START_TIMEOUT}    ${ODL_SYSTEM_${follower_node_2}_IP}

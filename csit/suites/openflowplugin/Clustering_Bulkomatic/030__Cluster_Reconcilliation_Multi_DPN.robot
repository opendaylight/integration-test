...
Resource          ../../../libraries/BulkomaticOpenFlow.robot
...
${orig_json_config_add}    sal_add_bulk_flow_small_config.json
${orig_json_config_get}    sal_get_bulk_flow_small_config.json
${orig_json_config_del}    sal_del_bulk_flow_small_config.json
...
Add Bulk Flow From Follower
    ...
    ${temp_json_config_add}    BulkomaticOpenFlow.Set DPN And Flow Count In Json Add    ${orig_json_config_add}    ${switch_count}    ${flow_count_per_switch}
...
Get Bulk Flows and Verify In Cluster
    ...
    ${temp_json_config_get}    BulkomaticOpenFlow.Set DPN And Flow Count In Json Get    ${orig_json_config_get}    ${switch_count}    ${flow_count_after_add}
...
Delete All Flows From Follower Node1
    ...
    ${temp_json_config_del}    BulkomaticOpenFlow.Set DPN And Flow Count In Json Del    ${orig_json_config_del}    ${switch_count}    ${flow_count_per_switch}
...
Remove All Temporary Json Files
    [Documentation]    Remove all temporary json files
    BulkomaticOpenFlow.Remove Temporary Json Files

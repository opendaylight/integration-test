*** Settings ***
Documentation     Test suite for 3Node Cluster HA with Bulk Flows - Cluster node convergance and Data consistency after leader and follower restart with fifteen switch connected
...
Check Shards Status After Leader Shutdown
    ...
    Wait Until Keyword Succeeds    ${operation_timeout}    3s    ClusterOpenFlow.Check OpenFlow Shards Status    ${Inventory_Followers}
...
#Karaf Console Messages
#    [Documentation]    Logs console messages 
#    ${output}    Issue Command On Karaf Console   ${cmd123} 
#    Log    ${output}

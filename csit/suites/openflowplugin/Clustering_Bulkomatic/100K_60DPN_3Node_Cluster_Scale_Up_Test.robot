*** Settings ***
Documentation     Test suite for 3Node Cluster - 100K flows in 60 DPNs
...
${flow_count_per_switch}    1667
${switch_count}    60
${flow_count_after_add}    100020
...
Add Bulk Flow From Leader
    [Documentation]    100020 Flows (1667 Flows per DPN) in 60 DPN added via Leader Node and verify it gets applied in all instances.
...
Delete All Flows From Leader Node
    [Documentation]    100020 Flows deleted via Leader Node and verify it gets applied in all instances.

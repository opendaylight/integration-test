...
RPC FlatBatch Failover
   ...
   ${ds_leader_idx}    ${ds_followers_idx_list}=    ClusterManagement.Get_State_Info_For_Shard    inventory     operational     ${controller_index_list}
...
FRM Failover Isolate
   ...
   #${ds_leader_idx}    ${ds_followers_idx_list}=    ClusterKeywords.Get Cluster Shard Status    ${controller_index_list}    operational    inventory
   ${ds_leader_idx}    ${ds_followers_idx_list}=    ClusterManagement.Get_State_Info_For_Shard    inventory     operational     ${controller_index_list}
   ${ds_leader_idx_0}      BuiltIn.Evaluate    ${ds_leader_idx}[0]
   ${ds_leader_ip}=    BuiltIn.Set Variable    ${ODL_SYSTEM_${ds_leader_idx_0}_IP}
   ...
   ClusterManagement.Isolate_Member_From_List_Or_All    ${ds_leader_idx_0}
   ...
   ClusterManagement.Rejoin_Member_From_List_Or_All   ${ds_leader_idx_0}
   #ClusterKeywords.Wait For Controller Sync     10 m    ${ds_leader_ip}
   BuiltIn.Wait Until Keyword Succeeds    1 x    10 m   ClusterManagement.Get_Sync_Status_Of_Member    ${ds_leader_idx_0}
...
FRM Failover Kill
   ...
   ClusterManagement.Kill_Members_From_List_Or_All  @{kill_controler_idx_list}
   ...
   ClusterManagement.Start_Single_Member    ${ds_leader_idx_0}  ${True}     5m
   BuiltIn.Should Be True    '${status_flows}' == 'PASS'
   BuiltIn.Should Be True    '${status_elections}' == 'PASS'
...
SW Restart Node Isolate Reconciliation
    ...
    ClusterManagement.Isolate_Member_From_List_Or_All    ${sw_leader_idx}
    ${status_flows}    ${return_flows}=            BuiltIn.Run Keyword And Ignore Error    BuiltIn.Wait Until Keyword Succeeds    5x    5s    Check Flow All Nodes    ${switch_name}    @{ds_followers_idx_list}
    ${status_elections_sw}    ${return_elections_sw}=    BuiltIn.Run Keyword And Ignore Error    BuiltIn.Wait Until Keyword Succeeds    5x    5s    Verify New Switch Leader    ${switch_name}    ${sw_leader_ip}
    BuiltIn.Log    ${status_flows}
    BuiltIn.Log    ${status_elections_sw}
...
RPC FlatBatch And FRM Failover Isolate With New Flows
    ...
    ${old_ds_leader_idx}    ${old_ds_followers_idx_list}=    ClusterManagement.Get_State_Info_For_Shard    inventory     operational     ${controller_index_list}
    ${old_ds_leader_idx_0}      BuiltIn.Evaluate    ${old_ds_leader_idx}[0]
    ${old_ds_leader_ip}=    BuiltIn.Set Variable    ${ODL_SYSTEM_${old_ds_leader_idx_0}_IP}
    ...
    ClusterManagement.Isolate_Member_From_List_Or_All    ${old_ds_leader_idx_0}
    ...
    ${ds_leader_idx}    ${ds_followers_idx_list}=    ClusterManagement.Get_State_Info_For_Shard     inventory     operational    ${old_ds_followers_idx_list}    ${ds_leader_ip}=    BuiltIn.Set Variable    ${ODL_SYSTEM_${old_ds_leader_idx}_IP}
    ...
    ClusterManagement.Rejoin_Member_From_List_Or_All   ${old_ds_leader_idx_0}
    #ClusterKeywords.Wait For Controller Sync     30 m    ${old_ds_leader_ip}
    BuiltIn.Wait Until Keyword Succeeds    1 x    30 m   ClusterManagement.Get_Sync_Status_Of_Member    ${old_ds_leader_idx_0}
    BuiltIn.Should Be True    '${status_elections_ds}' == 'PASS'
    BuiltIn.Should Be True    '${status_flows}' == 'PASS'
...
Get Switch Leader
    ...
    ${leader_idx}    ${followers_idx_list}=    ClusterManagement.Get_Owner_And_Successors_For_device   openflow:${idx}  openflow    @{CONTROLLER_NODES}
...
Verify New DS Leader
    ...
    ${ds_leader_idx}    ${ds_followers_idx_list}=    ClusterManagement.Get_State_Info_For_Shard    inventory     operational     ${cluster_node_idx_list}
    ${ds_leader_idx_0}      BuiltIn.Evaluate    ${ds_leader_idx}[0]
    ${ds_leader_ip}=    BuiltIn.Set Variable    ${ODL_SYSTEM_${ds_leader_idx_0}_IP}

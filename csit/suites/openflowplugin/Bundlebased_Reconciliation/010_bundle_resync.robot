...
TC01_Reconciliation check after switch restart
    ...
    Push Static Flow    ${TOOLS_SYSTEM_1_IP}
    ${switch_idx}    OVSDB.Get DPID    ${TOOLS_SYSTEM_1_IP}
    Push Flow Via Restcall    ${switch_idx}    ${FLOWFILE[6]}
    Utils.Run Command On Remote System    ${TOOLS_SYSTEM_1_IP}    sudo service openvswitch-switch restart
    ...
    ${Ovs1Flow}    Utils.Run Command On Remote System    ${TOOLS_SYSTEM_1_IP}    sudo ovs-ofctl dump-flows br-int -OOpenflow13

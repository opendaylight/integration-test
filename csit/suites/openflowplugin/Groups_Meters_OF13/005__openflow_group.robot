...
${REST_CONTEXT_CF}    ${RFC8040_NODES_API}/node=openflow%3A1
${REST_CONTEXT_OP}    ${RFC8040_NODES_API}/node=openflow%3A1
...
Get list of nodes
    ...
    Wait Until Keyword Succeeds    90s    1s    Check For Elements At URI    ${REST_CONTEXT_OP}${RFC8040_OPERATIONAL_API}    ${node_list}
...
Verify after adding group operational
    ...
    ...    weight    group-select
    Wait Until Keyword Succeeds    6s    2s    Check For Elements At URI    ${REST_CONTEXT_OP}/group=1${RFC8040_OPERATIONAL_API}    ${elements}
...
Verify after adding flow operational
    ...
    Wait Until Keyword Succeeds    6s    2s    Check For Elements At URI    ${REST_CONTEXT_OP}/table=0/flow=1${RFC8040_OPERATIONAL_API}    ${elements}

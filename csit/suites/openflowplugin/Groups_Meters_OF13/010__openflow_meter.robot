...
Get list of nodes
    ...
    Wait Until Keyword Succeeds    3s    1s    Check For Elements At URI    ${REST_CONTEXT_OP}${RFC8040_OPERATIONAL_API}    ${node_list}
...
Verify after adding meter operational
    ...
    Wait Until Keyword Succeeds    6s    2s    Check For Elements At URI    ${REST_CONTEXT_OP}/meter=1${RFC8040_OPERATIONAL_API}    ${elements}
...
Verify after adding flow operational
    ...
    Wait Until Keyword Succeeds    6s    2s    Check For Elements At URI    ${REST_CONTEXT_OP}/table=0/flow=2${RFC8040_OPERATIONAL_API}    ${elements}

...
Verify After Adding Group 1 In Operational DataStore
    ...
    ...    weight    group-select
    BuiltIn.Wait Until Keyword Succeeds    10s    1s    Utils.Check For Elements At URI    ${OPERATIONAL_NODES_API}/node/openflow:1/group/1    ${elements}
...
Verify After Adding Group 2 In Operational DataStore
    ...
    BuiltIn.Wait Until Keyword Succeeds    10s    1s    Utils.Check For Elements At URI    ${OPERATIONAL_NODES_API}/node/openflow:1/group/2    ${elements}
...
Verify After Adding Flow In Operational DataStore
    ...
    BuiltIn.Wait Until Keyword Succeeds    10s    1s    Utils.Check For Elements At URI    ${OPERATIONAL_NODES_API}/node/openflow:1/table/0/flow/1    ${elements}

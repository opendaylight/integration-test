...
Start Mininet And verify Switches
    ...
    ${mininet_conn_id}=    MininetKeywords.Start Mininet Multiple Controllers    options=--topo linear,${switch_count} --switch ovsk,protocols=OpenFlow13    ofport=${ofport}    protocol=${protocol}

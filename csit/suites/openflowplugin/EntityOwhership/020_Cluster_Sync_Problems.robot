...
Isolate Switchs Old Owner
    ...
    Collections.List Should Not Contain Value    ${old_followers}    ${old_owner}
    ...
    Collections.List Should Not Contain Value    ${followers}    ${owner}
...
Rejoin Switchs Old Owner
    ...
    Collections.List Should Not Contain Value    ${new_followers}    ${new_owner}
    Check Count Integrity    ${switch_name}    expected_controllers=3

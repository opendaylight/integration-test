...
Restarting Karaf Scenario
    ...
    BuiltIn.Set Test Variable    ${stopped_karaf}    ${None}
    ...
    [Teardown]    Run Keyword If    "${stopped_karaf}"!=${None}    Start Controller Node And Verify    ${stopped_karaf}
...
Stop Controller Node And Verify
    ...
    ClusterKeywords.Controller Down Check    ${node}

...
Start Suite
    ...
    \    RequestsLibrary.Create Session    controller${sid}    http://${ODL_SYSTEM_${sid}_IP}:${RESTCONFPORT}    auth=${AUTH}    headers=${HEADERS_XML}
...
Reconnecting Switch Scenario
    ...
    ${owner}   ${candidates}=     ClusterOpenFlow.Get OpenFlow Entity Owner Status For One Device    ${cntls_idx_list}    ${switch_name}

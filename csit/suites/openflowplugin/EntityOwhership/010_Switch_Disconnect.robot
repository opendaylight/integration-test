...
Disconnect Switchs Old Master
    ...
    Check Count Integrity    ${switch_name}    expected_controllers=1
...
Disconnect Switchs Follower
    ...
    BuiltIn.Wait Until Keyword Succeeds    5x    3s    Check Count Integrity    ${switch_name}    expected_controllers=1
    ${owner}    ${followers}=    ClusterManagement.Get Owner And Candidates For Device    openflow:${idx}    openflow    ${active_member}
...
Check Count Integrity
    [Arguments]    ${switch_name}    ${expected_controllers}=2

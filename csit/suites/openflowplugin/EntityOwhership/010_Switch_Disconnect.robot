...
Disconnect Switchs Old Master
    ...
    BuiltIn.Run Keyword If    '${ODL_STREAM}' == 'carbon' and '${ODL_OF_PLUGIN}' == 'lithium'    Check Count Integrity    ${switch_name}    expected_controllers=3
...
Disconnect Switchs Follower
    ...
    BuiltIn.Run Keyword If    '${ODL_STREAM}' == 'carbon' and '${ODL_OF_PLUGIN}' == 'lithium'    Collections.Lists Should Be Equal    ${followers}    ${old_followers}

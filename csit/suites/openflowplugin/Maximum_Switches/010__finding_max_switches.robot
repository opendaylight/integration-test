...
Find Max Switches
    ...
    \    ${max-switches}=    Set variable    ${switches}
    Log to console    ${\n}
    Log To Console    Execution stopped because: ${error_message}
    Log To Console    Max Switches: ${max_switches}
    OperatingSystem.Append To File    ${SWITCHES_RESULT_FILE}    Max Switches Linear Topo\n
    OperatingSystem.Append To File    ${SWITCHES_RESULT_FILE}    ${max_switches}\n
    OperatingSystem.Append To File    ${TIME_RESULT_FILE}    Topology Discover Time\n

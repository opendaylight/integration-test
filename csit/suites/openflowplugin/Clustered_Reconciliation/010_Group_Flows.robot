...
Disconnect Mininet From Successor
    ...
    #    Collections.Remove Values From List    ${successor_list}    ${original_owner}
    #    ${new_successor}=    Collections.Get From List    ${successor_list}    0
    #    ${current_successor}=    BuiltIn.Create List    ${new_successor}

...
#    ${controller_opt} =    BuiltIn.Catenate    ${controller_opt}    ${SPACE}tcp:${ODL_SYSTEM_${successor}_IP}:${ODL_OF_PORT}${SPACE}tcp:${ODL_SYSTEM_${successor}_IP}:${ODL_OF_PORT}
    Log    ${controller_opt}
    ${controller_opt} =    BuiltIn.Catenate    ${controller_opt}    ${SPACE}tcp:${ODL_SYSTEM_${successor}_IP}:${ODL_OF_PORT}
    Utils.Run Command On Mininet    ${TOOLS_SYSTEM_IP}    sudo ovs-vsctl set-manager ${controller_opt}
    ${ovsdb-manager} =    Utils.Run Command On Mininet    ${TOOLS_SYSTEM_IP}    sudo ovs-vsctl get-manager
    Log    ${ovsdb-manager} 

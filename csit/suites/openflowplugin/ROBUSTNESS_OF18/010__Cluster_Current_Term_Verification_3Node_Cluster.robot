...
Initial Current Term Verification
    ...
    ${Raftstate}    ${current_term_value_before}    ${data_object}    ${LastIndex}    ${LastApplied}    ClusterManagement.Get_Raft_State_Of_Shard_At_Member    ${shard_name}
    ...    ${shard_type}    ${Inventory_Leader}    ${verify_restconf}
...
Current Term Verification After Adding Bulk Flow
    ...
    ${Raftstate}    ${current_term_value_after}    ${data_object}    ${LastIndex}    ${LastApplied}    ClusterManagement.Get_Raft_State_Of_Shard_At_Member    ${shard_name}
    ...    ${shard_type}    ${Inventory_Leader}    ${verify_restconf}

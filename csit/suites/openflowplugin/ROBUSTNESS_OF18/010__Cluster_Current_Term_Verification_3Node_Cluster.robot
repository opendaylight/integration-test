...
Initial Current Term Verification
    ...
    ${current_term_value_before}    ClusterManagement.Get_Current_Term_Of_Shard_At_Member    ${shard_name}    ${shard_type}    ${Inventory_Leader}    ${verify_restconf}
...
Current Term Verification After Adding Bulk Flow
    ...
    ${current_term_value_after}    ClusterManagement.Get_Current_Term_Of_Shard_At_Member    ${shard_name}    ${shard_type}    ${Inventory_Leader}    ${verify_restconf}

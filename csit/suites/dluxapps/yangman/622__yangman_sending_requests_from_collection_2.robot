...
...               Verification that sending get requests from collections tab using send button with all checkboxes
...
...               Verification that sending get requests from collections tab using send button with save received data
...
...               Verification that sending get requests from collections tab using send button with save base response

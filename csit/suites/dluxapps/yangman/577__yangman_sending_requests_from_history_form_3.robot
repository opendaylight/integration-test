...
...               Verification that running delete requests from history using send button with all checkboxes in history
...               settings selected results in correct displaying of API and form content and status and time values of delete requests.
...               Verification that running delete requests from history using send button with fill form view with received data on history
...
...               Verification that running delete requests from history using send button with save base response data checkbox
...               unselected results in correct displaying of API and form content and status and time values of delete requests.
...               Verification that running delete requests from history using send button with save received data checkbox
...               unselected results in correct displaying of API and form content and status and time values of delete requests.
...
Delete t0 topology and navigate to history and verify request is present in history table
...
Send delete request from history using send button and verify requests are displayed in history
    YangmanKeywords.Navigate To Testing Module Config And Load Topology Topology Id Node In Form And Send Key_1 And Key_2 And Navigate To History    ${TOPOLOGY_ID_0}    ${TOPOLOGY_ID_1}    ${PUT_OPTION}    PUT
...
Unselect fill form with received data on request select checkbox and send delete requests from history using send button and verify API and form content and status and time values
    YangmanKeywords.Navigate To Testing Module Config And Load Topology Topology Id Node In Form And Send Key_1 And Key_2 And Navigate To History    ${TOPOLOGY_ID_0}    ${TOPOLOGY_ID_1}    ${PUT_OPTION}    PUT
    BuiltIn.Repeat Keyword    2 times    YangmanKeywords.Delete History Indexed Request Via Delete Request Button    0    0
...
Unselect save base response data checkbox and send delete requests from history using send button and verify status and time values of new requests are threedots
    YangmanKeywords.Navigate To Testing Module Config And Load Topology Topology Id Node In Form And Send Key_1 And Key_2 And Navigate To History    ${TOPOLOGY_ID_0}    ${TOPOLOGY_ID_1}    ${PUT_OPTION}    PUT
    BuiltIn.Repeat Keyword    2 times    YangmanKeywords.Delete History Indexed Request Via Delete Request Button    0    0
...
Unselect save received data checkbox and send delete requests from history using send button and verify status and time values of new requests are threedots
    YangmanKeywords.Navigate To Testing Module Config And Load Topology Topology Id Node In Form And Send Key_1 And Key_2 And Navigate To History    ${TOPOLOGY_ID_0}    ${TOPOLOGY_ID_1}    ${PUT_OPTION}    PUT
    BuiltIn.Repeat Keyword    2 times    YangmanKeywords.Delete History Indexed Request Via Delete Request Button    0    0

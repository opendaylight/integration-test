*** Settings ***
Documentation     Verification that GET requests that were run are present in history list with correct operation label
...               and API content and status and time values. Verification that unselecting fill form with received data
...               on request select checkbox results in correct displaying of API and form content and status and time values of GET requests.
...               Verification that unselecting save base response data checkbox and getting t0 and t1 topologies results in
...               correct displaying of API and form content and status and time values of GET requests.
...               Verification that unselecting save received data checkbox and getting t0 and t1 topologies results in
...               correct displaying of API and form content and status and time values, in this case threedots, of GET requests.
...               Verification that unselecting save received data checkbox and getting t0 and t1 topologies results in
...               correct displaying of API and form content and status and time values, in this case threedots, of GET requests.
...
Put t0 adn t1 topologies and get t0 and t0 topologies and navigate to history
...
Unselect save base response data checkbox and get t0 and t1 topologies and navigate to history and verify status and time values of new requests are threedots
...
Unselect save received data checkbox and get t0 and t1 topologies and navigate to history and verify status and time values of new requests are threedots
    ...
    ...    ${TOPOLOGY_ID_0}
    YangmanKeywords.Verify History Requests With Given Indeces Contain Data In Api And No Data In Form And Do Not Contain Status And Time Data    ${keys}    ${group_id}    0    3

...
...               Verification that running delete requests from collections tab using run request button with all checkboxes
...
...               Verification that running delete requests from collections tab using run request button with save received data
...
...               Verification that running delete requests from collections tab using run request button with save base response
...
Run requests from collections using run request button and verify these requests are present in history and verify API and form content and status and time values_1
...
Run requests from collections using run request button and verify these requests are present in history and verify API and form content and status and time values_2
...
Run requests from collections using run request button and verify these requests are present in history and verify API and form content and status and time values_3
    YangmanKeywords.Select And Expand Collection    0
    : FOR    ${index}    IN RANGE    0    2
    \    YangmanKeywords.Run Collection Indexed Request Via Run Request Button    ${collection_id_0}    ${index}
    YangmanKeywords.Navigate To History Tab

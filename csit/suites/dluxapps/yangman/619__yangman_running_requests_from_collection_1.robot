...
...               Verification that running put requests from collections tab using run request button with all checkboxes
...
...               Verification that running put requests from collections tab using run request button with save received data
...
...               Verification that running put requests from collections tab using run request button with save base response

...
...               Verification that running put requests from history using run request button with all checkboxes in history
...               settings selected results in correct displaying of API and form content and status and time values of put requests.
...               Verification that running put requests from history using run request button with fill form view with received data on history
...
...               Verification that running put requests from history using run request button with save base response data checkbox
...               unselected results in correct displaying of API and form content and status and time values of put requests.
...               Verification that running put requests from history using run request button with save received data checkbox
...               unselected results in correct displaying of API and form content and status and time values of put requests.
...
Run put requests from history using yangmenu run request button and verify requests are displayed in history
...
Unselect save base response data checkbox and run put requests from history using yangmenu run request button and verify status and time values of new requests are threedots

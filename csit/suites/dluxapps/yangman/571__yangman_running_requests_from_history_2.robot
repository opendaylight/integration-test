...
...               Verification that running get requests from history using run request button with all checkboxes in history
...               settings selected results in correct displaying of API and form content and status and time values of get requests.
...               Verification that running get requests from history using run request button with fill form view with received data on history
...
...               Verification that running get requests from history using run request button with save base response data checkbox
...               unselected results in correct displaying of API and form content and status and time values of get requests.
...               Verification that running get requests from history using run request button with save received data checkbox
...               unselected results in correct displaying of API and form content and status and time values of get requests.
...
Run get requests from history using yangmenu run request button and verify requests are displayed in history
...
Unselect save base response data checkbox and run get requests from history using yangmenu run request button and verify status and time values of new requests are threedots
...
Unselect save received data checkbox and run get requests from history using yangmenu run request button and verify status and time values of new requests are threedots

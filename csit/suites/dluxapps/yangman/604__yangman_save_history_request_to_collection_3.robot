...
...               using Save button results in the collection being displayed in the Collections tab with correct name.
...
Execute successful Put and Get and Delete operations and save each request to a single one collection using save button and verify collection is displayed in collections tab
    ...
    \    YangmanKeywords.Select History Request And Save It To Collection Using Save Button    0    ${index}    ${COLLECTION_NAME_0}

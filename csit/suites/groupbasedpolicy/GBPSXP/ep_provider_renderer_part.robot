...
Prepare_Renderer_Prerequisities
    ...
    \    BuiltIn.Wait_Until_Keyword_Succeeds    10x    3s    TemplatedRequests.Get_As_Xml_Templated    ${NETCONF_CONFIG_URI}/node/${IOS_XE_NODE_NAMES[${INDEX}]}/yang-ext:mount    session=session
    # config sfc
    # Sleep    5
    Utils.Add_Elements_To_URI_From_File    ${SFC_SERVICE_FUNCTIONS_URI}    ${SFC_SERVICE_FUNCTIONS_FILE}
    ...
    Utils.Add_Elements_To_URI_And_Verify    ${SFC_SF_FORWARDERS_URI}    ${sfc_sf_forwarders}
    Utils.Add_Elements_To_URI_From_File    ${SFC_SF_CHAINS_URI}    ${SFC_SF_CHAINS_FILE}
    Utils.Add_Elements_To_URI_From_File    ${SFC_SF_PATHS_URI}    ${SFC_SF_PATHS_FILE}
...
Wipe_Clean_Renderer_Policy_Cohort
    ...
    # clean sfc configs
    BuiltIn.Run_Keyword_And_Ignore_Error    Utils.Remove_All_Elements_If_Exist    ${SFC_SERVICE_FUNCTIONS_URI}
    BuiltIn.Run_Keyword_And_Ignore_Error    Utils.Remove_All_Elements_If_Exist    ${SFC_SF_FORWARDERS_URI}
    BuiltIn.Run_Keyword_And_Ignore_Error    Utils.Remove_All_Elements_If_Exist    ${SFC_SF_CHAINS_URI}
    BuiltIn.Run_Keyword_And_Ignore_Error    Utils.Remove_All_Elements_If_Exist    ${SFC_SF_PATHS_URI}

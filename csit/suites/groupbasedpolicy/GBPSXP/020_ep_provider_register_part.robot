...
Suite startup
    ...
    KarafKeywords.Execute_Controller_Karaf_Command_On_Background    feature:list -i
    KarafKeywords.Install a Feature    odl-sxp-controller
    Wait Until Keyword Succeeds    20    2    KarafKeywords.Verify Feature Is Installed    odl-sxp-controller

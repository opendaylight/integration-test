...
Configure sfc and ios-xe renderer using generated sgt
    ...
    should be equal as integers    100    ${security_group_json['source']['tag']}
    should be equal as integers    101    ${security_group_json['destination']['tag']}
...
Setup http and netconf
    ...
    ${logfile}    Utils.Get Log File Name    testtool
...
Teardown http and netconf
    ...
    \    RESTORE_CURRENT_SSH_CONNECTION_FROM_INDEX    ${ssh_session}
    \    Stop_Testtool
    Teardown_Ssh_Tooling    ${TOOLS_SESSIONS}
    Delete All Sessions

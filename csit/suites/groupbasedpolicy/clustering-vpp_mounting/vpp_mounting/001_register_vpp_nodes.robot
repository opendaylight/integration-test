...
Connect Controller
    ...
    Set Suite Variable    ${ODL_SYSTEM_IP}    ${ODL_SYSTEM_1_IP}
    Issue Command On Karaf Console    log:clear
    Register Node    controller    ${VPP_NODE_1}
...
Connect Compute 0
    ...
    Set Suite Variable    ${ODL_SYSTEM_IP}    ${ODL_SYSTEM_2_IP}
    Issue Command On Karaf Console    log:clear
    Register Node    compute0    ${VPP_NODE_2}
...
Connect Compute 1
    ...
    Set Suite Variable    ${ODL_SYSTEM_IP}    ${ODL_SYSTEM_3_IP}
    Issue Command On Karaf Console    log:clear
    Register Node    compute1    ${VPP_NODE_3}

...
Start VPP Nodes
    ...
    \   ConnUtils.Connect and Login    ${VPP_NODE}    10s
    \   SSHLibrary.Put File    ${scripts_dir}/*    ${VM_HOME_FOLDER}${/}${VM_SCRIPTS_FOLDER}/    mode=0755
    ...
    \   Log    ${out}
    \   Wait Until Keyword Succeeds    10 x    15 sec    Check For Honeycomb Start
    \   Wait Until Keyword Succeeds    10 x    5 sec    Check For Honeycomb Port    8283
    \   SSHLibrary.Close Connection

Check For Honeycomb Start
    [Documentation]    Check for service and start message in honeycomb log
    ${log}    SSHLibrary.Execute Command    service honeycomb status
    Log    ${log}

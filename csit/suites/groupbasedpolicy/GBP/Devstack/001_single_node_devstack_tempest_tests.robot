...
Run Devstack Gate Wrapper
    ${output}  ${sdderr}  ${rc}  Execute Command  neutron --version  return_stderr=True  return_stdout=TRUE  return_rc=TRUE
    Log    ${output}
    Log    ${stderr}
    Log    ${rc}
    ${output}  ${sdderr}  ${rc}  Execute Command  sudo neutron --version  return_stderr=True  return_stdout=TRUE  return_rc=TRUE
    Log    ${output}
    Log    ${stderr}
    Log    ${rc}
    Write Commands Until Prompt    cd $HOME/devstack
    ${results}    Write Commands Until Prompt    ls
    Log    ${result}
    Write Commands Until Prompt    cd $opt/stack/devstack
    ${results}    Write Commands Until Prompt    ls
    Log    ${result}

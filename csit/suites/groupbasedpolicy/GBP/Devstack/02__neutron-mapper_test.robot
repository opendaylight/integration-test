...
Test neutron security-group-create
    ...
    \    ${security_group_id}     Wrap Command and Execute
    ...  neutron security-group-create ${security_group} | grep -v _id | grep -w id | awk '{print $4}'
    \    Should Not Be Empty    ${security_group_id}
...
Start Suite
    ...
    Utils.Flexible SSH Login    ${usr}    #${pwd} - TODO is var in variables.py
...
Create neutron port
    ...
    ${mac_address}    Wrap Command and Execute

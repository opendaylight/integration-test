...
${SF_PATH}                      /rests/data/service-function:service-functions
${SF_FILE}                      ${CURDIR}/../../../../variables/gbp/6node/service_functions.json
${SFF_PATH}                     /rests/data/service-function-forwarder:service-function-forwarders
${SFF_FILE}                     ${CURDIR}/../../../../variables/gbp/6node/service_function_forwarders.json
${SFC_PATH}                     /rests/data/service-function-chain:service-function-chains
...
${SFP_PATH}                     /rests/data/service-function-path:service-function-paths
${SFP_ASYMM_FILE}

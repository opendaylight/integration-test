...
Put Service Function Chains
    ...
    Add Elements To URI From File    ${SFC_PATH}    ${SFC_SYMM_FILE}

Put Service Function Paths
    [Documentation]    Register Service Function Paths to ODL
    Add Elements To URI From File    ${SFP_PATH}    ${SFP_SYMM_FILE}
...
Put Tenant
    ...
    Add Elements To URI From File    ${TENANT_PATH}    ${TENANT_SYMM_FILE}

...
Setup Everything
    ...
    \    Log    ${stdout}
    \    Log    ${stderr}
    \    ${stdout}    ${stderr}=    SSHLibrary.Execute Command    cd /home/jenkins; ls -la    return_stderr=True
    \    Log    ${stdout}
    \    Log    ${stderr}
    \    ${stdout}    ${stderr}=    SSHLibrary.Execute Command    echo "export ODL=${CONTROLLER}" >> /home/${MININET_USER}/.profile    return_stderr=True
    \    Log    ${stdout}
    \    Log    ${stderr}

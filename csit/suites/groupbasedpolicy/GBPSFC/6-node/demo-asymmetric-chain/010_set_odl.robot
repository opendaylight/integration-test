...
Put Tunnels
    ...
    ${edited_json}     Replace String    ${edited_json}    CLASSIFIER2    ${MININET5}
...
Put Service Functions
    ...
    ${edited_json}     Replace String    ${json_to_edit}    SF1    ${MININET2}
    ${edited_json}     Replace String    ${edited_json}    SF2    ${MININET4}
...
Put Service Function Forwarders
    ...
    ${edited_json}     Replace String    ${json_to_edit}    SFF1    ${MININET1}
    ${edited_json}     Replace String    ${edited_json}    SFF2    ${MININET3}

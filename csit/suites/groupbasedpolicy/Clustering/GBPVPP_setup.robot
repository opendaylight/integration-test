...
Setup Nodes
    ...
    ${out}    SSHLibrary.Execute Command    ${VM_HOME_FOLDER}${/}${VM_SCRIPTS_FOLDER}/start-docker.sh 10.100.0.2/24 10.100.0.3/24 10.101.0.2/24
    Log    ${out}
    ...
    ${out}    SSHLibrary.Execute Command    ${VM_HOME_FOLDER}${/}${VM_SCRIPTS_FOLDER}/start-docker.sh 10.100.0.4/24 10.100.0.5/24 10.101.0.3/24
    Log    ${out}

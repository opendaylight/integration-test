...
Inicilaize ODL
    ...
    RequestsLibrary.Create Session    session    http://${ODL_SYSTEM_IP}:${RESTCONFPORT}
    Add Elements To URI From File And Verify    /restconf/config/neutron:neutron    ${NEUTRON_FILE}

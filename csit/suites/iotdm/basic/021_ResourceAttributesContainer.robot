...
1.1 After Created, test whether all the mandatory attribtues are exist.
    ...
    ${text} =    Text    ${r}
    Should Contain Sub List    ${text}    "ri":    "rn":    "cni"    "lt":    "pi":
    ...    "st":    "ct":    "ty":3    "cbs"
    Should Not Contain Sub List    ${text}    "lbl"    "creator"    "or"
    #==================================================
...
2.41 labels can be created through update (0-1)
    ...
    ${r} =    update Resource    ${iserver}    InCSE1/Container1    ${rt_container}    ${attr}
    ${text} =    Check Response and Retrieve Resource For Update    ${r}    InCSE1/Container1
    Should Contain Sub List    ${text}    lbl    label1
...
2.42 labels can be modified (1-1)
    ...
    Should Contain Sub List    ${text}    lbl    label2
...
2.43 if set to null, labels should be deleted(1-0)
    ...
    ${r} =    update Resource    ${iserver}    InCSE1/Container1    ${rt_container}    ${attr}
    ${text} =    Check Response and Retrieve Resource For Update    ${r}    InCSE1/Container1
    Should Not Contain Sub List    ${text}    lbl    label1    label2
...
2.44 labels can be created through update (0-n)
    ...
    ${r} =    update Resource    ${iserver}    InCSE1/Container1    ${rt_container}    ${attr}
    ${text} =    Check Response and Retrieve Resource For Update    ${r}    InCSE1/Container1
    Should Contain Sub List    ${text}    lbl    label3    label4    label5
...
2.45 labels can be modified (n-n)(across)
    ...
    ${r} =    update Resource    ${iserver}    InCSE1/Container1    ${rt_container}    ${attr}
    ${text} =    Check Response and Retrieve Resource For Update    ${r}    InCSE1/Container1
    Should Not Contain Sub List    ${text}    label1    label2    label3
    Should Contain Sub List    ${text}    lbl    label4    label5    label6
...
2.46 labels can be modified (n-n)(not across)
    ...
    ${r} =    update Resource    ${iserver}    InCSE1/Container1    ${rt_container}    ${attr}
    ${text} =    Check Response and Retrieve Resource For Update    ${r}    InCSE1/Container1
    Should Not Contain Sub List    ${text}    label1    label2    label3    label4    label5    label6
    Should Contain Sub List    ${text}    lbl    label7    label8    label9
...
2.47 if set to null, labels should be deleted(n-0)
    ...
    ${r} =    update Resource    ${iserver}    InCSE1/Container1    ${rt_container}    ${attr}
    ${text} =    Check Response and Retrieve Resource For Update    ${r}    InCSE1/Container1
    Should Not Contain Sub List    ${text}    label1    label2    label3    label4    label5    label6    label7
    ...    label8    label9    lbl
    #======================================================
...
3.11 Mulitiple maxNrofInstance should return error
    ...
    Should Contain Sub List    ${error}    Duplicate key    mni
...
3.12 Mulitiple maxByteSize should return error
    ...
    ${error} =    Create Container Expect Cannot Create Error    ${attr}
    Should Contain Sub List    ${error}    Duplicate key    mbs
...
3.13 Multiple creator should return error
    ...
    ${error} =    Create Container Expect Cannot Create Error    ${attr}
    Should Contain Sub List    ${error}    Duplicate key    cr
...
3.14 Multiple ontologyRef should return error
    ...
    ${error} =    Create Container Expect Cannot Create Error    ${attr}
    Should Contain Sub List    ${error}    Duplicate key    or
...
3.14 Multiple label attribute should return error(multiple array)
    ...
    ${error} =    Create Container Expect Cannot Create Error    ${attr}
    Should Contain Sub List    ${error}    Duplicate key    lbl
...
4.81 creator -- value must be null
    ...
    ${error} =    Run Keyword And Expect Error    Cannot create this resource [400]*    Create Resource    ${iserver}
    ...    InCSE1/Container1    ${rt_container}    ${attr}
    Should Contain Sub List    ${error}    error    cr
    #==================================================
    #    Finish
    #==================================================

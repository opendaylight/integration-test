...
1.15 Valid Update AE's label
    ...
    ${Json} =    Convert To String    ${r.text}
    Should Contain All Sub Strings    ${Json}    "aaa"    "bbb"    "ccc"
    Should Contain All Sub Strings    ${r.json()['m2m:ae']['lbl']}    aaa    bbb    ccc
    #==================================================
    #    Container Test
    #==================================================
...
2.14 Update Container Label
    ...
    ${Json} =    Convert To String    ${r.text}
    Should Contain All Sub Strings    ${Json}    "aaa"    "bbb"    "ccc"
    Should Contain All Sub Strings    ${r.json()['m2m:cnt']['lbl']}    aaa    bbb    ccc
    #----------------------------------------------------------------------

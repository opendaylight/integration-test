...
2.00.03 Default result of onem2m-plugin-manager-iotdm-plugin-registrations RPC - MQTT
    ...
    TemplatedRequests.Post_As_Json_Templated_Check_Response_Empty    folder=${VAR_BASE}/iotdm_plugin_registrations/mqtt/default
...
5.00.03 Default Communication channel for MQTT plugin
    ...
    TemplatedRequests.Post_As_Json_Templated_Check_Response_Empty    folder=${VAR_BASE}/communication_channels/mqtt/default
...
Verify Default PluginData Output
    ...
    TemplatedRequests.Post_As_Json_Templated_Check_Response_Empty    folder=${VAR_BASE}/plugin_data/mqtt/default

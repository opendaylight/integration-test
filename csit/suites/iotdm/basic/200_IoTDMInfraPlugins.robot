...
6.05 Restart IoTDM and verify configuration of all plugins
    ...
    Restart Cluster
    BuiltIn.Wait_Until_Keyword_Succeeds    60 sec    1 sec    TemplatedRequests.Post_As_Json_Templated    folder=${VAR_BASE}/plugin_data/changed_data    session=ClusterManagement__session_1    verify=True

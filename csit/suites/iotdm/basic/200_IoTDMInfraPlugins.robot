...
1.00 Default result of onem2m-plugin-manager-iotdm-plugin-registrations RPC
    ...
    ...    ${REST_CONTEXT}/onem2m-plugin-manager:onem2m-plugin-manager-iotdm-plugin-registrations    headers=${headers}
    Set Suite Variable    ${global_resp}    ${resp}
...
1.01 Registration parameters of HTTP IoTDM plugin
    ...
    Should Contain    ${global_resp.content}    registered-iotdm-plugin-instances

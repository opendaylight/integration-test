...
Find Json Children By Value 
    ...
    \    return from keyword if    '''${value}''' in '''${json[${INDEX}]}'''
    ...    ${json[${INDEX}]}
...
Check Common Data
    ...
    Run Keyword If    '${test}'=='onem2m-plugin-manager-iotdm-plugin-registrations'    Run Keywords
    ...    Test data 1    ${resp}    ${jArgument}    ${jArgumentSpecific}    AND
    ...    Test data 3    ${resp}    ${jArgument}    ${jArgumentSpecific}
    ...    ELSE IF    '${test}'=='onem2m-plugin-manager-db-api-client-registrations'    Run Keywords
    ...    Test data 3    ${resp}    ${jArgument}    ${jArgumentSpecific}    AND
    ...    Test data 2    ${resp}    ${jArgument}    ${jArgumentSpecific}
    ...    ELSE IF    '${test}'=='onem2m-plugin-manager-simple-config-client-registrations'
    ...    Test data 3    ${resp}    ${jArgument}    ${jArgumentSpecific}
    ...    ELSE IF    '${test}'=='onem2m-plugin-manager-plugin-data'    Run Keywords
    ...    Test data 1    ${resp}    ${jArgument}    ${jArgumentSpecific}    AND
    ...    Test data 2    ${resp}    ${jArgument}    ${jArgumentSpecific}    AND
    ...    Test data 3    ${resp}    ${jArgument}    ${jArgumentSpecific}

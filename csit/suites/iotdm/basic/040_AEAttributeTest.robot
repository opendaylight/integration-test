...
3.33 resouceNme cannot be update.(write once)
    ...
    Should Contain    ${error}    Resource Name cannot be updated:
...
3.36 app-id cannot be update
    ...
    Should Contain    ${error}    APP_ID cannot be updated
...
3.37 ae-id cannot be updated
    ...
    Should Contain    ${error}    CONTENT(pc) AE_ID should be assigned by the system, please do not include aei

...
@{VNI_NET_0_VMS}    vni_l3_net_0_vm_1
@{VNI_NET_1_VMS}    vni_l3_net_1_vm_1
@{VNI_NET_2_VMS}    vni_l3_net_2_vm_1
@{VNI_NET_3_VMS}    vni_l3_net_3_vm_1
@{VNI_NET_4_VMS}    vni_l3_net_4_vm_1
@{VNI_NET_5_VMS}    vni_l3_net_5_vm_1
...
VNI Based L3 Forwarding With BGPVPN Network Association
    ...
    Wait Until Keyword Succeeds    60s    5s    OVSDB.Verify Vni Segmentation Id and Tunnel Id    @{VNI_NET_2_PORTS}[0]    @{VNI_NET_3_PORTS}[0]    @{VNI_NETWORKS}[2]
...
VNI Based L3 Forwarding With BGPVPN With Irt Ert
    ...
    Wait Until Keyword Succeeds    60s    5s    OVSDB.Verify Vni Segmentation Id and Tunnel Id    @{VNI_NET_4_PORTS}[0]    @{VNI_NET_5_PORTS}[0]    @{VNI_NETWORKS}[4]

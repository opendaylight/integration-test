...
VNI Based L3 Forwarding
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify Vni Segmentation Id and Tunnel Id    @{VNI_NET_0_PORTS}[0]    @{VNI_NET_1_PORTS}[0]    @{VNI_NETWORKS}[0]
...
VNI Based L3 Forwarding With BGPVPN Network Association
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify Vni Segmentation Id and Tunnel Id    @{VNI_NET_2_PORTS}[0]    @{VNI_NET_3_PORTS}[0]    @{VNI_NETWORKS}[2]
...
VNI Based L3 Forwarding With BGPVPN With Irt Ert
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify Vni Segmentation Id and Tunnel Id    @{VNI_NET_4_PORTS}[0]    @{VNI_NET_5_PORTS}[0]    @{VNI_NETWORKS}[4]

...
Create VM Instances in DPN1
    ...
    \    ${InstanceId}    ${VM_IP}    Create Vm Instance With Port On Compute Node    ${PORT_LIST[${Index}]}    ${VM_LIST[${Index}]}    ${OS_CNTL_HOSTNAME}    sg=${SGP_ID}
...
Create VM Instances in DPN2
    ...
    \    ${InstanceId}    ${VM_IP}    Create Vm Instance With Port On Compute Node    ${PORT_LIST[${Index}]}    ${VM_LIST[${Index}]}    ${OS_CMP1_HOSTNAME}    sg=${SGP_ID}
    \    ${portmac}    Get Port Mac    ${PORT_LIST[${Index}]}

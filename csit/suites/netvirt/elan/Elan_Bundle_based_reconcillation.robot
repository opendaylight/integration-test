...
@{VM_NAMES_NAMES}      elan_bundle_dpn_1_vm_1    elan_bundle_dpn_1_vm_2    elan_bundle_dpn_2_vm_1    elan_bundle_dpn_2_vm_2
...
Start Suite
    ...
    BuiltIn.Wait Until Keyword Succeeds    30s   5s    KarafKeywords.Check Karaf Log Message Count      ${DEBUG_MSG}     ${1}    False
    Create Setup

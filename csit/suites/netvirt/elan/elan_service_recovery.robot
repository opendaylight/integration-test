...
${REQ_SUBNET}     elansr_sub_net_1
${REQ_SUBNET_CIDR}    85.1.0.0/16
${SECURITY_GROUP}    elanservice_sg
...
To Verify ELAN Service Recovery
    ...
    FlowLib.Delete Flows From ODL    ${DPNID_1}    ${ELAN_SMAC_TABLE}    @{PORT_MAC_ADDR}[0]
    FlowLib.Delete Flows From ODL    ${DPNID_2}    ${ELAN_SMAC_TABLE}    @{PORT_MAC_ADDR}[2]

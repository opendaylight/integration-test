...
${REQ_NETWORK}    elans_net1
@{VM_INSTANCES_DPN1}    elansr_vm1_dpn1    elansr_vm2_dpn1
@{VM_INSTANCES_DPN2}    elansr_vm3_dpn2    elansr_vm4_dpn2
@{NET_1_VMS}      elansr_net1_vm1    elansr_net1_vm2
@{NET_2_VMS}      elansr_net2_vm3    elansr_net2_vm4
@{PORT_LIST}      elansr_net1_port1    elansr_net1_port2    elansr_net1_port3    elansr_net1_port4
${REQ_SUBNET}     elansr_subnet1

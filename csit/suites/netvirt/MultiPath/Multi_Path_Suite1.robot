...
*** Variables ***
@{PORT_LIST}    MULTIPATH_PORT1    MULTIPATH_PORT2    MULTIPATH_PORT3    MULTIPATH_PORT4    MULTIPATH_PORT5    MULTIPATH_PORT6    MULTIPATH_PORT7    MULTIPATH_PORT8
@{VM_LIST}    NOVA_VM1    NOVA_VM2    NOVA_VM3    NOVA_VM4    NOVA_VM5    NOVA_VM6    NOVA_VM7    NOVA_VM8
...
TC02 Verify Distribution of traffic - 2 VM on CSS1 , 2 VM on CSS2
    ...
    Log    Update the Router with MultiPath Route
    Update Router    ${ROUTER_NAME}    --no-route

...
Suite Setup       BuiltIn.Run Keywords    KarafKeywords.Setup Karaf Keywords    AND    Create Session    session    http://${ODL_SYSTEM_IP}:${RESTCONFPORT}    auth=${AUTH}    headers=${HEADERS}

...
Suite Setup       BuiltIn.Run Keywords    Create Session    session    http://${ODL_SYSTEM_IP}:${RESTCONFPORT}    auth=${AUTH}    headers=${HEADERS}    AND    ClusterManagement.ClusterManagement_Setup

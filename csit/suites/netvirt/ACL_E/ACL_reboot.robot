...
Verify ICMP traffic with between two VMs with Security Group after restarting the OVSDB in Multi-DPN 
    ...
    Wait Until Keyword Succeeds    240 sec    60 sec    Run Command On Remote System    ${OS_CMP1_CONN_ID}    ${cmd}
    Wait Until Keyword Succeeds    240 sec    60 sec    Run Command On Remote System    ${OS_CMP1_CONN_ID}    ${cmd1}
    ...
    ${ijk}    Run Command On Remote System    ${OS_CMP1_CONN_ID}    ${cmd2}

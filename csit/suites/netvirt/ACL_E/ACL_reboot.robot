...
${br_name}    br-int
${cmd}    sudo /usr/share/openvswitch/scripts/ovs-ctl stop
${cmd1}    sudo /usr/share/openvswitch/scripts/ovs-ctl start
${cmd2}    sudo ovs-ofctl -O OpenFlow13 dump-flows br-int | grep table=210
...
Verify ICMP traffic with between two VMs with Security Group after restarting the OVSDB in Multi-DPN 
    ...
    Wait Until Keyword Succeeds    240 sec    60 sec    Run Command On Remote System    ${OS_COMPUTE_1_IP}    ${cmd}
    Wait Until Keyword Succeeds    240 sec    60 sec    Run Command On Remote System    ${OS_COMPUTE_1_IP}    ${cmd1}
    ...
    ${ijk}    Run Command On Remote System    ${OS_COMPUTE_1_IP}    ${cmd2}

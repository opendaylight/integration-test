...
TC01 Verify Distribution of traffic with weighted buckets-3 VM on CSS1 , 2 VM on CSS2
    ...
    ${RouterUpdateCmd}    Set Variable    --route destination=${StaticIp}/32,gateway=${VM_IPs[0]} --route destination=${StaticIp}/32,gateway=${VM_IPs[1]} --route destination=${StaticIp}/32,gateway=${VM_IPs[2]} 
#--route destination=${StaticIp}/32,gateway=${VM_IPs[3]} --route destination=${StaticIp}/32,gateway=${VM_IPs[4]}

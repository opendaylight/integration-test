...
@{allowed_ip}    100.100.100.100    100.100.100.100
...
#--route destination=${StaticIp}/32,gateway=${VM_IPs[2]} --route destination=${StaticIp}/32,gateway=${VM_IPs[3]} --route destination=${StaticIp}/32,gateway=${VM_IPs[4]}
    ...
    ...    sudo ifconfig eth0:0 ${StaticIp}/24 netmask 255.255.255.0 up
    ...    AND    Execute Command on VM Instance    Network1    ${VM_IPs[1]}    sudo ifconfig eth0:0 ${StaticIp}/24 netmask 255.255.255.0 up
#    ...    AND    Execute Command on VM Instance    Network1    ${VM_IPs[2]}    sudo ifconfig eth0:0 ${StaticIp}/24 netmask 255.255.255.0 up
#    ...    AND    Execute Command on VM Instance    Network1    ${VM_IPs[3]}    sudo ifconfig eth0:0 ${StaticIp}/24 netmask 255.255.255.0 up
#    ...    AND    Execute Command on VM Instance    Network1    ${VM_IPs[4]}    sudo ifconfig eth0:0 ${StaticIp}/24 netmask 255.255.255.0 up

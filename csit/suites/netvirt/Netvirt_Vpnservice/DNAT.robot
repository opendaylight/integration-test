...
TC06 Verify_de-provision_of_1_floating_IP_from_2_Floating_IPs_which_are_distributed_across_2_neutron_ports_across_2_Vswitches
    ...
    ${floating_ip_id2_new}    Create Floating IP    ${EXT_NETWORK}
    Set Global Variable    ${floating_ip_id2_new}
    Associate Floating IP To Port    ${floating_ip_id2_new}    ${port_id2}
    ${floating_ip_add2}    Get Floating IP Address    ${floating_ip_id2_new}
...
TC10 Verify_disassociation_of_subnet(which_has_FIP_is_assigned)_from_router
    ...
    [Teardownn]    BuiltIn.Run Keywords      Delete SubNet    ${EXT_SUBNET}     AND     Delete Network    ${EXT_NETWORK}

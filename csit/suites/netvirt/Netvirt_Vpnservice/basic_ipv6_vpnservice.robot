...
Create Neutron Subnets
    ...
    ${additional_args}=    Set Variable    --ip-version=6 --ipv6-address-mode=slaac --ipv6-ra-mode=slaac
    Create SubNet    ${NETWORKS[0]}    ${SUBNETS[0]}    ${SUBNET_CIDR[0]}    ${additional_args}
    Create SubNet    ${NETWORKS[1]}    ${SUBNETS[1]}    ${SUBNET_CIDR[1]}    ${additional_args}

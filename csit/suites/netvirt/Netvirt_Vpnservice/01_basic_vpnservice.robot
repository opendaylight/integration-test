...
Check L3_Datapath Traffic Across Networks With Router
    ...
    \    Wait Until Keyword Succeeds    30s    5s    Verify Flows Are Present For L3VPN    ${ip}    ${vm_instances}
...
Delete Router And Router Interfaces With L3VPN
    ...
    Should Not Contain    ${resp}    ${router_id}
    : FOR    ${ip}    IN    @{OS_CMP_IPS}
    \    Wait Until Keyword Succeeds    30s    5s    Verify GWMAC Flow Entry Removed From Flow Table    ${ip}

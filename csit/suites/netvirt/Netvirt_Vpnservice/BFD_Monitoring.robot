...
TC01 Verify That Default Tunnel Type Is Set To BFD
    ...
    Wait Until Keyword Succeeds    60s    10s    Verify VXLAN interface
...
Create Setup
    ...
    #    ${VM_IP_NET1}    ${DHCP_IP1}    Wait Until Keyword Succeeds    180s    20s    Verify VMs Received DHCP Lease
    ...    # @{VM_INSTANCES_NET1}
    #    Log    ${VM_IP_NET1}
    #    Set Suite Variable    ${VM_IP_NET1}
    #    ${VM_IP_NET2}    ${DHCP_IP2}    Wait Until Keyword Succeeds    180s    20s    Verify VMs Received DHCP Lease
    ...    # @{VM_INSTANCES_NET2}
    #    Log    ${VM_IP_NET2}
    #    Set Suite Variable    ${VM_IP_NET2}
    #    ${VM_IP_NET1}    ${DHCP_IP1}    Wait Until Keyword Succeeds    180s    10s    Verify VMs Received DHCP Lease
    ...    # @{VM_INSTANCES_NET1}
    #    Log    ${VM_IP_NET1}
    #    Set Suite Variable    ${VM_IP_NET1}
    #    ${VM_IP_NET2}    ${DHCP_IP2}    Wait Until Keyword Succeeds    180s    10s    Verify VMs Received DHCP Lease
    ...    # @{VM_INSTANCES_NET2}
    #    Log    ${VM_IP_NET2}
    #    Set Suite Variable    ${VM_IP_NET2}
    ${VM_IP_NET1}    ${VM_IP_NET2}    Wait Until Keyword Succeeds    180s    20s    Verify VMs received IP
    Set Suite Variable    ${VM_IP_NET2}
    Set Suite Variable    ${VM_IP_NET1}
#    ${output}=    Wait Until Keyword Succeeds    180s    20s    Execute Command on VM Instance    @{NETWORKS}[0]    30.1.1.3    ping -c 3 30.1.1.4
#    Should Contain    ${output}    ${PING_REGEXP}
#    ${output}=    Wait Until Keyword Succeeds    180s    20s    Execute Command on VM Instance    @{NETWORKS}[1]    40.1.1.3    ping -c 3 40.1.1.4
#    Should Contain    ${output}    ${PING_REGEXP}

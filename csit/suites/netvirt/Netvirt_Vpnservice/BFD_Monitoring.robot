...
TC04
    ...
    ${ifconfig_output}=    Run Command On Remote System    ${OS_COMPUTE_1_IP}    sudo route add -net 11.1.1.60 netmask 255.255.255.255 gw 192.168.2.21
 ${ifconfig_output}=    Run Command On Remote System    ${OS_COMPUTE_1_IP}    sudo route del -net 11.1.1.60 netmask 255.255.255.255 gw 192.168.2.21

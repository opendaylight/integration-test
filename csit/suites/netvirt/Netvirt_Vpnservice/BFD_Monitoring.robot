...
Create Setup
    ...
    #ITM Delete Tunnel     default-transport-zone
    ${output}=    ITM Get Tunnels
    Log    ${output}
    ${resp}    RequestsLibrary.Delete Request    session    /restconf/config/itm:transport-zones
    Log      ${resp.content}
    ${resp}    RequestsLibrary.Delete Request    session    /restconf/config/ietf-interfaces:interfaces/
    Log      ${resp.content}
    #${output}=    ITM Get Tunnels
    #Log    ${output}

...
Variables         ../../../variables/netvirt/put.json
...
#    ${All_PORT_STATUS}    SW_GET_ALL_PORT_STATUS    ${OS_COMPUTE_1_IP}    br-int
#    Log    ${All_PORT_STATUS}
#    ${All_PORT_STATUS}    SW_GET_ALL_PORT_STATUS    ${OS_COMPUTE_2_IP}    br-int
#    Log    ${All_PORT_STATUS}

TC02
    [Documentation]    Test Case 1
    Log    Disabling the tunnel monitoring from REST
    TemplatedRequests.Post_As_Json_Templated    folder=${VAR_BASE}/tunnel_monitoring     session=session
    #${resp}    RequestsLibrary.Put Request    session    ${TUNNEL_MONITOR_PUT}    data=${put}

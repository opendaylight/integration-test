...
Check L3_Datapath Traffic Across Networks With Router
    ...
    \    Wait Until Keyword Succeeds    30s    10s    Verify GWMAC Flow Entry On Flow Table    ${ip}    ipv4
...
Verify L3VPN Datapath With Router Association
    ...
    Wait Until Keyword Succeeds    30s    10s    Verify GWMAC Entry On ODL    ${GWMAC_ADDRS}
    : FOR    ${ip}    IN    @{OS_CMP_IPS}
    \    Wait Until Keyword Succeeds    30s    10s    Verify GWMAC Flow Entry On Flow Table    ${ip}

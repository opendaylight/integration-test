...
Add Interfaces To Router For V6 Test
...
Create Neutron Ports For V6 Tests
...
Check ELAN Datapath Traffic Within The Networks For V6 Test
...
Check L3_Datapath Traffic Across Networks With Router For V6 Tests
...
Add Multiple Extra Routes And Check Datapath Before L3VPN Creation For V6 Tests
...
Delete Extra Route For V6 Test
    [Documentation]    Delete the extra routes
    Update Router    @{ROUTERS}[0]    ${RT_CLEAR}
    Show Router    @{ROUTERS}[0]    -D

Delete And Recreate Extra Route For V6 Test
...
Associate L3VPN To Routers For V6 Test
...
Verify L3VPN Datapath With Router Association For V6 Test
...
Dissociate L3VPN From Routers For V6 Test
...
Delete Router And Router Interfaces With L3VPN For V6 Test
...
Delete Router With NonExistentRouter Name For V6 Test
...
Associate L3VPN To Networks For V6 Test
...
Dissociate L3VPN From Networks For V6 Test
...
Delete L3VPN For V6 Test
    [Documentation]    Delete L3VPN
    VPN Delete L3VPN    vpnid=${VPN_INSTANCE_ID[0]}

Create Multiple L3VPN For V6 Test
...
Delete Multiple L3VPN For V6 Test

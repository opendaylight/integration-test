...
Verify BGP Configuration After OVS restart
    [Documentation]    Verify BGP configuration after OVS restart
...
Verify BGP Configuration After Delete and Re-create BGP Neighbor From ODL
    [Documentation]    Delete and re-create BGP Neighbor on ODL and verify the configuration
...
Delete BGP Config On ODL
    ...
    Should Not Contain    ${output}    ${DCGW_SYSTEM_1_IP}
    Should Not Contain    ${output}    ${DCGW_SYSTEM_2_IP}
    [Teardown]    Run Keywords    Collect ZRPCD Log From ODL
    ...    AND    Get Test Teardown Debugs

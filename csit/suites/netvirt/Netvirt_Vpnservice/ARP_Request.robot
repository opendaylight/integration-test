...
${FIB_ENTRY_MIP_REGEX}    destPrefix\\":\\"${FIB_ENTRY_2}\/32\\",\\"label\\":\\d+,\\"nextHopAddressList\\":\\[\\"${OS_COMPUTE_2_IP}\\"\\],\\"origin\\":\\"[a-z]
...
TC01
    ...
    Log    ${resp.content}
    ${resp}=    Should Match Regexp    ${resp.content}    ${FIB_ENTRY_MIP_REGEX}
    Log    ${resp}

...
Create Nova VMs
    ...
    ${VM_IP_NET10}    ${DHCP_IP1}    Wait Until Keyword Succeeds    60s    5s    Verify And Collect VM DHCP Addresses    @{VM_INSTANCES_NET10}
    ${VM_IP_NET20}    ${DHCP_IP2}    Wait Until Keyword Succeeds    60s    5s    Verify And Collect VM DHCP Addresses    @{VM_INSTANCES_NET20}

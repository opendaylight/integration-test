...
Check L3_Datapath Traffic Across Networks With Router
    ...
    Start Tcpdumping    ${OS_COMPUTE_1_IP}    file_Name=tcpDumpCN1
    Start Tcpdumping    ${OS_COMPUTE_2_IP}    file_Name=tcpDumpCN2
    Start Tcpdumping    ${OS_CONTROL_NODE_IP}    file_Name=tcpDumpOS
    ...
    [Teardown]    Test Teardown With Tcpdump Stop
...
Test Teardown With Tcpdump Stop
    Stop Tcpdumping    ${OS_COMPUTE_1_IP}
    Stop Tcpdumping    ${OS_COMPUTE_2_IP}
    Stop Tcpdumping    ${OS_CONTROL_NODE_IP}

...
Delete Router With NonExistentRouter Name
    ...
    ${output}=    Run Keyword If    '${OPENSTACK_BRANCH}'=='stable/mitaka'    Write Commands Until Prompt    neutron router-list | grep "nonExistentRouter" | awk '{print $2}'    30s
    ...    ELSE    Write Commands Until Prompt    openstack router list | grep "nonExistentRouter" | awk '{print $2}'    30s
    Close Connection

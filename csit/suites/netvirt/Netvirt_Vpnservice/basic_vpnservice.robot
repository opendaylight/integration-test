...
Create BGP Config On DCGW
    ...
    Create BGP and Add Neighbor On quagga    ${DCGW_SYSTEM_IP}    ${AS_ID}    ${DCGW_SYSTEM_IP}    ${ODL_SYSTEM_IP}    ${VPN_NAME[0]}    ${DCGW_RD}     ${LOOPBACK_IP} 
    ...
    Log    ${output}
    ${output} =    Execute Show Command On Quagga    ${DCGW_SYSTEM_IP}     show bgp neighbors
    Log    ${output}
...
Verify End To End L3 Datapath with DCGW

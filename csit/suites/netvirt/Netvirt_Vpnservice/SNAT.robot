...
@{EXT_MULTISUBNET}    ext-sub1    ext-sub1
...
TC07 Verify_provisioning_multiple_floating_IPs_distributed_across_neutron_routers
...
Dump Flows
    ...
    Log    ${flow_output_2}
    ${flow_output_1}=    Run Command On Remote System    ${OS_COMPUTE_1_IP}    sudo ovs-ofctl -O OpenFlow13 dump-groups br-int
    Log    ${group_output_1}
    ${flow_output_2}=    Run Command On Remote System    ${OS_COMPUTE_2_IP}    sudo ovs-ofctl -O OpenFlow13 dump-groups br-int
    Log    ${group_output_2}

...
TC14 Verify_update_router_with_scenario_where_externalIPs_are_more_than_subnet_associated_to_router
...
TC15 Verify_update_router_with_scenario_where_externalIPs_are_less_than_subnets_associated_to_router
    ...
    ${primary_flow}    Run Keyword If    ${primary_dpid}=${dpnid1}    Get Flows For Primary DPN    ${OS_COMPUTE_1_IP}
    ${Primary_flow}    Run Keyword If    ${primary_dpid}=${dpnid2}    Get Flows For Primary DPN    ${OS_COMPUTE_2_IP}
    [Teardown]     Get Test Teardown Debugs

TC16 Verify_update_router_from_multiple_externalIPs_to_single_externalIP

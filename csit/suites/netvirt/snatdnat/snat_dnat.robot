...
${ROUTER}         nat_router
${TABLE_NO_44}    table=44
${TABLE_NO_46}    table=46
...
Create BGP Config On ODL
    ...
    BgpOperations.Create BGP Configuration On ODL    localas=${DCGW_RD}    routerid=${ODL_SYSTEM_IP}
    BgpOperations.AddNeighbor To BGP Configuration On ODL    remoteas=${DCGW_RD}   neighborAddr=${DCGW_SYSTEM_IP}
...
Create BGP Config On DCGW
    ...
    BgpOperations.Configure BGP And Add Neighbor On DCGW    ${DCGW_SYSTEM_IP}    ${DCGW_RD}    ${DCGW_SYSTEM_IP}    ${ODL_SYSTEM_IP}    ${VPN_NAME}    ${DCGW_RD}
    ...    ${LOOPBACK_IPS}

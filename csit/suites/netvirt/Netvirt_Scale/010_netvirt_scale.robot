...
Suite Setup       NeutronNB Setup
Suite Teardown    Scalability Suite Teardown
Test Setup        Log Testcase Start To Controller Karaf
Resource          ${CURDIR}/../../../libraries/MininetKeywords.robot
Resource          ${CURDIR}/../../../libraries/NeutronNB.robot
Resource          ${CURDIR}/../../../libraries/OvsManager.robot
Resource          ${CURDIR}/../../../libraries/OVSDB.robot
Resource          ${CURDIR}/../../../libraries/Scalability.robot
...
Get Neutron NB Final State
    ...
    NeutronNB.Get Neutron Networks    shell=${tools_system_shell}

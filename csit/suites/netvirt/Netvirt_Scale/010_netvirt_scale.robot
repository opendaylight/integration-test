...
*** Test Cases ***
Verify No OVS
    [Documentation]    Various checks to verify OVS Mininet network is down at test start
    Scalability.Check No Switches
    Scalability.Check No Topology
...
Verify OVS
    [Documentation]    Various checks to verify OVS Mininet network is up and connected to ODL

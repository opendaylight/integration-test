...
Start Mininet
    ...
    ${status}    ${result}    BuiltIn.Run Keyword And Ignore Error    Wait Until Keyword Succeeds    ${switches*2}    10s    Check Linear Topology    ${switches}
    Should Not Be Equal As Strings    ${status}    FAIL

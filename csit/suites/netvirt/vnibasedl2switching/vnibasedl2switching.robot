...
VNI Based L2 Switching
    ...
    ${egress_tun_id}    ${before_count_egress_port1} =    Get Tunnel Id And Packet Count    ${OS_CMP1_CONN_ID}    ${ELAN_DMACTABLE}    direction=@{direction}[0]    port_mac1=${port_mac2}
    ...    port_mac2=${port_mac2}
    ...
    ${tun_id}    ${after_count_egress_port1} =    Get Tunnel Id And Packet Count    ${OS_CMP1_CONN_ID}    ${ELAN_DMACTABLE}    direction=@{direction}[0]    port_mac1=${port_mac2}
    ...    port_mac2=${port_mac2}

...
VNI Based L2 Switching
    ...
    ${egress_tun_id}    ${before_count_egress_port1} =    Get Tunnel Id And Packet Count    ${OS_CMP1_CONN_ID}    ${ELAN_DMACTABLE}    direction=@{direction}[0]    port_mac1=${port_mac1}
    ...    port_mac2=${port_mac2}
    Should Be Equal As Numbers    ${segmentation_id}    ${egress_tun_id}
    ${egress_tun_id}    ${before_count_egress_port2} =    Get Tunnel Id And Packet Count    ${OS_CMP2_CONN_ID}    ${ELAN_DMACTABLE}    direction=@{direction}[0]    port_mac1=${port_mac1}
    ...    port_mac2=${port_mac2}
    Should Be Equal As Numbers    ${segmentation_id}    ${egress_tun_id}
    ...
    ${tun_id}    ${after_count_egress_port1} =    Get Tunnel Id And Packet Count    ${OS_CMP1_CONN_ID}    ${ELAN_DMACTABLE}    direction=@{direction}[0]    port_mac1=${port_mac1}
    ...    port_mac2=${port_mac2}
    ...
    ${tun_id}    ${after_count_egress_port2} =    Get Tunnel Id And Packet Count    ${OS_CMP2_CONN_ID}    ${ELAN_DMACTABLE}    direction=@{direction}[0]    port_mac1=${port_mac1}
    ...    port_mac2=${port_mac2}
...
Get Tunnel Id And Packet Count
    ...
    [Documentation]    Get tunnel id and packet count from specified table id and port mac.

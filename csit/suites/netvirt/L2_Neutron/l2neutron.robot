...
${BGP_AS_ID}      500
${DCGW_SYSTEM_IP}    192.168.122.170
...
DCGW Suite Setup
    ...
    ${dcgw_conn_id}=    SSHLibrary.Open Connection    ${DCGW_SYSTEM_IP}    prompt=${DCGW_PROMPT}
    Set Suite Variable    ${dcgw_conn_id}
    Log    ${dcgw_conn_id}
    Utils.Flexible SSH Login    mininet    mininet
    ...
    Create BGP and Add Neighbor On DCGW    ${BGP_AS_ID}    ${DCGW_SYSTEM_IP}    ${ODL_SYSTEM_IP}
...
Configure ODL Setup
    ...
    AddNeighbor To BGP Configuration On ODL    remoteas=${BGP_AS_ID}    neighborAddr=${DCGW_SYSTEM_IP}

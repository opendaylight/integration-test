...
Start Mininet Multiple Connections
    ...
    ${mininet_conn_id}    Ovsdb.Add Multiple Managers to OVS    ${TOOLS_SYSTEM_IP}    ${ClusterManagement__member_index_list}
...
Create External Net for Tenant
    ...
    Log    ${Data}
    ClusterManagement.Put_As_Json_And_Check_Member_List_Or_All    ${NEUTRON_NETWORKS_API}/networks/${EXT_NET1_ID}    ${Data}    1

Delete External Net for Tenant
    [Documentation]    Create External Net for Tenant
    [Tags]    OpenStack Call Flow
    ClusterManagement.Delete_And_Check_Member_List_Or_All    ${NEUTRON_NETWORKS_API}/networks/${EXT_NET1_ID}    1

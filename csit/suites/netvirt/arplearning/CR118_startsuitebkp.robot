...
TC11_Verify GWMAC entires are populated with port MAC address for network to VPN association in GWMAC table
    ...
    #${rtr_id}    Get Router Id    ${ROUTER}
    ${output}=    FIB Output
    Check RD And Subnet In FIB Entry    ${output}     100:31     ${REQ_SUBNET_CIDR[0]}     192.168.113.10
    Check RD And Subnet In FIB Entry    ${output}     100:31     ${REQ_SUBNET_CIDR[1]}     192.168.113.10

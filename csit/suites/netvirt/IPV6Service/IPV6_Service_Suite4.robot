...
Verify ping6 between VM on CSS and VM on TOR in same ELAN
    ...
    :FOR    ${elem}    IN    @{array}
    \    Wait Until Keyword Succeeds    40 sec    10 sec    Verify Ovs-vsctl Output    show    ${elem}
    \    ...    ${TOOLS_SYSTEM_1_IP}
    ...
    ${net1_id}    Get Net Id    ${conn_id_1}    ${Networks[0]}
    ${net2_id}    Get Net Id    ${conn_id_1}    ${Networks[1]}

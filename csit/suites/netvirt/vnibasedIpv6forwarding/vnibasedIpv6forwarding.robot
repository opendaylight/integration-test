...
Suite Teardown
    ...
    OpenStackOperations.Delete Vm Instance     @{VNI6_NET_4_VMS}[0]
    OpenStackOperations.Delete Vm Instance     @{VNI6_NET_5_VMS}[0]
    ...
    OpenStackOperations.Delete Port     @{VNI6_NET_4_PORTS}[0]
    OpenStackOperations.Delete Port     @{VNI6_NET_5_PORTS}[0]

...
@{log_level}      TRACE org.opendaylight.netvirt.aclservice    TRACE org.opendaylight.genius.interfacemanager    TRACE org.opendaylight.genius.srm
...
Start Suite
    ...
    KarafKeywords.Issue Command On Karaf Console    log:set ${log_level}[0]
    KarafKeywords.Issue Command On Karaf Console    log:set ${log_level}[1]
    KarafKeywords.Issue Command On Karaf Console    log:set ${log_level}[2]

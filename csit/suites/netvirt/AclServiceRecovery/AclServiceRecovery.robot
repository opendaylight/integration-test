...
ACL Service Recovery CLI
    ...
    ${node_id}    Get Dpn Id    ${OS_CMP1_CONN_ID}
...
ACL Instance Recovery CLI
    ...
    ${output}=    OpenStack CLI    openstack security group show ${SECURITY_GROUP} | awk '/ id / {print $4}'    ${DEFAULT_LINUX_PROMPT_STRICT}
...
ACL Interface Recovery CLI
    ...
    OpenStackOperations.Get DumpFlows And Ovsconfig    ${OS_CMP1_CONN_ID}
    SSHLibrary.Switch Connection    ${OS_CMP1_CONN_ID}
    ${output}=    OpenStack CLI    openstack port show ${NET_1_PORTS[0]} |awk '/ mac_address / {print$4}'    ${DEFAULT_LINUX_PROMPT_STRICT}
    @{list}=    Split String    ${output}
    ...
    ${output}=    OpenStack CLI    openstack port show ${NET_1_PORTS[0]} |awk '/ id / {print$4}'    ${DEFAULT_LINUX_PROMPT_STRICT}
    ${splitted_output} =    String.Split String    ${output}    ${EMPTY}
...
Get Dpn Id
    ...
    ${Bridgename1}    Set Variable    br-int
    log    ${Bridgename1}

...
ACL Service Recovery CLI
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify ACL Flows    ${OS_CMP1_CONN_ID}    ${table_ids[0]}
...
ACL Instance Recovery CLI
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify ACL Flows    ${OS_CMP1_CONN_ID}    ${table_ids[1]}    icmp
...
ACL Interface Recovery CLI
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify ACL Flows    ${OS_CMP1_CONN_ID}    ${table_ids[2]}    ${port_mac}

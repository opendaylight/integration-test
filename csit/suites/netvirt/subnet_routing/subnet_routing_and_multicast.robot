...
@{NET_1_VMS}      multicast_net1_vm1    multicast_net1_vm2    multicast_net1_vm3    multicast_net1_vm4
@{NET_2_VMS}      multicast_net2_vm1    multicast_net2_vm2    multicast_net2_vm3    multicast_net2_vm4
@{NET_3_VMS}      multicast_net3_vm1    multicast_net3_vm2    multicast_net3_vm3    multicast_net3_vm4
@{NET_1_PORTS}    multicast_net1_port1    multicast_net1_port2    multicast_net1_port3    multicast_net1_port4
@{NET_2_PORTS}    multicast_net2_port1    multicast_net2_port2    multicast_net2_port3    multicast_net2_port4
@{NET_3_PORTS}    multicast_net3_port1    multicast_net3_port2    multicast_net3_port3    multicast_net3_port4
...
@{REQ_VM_INSTANCES_NET1}    multicast_net1_vm1    multicast_net1_vm2    multicast_net1_vm3    multicast_net1_vm4
@{REQ_VM_INSTANCES_NET2}    multicast_net2_vm1    multicast_net2_vm2    multicast_net2_vm3    multicast_net2_vm4
@{REQ_VM_INSTANCES_NET3}    multicast_net3_vm1    multicast_net3_vm2    multicast_net3_vm3    multicast_net3_vm4
${LOOPBACK_IP}    5.5.5.2
...
Create Setup
    ...
    OpenStackOperations.Set Instance Quota For Admin Project    30
...
Create L3VPN
    ...
    VpnOperations.VPN Create L3VPN    vpnid=${VPN_INSTANCE_ID[0]}    name=${VPN_NAME[0]}    rd=["${L3VPN_RD}"]    exportrt=["${L3VPN_RD}"]    importrt=["${L3VPN_RD}"]    tenantid=${tenant_id}
...
Create BGP Config On DCGW
    ...
    BgpOperations.Configure BGP And Add Neighbor On DCGW    ${DCGW_SYSTEM_IP}    ${AS_ID}    ${DCGW_SYSTEM_IP}    ${ODL_SYSTEM_IP}    ${VPN_NAME[0]}    ${L3VPN_RD}
    ...    ${LOOPBACK_IP}

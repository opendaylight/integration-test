...
Get SNAT NAPT Switch DPIN ID
    ...
    ${output} =    Utils.Run Command On Remote System    ${OS_CMP1_IP}    curl -v -u admin:admin GET http://${ODL_SYSTEM_1_IP}:${RESTCONFPORT}${CONFIG_API}/odl-nat:napt-switches/router-to-napt-switch

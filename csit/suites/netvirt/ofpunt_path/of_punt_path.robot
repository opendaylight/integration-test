...
Verify learnt flow in table=195 and table=196 for ARP request
    ...
    OVSDB.Verify Dump Flows For Specific Table    ${OS_CMP1_IP}    ${ARP_PUNT_TABLE_1}   True     ${EMPTY}    arp_tpa=@{EXTRA_NW_IP}[1],arp_op=1
    OVSDB.Verify Dump Flows For Specific Table    ${OS_CMP1_IP}    ${ARP_PUNT_TABLE_2}   True    ${EMPTY}    arp_tpa=@{VM_IPS}[3],arp_op=1
...
Verify learnt flow in table=195 and table=196 for ARP reply
    ...
    OVSDB.Verify Dump Flows For Specific Table    ${OS_CMP1_IP}    ${ARP_PUNT_TABLE_1}   True     ${EMPTY}    arp_tpa=@{EXTRA_NW_IP}[0],arp_op=1
    OVSDB.Verify Dump Flows For Specific Table    ${OS_CMP1_IP}    ${ARP_PUNT_TABLE_2}   True    ${EMPTY}    arp_tpa=@{VM_IPS}[1],arp_op=1
    #${count_after_traffic}    Get Packet Count from Default Flow    ${OS_COMPUTE_2_IP}    ${ARP_PUNT_TABLE_1}
...
Verify learnt flow in table=195 and table=196 for GARP
    ...
    OVSDB.Verify Dump Flows For Specific Table    ${OS_CMP1_IP}    ${ARP_PUNT_TABLE_1}   True     ${EMPTY}    arp_tpa=@{VM_IPS}[0],arp_op=1
    ...
    OVSDB.Verify Dump Flows For Specific Table    ${OS_CMP1_IP}    ${ARP_PUNT_TABLE_2}   True     ${EMPTY}    arp_tpa=@{VM_IPS}[0],arp_op=1

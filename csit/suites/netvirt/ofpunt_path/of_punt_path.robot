...
Verify resync subnet, SNAT and ARP route flow table after disconnect and reconnecting CSC-CSS control path
    ...
    Restart Karaf
    Sleep    120s
    BuiltIn.Run Keyword And Ignore Error    OVSDB.Check OVS OpenFlow Connections    ${OS_CNTL_IP}    3
    : FOR    ${index}    IN RANGE    0    3
    ...
    BuiltIn.Run Keyword And Ignore Error    OVSDB.Check OVS OpenFlow Connections    ${OS_CONTROL_NODE_IP}    2

...
Verify creation of host route via openstack subnet update option
    ...
    ...    @{SUBNET_CIDR}[2]\\s+${NON_NEUTRON_NEXTHOP}
...
Verify creation of host route via openstack subnet set option with VM port as next hop IP with change in destination prefix
    ...
    ...    @{SUBNET_CIDR}[2]\\s+@{GATEWAY_VM_IPS}[0]
...
Verify creation of host route via openstack subnet set option with change in next hop IP
    ...
    BuiltIn.Wait Until Keyword Succeeds    30s    5s    Utils.Check For Elements At URI    ${SUBNETWORK_URL}    ${elements}
    BuiltIn.Wait Until Keyword Succeeds    60s    10s    Verify Hostroutes In VM    @{NETWORKS}[0]    ${NETWORK_1_VM_IPS}    @{SUBNET_CIDR}[1]\\s+@{SUBNET_GW_IP}[0]
    ...    @{SUBNET_CIDR}[2]\\s+@{GATEWAY_VM_IPS}[0]
...
Verify host route in VM with multi destination prefix to next hop IP VM.
    ...
    ${elements} =    BuiltIn.Create List    "destination":"@{EXTRA_SUBNETS_CIDR}[0]${PREFIX24}","nexthop":"@{GATEWAY_VM_IPS}[0]"    "destination":"@{EXTRA_SUBNETS_CIDR}[1]${PREFIX24}","nexthop":"@{GATEWAY_VM_IPS}[0]"    "destination":"@{EXTRA_SUBNETS_CIDR}[2]${PREFIX24}","nexthop":"@{GATEWAY_VM_IPS}[0]"    "destination":"@{EXTRA_SUBNETS_CIDR}[3]${PREFIX24}","nexthop":"@{GATEWAY_VM_IPS}[0]"    "destination":"@{EXTRA_SUBNETS_CIDR}[4]${PREFIX24}","nexthop":"@{GATEWAY_VM_IPS}[0]"
    ...    "destination":"@{EXTRA_SUBNETS_CIDR}[5]${PREFIX24}","nexthop":"@{GATEWAY_VM_IPS}[0]"
    BuiltIn.Wait Until Keyword Succeeds    30s    5s    Utils.Check For Elements At URI    ${SUBNETWORK_URL}    ${elements}
    Verify Hostroutes In Subnet    @{SUBNETS}[0]    destination='@{EXTRA_SUBNETS_CIDR}[0]${PREFIX24}',\\sgateway='@{GATEWAY_VM_IPS}[0]'    destination='@{EXTRA_SUBNETS_CIDR}[1]${PREFIX24}',\\sgateway='@{GATEWAY_VM_IPS}[0]'    destination='@{EXTRA_SUBNETS_CIDR}[2]${PREFIX24}',\\sgateway='@{GATEWAY_VM_IPS}[0]'    destination='@{EXTRA_SUBNETS_CIDR}[3]${PREFIX24}',\\sgateway='@{GATEWAY_VM_IPS}[0]'    destination='@{EXTRA_SUBNETS_CIDR}[4]${PREFIX24}',\\sgateway='@{GATEWAY_VM_IPS}[0]'
    ...    destination='@{EXTRA_SUBNETS_CIDR}[5]${PREFIX24}',\\sgateway='@{GATEWAY_VM_IPS}[0]'
    BuiltIn.Wait Until Keyword Succeeds    60s    10s    Verify Hostroutes In VM    @{NETWORKS}[0]    ${NETWORK_1_VM_IPS}    @{EXTRA_SUBNETS_CIDR}[0]\\s+@{GATEWAY_VM_IPS}[0]
    ...    @{EXTRA_SUBNETS_CIDR}[1]\\s+@{GATEWAY_VM_IPS}[0]    @{EXTRA_SUBNETS_CIDR}[2]\\s+@{GATEWAY_VM_IPS}[0]    @{EXTRA_SUBNETS_CIDR}[3]\\s+@{GATEWAY_VM_IPS}[0]    @{EXTRA_SUBNETS_CIDR}[4]\\s+@{GATEWAY_VM_IPS}[0]    @{EXTRA_SUBNETS_CIDR}[5]\\s+@{GATEWAY_VM_IPS}[0]

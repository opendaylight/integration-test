...
@{GATEWAY_PORTS}    host_route_gw_port_1    host_route_gw_port_2    host_route_gw_port_3    host_route_gw_port_4    host_route_gw_port_5    host_route_gw_port_6
...
@{NETWORK_4_VMS}    host_route_vm_6    host_route_vm_6
...
Verify creation of host route via openstack subnet create option
    ...
    OpenStackOperations.Create Port    ${NETWORKS[${0}]}    ${GATEWAY_PORTS[${0}]}    ${SECURITY_GROUP}    ${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${2}]}    ${GATEWAY_PORTS[${4}]}    ${SECURITY_GROUP}    ${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Vm Instance With Ports On Compute Node    ${GW_PORTS[${0}]}    ${GW_PORTS[${1}]}    ${VM_INSTANCES_GW[${0}]}    ${OS_CMP1_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance With Ports On Compute Node    ${GW_PORTS[${4}]}    ${GW_PORTS[${5}]}    ${VM_INSTANCES_GW[${1}]}    ${OS_CMP2_HOSTNAME}    sg=${SECURITY_GROUP}
...
Create Setup
    ...
    OpenStackOperations.Create Port    ${NETWORKS[${1}]}    ${PORTS[${1}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${2}]}    ${PORTS[${2}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${3}]}    ${PORTS[${3}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${1}]}    ${PORTS[${4}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${2}]}    ${PORTS[${5}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${3}]}    ${PORTS[${6}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${1}]}    ${GATEWAY_PORTS[${1}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${2}]}    ${GATEWAY_PORTS[${2}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${3}]}    ${GATEWAY_PORTS[${3}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Port    ${NETWORKS[${1}]}    ${GATEWAY_PORTS[${5}]}    sg=${SECURITY_GROUP}    ${allowed_address_pairs}=${ALLOWED_ADDRESS_PAIR}
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${PORTS[${1}]}    ${NETWORK_2_VMS[${0}]}    ${OS_CMP1_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${PORTS[${2}]}    ${NETWORK_3_VMS[${0}]}    ${OS_CMP1_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${PORTS[${3}]}    ${NETWORK_4_VMS[${0}]}    ${OS_CMP1_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${PORTS[${4}]}    ${NETWORK_2_VMS[${1}]}    ${OS_CMP2_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${PORTS[${5}]}    ${NETWORK_3_VMS[${1}]}    ${OS_CMP2_HOSTNAME}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance With Port On Compute Node    ${PORTS[${6}]}    ${NETWORK_4_VMS[${1}]}    ${OS_CMP2_HOSTNAME}    sg=${SECURITY_GROUP}
    ...
    BuiltIn.Set Suite Variable    @{NETWORK_2_VMS}
    BuiltIn.Should Not Contain    @{NETWORK_2_VMS}    None
    BuiltIn.Set Suite Variable    @{NETWORK_3_VMS}
    BuiltIn.Should Not Contain    @{NETWORK_3_VMS}    None
    BuiltIn.Set Suite Variable    @{NETWORK_4_VMS}
    BuiltIn.Should Not Contain    @{NETWORK_4_VMS}    None

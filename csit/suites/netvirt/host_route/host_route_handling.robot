...
Verify creation of host route via openstack subnet create option
    ...
    ${NETWORK_1_VM_IPS}    ${NETWORK_1_DHCP_IP} =    OpenStackOperations.Get VM IP    fail_on_none='true'    ${NETWORK_1_VMS}
    ...
    BuiltIn.Should Not Contain    @{GATEWAY_VM_IPS}    None
...
#    : FOR    ${i}    IN RANGE    2    5
#    \    @{NETWORK_${i}_VM_IPS}    ${NETWORK_${i}_DHCP_IP} =    OpenStackOperations.Get VM IPs    @{NETWORK_${i}_VMS}
#    \    BuiltIn.Should Not Contain    @{NETWORK_${i}_VM_IPS}    None
#    \    BuiltIn.Set Suite Variable    @{NETWORK_${i}_VM_IPS}
    ...
    BuiltIn.Should Not Contain    @{NETWORK_2_VM_IPS}    None
    BuiltIn.Set Suite Variable    @{NETWORK_3_VM_IPS}
    BuiltIn.Should Not Contain    @{NETWORK_3_VM_IPS}    None
    BuiltIn.Set Suite Variable    @{NETWORK_4_VM_IPS}
    BuiltIn.Should Not Contain    @{NETWORK_4_VM_IPS}    None

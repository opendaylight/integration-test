...
Verification of route update after VM port removed and re added to VPN
    ...
    ${output}=    Wait Until Keyword Succeeds    30s    10s    VpnOperations.Get Fib Entries    session
...
Verification of route update after reconfiguring vpn by adding new ports
    ...
    @{VM_IP_NET1_New}    ${NET_1_DHCP_IP} =    OpenStackOperations.Get VM IPs    @{VM_NAME_NEW}

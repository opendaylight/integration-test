...
Add Multiple Extra Routes And Check Datapath Before L3VPN Creation
    ...
    OpenStackOperations.Update Router    @{ROUTER}[0]    ${cmd}
    OpenStackOperations.Show Router    @{ROUTER}[0]    -D
...
Delete Extra Route
    OpenStackOperations.Update Router    @{ROUTER}[0]    ${RT_CLEAR}
    OpenStackOperations.Show Router    @{ROUTER}[0]    -D
...
Delete And Recreate Extra Route
    ...
    [Teardown]    BuiltIn.Run Keywords    OpenStackOperations.Update Router    @{ROUTER}[0]    ${RT_CLEAR}
    ...    AND    OpenStackOperations.Show Router    @{ROUTER}[0]    -D
    ...    AND    OpenStackOperations.Get Test Teardown Debugs

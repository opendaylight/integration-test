...
Create Neutron Ports
    ...
    ${allowed_address_pairs_args}=    BuiltIn.Set Variable    --allowed-address-pairs type=dict list=true ip_address=${EXTRA_NW_SUBNET[0]} ip_address=${EXTRA_NW_SUBNET[1]} ip_address=${EXTRA_NW_SUBNET[2]} ip_address=${EXTRA_NW_SUBNET[3]}

...
Add Multiple Extra Routes And Check Datapath Before L3VPN Creation
    ...
    \    BuiltIn.Should Contain    ${output}    64 bytes
    \    ${output} =    OpenStackOperations.Execute Command on VM Instance    @{NETWORKS}[0]    ${NET_2_VM_IPV4[0]}    ping -c 3 ${EXTRA_NW_IP}
    \    BuiltIn.Should Contain    ${output}    64 bytes
    \    ${output} =    OpenStackOperations.Execute Command on VM Instance    @{NETWORKS}[0]    ${NET_2_VM_IPV4[1]}    ping -c 3 ${EXTRA_NW_IP}
    \    BuiltIn.Should Contain    ${output}    64 bytes
    ...
    \    BuiltIn.Should Contain    ${output}    64 bytes
    \    ${output} =    OpenStackOperations.Execute Command on VM Instance    @{NETWORKS}[0]    ${NET_2_VM_IPV6[0]}    ping6 -c 3 ${EXTRA_NW_IP}
    \    BuiltIn.Should Contain    ${output}    64 bytes
    \    ${output} =    OpenStackOperations.Execute Command on VM Instance    @{NETWORKS}[0]    ${NET_2_VM_IPV6[1]}    ping6 -c 3 ${EXTRA_NW_IP}
    \    BuiltIn.Should Contain    ${output}    64 bytes

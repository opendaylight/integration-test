...
Check L3_Datapath Traffic Across Networks With Router
    ...
    Test Operations From Vm Instance    @{NETWORKS}[0]    @{NET_1_VM_IPV4}[0]    ${NET_2_VM_IPV4}
    Test Operations From Vm Instance    @{NETWORKS}[1]    @{NET_2_VM_IPV4}[0]    ${NET_1_VM_IPV4}
    Test Operations From Vm Instance    @{NETWORKS}[0]    @{NET_1_VM_IPV6}[0]    ${NET_2_VM_IPV6}
    Test Operations From Vm Instance    @{NETWORKS}[1]    @{NET_2_VM_IPV6}[0]    ${NET_1_VM_IPV6}

...
Check L3_Datapath Traffic Across Networks With Router
    ...
    VpnOperations.Verify GWMAC Flow Entry On Flow Table On All Compute Nodes
    ...
    #BuiltIn.Set Suite Variable    ${GWIP_ADDRS}
    VpnOperations.Verify GWMAC Flow Entry On Flow Table On All Compute Nodes    ipv6
    BuiltIn.Log    L3 Datapath test across the networks using router
    OpenStackOperations.Test Operations From Vm Instance    @{NETWORKS}[0]    @{NET_1_VM_IPV4}[0]    ${NET_2_VM_IPV4}
    OpenStackOperations.Test Operations From Vm Instance    @{NETWORKS}[1]    @{NET_2_VM_IPV4}[0]    ${NET_1_VM_IPV4}
    OpenStackOperations.Test Operations From Vm Instance    @{NETWORKS}[0]    @{NET_1_VM_IPV6}[0]    ${NET_2_VM_IPV6}
    OpenStackOperations.Test Operations From Vm Instance    @{NETWORKS}[1]    @{NET_2_VM_IPV6}[0]    ${NET_1_VM_IPV6}

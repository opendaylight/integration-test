...
Verify Data Traffic On Configured Subnet Ipv4/IPv6 Address
    ...
    BuiltIn.Wait Until Keyword Succeeds    30s    5s    Verify Ipv4 Data Traffic
    BuiltIn.Wait Until Keyword Succeeds    30s    5s    Verify Ipv6 Data Traffic
...
Dissociate L3VPN From Routers and verify traffic
    ...
    BuiltIn.Wait Until Keyword Succeeds    30s    5s    Verify Ipv4 Data No Traffic
    BuiltIn.Wait Until Keyword Succeeds    30s    5s    Verify Ipv6 Data No Traffic

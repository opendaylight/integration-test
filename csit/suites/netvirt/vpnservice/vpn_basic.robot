...
Add Multiple Extra Routes And Check Datapath Before L3VPN Creation
    ...
    ${ext_rt1} =    BuiltIn.Set Variable    destination=@{EXTRA_NW_SUBNET}[0]/24,gateway=@{NET_1_VM_IPS}[0]
    ${ext_rt2} =    BuiltIn.Set Variable    destination=@{EXTRA_NW_SUBNET}[1]/24,gateway=@{NET_1_VM_IPS}[0]

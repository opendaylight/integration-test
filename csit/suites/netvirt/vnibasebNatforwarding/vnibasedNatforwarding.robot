...
@{VNI_NAT_FIXED_IPS}    71.1.1.5    71.1.1.6
${VNI_NAT_NETWORKS}    vni_nat_net_1
@{VNI_NAT_PORTS}    vni_nat_port_1    vni_nat_port_2
${VNI_NAT_PROVIDER_NETWORK_TYPE}    gre
${VNI_NAT_ROUTER}    vni_nat_router1
${VNI_NAT_SECURITY_GROUP}    vni_nat_sg
${VNI_NAT_SUBNET_CIDRS}    71.1.1.0/24
${VNI_NAT_SUBNETS}    vni_nat_sub_1
@{VNI_NAT_VMS}    vni_nat_vm_1    vni_nat_vm_1
${VNI_PORT}       vni_port3
${VNI_VM}         vni_vm3
${VNI_NAT_RDS}    ["2200:2"]
...
Vni Based NAT Forwarding SNAT To DNAT
    ...
    #get nat switch
    ${napt_switch_id} =    OpenStackOperations.Get Napt Switch Id
    ...
    Run Keyword If    "${dpn_id1}" == "${napt_switch_id}"    Verify Snat Based Vni Segmentation Id and Tunnel Id    ${OS_CMP1_CONN_ID}    ${OS_CMP2_CONN_ID}    ${OS_CMP2_HOSTNAME}

...
Verify Snat Based Vni Segmentation Id and Tunnel Id
    [Arguments]    ${napt_switch_id}    ${non_napt_switch_id}    ${host_name}    ${floating_ip}    ${vm_ip}
    ...
    ${tunnel_id} =    BuiltIn.Convert To Integer    ${output}    16
    BuiltIn.Should Be Equal As Numbers    ${router_vni_value}    ${tunnel_id}
    OpenStackOperations.Test Netcat Operations From Vm Instance    ${VNI_NAT_NETWORKS}    @{NET_VM_IPS}[2]    ${vm_ip}

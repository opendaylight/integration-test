...
Verify Multipath
    ...
    Run Keyword If    ${Enable}==True    BuiltIn.Should Contain    ${output}    ${Address-Families}
    ...    ELSE    BuiltIn.Should Not Contain    ${output}    ${Address-Families}

...
TC13_Verify route resynchronization of DC-GW with QBGP, when one or more DC-GW fails/rebooted
    ...
    BuiltIn.Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[0]    1
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[1]    1
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[2]    1
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[0]    1
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[1]    1
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[2]    1
    Verify Route Entry With Nexthop    @{RD}[0]    @{NETWORK_IP}[0]    start=0    end=1
    ...
    BuiltIn.Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[0]    0
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[0]    0
...
TC15_Verify the scenario when CSC receives back to back route advertisement and withdrawal for the same prefix and single VRF
    ...
    BuiltIn.Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[0]    2
    BuiltIn.Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[0]    2
...
TC16_Verify the scenario when CSC receives back to back route advertisement and withdrawal for the same prefix and multi VRF after Qbpg restart
    ...
    Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[0]    1
    Wait Until Keyword Succeeds    10s    2s    Verify Routing Entry    @{RD}[1]    @{NETWORK_IP}[0]    2
    Wait Until Keyword Succeeds    10s    2s    Verify Routing Entry    @{RD}[2]    @{NETWORK_IP}[0]    3
    Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[0]    6
    Verify Route Entry With Nexthop    @{RD}[0]    @{NETWORK_IP}[0]    start=0    end=1
    ...
    Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[0]    0
    Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[1]    @{NETWORK_IP}[0]    1
    Wait Until Keyword Succeeds    10s    2s    Verify Routing Entry    @{RD}[2]    @{NETWORK_IP}[0]    2
    Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[0]    3
    Add Routes    @{DCGW_IP_LIST}[0]    @{DCGW_RD}[0]    @{NETWORK_IP}[0]    @{LABEL}[0]
    Add Routes    @{DCGW_IP_LIST}[1]    @{DCGW_RD}[1]    @{NETWORK_IP}[0]    @{LABEL}[1]
    Add Routes    @{DCGW_IP_LIST}[2]    @{DCGW_RD}[2]    @{NETWORK_IP}[0]    @{LABEL}[2]
    Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[0]    @{NETWORK_IP}[0]    1
    Wait Until Keyword Succeeds    60s    10s    Verify Routing Entry    @{RD}[1]    @{NETWORK_IP}[0]    2
    Wait Until Keyword Succeeds    10s    2s    Verify Routing Entry    @{RD}[2]    @{NETWORK_IP}[0]    3
    Wait Until Keyword Succeeds    10s    2s    Verify FIB Entry    @{NETWORK_IP}[0]    6

...
Create And Verify Networks Subnets And Ports
    ...
    Create SubNet    ${NETWORKS[0]}    ${SUBNETS[0]}    ${SUBNET_CIDR[0]}    additional_args=--enable-dhcp
    Create SubNet    ${NETWORKS[1]}    ${SUBNETS[1]}    ${SUBNET_CIDR[1]}    additional_args=--enable-dhcp

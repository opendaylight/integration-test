...
Wait For Full Sync
    ...
    #Wait Until Keyword Succeeds    90s    5s    OpenStackOperations.Neutron Port List Rest
    #BuiltIn.Sleep       20s
...
Canary Network Should Exist
    BuiltIn.Log       OpenStackOperations.List Networks
    ${net_show}=      OpenStackOperations.Show Network      "Sync Canary Network"
    BuiltIn.Should Contain      ${net_show}     bd8db3a8-2b30-4083-a8b3-b3fd46401142

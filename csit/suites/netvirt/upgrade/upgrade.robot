...
Stop ODL
    ...
    ClusterManagement.Stop_Members_From_List_Or_All    wait_for_sync=False
...
Create resources
    ...
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS}[0]    ${NET_1_VMS}    ${OS_COMPUTE_1_IP}    sg=${SECURITY_GROUP}
    Run Keyword If    2 < ${NUM_OS_SYSTEM}    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS}[1]    ${NET_2_VMS}    ${OS_COMPUTE_2_IP}    sg=${SECURITY_GROUP}

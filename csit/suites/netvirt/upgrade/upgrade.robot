...
Create resources
    ...
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS}[0]    ${NET_1_VMS}    sg=${SECURITY_GROUP}
    OpenStackOperations.Create Vm Instance On Compute Node    @{NETWORKS}[1]    ${NET_2_VMS}    sg=${SECURITY_GROUP}

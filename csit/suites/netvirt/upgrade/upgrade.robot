...
*** Variables ***
${LOG_LOCATION}    /w/workspace/janki-netvirt-csit-1node-openstack-queens-upstream-stateful-oxygen-upgrade
${LOG_BEFORE_RESTART}    ${LOG_LOCATION}/archives/LOG_BEFORE_RESTART.txt
${LOG_AFTER_RESTART}    ${LOG_LOCATION}/archives/LOG_AFTER_RESTART.txt
...
Start ODL
    ...
    KarafKeywords.Execute_Controller_Karaf_Command_On_Background    log:set DEBUG org.opendaylight.ovsdb
    KarafKeywords.Execute_Controller_Karaf_Command_On_Background    log:set DEBUG org.opendaylight.ovsdb.lib
    KarafKeywords.Execute_Controller_Karaf_Command_On_Background    log:set DEBUG org.opendaylight.netvirt
    KarafKeywords.Execute_Controller_Karaf_Command_On_Background    log:set DEBUG org.opendaylight.genius
    KarafKeywords.Execute_Controller_Karaf_Command_On_Background    log:list

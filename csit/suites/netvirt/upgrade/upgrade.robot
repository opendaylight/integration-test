...
Start ODL
    ...
    ${features} =       KarafKeywords.Issue_Command_On_Karaf_Console    feature:list
    BuiltIn.Log         ${features}
...
Set Custom Component Logging To
    [Arguments]     ${level}
    KarafKeywords.Issue_Command_On_Karaf_Console    log:set ${level} org.opendaylight.ovsdb
    KarafKeywords.Issue_Command_On_Karaf_Console    log:set ${level} org.opendaylight.ovsdb.lib
    KarafKeywords.Issue_Command_On_Karaf_Console    log:set ${level} org.opendaylight.netvirt
    KarafKeywords.Issue_Command_On_Karaf_Console    log:set ${level} org.opendaylight.genius

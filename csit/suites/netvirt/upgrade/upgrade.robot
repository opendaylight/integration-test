...
${ROUTER}         router_1
${TYPE}           tun
${KARAF_HOME1}    ${WORKSPACE}${/}${BUNDLEFOLDER}
...
Wipe Cache
    ...
    SSHLibrary.Get Directory    ${KARAF_HOME1}/data/log    karaf_log/before_delete/    recursive=True
    ClusterManagement.Clean_Journals_And_Snapshots_On_List_Or_All

Start ODL
    [Documentation]    Install odl-netvirt-openstack and Start ODL
    TopoprocessingKeywords.Install Features    odl-netvirt-openstack
...
Trigger Full Sync
    ...
    RequestsLibrary.Create Session    ODL_SESSION    http://${ODL_SYSTEM_IP}:${PORT}

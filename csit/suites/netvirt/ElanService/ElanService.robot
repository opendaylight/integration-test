...
Verify Datapath for Multiple ELAN with Multiple DPN
    ...
    ${cn1_conn_id} =    Start Packet Capture on Node    node_ip=${OS_CMP1_IP}    file_Name=${filename_prefix}_CN1
    ${cn2_conn_id} =    Start Packet Capture on Node    node_ip=${OS_CMP2_IP}    file_Name=${filename_prefix}_CN2

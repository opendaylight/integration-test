...
Delete All ELAN1 VM And Verify Flow Table Updated
    ...
    Wait Until Keyword Succeeds    30s    5s    Verify Flows Are Removed For ELAN Service    ${OS_CMP1_IP}    ${VM_MACAddr_ELAN1}
    Wait Until Keyword Succeeds    30s    5s    Verify Flows Are Removed For ELAN Service    ${OS_CMP2_IP}    ${VM_MACAddr_ELAN1}

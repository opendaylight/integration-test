...
Create l2vlan transparent interface
    ...
    Wait Until Keyword Succeeds    10    5    get operational interface    ${interface_name}
    ${ovs-check}    Wait Until Keyword Succeeds    30    10    table0 entry    ${conn_id_1}    ${bridgename}

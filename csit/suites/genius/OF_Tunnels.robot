...
Verify Reference Count with Selective BFD
    ...
    \    BuiltIn.Wait Until Keyword Succeeds    60    5    OFT Set BFD State per Switch    @{DPN_ID_LIST}[${num}]    ${dst_dpn_id_list}
    \    ...    ${True}
    \    BuiltIn.Wait Until Keyword Succeeds    60    5    OFT Verify BFD State per Switch    @{DPN_ID_LIST}[${num}]    ${dst_dpn_id_list}
    \    ...    ${True}
    \    BuiltIn.Wait Until Keyword Succeeds    60    5    OFT Verify Reference Count per Source    @{DPN_ID_LIST}[${num}]    ${dst_dpn_id_list}
    \    ...    1
    \    BuiltIn.Wait Until Keyword Succeeds    60    5    OFT Verify P2P per Source    @{DPN_ID_LIST}[${num}]    ${dst_dpn_id_list}
    \    ...    ${True}
...
Delete and Verify OFT TEPs with Non-Zero Reference Count
    ...
    \    BuiltIn.Wait Until Keyword Succeeds    60    5    OFT Verify P2P per Source    ${src_dpn_id}    ${DPN_ID_LIST}
    \    ...    ${False}

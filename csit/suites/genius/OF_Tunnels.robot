...
Verify Creation and Deletion of OF based tunnels on 2 DPNs
    ...
    ...    ${FILENAME1}
    OVSDB.Ovs Verification For Tunnels    ${conn_id_1}    True    ${REMOTE_FLOW}
    ${ovs_of_tunnel_1} =    BuiltIn.Wait Until Keyword Succeeds    40    10    Get Tunnel From OVS Show    ${conn_id_1}    ${Bridge-1}
    BuiltIn.Should Match Regexp    ${ovs_of_tunnel_1}    ${TUN}
    ${ovs_of_tunnel_2} =    BuiltIn.Wait Until Keyword Succeeds    40    10    Get Tunnel From OVS Show    ${conn_id_2}    ${Bridge-2}
    ...
    ...    ${REMOTE_FLOW}    ${ovs_of_tunnel_2}    ${tunnel-type}

...
Delete and Verify VTEP
    ...
    \    KarafKeywords.Issue Command On Karaf Console    tep:delete @{DPN_ID_LIST}[${dpn_id_index}] ${port_name} ${NO_VLAN} ${node} ${subnet}/24 null ${itm_created[0]}
    \    KarafKeywords.Issue Command On Karaf Console    tep:commit
...
Get Tunnels On OVS
    ...
    \    ...    ${DPN_ID_UPDATED_LIST[${tool_system_index}]}

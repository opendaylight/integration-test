...
Verify Tunnels By Enabling/Disabling BFD
    ...
    BuiltIn.Run Keyword If    '${branch}' == 'ATLEAST NEON'    BuiltIn.Run Keywords    Verify Tunnels By Enabling BFD    Verify Tunnels By Disabling BFD
    BuiltIn.Run Keyword If    '${branch}' == 'LESS THAN NEON'    BuiltIn.Run Keywords    Verify Tunnels By Disabling BFD    Verify Tunnels By Enabling BFD

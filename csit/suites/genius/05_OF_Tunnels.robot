...
Configure and verify OF based tunnels on all 3 DPNs
    ...
    #${Dpn_id_1}=    Set Variable    33622755178570
    #${Dpn_id_2}=    Set Variable    134557323923267
    #${Dpn_id_3}=    Set Variable    59791788831304
    Set Global Variable    ${Dpn_id_1}
    Set Global Variable    ${Dpn_id_2}
    Set Global Variable    ${Dpn_id_3}
    ${vlan}=    Set Variable    0
    ...
    Display OVS Show    ${conn_id_3}
    Sleep    2
    Display IFCONFIG    ${conn_id_1}
    Display IFCONFIG    ${conn_id_2}
    Display IFCONFIG    ${conn_id_3}
...
Configure and verify OF based tunnels on two of 3 DPNs
    ...
    # Below hardcoded DPN IDs is for testing environment.
    # Remove while commiting to CSIT
    #${Dpn_id_1}    Set Variable    165679944141894
    #${Dpn_id_2}    Set Variable    217736862464844
    #${Dpn_id_3}    Set Variable    95456445293636
    Set Global Variable    ${Dpn_id_1}
    Set Global Variable    ${Dpn_id_2}
    Set Global Variable    ${Dpn_id_3}
    ${vlan}=    Set Variable    0
...
Display IFCONFIG
    [Arguments]    ${connection_id}
    Switch connection    ${connection_id}
    ${cmd}    set Variable    sudo ifconfig -a
    ${Bridgename1}    Execute command    ${cmd}
    log    ${Bridgename1}

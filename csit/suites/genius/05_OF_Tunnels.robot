...
Verify OF based tunnels on all 2 DPNs
    ...
    #${Dpn_id_1}    Set Variable    2922211818825
    #${Dpn_id_2}    Set Variable    235520975767118
    #${Dpn_id_3}    Set Variable    279536641571662
...
Verify OF tunnels on 1 DPN and non-OF tunnel on another DPN
    ...
    #${Dpn_id_1}    Set Variable    266377360759622
    #${Dpn_id_2}    Set Variable    77953314085704
    #${Dpn_id_3}    Set Variable    279536641571662
...
Configure and verify OF based tunnels on all 3 DPNs
    ...
    #${Dpn_id_1}    Set Variable    33916391896905
    #${Dpn_id_2}    Set Variable    196342776294723
    #${Dpn_id_3}    Set Variable    165636899526728
...
Verify OF Tunnel ports gets deleted when TEP is deleted from DPN
    ...
    ${resp}    RequestsLibrary.Put Request    session    ${CONFIG_API}/itm:transport-zones/transport-zone/TZA    data=${2_node_vtep}
    ${respjson}    RequestsLibrary.To Json    ${resp.content}    pretty_print=True
    Log    ${respjson}

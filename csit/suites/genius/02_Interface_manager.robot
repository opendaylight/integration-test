...
Create l2vlan trunk interface
    ...
    log    ${get_oper_resp}
    Comment    sleep    5
    ${resp}    Wait Until Keyword Succeeds    30    10    table0 entry    ${mininet1_conn_id_1}    ${bridgename}
...
Create l2vlan Trunk member interface
    ...
    log    ${get_oper_resp}
    Wait Until Keyword Succeeds    30    10    ovs check for member interface creation    ${mininet1_conn_id_1}    ${bridgename}
...
Bind service on Interface
    ...
    ${Ovs-resp}    Wait Until Keyword Succeeds    15    5    table entry    ${command}
    log    ${Ovs-resp}
...
Create l2vlan transparent interface
    ...
    ${get_oper_resp}    Wait Until Keyword Succeeds    10    5    get operational interface    ${interface_name}
    log    ${get_oper_resp}
    ${ovs-check}    Wait Until Keyword Succeeds    15    5    table0 entry    ${mininet1_conn_id_1}    ${bridgename}

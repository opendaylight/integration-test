...
Create l2vlan trunk interface
    ...
    @{l2vlan}    BuiltIn.Create List    l2vlan-trunk    l2vlan    trunk    tap8ed70586-6c    true
    Utils.Check For Elements At URI    ${CONFIG_API}/ietf-interfaces:interfaces/    ${l2vlan}
    BuiltIn.Wait Until Keyword Succeeds    50    5    get operational interface    ${interface_name}
...
Create l2vlan Trunk member interface
    ...
    @{l2vlan}    BuiltIn.Create List    l2vlan-trunk1    l2vlan    trunk-member    1000    l2vlan-trunk
    ...    true
    Utils.Check For Elements At URI    ${CONFIG_API}/ietf-interfaces:interfaces/    ${l2vlan}
...
table entry
    ...
    ${result} =    Utils.Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    sudo ovs-ofctl -O OpenFlow13 dump-flows ${BRIDGE}
...
no table0 entry
    ...
    ${ovs-check} =    Utils.Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    sudo ovs-ofctl -O OpenFlow13 dump-flows ${BRIDGE}
...
no goto_table entry
    ...
    ${ovs-check1} =    Utils.Run Command On Remote System And Log    ${TOOLS_SYSTEM_1_IP}    sudo ovs-ofctl -O OpenFlow13 dump-flows ${BRIDGE}
...
table0 entry
    ...
    ${ovs-check} =    Utils.Run Command On Remote System And Log    ${tools_ip}    sudo ovs-ofctl -O OpenFlow13 dump-flows ${BRIDGE}

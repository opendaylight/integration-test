...
Create Bridge
    ...
    Run Command On Remote System    ${TOOLS_SYSTEM_1_IP}    sudo ovs-vsctl set bridge BR1 protocols=OpenFlow13
    Run Command On Remote System    ${TOOLS_SYSTEM_1_IP}    sudo ifconfig BR1 up
    Run Command On Remote System    ${TOOLS_SYSTEM_1_IP}    sudo ovs-vsctl add-port BR1 tap8ed70586-6c -- set Interface tap8ed70586-6c type=tap
...
Create VTEP and Verify
    ...
    Comment    Genius.Verify Tunnel Status as UP    TZA

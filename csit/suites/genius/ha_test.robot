...
Verify interface after taking down ODL1
...
Verify interface after bringing up ODL1
    Verify IETF Interfaces
...
Start Suite
    ...
    ${conn_id_1}=    Open Connection    ${TOOLS_SYSTEM_1_IP}
    Set Suite Variable    ${conn_id_1}
    ${conn_id_2}=    Open Connection    ${TOOLS_SYSTEM_2_IP}
    Set Suite Variable    ${conn_id_2}
...
Create Bridge
    ...
    : FOR    ${i}    IN RANGE    1    ${NUM_ODL_SYSTEM}

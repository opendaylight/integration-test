...
BFD_TC00 Create ITM between DPNs Verify_BFD_Enablement
    ...
    Genius.Create Vteps    ${Dpn_id_1}    ${Dpn_id_2}    ${TOOLS_SYSTEM_1_IP}    ${TOOLS_SYSTEM_2_IP}    ${vlan}    ${gateway-ip}
    Genius.Create Vteps    ${Dpn_id_1}    ${Dpn_id_3}    ${TOOLS_SYSTEM_1_IP}    ${TOOLS_SYSTEM_3_IP}    ${vlan}    ${gateway-ip}

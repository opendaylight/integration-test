...
Create and Verify VTEP -No Vlan
    ...
    Wait Until Keyword Succeeds    40    5    Genius.Verify Tunnel Status as UP
    ...
    ${port_num}    Genius.Get Port Number
    : FOR    ${i}    INRANGE    ${NUM_TOOLS_SYSTEM}
    \    Wait Until Keyword Succeeds    40    10    Genius.Check Table0 Entry For 2 Dpn    ${conn_id_list[${i}]}    ${Bridge_List[${i}]}
    \    ...    ${port_num}

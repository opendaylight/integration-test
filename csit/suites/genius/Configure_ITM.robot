...
Delete and Verify VTEP IPv6 -No Vlan
    ...
    ${tunnel-1}    Get_Tunnel    ${Dpn_id_1}    ${Dpn_id_2}    ${type}
    ${tunnel-2}    Get_Tunnel    ${Dpn_id_2}    ${Dpn_id_1}    ${type}
    Remove All Elements At URI And Verify    ${CONFIG_API}/itm-state:dpn-endpoints/DPN-TEPs-info/${Dpn_id_1}/tunnel-end-points/@{PORT}[0]/@{VLAN}[0]/${ipv6_1}/VXLAN/tz-membership/${itm_created[0]}
    Remove All Elements At URI And Verify    ${CONFIG_API}/itm-state:dpn-endpoints/DPN-TEPs-info/${Dpn_id_2}/tunnel-end-points/@{PORT}[1]/@{VLAN}[0]/${ipv6_2}/VXLAN/tz-membership/${itm_created[0]}

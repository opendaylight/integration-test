...
Verify TEPs with transport zone configured from OVS will be added to corresponding transport zone
    ...
    :FOR    ${node_number}    IN RANGE    0    2
    \    ${output} =    Utils.Run Command On Remote System    @{TOOLS_SYSTEM_ALL_IPS}[${node_number}]    ${GET_EXTERNAL_IDS}
    ...
    BuiltIn.Wait Until Keyword Succeeds    3x    10 sec    Genius.Verify Tunnel Status as Up    2

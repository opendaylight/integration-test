...
@{NET_1_VMS}      vm_1    vm_2    vm_3    vm_4    vm_5    vm_6    vm_7    vm_8
${ROUTER}         router1   
...
#    ${vm1_ip}    Wait Until Keyword Succeeds    240s    10s    Get VM IP    @{NETWORKS}[0]     @{NET_1_VMS}[0]
#    ${vm2_ip}    Wait Until Keyword Succeeds    240s    10s    Get VM IP    @{NETWORKS}[0]     @{NET_1_VMS}[0]
#    sleep    40s

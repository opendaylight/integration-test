...
Verify TEP in controller and transport zone in OVSDB table of compute nodes
    ...
    Utils.Get URI And Verify    session    ${TUNNEL_NAME}${DPN2}/${DPN1}/${TUNNEL_TYPE_KEY_VAL}
    Utils.Get URI And Verify    session    ${TUNNEL_NAME}${DPN1}/${DPN2}/${TUNNEL_TYPE_KEY_VAL}
...
Verify TEPs with transport zone configured from OVS will be added to corresponding transport zone
    ...
    Utils.Get URI And Verify    session    ${TRANSPORT_ZONE_ENDPOINT_URL}/${DEFAULT_TRANSPORT_ZONE}

...
Dumb Test1
    ...
    \    SSHLibrary.Execute Command    sudo docker exec container${count} ovs-vsctl -- set-manager tcp:${ODL_SYSTEM_IP}:6640 -- ovs-vsctl set-controller br-int tcp:${ODL_SYSTEM_IP}:6653

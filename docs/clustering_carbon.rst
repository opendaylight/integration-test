...
.. table:: Test results
   ...
   ddb-cls-ms-ll-t_       2017-05-18    `8403 <https://bugs.opendaylight.org/show_bug.cgi?id=8403#c3>`__    `FAIL <https://logs.opendaylight.org/releng/jenkins092/controller-csit-3node-clustering-only-carbon/694/archives/log.html.gz#s1-s20-t1-k2-k8>`__
   ...
   ddb-cls-ps-lr-t_       S017-05-18                                                                        `PASS <https://logs.opendaylight.org/sandbox/jenkins091/controller-csit-3node-clustering-only-carbon/13/archives/log.html.gz#s1-s22-t3>`__
   ...
   ddb-elm-ps-rr-t_       S017-05-18                                                                        `PASS <https://logs.opendaylight.org/sandbox/jenkins091/controller-csit-3node-clustering-only-carbon/13/archives/log.html.gz#s1-s26-t1>`__

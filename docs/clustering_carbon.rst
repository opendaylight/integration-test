...
.. table:: Test results
   ...
   ddb-cls-ms-ll-t_       2017-05-19                                                                        `PASS <https://logs.opendaylight.org/releng/jenkins092/controller-csit-3node-clustering-only-carbon/698/archives/log.html.gz#s1-s20-t1>`__
   ddb-cls-ms-lr-t_       2017-05-19                                                                        `PASS <https://logs.opendaylight.org/releng/jenkins092/controller-csit-3node-clustering-only-carbon/698/archives/log.html.gz#s1-s20-t3>`__
   ...
   ddb-cls-ps-lr-t_       2017-05-19                                                                        `PASS <https://logs.opendaylight.org/releng/jenkins092/controller-csit-3node-clustering-only-carbon/698/archives/log.html.gz#s1-s22-t3>`__

...
.. table:: Releng stability results (post SR1, pre SR2)
   ...
   ddb-li-ps-dt-t      2017-08-02  2017-08-02  `8845 <https://bugs.opendaylight.org/show_bug.cgi?id=8845>`__  `tell <https://logs.opendaylight.org/releng/jenkins092/controller-csit-3node-clustering-only-carbon/802/log.html.gz#s1-s30-t3-k2-k25-k1-k8>`__
   ...
   ddb-ls-ps-lr-t      2017-08-02  2017-08-02  `8733 <https://bugs.opendaylight.org/show_bug.cgi?id=8733>`__  `tell <https://logs.opendaylight.org/releng/jenkins092/controller-csit-3node-clustering-only-carbon/802/log.html.gz#s1-s38-t1-k2-k14-k2-k1-k4-k7-k1>`__

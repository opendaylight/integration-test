...
.. table:: Test results (pre-release)
   ...
   ddb-elm-ms-lr-t_       2017-05-23    `8403 <https://bugs.opendaylight.org/show_bug.cgi?id=8403#c15>`__    `FAIL <https://logs.opendaylight.org/sandbox/jenkins091/controller-csit-3node-clustering-only-carbon/15/archives/log.html.gz#s1-s24-t1-k2-k10>`__
   ...
   ddb-elm-ms-rl-t_       2017-05-23    `8403 <https://bugs.opendaylight.org/show_bug.cgi?id=8403#c15>`__    `FAIL <https://logs.opendaylight.org/sandbox/jenkins091/controller-csit-3node-clustering-only-carbon/15/archives/log.html.gz#s1-s24-t5-k2-k10>`__
   ...
   ddb-elm-ps-rl-t_       2017-05-23    `8403 <https://bugs.opendaylight.org/show_bug.cgi?id=8403#c15>`__    `FAIL <https://logs.opendaylight.org/sandbox/jenkins091/controller-csit-3node-clustering-only-carbon/15/archives/log.html.gz#s1-s26-t5-k2-k9>`__
